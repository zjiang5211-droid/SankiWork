...
export type AgentGuideCopy = {
  ...
  // "With SankiWork" — the drive-to-OD section
  withOdTitle: string;
  withOdLead: string;
  withOdSteps: string[];
...
const INFO_PAGE_COPY: Partial<Record<LandingLocaleCode, InfoPageCopy>> = {
  en: {
    ...
    official: {
      title: 'Official SankiWork — Source page, GitHub, releases, and aliases',
      description:
        'Official source page for SankiWork (also searched as SankiWork, sankiwork, sankiwork, SankiWork AI, OD). Canonical site, GitHub repository, releases, Discord, license, and maintainer identity in one place.',
      breadcrumb: 'Official',
      label: 'Source · Nº 00',
      heading: 'Official SankiWork source page.',
      lead:
        'SankiWork (also searched as SankiWork, sankiwork, sankiwork, or SankiWork AI) is the official open-source AI design workspace from the nexu-io/open-design project. This page lists every canonical surface so you can verify the source for yourself.',
      canonicalTitle: 'Canonical surfaces',
      canonicalBody:
        'Bookmark sanki-ai.cloud and the GitHub repo. Everything else points back to one of these two.',
      sources: [
        { label: 'Official website', name: 'sanki-ai.cloud' },
      ...
      aliases: [
        { label: 'SankiWork', body: 'display name in the product UI, blog, and READMEs.' },
        { label: 'SankiWork', body: 'common one-word search variant; same project.' },
        { label: 'sankiwork', body: 'repository / package slug.' },
        { label: 'sankiwork', body: 'lowercase alias used in URLs and CLI invocations.' },
        { label: 'SankiWork AI', body: 'long-form search variant for AI-design queries.' },
        { label: 'OD', body: 'internal abbreviation for the runtime and CLI bin.' },
      ],
      aliasesClosing: 'All six names refer to this same project. The canonical URL is always sanki-ai.cloud.',
      maintainerTitle: 'Maintainer & license',
      maintainerBody:
        'SankiWork is developed in the open at github.com/nexu-io/open-design and released under the Apache-2.0 license. Issues, RFCs, and roadmap conversations happen on GitHub Issues and Discord.',
      runtimeTitle: 'What runs on your machine',
      runtimeBody: 'SankiWork ships three runnable surfaces — all open source, all local-first:',
      runtimeItems: [
    ...
    quickstart: {
      title: 'SankiWork quickstart — Install in three commands (Node 24, pnpm)',
      description:
        'Install SankiWork locally with three commands. Requirements (Node 24, pnpm 10.33.2), commands, expected output, troubleshooting, and how to generate your first design artifact with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Quickstart',
      label: 'Install · Nº 01',
      heading: 'SankiWork quickstart.',
      lead:
        'SankiWork runs entirely on your machine. Three commands gets you from a clean checkout to a running daemon, web UI, and your first generated design artifact.',
      ...
      steps: [
        {
          ...
          text:
            'Clone the sankiwork repository and install workspace dependencies with pnpm. Requires Node 24 and pnpm 10.33.2.',
      ...
      troubleshooting: [
        ...
        { label: 'Agent does not show up', body: 'check /agents/ and your .sankiwork/media-config.json credentials.' },
      ...
      nextItems: [
        ...
        { label: 'Compare SankiWork', body: 'with Claude Design, Figma Make, v0, and Lovable.' },
    ...
    agents: {
      title: 'SankiWork agents — {count} BYOK adapters',
      description:
        'SankiWork ships {count} BYOK adapters out of the box. Drive design from the same agent you use for code — no separate vendor login.',
      breadcrumb: 'Agents',
      label: 'Adapters · Nº 04',
      heading: (count) => `${count} BYOK agents, one skill protocol.`,
      lead: (count) =>
        `SankiWork ships ${count} first-party adapters out of the box. The same composable skills and portable DESIGN.md systems work with every one. BYOK throughout — your keys, your spend, your data.`,
      adaptersTitle: 'How adapters plug in',
      adaptersBody:
        'Every adapter is a thin shim between the agent native message format and SankiWork skill protocol. Adding a new adapter is a single file — no fork required.',
      tiers: [
        {
          label: 'Tier 1 — first-party tested',
          blurb:
            'Battle-tested daily by the SankiWork maintainers. Stream-JSON IPC where supported, full AskUserQuestion mid-turn, skill-aware system prompts.',
        },
        {
      ...
      byokLead: 'BYOK ("bring your own key") in SankiWork keeps credentials and spend on your side:',
      byokItems: [
        'Credentials live in .sankiwork/media-config.json or your shell env.',
      ...
      ctaBody:
        'Pick the agent already on your laptop, point SankiWork at it, and start rendering.',
    },
    compare: {
      title: 'SankiWork vs Figma, Lovable, Bolt, v0, Framer — honest comparisons',
      description:
        'Compare SankiWork to the major AI design and app-building tools. Hosted vs local-first, BYOK vs vendor-locked, single-shot generation vs portable DESIGN.md systems.',
      breadcrumb: 'Compare',
      label: 'Evaluation · Nº 02',
      heading: 'SankiWork vs everything else.',
      lead:
        'Short, honest summaries of how SankiWork relates to the other AI design and app-building tools you might be evaluating. Each links to a full, candid comparison.',
      toc: ['vs Claude Design', 'vs Figma', 'vs Lovable', 'vs Bolt', 'vs v0', 'vs Framer', 'Honest limits'],
      comparisons: [
        {
          competitor: 'Claude Design',
          summary:
            'Hosted product tied to a single vendor. SankiWork is local-first, BYOK, and Apache-2.0 — your skills and DESIGN.md live in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Figma',
          summary:
            'Figma is a hosted, hands-on design canvas. SankiWork is agent-driven and local-first, with your brand and artifacts as files in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Lovable',
          summary:
            'Lovable ships hosted prompt-to-app builds. SankiWork is the design-first, BYOK layer for the coding agent you already use.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Bolt',
          summary:
            'Bolt builds running full-stack apps in the browser. SankiWork produces design artifacts you own, locally, with your own agent.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'v0',
          summary:
            'v0 generates hosted UI tuned for the Vercel and React stack. SankiWork generates design with any agent, locally, as files you own.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Framer',
          summary:
            'Framer is a hosted no-code site builder. SankiWork is the open-source, agent-driven alternative that keeps design as files you deploy anywhere.',
          cta: 'Read the full comparison ->',
        },
      ],
      limitsTitle: "Honest limits — what SankiWork isn't",
      limitsBody:
        'SankiWork is not trying to be every hosted AI design tool. These questions describe the trade-offs instead of glossing them.',
      limitsFaq: [
        { name: 'Does SankiWork offer a hosted web sandbox?', text: 'No. SankiWork is local-first by design.' },
        { name: 'Can I use SankiWork without installing anything?', text: 'Not today. The minimum is a local daemon plus a coding agent.' },
        { name: 'Is SankiWork a v0 / Lovable / Bolt replacement?', text: 'It depends. SankiWork focuses on prompt-to-design-artifact via a skill protocol you can fork.' },
        { name: 'Does SankiWork send my data to Anthropic, OpenAI, or Google?', text: 'Only your prompt and skill context goes to the provider whose key you brought.' },
        { name: 'Can I self-host SankiWork on my own infrastructure?', text: 'Yes. Apache-2.0 license, Node 24 daemon, no required SaaS.' },
      ],
    },
    claudeAlternative: {
      title: 'Open-source Claude Design alternative — SankiWork (BYOK, local-first)',
      description:
        'SankiWork is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Open-source Claude Design alternative',
      label: 'Alternative · Nº 03',
      heading: 'Open-source Claude Design alternative.',
      lead:
        'SankiWork is the official open-source, local-first alternative to Claude Design. BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
      tldrTitle: 'TL;DR',
      tldrBody:
      ...
      localByokBody: [
        'SankiWork runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine.',
      ...
      pickOpenTitle: 'Pick SankiWork if',
      pickOpen: [
      ...
      migrateSteps: [
        'Install SankiWork from the quickstart.',
      ...
      faqTitle: 'FAQ',
      faq: [
        { name: 'Is SankiWork really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
        { name: 'Can I use Claude as my agent in SankiWork?', text: 'Yes. SankiWork supports Claude Code and Anthropic API BYOK flows.' },
        { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside SankiWork; migration is manual today.' },
        { name: 'Does SankiWork generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
        ...
        { name: 'Who builds and maintains SankiWork?', text: 'The project lives at github.com/nexu-io/open-design and is Apache-2.0.' },
      ],
    ...
    alternatives: {
      lovable: {
        title: 'Open-source Lovable alternative — SankiWork (design-first, BYOK, local)',
        description:
          'SankiWork is the open-source, local-first alternative to Lovable for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Lovable alternative',
        label: 'Alternative · Lovable',
        heading: 'Open-source Lovable alternative.',
        lead:
          'Lovable turns a prompt into a deployed full-stack app. SankiWork is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Lovable ships hosted apps; SankiWork ships design artifacts as files you own. If you want a design-first, BYOK, open-source workflow with your own agent, SankiWork is the alternative — and it is honest about where Lovable wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'SankiWork runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine — no design output is forced through a vendor cloud.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is SankiWork a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; SankiWork is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
          { name: 'Can SankiWork build a full app like Lovable?', text: 'SankiWork focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
          { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Can I keep using Lovable alongside SankiWork?', text: 'Yes. Many teams prototype design in SankiWork and ship apps in Lovable; migration is manual today.' },
        ...
        rich: {
          heroCtaLead:
            'SankiWork is the open-source, local-first design layer around the coding agent you already use — your key, your files, a curated skill and design-system library.',
          heroCtaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
          ...
          heroImage: {
            ...
            alt: 'SankiWork vs Lovable — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Lovable turns a prompt into a deployed full-stack app. SankiWork is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                { kind: 'p', text: 'Looking for a Lovable alternative? The best Lovable alternatives are SankiWork (open-source, local-first), Bolt, v0, Cursor, Replit, and Dyad — here is how they compare and where each one fits. SankiWork is the pick if you want to own your design artifacts as version-controlled files instead of state inside a hosted app-builder.' },
                { kind: 'table', columns: ['Tool', 'License', 'Pricing', 'Best for', 'Open source'], rows: [
                  ['SankiWork', 'Apache-2.0', 'Free app · BYOK (pay your own API)', 'Design-first artifacts you own as files', 'Yes'],
                ...
                { kind: 'steps', items: [
                  { label: 'SankiWork', body: 'The open-source, local-first, design-first pick — #1 for people who want to own their design artifacts as files, not a Lovable clone. Apache-2.0, BYOK, drives the coding agent you already use. Best for design artifacts and a portable brand you keep in your own repo.' },
                ...
                { kind: 'p', text: 'Where SankiWork fits honestly: it is a design layer around the coding agent you already use — BYOK, Apache-2.0 — so it is the Lovable alternative for people who want design artifacts as version-controlled files rather than a hosted app-builder. If you specifically want a hosted prompt-to-app builder, Lovable, Bolt, or Replit fit better.' },
              ],
            },
            {
              id: 'free-oss',
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-message credits. That is a different posture from SankiWork, which is a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on hosting a backend.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              blocks: [
                { kind: 'p', text: 'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — SankiWork never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'SankiWork vs Lovable, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Lovable'], rows: [
                ...
                { kind: 'p', text: 'Where Lovable wins: if your goal is a deployed, hosted full-stack app with the backend wired up for you, Lovable does that out of the box and SankiWork does not. SankiWork is design-first.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Lovable into SankiWork',
              blocks: [
          ...
          faq: [
            { name: 'Is SankiWork a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; SankiWork is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
            { name: 'What is the best free Lovable alternative?', text: 'SankiWork — it is free and open-source (Apache-2.0, BYOK, so you pay only your own API spend) and is the strongest pick for design-first work. If you specifically want a local open-source app builder instead, Dyad (Apache-2.0) is free to run.' },
            { name: 'Is there an open-source Lovable alternative?', text: 'Yes — SankiWork is an open-source, local-first alternative focused on design artifacts (Apache-2.0, agent-native), and Dyad is an open-source local app builder (Apache-2.0). Both are free to run.' },
            { name: 'Lovable vs Bolt vs v0 — which should I use?', text: 'Lovable is aimed at non-technical makers building full apps from a prompt; Bolt (bolt.new) builds a full-stack app in the browser; v0 (Vercel) generates React/Next.js UI and components. Pick SankiWork when you want to own your design artifacts as version-controlled files rather than state inside a hosted builder.' },
            { name: 'Can SankiWork build a full app like Lovable?', text: 'SankiWork focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
            { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
            { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Can I keep using Lovable alongside SankiWork?', text: 'Yes. Many teams prototype design in SankiWork and ship apps in Lovable; migration is manual today.' },
            { name: 'Is SankiWork affiliated with Lovable?', text: 'No. SankiWork is an independent, open-source project. Lovable is a trademark of its owner; this is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Design-first, in three commands.',
          ctaBody:
            'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
      ...
      figma: {
        title: 'Open-source Figma alternative — SankiWork (design-first, BYOK, local)',
        description:
          'SankiWork is the open-source, local-first alternative to Figma for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Figma alternative',
        label: 'Alternative · Figma',
        heading: 'Open-source Figma alternative.',
        lead:
          'Figma is a hosted, collaborative canvas you design on by hand. SankiWork is a self-evolving design agent for Claude Code — local-first, BYOK, Apache-2.0 — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Figma is a manual cloud design tool; SankiWork is an agent-driven, local-first, open-source design layer. If you want files in your repo and BYOK over a hosted canvas, SankiWork is the alternative — and it is honest about where Figma wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not cloud documents.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is SankiWork a drop-in replacement for Figma?', text: 'No. Figma is a hands-on collaborative canvas; SankiWork is an agent-driven, local-first design layer. They overlap on producing interfaces, not on real-time canvas editing.' },
          { name: 'Can I still use Figma alongside SankiWork?', text: 'Yes. Many teams design in Figma and use SankiWork to generate and iterate from a portable brand; migration is manual today.' },
          { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is SankiWork affiliated with Figma?', text: 'No. SankiWork is an independent, open-source project. Figma is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'SankiWork vs Figma — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Figma turns a cloud canvas into shared, hands-on interface design. SankiWork is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                { kind: 'p', text: 'The best Figma alternatives are Penpot, SankiWork, Lunacy, Pixso, and OpenPencil — with Penpot and SankiWork leading on the open-source, free-to-use angle. Here is how they compare and where each fits.' },
                { kind: 'table', columns: ['Tool', 'License', 'Pricing', 'Best for', 'Open source'], rows: [
                  ['Penpot', 'Open source (MPL-2.0)', 'Free, self-host', 'Open-source design & prototyping canvas', 'Yes'],
                  ['SankiWork', 'Apache-2.0', 'Free app · BYOK (pay your own API)', 'Agent-native design artifacts you own as files', 'Yes'],
                ...
                { kind: 'steps', items: [
                  ...
                  { label: 'SankiWork', body: 'The agent-native, local-first pick — for people who want design artifacts as version-controlled files driven by the coding agent they already use, not a Figma-canvas clone. Apache-2.0, BYOK. Best for owning your design output as files in your own repo.' },
                ...
                { kind: 'p', text: 'Where SankiWork fits honestly: it is a design layer around the coding agent you already use — BYOK, Apache-2.0 — a different job from a canvas editor. It is for owning your design output as files, not pixel-pushing on a shared canvas. If you specifically want an open-source Figma-style canvas, Penpot is the closest replacement.' },
              ],
            },
            {
              id: 'free-oss',
              ...
              blocks: [
                { kind: 'p', text: 'Figma is proprietary and closed-source. If you want an open-source alternative you can self-host, Penpot (MPL-2.0) is the closest canvas replacement and SankiWork (Apache-2.0) is the agent-native, local-first option; both are free to use.' },
              ],
            },
            {
              id: 'what-is-figma',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed per editor seat. SankiWork is a different shape: a local-first, open-source design agent you point your own coding agent at — the two overlap on producing interfaces, not on real-time canvas editing.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not cloud documents, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — SankiWork never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'SankiWork vs Figma, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Figma'], rows: [
                ...
                { kind: 'p', text: 'Where Figma wins: hands-on vector editing, a real-time multiplayer canvas, and a deep, mature plugin and component ecosystem. If that hands-on canvas is the job, Figma is hard to beat — SankiWork is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Figma into SankiWork',
              blocks: [
          ...
          faq: [
            { name: 'Is SankiWork a drop-in replacement for Figma?', text: 'No. Figma is a hands-on collaborative canvas; SankiWork is an agent-driven, local-first design layer. They overlap on producing interfaces, not on real-time canvas editing.' },
            { name: 'What are the best free Figma alternatives?', text: 'Penpot and SankiWork are free and open-source; Lunacy is a free proprietary option.' },
            { name: 'Is Figma open source?', text: 'No, Figma is proprietary/closed-source; Penpot and SankiWork are open-source alternatives.' },
            { name: 'Is there an open-source Figma alternative?', text: 'Yes — Penpot (MPL-2.0) as a canvas replacement, SankiWork (Apache-2.0) as an agent-native design layer, OpenPencil (MIT) as an AI-native .fig-reading option.' },
            { name: 'Can I still use Figma alongside SankiWork?', text: 'Yes. Many teams design in Figma and use SankiWork to generate and iterate from a portable brand; migration is manual today.' },
            { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
            { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Is SankiWork affiliated with Figma?', text: 'No. SankiWork is an independent, open-source project. Figma is a trademark of its owner; this is an unaffiliated comparison.' },
      ...
      bolt: {
        title: 'Open-source Bolt alternative — SankiWork (design-first, BYOK, local)',
        description:
          'SankiWork is the open-source, local-first alternative to Bolt (bolt.new) for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Bolt alternative',
        label: 'Alternative · Bolt',
        heading: 'Open-source Bolt alternative.',
        lead:
          'Bolt (bolt.new) turns a prompt into a running full-stack app in the browser. SankiWork is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Bolt ships hosted apps; SankiWork ships design artifacts as files you own. If you want a design-first, BYOK, open-source workflow with your own agent, SankiWork is the alternative — and it is honest about where Bolt wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — no design output is forced through a vendor cloud.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is SankiWork a drop-in replacement for Bolt?', text: 'No. Bolt ships running full-stack apps; SankiWork is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on running a backend.' },
          { name: 'Can SankiWork build a full app like Bolt?', text: 'SankiWork focuses on design artifacts, prototypes, and brand systems. For an instant in-browser full-stack app, Bolt is the better fit.' },
          { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is SankiWork affiliated with Bolt?', text: 'No. SankiWork is an independent, open-source project. Bolt and bolt.new are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'SankiWork vs Bolt — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Bolt turns a prompt into a running full-stack app in the browser. SankiWork is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                { kind: 'p', text: 'The best bolt.new alternatives are SankiWork (open-source, local-first), Lovable, v0, Cursor, Replit, and the community fork OpenBolt — here is how they compare and where each one fits. SankiWork is the pick if you want to own your design artifacts as version-controlled files instead of state inside a hosted app-builder.' },
                { kind: 'table', columns: ['Tool', 'License', 'Pricing', 'Best for', 'Open source'], rows: [
                  ['SankiWork', 'Apache-2.0', 'Free app · BYOK (pay your own API)', 'Design-first artifacts you own as files', 'Yes'],
                ...
                { kind: 'steps', items: [
                  { label: 'SankiWork', body: 'The open-source, local-first, design-first pick — #1 for people who want to own their design artifacts as files, not a bolt.new clone. Apache-2.0, BYOK, drives the coding agent you already use. Best for design artifacts and a portable brand you keep in your own repo.' },
                ...
                { kind: 'p', text: 'Where SankiWork fits honestly: it is a design layer around the coding agent you already use — BYOK, Apache-2.0 — so it is the bolt.new alternative for people who want design artifacts as version-controlled files rather than a hosted app-builder. If you specifically want a hosted prompt-to-app builder, Lovable, Replit, or bolt.new itself fit better.' },
              ],
            },
            {
              id: 'free-oss',
              ...
              blocks: [
                { kind: 'p', text: 'Yes. SankiWork is free and open-source — Apache-2.0, BYOK, so the app costs nothing and you pay only your own provider API spend. For the bolt.new experience itself as open source, OpenBolt (bolt.diy) is the community OSS fork of bolt.new you can self-host. Between them they cover the two high-intent needs behind "free open-source bolt.new alternative": design-first artifact ownership (SankiWork) and a self-hostable app builder (OpenBolt).' },
              ],
            },
            {
              id: 'what-is-bolt',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and hosted, billed by subscription and per-token credits. SankiWork is a different posture: a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on running a backend.' },
                { kind: 'ul', items: [
            ...
            {
              id: 'compare',
              heading: 'SankiWork vs Bolt, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Bolt'], rows: [
                ...
                { kind: 'p', text: 'Where Bolt wins: if your goal is an instant, running full-stack app in the browser with the dev environment wired up for you, Bolt does that out of the box. SankiWork is design-first.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Bolt into SankiWork',
              blocks: [
          ...
          faq: [
            { name: 'Is SankiWork a drop-in replacement for Bolt?', text: 'No. Bolt ships running full-stack apps; SankiWork is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on running a backend.' },
            { name: 'What is the best free bolt.new alternative?', text: 'SankiWork — it is free and open-source (Apache-2.0, BYOK, so you pay only your own API spend) and is the strongest pick for design-first work. If you specifically want the bolt.new experience itself as open source, OpenBolt (bolt.diy) lets you self-host it for free.' },
            { name: 'Is there an open-source bolt.new?', text: 'bolt.new itself is proprietary, but OpenBolt (bolt.diy) is the community open-source fork you can self-host. SankiWork is a separate open-source, local-first alternative focused on design artifacts rather than a hosted app builder.' },
            { name: 'bolt.new vs Lovable vs v0 — which should I use?', text: 'bolt.new builds a full-stack app in the browser from a prompt; Lovable is aimed at non-technical makers building full apps; v0 (Vercel) generates React/Next.js UI and components. Pick SankiWork when you want to own your design artifacts as version-controlled files rather than state inside a hosted builder.' },
            { name: 'Can SankiWork build a full app like Bolt?', text: 'SankiWork focuses on design artifacts, prototypes, and brand systems. For an instant in-browser full-stack app, Bolt is the better fit.' },
            { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
            { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Is SankiWork affiliated with Bolt?', text: 'No. SankiWork is an independent, open-source project. Bolt and bolt.new are trademarks of their owner; this is an unaffiliated comparison.' },
      ...
      v0: {
        title: 'Open-source v0 alternative — SankiWork (design-first, BYOK, local)',
        description:
          'SankiWork is the open-source, local-first alternative to v0 by Vercel for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source v0 alternative',
        label: 'Alternative · v0',
        heading: 'Open-source v0 alternative.',
        lead:
          'v0 by Vercel turns a prompt into hosted UI components. SankiWork is a self-evolving design agent for Claude Code — local-first, BYOK, open source — that drives any coding agent and keeps your brand and artifacts as files. Closest overlap of the bunch: prompt-to-UI, different posture.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'v0 generates UI in Vercel’s hosted flow; SankiWork generates design with your own agent, locally, as files you own. If you want BYOK, any agent, and open source over a hosted generator, SankiWork is the alternative — and it is honest about where v0 wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your UI is files, not hosted generations.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is SankiWork a drop-in replacement for v0?', text: 'No. v0 generates UI in Vercel’s hosted flow; SankiWork is design-first and produces artifacts you own with any agent. They overlap on prompt-to-UI, not on the Vercel-hosted pipeline.' },
          { name: 'Does SankiWork lock me to a stack?', text: 'No. BYOK with any supported agent, and your output is plain files in your repo — not tied to one framework or host.' },
          { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is SankiWork affiliated with v0 or Vercel?', text: 'No. SankiWork is an independent, open-source project. v0 and Vercel are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'SankiWork vs v0 — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'v0 by Vercel turns a prompt into hosted UI components, tuned for the React and Vercel ecosystem. SankiWork is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-generation credits. SankiWork is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on prompt-to-UI, not on the Vercel-hosted pipeline.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your UI is files, not hosted generations, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — SankiWork never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'SankiWork vs v0, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'v0'], rows: [
                ...
                { kind: 'p', text: 'Where v0 wins: if you live in the Vercel, Next.js and React ecosystem and want UI generated and deployed in one tight hosted flow, v0 is built for exactly that. SankiWork is design-first and stack-agnostic.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from v0 into SankiWork',
              blocks: [
      ...
      framer: {
        title: 'Open-source Framer alternative — SankiWork (design-first, BYOK, local)',
        description:
          'SankiWork is the open-source, local-first alternative to Framer for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Framer alternative',
        label: 'Alternative · Framer',
        heading: 'Open-source Framer alternative.',
        lead:
          'Framer is a hosted, no-code visual builder for designing and publishing sites. SankiWork is a self-evolving design agent for Claude Code — local-first, BYOK, open source — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Framer is a hosted no-code site builder; SankiWork is an agent-driven, local-first, open-source design layer. If you want files in your repo and BYOK over a hosted canvas, SankiWork is the alternative — and it is honest about where Framer wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not a hosted project.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is SankiWork a drop-in replacement for Framer?', text: 'No. Framer is a hosted no-code site builder; SankiWork is an agent-driven, local-first design layer. They overlap on producing interfaces, not on no-code publishing and hosting.' },
          { name: 'Can SankiWork publish a site like Framer?', text: 'SankiWork produces design artifacts and code you own; you deploy them yourself. For an all-in-one no-code builder plus hosting, Framer is the better fit.' },
          { name: 'Which agent does SankiWork use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is SankiWork affiliated with Framer?', text: 'No. SankiWork is an independent, open-source project. Framer is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'SankiWork vs Framer — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Framer turns a hosted, no-code canvas into designed and published websites. SankiWork is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription. SankiWork is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on producing interfaces, not on no-code publishing and hosting.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not a hosted project, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — SankiWork never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'SankiWork vs Framer, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Framer'], rows: [
                ...
                { kind: 'p', text: 'Where Framer wins: if you want a no-code visual builder that designs and publishes a marketing site with hosting included, Framer does that end to end. SankiWork is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Framer into SankiWork',
              blocks: [
      ...
      stitch: {
        title: 'Best Google Stitch alternative for design — SankiWork',
        description:
          'Google Stitch is a free Gemini-powered UI generator from Google Labs, capped at ~350 standard generations/month in a hosted canvas. SankiWork is the open-source, local-first alternative — BYOK, no Google account, design system as files you own.',
        ...
        lead:
          'Google Stitch turns a prompt into a polished, Gemini-generated UI inside a hosted Google Labs canvas — free, but capped at ~350 standard generations a month and tied to a Google account. SankiWork is a local-first, open-source design agent you point your own coding agent at: same prompt-to-UI surface, but the source, the design system, and the output stay as files you own.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Google Stitch is a free, Gemini 3-powered UI generator from Google Labs — fast first drafts, Figma paste, HTML/CSS and React export, but cloud-only, closed-source, monthly generation caps, and no enforceable design system. SankiWork is the open-source, local-first alternative: BYOK with your own coding agent, a portable DESIGN.md brand in your repo, and no account gating. This page is honest about where Stitch genuinely wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your own machine — no design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects. There is no monthly generation cap baked into the product.',
          'You bring your own agent key — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials stay in local config or environment variables (SankiWork never proxies them), model spend bills directly to your provider account, and you can drive everything from the od CLI or the local HTTP daemon, not just a web UI.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateSteps: [
          'Install SankiWork from the download page and bring your own agent key (Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen).',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'What are Google Stitch’s generation limits?', text: 'Stitch’s free tier runs roughly 350 standard generations per month on Gemini 2.5 Flash, plus a smaller experimental pool on Gemini 2.5 Pro (commonly reported around 50). Reports through 2026 show the cap shifting and sometimes resetting daily; either way there is no paid tier to raise it and no bring-your-own-key option. SankiWork has no app-level cap — you pay your own model API spend.' },
          { name: 'Is Google Stitch free?', text: 'Yes. Stitch is a free Google Labs experiment with no subscription, but it requires a Google account and the work lives in Google’s cloud. SankiWork is also free and open source (Apache-2.0); you bring your own agent key, so model spend bills to you with no vendor cap.' },
          { name: 'Can I self-host an alternative to Google Stitch?', text: 'Stitch is cloud-only and closed-source — there is no self-host option. SankiWork runs locally and self-hosts anywhere Node 24 runs, with full source on GitHub under Apache-2.0.' },
          { name: 'How does export compare?', text: 'Stitch exports HTML/CSS and React and supports paste-into-Figma (auto-layout, named layers, editable text — a real starting point, not pixel-perfect). SankiWork writes real files into your repo — HTML/CSS, React, decks, and a portable DESIGN.md — that you own and version directly.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Google Stitch is a closed-source Google Labs product.' },
          { name: 'Is SankiWork affiliated with Google or Stitch?', text: 'No. SankiWork is an independent, open-source project. Google Stitch is a product of Google Labs (built on the 2025 Galileo AI acquisition); this is an unaffiliated comparison.' },
        ],
        ...
        rich: {
          heroCtaLead:
            'SankiWork is the open-source, local-first alternative to Google Stitch — prompt-to-UI with the coding agent you already use, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'SankiWork vs Google Stitch — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'SankiWork vs Google Stitch, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Google Stitch'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'You run out of generations', body: 'The ~350 standard generations a month, plus a much smaller experimental pool, sound generous until you are iterating on a real project. There is no paid tier and no bring-your-own-key escape hatch — so heavy days mean waiting for a reset. SankiWork has no app-level cap; you pay your own model spend and keep going.' },
                  { label: 'The brand never sticks', body: 'Stitch has no enforceable design system: you re-prompt brand colors as hex values every time, the same prompt yields a different result each run, and navigation can drift between screens. SankiWork centralizes brand in one DESIGN.md that every render obeys, so iterations stay consistent.' },
                  { label: 'It lives in a separate tab', body: 'Design happens in Stitch’s cloud canvas, disconnected from your repo — you export a snapshot and re-integrate by hand, with no API to wire it into CI or an agent loop. SankiWork output lands as files in your project and is drivable from the od CLI and local HTTP daemon.' },
                  { label: 'You cannot own or fork it', body: 'Stitch is closed-source and Google-hosted: no self-host, no audit, no rebrand for your studio. SankiWork is Apache-2.0 — fork it, run it on your own machine, embed it in pipelines, and own every artifact it produces.' },
                ] },
              ],
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/stitch/stitch-design-systems.webp', alt: 'The SankiWork design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in SankiWork — portable, versioned, rendered by every skill.' }, text: [
                  'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs <b>on your machine</b>. No design output is forced through a vendor cloud, and your brand lives in your repo as a <b>portable DESIGN.md</b> file every skill respects.',
                  'You <b>bring your own agent key</b>. Credentials stay in local config or environment variables — SankiWork never proxies them — and the API spend <b>bills directly to you</b>.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all SankiWork comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download SankiWork</a> to try it.' },
              ],
            },
            {
              id: 'decision',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'A quick way to decide by what you actually want to do — <b>most paths point to SankiWork</b>, but the honest exceptions are listed too:' },
                { kind: 'table', compact: true, columns: ['If you want to…', 'Best pick'], rows: [
                  ['Own your UI, code, and design system as files in git', 'SankiWork'],
                  ['Iterate heavily without a monthly generation cap', 'SankiWork'],
                  ['Enforce one brand (DESIGN.md) across every render', 'SankiWork'],
                  ['Run open-source you can self-host, fork, or rebrand', 'SankiWork'],
                  ['Drive design from your coding agent / CLI / CI (BYOK)', 'SankiWork'],
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Google Stitch into SankiWork',
              blocks: [
          ...
          faqTitle: 'FAQ',
          faq: [
            { name: 'What are Google Stitch’s generation limits?', text: 'Stitch’s free tier runs roughly 350 standard generations per month on Gemini 2.5 Flash, plus a smaller experimental pool on Gemini 2.5 Pro (commonly reported around 50). Reports through 2026 show the cap shifting and at times resetting daily; either way there is no paid tier to raise it and no bring-your-own-key option. SankiWork has no app-level cap — you pay your own model API spend and keep going.' },
            { name: 'Is Google Stitch free?', text: 'Yes. Stitch is a free Google Labs experiment with no subscription, but it requires a Google account and the work lives in Google’s cloud. SankiWork is also free and open source (Apache-2.0); you bring your own agent key, so model spend bills to you with no vendor-set cap.' },
            { name: 'Can I self-host an alternative to Google Stitch?', text: 'Stitch is cloud-only and closed-source — there is no self-host option. SankiWork runs locally and self-hosts anywhere Node 24 runs, with full source on GitHub under Apache-2.0.' },
            { name: 'How does export compare?', text: 'Stitch exports HTML/CSS and React and supports paste-into-Figma (auto-layout, named layers, editable text — a real starting point, not pixel-perfect). SankiWork writes real files into your repo — HTML/CSS, React, decks, and a portable DESIGN.md — that you own and version directly.' },
            { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Google Stitch is a closed-source Google Labs product.' },
            { name: 'Is SankiWork affiliated with Google or Stitch?', text: 'No. SankiWork is an independent, open-source project. Google Stitch is a product of Google Labs (built on the 2025 Galileo AI acquisition); this is an unaffiliated comparison.' },
      ...
      'pencil-dev': {
        title: 'Best Pencil.dev alternative for design — SankiWork',
        description:
          'Pencil (pencil.dev) is an a16z-backed, agent-driven design canvas that keeps .pen files in your repo — free in early access, but the app itself is closed-source and tuned for Claude. SankiWork is the fully open-source (Apache-2.0), BYOK alternative: the whole app is yours, not just the file format.',
        breadcrumb: 'Best Pencil.dev alternative',
        label: 'Alternative · Pencil.dev',
        heading: 'Best Pencil.dev alternative for design.',
        lead:
          'Pencil (pencil.dev) puts an AI design canvas inside your IDE and keeps its .pen design files in your repo under Git — genuinely close to how SankiWork works. The difference: Pencil’s app is closed-source and free only while it is in early access, and it is tuned first for Claude. SankiWork is fully open-source (Apache-2.0) and BYOK across every major coding agent — the whole tool is yours, not just the file format.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Pencil (pencil.dev) is an a16z-backed, agent-driven design canvas that lives in your IDE and keeps .pen JSON files in your repo — a polished vector canvas, Figma paste, built-in UI kits, and free while in early access. But the app itself is closed-source (only the file format is documented), it is optimized for Claude Code, and “free” is early-access, not a business model. SankiWork is the fully open-source (Apache-2.0), local-first alternative: BYOK with any major coding agent, output as files you own, and a portable DESIGN.md brand. These two are unusually close — this page is honest about where Pencil genuinely wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        whyTitle: 'Why people search for a Pencil.dev alternative',
        whyLead: 'Pencil and SankiWork overlap more than most tools on this page — both are agent-driven and keep design as files in your repo. The reasons people still look for an alternative are specific:',
        reasons: [
          { label: 'The app is closed-source; only the format is “open”.', body: 'Pencil markets “open design files,” and the .pen JSON format is documented — but the application itself is a closed-source, a16z-backed product with no public source, and the format docs reserve the right to introduce breaking changes. SankiWork is Apache-2.0: the whole app, not just the file spec, is yours to read, fork, and self-host.' },
          { label: '“Free” is early-access, not structural.', body: 'Pencil is free today but explicitly in early access — the founders say “Free is not a business model,” so paid plans and limits are on the way. SankiWork is free because it is open source; there is no vendor that needs to meter you later, and you only ever pay your own model API spend.' },
          { label: 'Optimized for Claude, weaker elsewhere.', body: 'Pencil connects several agents over MCP but is tuned first for Claude Code, and reviewers report a weaker experience with other models. SankiWork is BYOK and provider-neutral — Claude, Codex, Cursor, Gemini, OpenCode, or Qwen, all first-class.' },
          { label: 'UI-to-code, not a broader design surface.', body: 'Pencil is focused on turning UI into code. SankiWork renders a wider range of artifacts from the same brand — UI, landing pages, decks, prototypes, and a portable DESIGN.md design system — all as files you own.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Both Pencil and SankiWork are local-first — that is genuinely common ground. SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine, and your brand lives in your repo as a portable DESIGN.md every skill respects. Output lands as real files in your project, not state in a vendor cloud.',
          'The difference is ownership and neutrality. SankiWork is Apache-2.0, so the whole application — not just a documented file format — is yours to fork, audit, and self-host. And you bring your own agent key: Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, with credentials in local config and spend billed to your own provider.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Pencil and SankiWork both keep design as files in your repo, so moving over is design-first — extract your brand once and render against it:',
        migrateSteps: [
          'Install SankiWork from the download page and bring your own agent key (Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen).',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is Pencil (pencil.dev) open source?', text: 'Not the app. Pencil is a closed-source, a16z-backed product; what is “open” is the .pen file format, which is documented but can change (the team reserves the right to make breaking changes). SankiWork is fully open source under Apache-2.0 — the entire application, not just the file spec — and is self-hostable.' },
          { name: 'Is Pencil.dev free?', text: 'It is free today, but explicitly in early access. The founders have said “Free is not a business model,” signaling future paid plans and limits. SankiWork is free because it is open source; you bring your own agent key, so model spend bills to you with no vendor-set cap.' },
          { name: 'What is the difference between SankiWork and Pencil?', text: 'They are close — both are agent-driven and keep design as files in your repo under Git. The differences: SankiWork is fully open source (Apache-2.0, not just an open format), provider-neutral BYOK (not tuned mainly for Claude), and renders a wider range of artifacts (UI, decks, prototypes, design systems). Pencil offers a more mature hands-on vector canvas and native Figma paste.' },
          { name: 'Does Pencil work with agents other than Claude?', text: 'Yes — it connects several agents over MCP (Cursor, Windsurf, Codex, and others), but it is optimized for Claude Code and reviewers report a weaker experience with other models. SankiWork treats Claude, Codex, Cursor, Gemini, OpenCode, and Qwen as first-class.' },
          { name: 'Is SankiWork affiliated with Pencil?', text: 'No. SankiWork is an independent, open-source project (github.com/nexu-io/open-design, Apache-2.0). Pencil is a separate, a16z-backed product at pencil.dev; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own the whole tool, not just the file format.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. SankiWork is open source end to end — your UI, code, and DESIGN.md system stay in your repo from the first render onward.',
        rich: {
          heroCtaLead:
            'SankiWork is the fully open-source, local-first alternative to Pencil — an agent-native design workspace you drive with the coding agent you already use, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'SankiWork vs Pencil.dev — warm-paper editorial illustration of a design canvas converging into a repo of files you own',
          },
          intro: [
            ...
            'SankiWork is the <b>fully open-source, local-first</b> alternative: an agent-native design workspace you point <b>your own coding agent</b> at (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) over BYOK. These two are unusually close — both agent-driven, both keeping design as files in your repo. The differences are ownership and range: with SankiWork the <b>whole app</b> is Apache-2.0 (not just a documented format), BYOK is <b>provider-neutral</b>, and the output spans UI, decks, prototypes, and a portable <b>DESIGN.md</b>. This page is honest about where Pencil genuinely wins.',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'SankiWork vs Pencil, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Pencil (pencil.dev)'], rows: [
                ...
                { kind: 'p', text: 'Read it honestly: Pencil wins on the <b>hands-on canvas</b> — a mature, Figma-like surface you edit directly, with native Figma paste and built-in UI kits, right inside your IDE. SankiWork wins on <b>ownership and range</b> — the whole app is open source (not just the file format), BYOK is provider-neutral instead of Claude-first, “free” stays free because there is no vendor to monetize you, and the output spans UI, decks, prototypes, and a portable design system as files you keep.' },
              ],
            },
            {
              id: 'why-switch',
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'The app is closed, only the format is open', body: 'Pencil’s .pen format is documented, but the application is closed-source and a16z-backed, and the format spec reserves the right to change. SankiWork is Apache-2.0 end to end — fork it, audit it, self-host it, and own every artifact it produces.' },
                  { label: '“Free” has an expiry date', body: 'Pencil is free while it is in early access, but the founders are explicit that “Free is not a business model.” Paid plans and limits are coming. SankiWork is free because it is open source; you only ever pay your own model spend.' },
                  { label: 'It is Claude-first', body: 'Pencil connects several agents over MCP but is tuned for Claude Code, with a weaker experience elsewhere. SankiWork is provider-neutral BYOK — Claude, Codex, Cursor, Gemini, OpenCode, and Qwen are all first-class.' },
                  { label: 'You want more than UI-to-code', body: 'Pencil is focused on UI → code. SankiWork renders UI, landing pages, decks, prototypes, and a portable DESIGN.md design system from the same brand, all as files in your repo.' },
                ] },
              ],
            },
            {
              ...
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/pencil-dev/pencil-dev-design-systems.webp', alt: 'The SankiWork design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in SankiWork — portable, versioned, rendered by every skill.' }, text: [
                  'Both tools are local-first and keep design as files in your repo — that part is common ground. Where SankiWork differs is that the <b>whole application</b> is Apache-2.0, not just a documented file format, so you can fork, audit, and self-host it. Your brand lives in your repo as a <b>portable DESIGN.md</b> every skill respects.',
                  'You also <b>bring your own agent key</b>, provider-neutral. Credentials stay in local config or environment variables — SankiWork never proxies them — and the API spend <b>bills directly to you</b>, at your provider’s rates, with no vendor cap after early access.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all SankiWork comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/stitch/">Google Stitch</a> — or <a href="/download/">download SankiWork</a> to try it.' },
              ],
            },
            {
              id: 'decision',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Pencil into SankiWork',
              blocks: [
      ...
      genspark: {
        title: 'Best Genspark AI Designer alternative for design — SankiWork',
        description:
          'Looking for a Genspark AI Designer alternative for product design? SankiWork is an open-source, local-first design agent. Drive it with your own coding agent (BYOK) and own every file — UI, code, and design system — in your repo.',
        ...
        lead:
          'Genspark AI Designer (launched Aug 2025) is Genspark\'s one-prompt design product — strongest at graphic and marketing design: logos, posters, social graphics, packaging, whole brand systems. SankiWork is an open-source, local-first design agent for product UI: your coding agent, your key, files you own.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Genspark AI Designer is a closed, credit-metered SaaS that excels at marketing graphics in one shot. SankiWork is the open-source (Apache-2.0), local-first alternative for product UI: BYOK with your own agent, a portable DESIGN.md in your repo, and output you keep as files. They do different jobs — this page is honest about where Genspark wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        reasons: [
          ...
          { label: 'Own the output as files.', body: 'Genspark assets live in its cloud (AI Drive) tied to an account. SankiWork writes UI, code and design tokens as files in your repo that you keep whether or not you keep the tool.' },
          { label: 'Open source.', body: 'Genspark is closed-source SaaS. SankiWork is Apache-2.0 — read it, fork it, run it locally, audit what touches your designs.' },
          { label: 'BYOK over metered credits.', body: 'Genspark meters every generation in credits (and reviewers report being charged for failed or low-quality retries). SankiWork runs on your own coding agent and key, so spend is just provider rates.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'SankiWork runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Output lands as files in your repo, and your brand lives as a portable DESIGN.md every skill respects.',
        ...
        faq: [
          ...
          { name: 'Is SankiWork free?', text: 'SankiWork is free and open source (Apache-2.0). There is no subscription and no credit meter — you bring your own agent key, so model spend bills to your account at provider rates.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Genspark is closed-source.' },
          { name: 'Who owns the output each produces?', text: 'With SankiWork you own everything — UI, code and design system are written as plain files into your own repository, no proprietary cloud format. Genspark assets live in its cloud (AI Drive) tied to your account and are exported as flattened images.' },
          { name: 'Is SankiWork affiliated with Genspark?', text: 'No. SankiWork is an independent, open-source project, not affiliated with Genspark or Mainfunc. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Designing product UI? Own it as files.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Keep Genspark for marketing graphics — bring SankiWork in for the product.',
        rich: {
          heroCtaLead:
            'SankiWork is the open-source, local-first alternative to Genspark for product UI — your coding agent, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'SankiWork vs Genspark — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
            ...
            'SankiWork plays a different position, so this is an honest comparison — the two tools do <b>different jobs</b>. SankiWork is an <b>open-source (Apache-2.0)</b>, <b>local-first</b> design agent for <b>product UI</b>: screens, flows, components and a design system, plus the code behind them. You drive it with <b>your own coding agent (BYOK)</b> and everything lands as <b>files in your repo</b>. Below we are upfront about where Genspark genuinely wins (marketing-graphic breadth, one-shot polish) and where SankiWork wins (open source, local-first, product UI, code you own).',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  ...
                  { label: 'Own the output as files', body: 'Genspark assets live in its cloud (AI Drive) tied to your account and export as flattened images. SankiWork writes UI, components and tokens as real files you commit to git and keep forever — the implication: no migration cost if you leave the tool.' },
                  { label: 'Open source you can audit', body: 'Genspark is closed-source SaaS; you cannot read, fork or self-host it. SankiWork is Apache-2.0, so security teams can audit exactly what runs against the codebase and run it on infrastructure you control.' },
                  { label: 'BYOK over a credit meter', body: 'Genspark bills generations in credits (100/day free, then 10k–125k/mo on paid plans) and reviewers report paying for failed retries. SankiWork runs on the coding agent and key you already have, so spend is provider rates with no per-design meter.' },
                ] },
              ],
            },
            {
              id: 'compare',
              heading: 'SankiWork vs Genspark AI Designer, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Genspark AI Designer'], rows: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/genspark/genspark-design-systems.webp', alt: 'The SankiWork design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in SankiWork — portable, versioned, rendered by every skill.' }, text: [
                  ...
                  '<b>BYOK</b> means you supply the model. SankiWork runs on the <b>coding agent you already use</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>; inference bills to you at provider rates.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all SankiWork comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download SankiWork</a>.' },
              ],
            },
            {
              id: 'decision',
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want to…', 'Best pick'], rows: [
                  ['Design product UI plus the code and a design system', 'SankiWork'],
                  ['Own the output as editable files in your repo', 'SankiWork'],
                  ['Run an open-source design agent you can fork and audit', 'SankiWork'],
                  ['Keep everything local and self-hosted, no account', 'SankiWork'],
                  ['Bring your own coding agent and model (BYOK)', 'SankiWork'],
            ...
            {
              id: 'migrate',
              heading: 'Moving from Genspark to SankiWork',
              blocks: [
          ...
          faq: [
            ...
            { name: 'Is SankiWork free?', text: 'Yes — SankiWork is free and open source (Apache-2.0), with no subscription and no credit meter. You bring your own agent key, so model spend bills to your account at provider rates.' },
            { name: 'Is SankiWork really open source?', text: 'Yes — github.com/nexu-io/open-design under Apache-2.0, fully self-hostable. Genspark is closed-source.' },
            { name: 'Who owns the output each one produces?', text: 'With SankiWork you own everything — UI, code and design system land as plain files in your own repository. Genspark assets live in its cloud (AI Drive) tied to your account and export as flattened images.' },
            { name: 'Is SankiWork affiliated with Genspark?', text: 'No. SankiWork is an independent, open-source project, not affiliated with Genspark or Mainfunc. This is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Designing product UI? Own it as files.',
          ctaBody:
            'Star the repo, grab the desktop build, or run the install in your terminal. Keep Genspark for the logo and the launch poster — bring SankiWork in for the product UI, the design system, and the code you own.',
          ctaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      'figma-make': {
        title: 'Best Figma Make alternative for design — SankiWork',
        description:
          'Figma Make turns prompts into React apps inside Figma\'s cloud — behind a Full seat and AI credits. SankiWork is the open-source, local-first, BYOK alternative.',
        breadcrumb: 'Best Figma Make alternative',
        label: 'Alternative · Figma Make',
        heading: 'Best Figma Make alternative for design.',
        lead:
          'Figma Make turns a prompt — or an existing Figma frame — into a running React app, hosted inside Figma and powered by Claude Sonnet. SankiWork is the open-source, local-first alternative: your coding agent, your key, output you own as files in your repo.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Figma Make ships React apps inside Figma\'s cloud, behind a paid Full seat and AI credits that reset monthly. SankiWork ships product UI as files you own — open source, local-first, driven by your own agent (BYOK). For a full move off Figma the design tool, see the Figma comparison; this page is about Figma Make.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        reasons: [
          { label: 'The app lives in Figma\'s cloud, not your repo.', body: 'Make exports React/TSX, but the running app, its publish targets and Supabase wiring stay in Figma\'s runtime behind a Full seat. SankiWork writes UI, code, and your design system straight into your repo.' },
          { label: 'AI usage is metered and unpredictable.', body: 'Teams burn a 3,000-credit monthly allowance in a day, mostly fixing imperfect output — and undo never refunds a credit. SankiWork is BYOK: pay your provider directly, no credit ledger.' },
          { label: 'Authoring needs a paid Full seat.', body: 'A View or Dev seat can\'t build in Make — you need a Full seat (~$16–$90/user/mo) on top of credits. SankiWork is Apache-2.0 and free to run.' },
          { label: 'Closed-source and cloud-only.', body: 'No self-host, no local mode, no on-premise option. SankiWork is open source and local-first — it runs on your machine and you can audit it.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          ...
          'BYOK means SankiWork runs on the coding agent you already use (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with your own key — you own the output and the engine driving it.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Moving a Figma Make prototype toward an SankiWork workflow:',
        migrateSteps: [
          'Install your coding agent (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) and add your own key — no Figma seat, no credits.',
          'Point SankiWork at your repo; it runs locally and writes UI and code where your build and CI already are.',
        ...
        migrateClosing:
          'For a broader move off Figma the design tool, see the SankiWork vs Figma comparison; this page is about Figma Make specifically.',
        faqTitle: 'FAQ',
        faq: [
          { name: 'How much does Figma Make cost?', text: 'Authoring requires a paid Figma Full seat (~$16/user/mo on Professional up to $90 on Enterprise) plus AI credits metered per action. Credit allowances run 500/mo (Starter) to 4,250/mo (Enterprise), reset monthly, no rollover; a full app generation can cost 100+ credits. SankiWork is free to run — you only pay your own model provider via your key.' },
          { name: 'Can I self-host Figma Make or run it locally?', text: 'No. Figma Make runs exclusively inside Figma\'s hosted cloud — no local mode, self-host, or on-premise option. SankiWork is local-first and runs entirely on your machine.' },
          { name: 'Do I need a paid Figma seat to use Figma Make?', text: 'Yes. Authoring in Make requires a paid Full seat; Dev and Collab seats get trial access only and a View seat can\'t author. SankiWork needs no account or seat — clone the repo and run it with your own coding agent.' },
          { name: 'Can I export the code Figma Make generates?', text: 'Yes — download the React/TypeScript app as a ZIP or push it to a GitHub repo. The caveat: the export is source, not a turnkey deploy, and the running app and Supabase wiring stay tied to Figma\'s runtime. With SankiWork the output is files in your repo from the start.' },
          { name: 'Is SankiWork open source?', text: 'Yes — Apache-2.0, local-first, BYOK with your own coding agent (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) and your own model key. Figma Make is proprietary and closed-source.' },
          { name: 'Is SankiWork affiliated with Figma?', text: 'No. SankiWork is an independent, open-source project, not affiliated with or endorsed by Figma. Figma and Figma Make are trademarks of Figma, Inc.; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your output — from prompt to repo.',
        ctaBody:
          'Figma Make is the fastest path from a Figma frame to a hosted prototype — if you author behind a Full seat, spend AI credits, and keep the running app in Figma\'s cloud. SankiWork takes the other path: open source, local-first, your own agent and key, every generation a file you own.',
        rich: {
          heroCtaLead:
            'SankiWork is the open-source, local-first alternative to Figma Make — your coding agent, your key, your files, and a portable design system you keep in your repo, with no Figma cloud lock-in and no credit meter.',
          heroCtaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'SankiWork vs Figma Make — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'SankiWork vs Figma Make, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Figma Make'], rows: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/figma-make/figma-make-design-systems.webp', alt: 'The SankiWork design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in SankiWork — portable, versioned, rendered by every skill.' }, text: [
                  ...
                  '<b>BYOK</b> means you point SankiWork at the <b>coding agent you already trust</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>. You pick the model, pay your provider directly, and own both the output and the engine driving it — no credit meter in between.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all SankiWork comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download SankiWork</a>.' },
              ],
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want…', 'Best pick'], rows: [
                  ['Output as files in your own repo, owned outright', 'SankiWork'],
                  ['Open-source, auditable, self-hostable / local', 'SankiWork'],
                  ['No per-seat paywall and no AI credit cap', 'SankiWork'],
                  ['Freedom to use any model and any coding agent (BYOK)', 'SankiWork'],
            ...
            {
              id: 'migrate',
              heading: 'Moving from Figma Make to SankiWork',
              blocks: [
                { kind: 'p', text: 'Getting from a Figma Make prototype to an SankiWork workflow:' },
                { kind: 'ol', items: [
                  ...
                  'Point SankiWork at your repo; it runs locally and writes generated UI, components, and code where your build and CI already are.',
                ...
                { kind: 'p', text: 'For a broader move off Figma the design tool, see <a href="/alternatives/figma/">the SankiWork vs Figma comparison</a>.' },
              ],
            },
          ],
          faqTitle: 'FAQ',
          ...
          ctaTitle: 'Own your output — from prompt to repo.',
          ctaBody:
            'Figma Make is the fastest path from a Figma frame to a hosted prototype — if you author behind a Full seat, spend AI credits, and keep the running app in Figma\'s cloud. SankiWork takes the other path: open source, local-first, drive it with the coding agent and key you already have, and every generation lands as files you own in your own repo.',
          ctaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      qoder: {
        title: 'Best QoderWork Design alternative for design — SankiWork',
        description:
          'Looking for a QoderWork Design alternative? SankiWork is the open-source, local-first design agent: drive it with your own coding agent, own every file it writes, no IDE or vendor lock-in.',
        ...
        lead:
          'QoderWork Design and SankiWork agree on the big idea — design-as-code, prompt-to-UI, editable output. They diverge on everything around it: SankiWork is open source, local-first, and runs on your own agent (BYOK); Qoder is closed-source and bound to Alibaba\'s IDE and models.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Qoder is one of the closest products in spirit to SankiWork — both do design-as-code. The difference is openness: SankiWork is Apache-2.0, local-first, and BYOK with your own coding agent; Qoder is closed-source and built around Qoder IDE. It is honest about where Qoder wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        reasons: [
          { label: 'You want open source.', body: 'Qoder is closed-source, built by Alibaba. SankiWork is Apache-2.0 — read, self-host, fork, audit.' },
          { label: 'You want BYOK and agent choice.', body: 'Qoder runs its own models inside its product; SankiWork runs on the coding agent you already use, with your keys.' },
          { label: 'You don\'t want IDE lock-in.', body: 'Qoder\'s smoothest path runs through Qoder IDE; SankiWork works alongside whatever you already have.' },
          { label: 'You want to truly own output.', body: 'With SankiWork the deliverable is files in your repo — committed, versioned, yours from the first keystroke.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Local-first means your design work lives where your code lives: real source — components, styles, a portable DESIGN.md every skill follows — written into your repo, versioned in git, usable even if you stop using SankiWork.',
          'BYOK means SankiWork ships no model and charges no inference. You point it at the agent and key you already have (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen); you choose the model and see the cost.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Moving from Qoder to SankiWork — since both speak code, your existing output is the starting point:',
        migrateSteps: [
          ...
          'Point SankiWork at the coding agent you already use with your own key.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'SankiWork and Qoder look really similar — what\'s the difference?', text: 'They are close: both do prompt-to-UI, design-as-code, editable output. The difference is everything around generation. SankiWork is open source (Apache-2.0), local-first, and BYOK with your own agent, output in your repo. Qoder is closed-source, built around Alibaba\'s models and Qoder IDE.' },
          { name: 'Is SankiWork really open source?', text: 'Yes — Apache-2.0. Read the source, self-host, fork, audit. QoderWork Design is closed-source.' },
          { name: 'Which AI agent do I use with SankiWork?', text: 'Whichever you already have — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, via BYOK with your own keys.' },
          { name: 'Does Qoder also keep my work local?', text: 'Partly — it can pin a project to a local folder and hand off to Qoder IDE. But the primary surface is a hosted canvas. In SankiWork, the repo itself is the product.' },
          { name: 'Does SankiWork have an interactive canvas?', text: 'No — a deliberate trade. Qoder\'s canvas with marquee-select and Nudge is excellent for visual editing. SankiWork is code- and file-driven through your coding agent.' },
          { name: 'Is SankiWork affiliated with Qoder or Alibaba?', text: 'No. SankiWork is an independent, open-source project, not affiliated with Qoder or Alibaba. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your design workflow — end to end.',
        ctaBody:
          'SankiWork runs on the coding agent you already use and writes files you actually own. No lock-in, no second subscription, no canvas you can\'t leave.',
        rich: {
          heroCtaLead:
            'SankiWork is the open-source, local-first alternative to QoderWork Design — the same design-as-code idea, but Apache-2.0, BYOK with your own coding agent, and output that lives in your repo and belongs to you.',
          heroCtaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'SankiWork vs Qoder — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
            'Of every tool in this comparison series, QoderWork Design is the closest to SankiWork in spirit. Built by the Qoder team at Alibaba (<a href="https://qoder.com" target="_blank" rel="noopener">qoder.com</a>), it bills itself as <b>"AI-native design as code"</b>: you describe what you want, it renders a real, runnable design on an infinite canvas, you clarify intent through <b>Questions</b>, preview a structured <b>Design Plan</b> before it builds, and then <b>Nudge</b> color, spacing and radius after the fact. The output is genuine front-end code — HTML or React on shadcn/ui, Spark Design or Ant Design — not a flattened vector mock. That is a real product with a polished loop, and it deserves the credit.',
            'Because the two tools share a thesis — prompt to UI, design as <i>code</i>, editable output you can ship — the honest comparison is not about who generates nicer screens. It is about everything <i>around</i> generation. SankiWork is <b>Apache-2.0</b>, <b>local-first</b>, and <b>BYOK</b>: it ships no model, runs on the coding agent you already pay for, and writes its output straight into your repository. QoderWork Design is <b>closed-source</b>, runs on <b>Qoder\'s own (undisclosed) models</b> behind a credit meter, and is at its best inside Alibaba\'s own IDE. If you want the most polished integrated canvas, Qoder is excellent. If you want openness, your own agent, and a workflow that is not bet on a single vendor, that is the gap SankiWork fills.',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'You want open source', body: 'Qoder is closed-source and built by Alibaba — you cannot read how it works, self-host it, or fork it if priorities change. SankiWork is Apache-2.0: the entire agent, skill library and renderer are on GitHub to read, audit, run on your own machine, and fork. For anyone with a security-review or supply-chain requirement, "we can read the code" is not a nice-to-have.' },
                  { label: 'You want BYOK and agent choice', body: 'QoderWork Design runs on Qoder\'s own models — which it does not publicly name — and meters them in credits you buy from Alibaba. SankiWork ships no model and resells no inference. You point it at the coding agent and key you already pay for (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen), pick the model, and see the real cost — no second subscription, no opaque per-credit pricing.' },
                  { label: 'You don\'t want IDE or vendor lock-in', body: 'Qoder\'s smoothest path runs through the standalone Qoder IDE and the broader Alibaba ecosystem; the one-click handoff is great precisely because it assumes you live there. SankiWork is just files in a repo, so it works alongside VS Code, JetBrains, Neovim, your CI, and your existing review process — nothing has to route through one editor.' },
                  { label: 'You want to truly own the output', body: 'In SankiWork the deliverable is real source committed to your repository — components, styles, and a portable DESIGN.md — versioned in git and fully usable even if you stop using SankiWork tomorrow. Qoder can pin to a local folder, but the product surface is a hosted canvas you have to stay inside; the files are a sync target downstream of it, not the source of truth.' },
                ] },
              ],
            },
            {
              id: 'compare',
              heading: 'SankiWork vs QoderWork Design, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'QoderWork Design'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you care most about…', 'Lean toward'], rows: [
                  ['Open source you can read, audit, fork, and self-host', 'SankiWork'],
                  ['Using your own coding agent and keys (BYOK)', 'SankiWork'],
                  ['Output that lives and stays in your own repo', 'SankiWork'],
                  ['Freedom from any one IDE, vendor, or ecosystem', 'SankiWork'],
                  ['No credit meter — you pay only your own agent', 'SankiWork'],
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/qoder/qoder-design-systems.webp', alt: 'The SankiWork design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in SankiWork — portable, versioned, rendered by every skill.' }, text: [
                  '<b>Local-first</b> means your design work lives as <b>files in your own repo</b>: real source and a portable <b>DESIGN.md</b> that every skill obeys, versioned in git, reviewable in pull requests, and fully usable even if you stopped using SankiWork tomorrow. QoderWork Design can pin a project to a local folder and hand it to Qoder IDE — real and useful — but the product surface is still the hosted canvas, and the local files are a sync target downstream of it. In SankiWork the repo <i>is</i> the surface; there is no canvas you have to stay inside.',
                  '<b>BYOK</b> means SankiWork ships no model and charges no inference. Point it at <b>your own agent and key</b> — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — pick the model, and pay your provider directly. No credits to top up, no opaque per-task burn, and you upgrade to a better model the day it ships instead of waiting for a vendor to wire it in.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all SankiWork comparisons</a> — including <a href="/alternatives/figma/">Figma</a>, <a href="/alternatives/lovable/">Lovable</a>, and <a href="/alternatives/v0/">v0</a> — or <a href="/download/">download SankiWork</a>.' },
              ],
            },
            {
              id: 'migrate',
              ...
              blocks: [
                ...
                { kind: 'ol', items: [
                  ...
                  'Capture your design language — colors, spacing, radii, type scale, components — once in a portable DESIGN.md that every SankiWork skill will follow.',
                  'Point SankiWork at the coding agent you already use, authenticated with your own key (BYOK); nothing routes through SankiWork\'s servers.',
          ...
          faqTitle: 'FAQ',
          faq: [
            { name: 'QoderWork Design and SankiWork both do design-as-code — how are they actually different?', text: 'They are the closest peers in this comparison: both turn a prompt into runnable, editable UI code rather than a flattened mock. The difference is everything around generation. SankiWork is open source (Apache-2.0), local-first, and BYOK — it runs on the coding agent you already pay for and writes output straight into your repo. QoderWork Design is closed-source, runs on Qoder\'s own undisclosed models behind a credit meter, and is at its best inside Alibaba\'s Qoder IDE. Same idea; opposite stances on openness and ownership.' },
            { name: 'Is SankiWork really open source?', text: 'Yes — Apache-2.0. The whole thing — the agent, the skill and design-system library, and the renderer — is on GitHub to read, self-host, fork, and audit. QoderWork Design is closed-source.' },
            { name: 'Which AI agent and model does SankiWork use?', text: 'Whichever you already have. SankiWork is BYOK and ships no model of its own: Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, with your own keys, and you choose the underlying model. QoderWork Design instead runs on Qoder\'s own models, which it does not publicly name, metered in credits.' },
            { name: 'Does QoderWork Design also keep my work local?', text: 'Partly. It can pin a project to a local folder and hand off to the Qoder IDE in one click, which is genuinely useful. But the primary working surface is a hosted canvas, so the local files are a sync target downstream of it. In SankiWork the repo itself is the product — there is no hosted canvas in the loop.' },
            { name: 'Will my workflow be locked into Qoder IDE or the Alibaba ecosystem?', text: 'With QoderWork Design the smoothest path assumes you do — the one-click handoff lands in Qoder IDE, and the experience is tuned for the Qoder/Alibaba stack. SankiWork has no IDE lock-in: output is just files in a repo, so it works alongside VS Code, JetBrains, Neovim, your CI, and your existing review process.' },
            { name: 'How much does each cost?', text: 'SankiWork is free and open source; the only thing you pay for is your own coding agent (BYOK), so there is no separate seat or credit charge. Qoder is credit-based — Pro is roughly $30/month for around 2,000 credits, Pro+ about $60, and Ultra about $200, with extra credits sold per-credit; credit-heavy tasks can burn a Pro plan in days. Check qoder.com for current numbers.' },
            { name: 'Is SankiWork affiliated with Qoder or Alibaba?', text: 'No. SankiWork is an independent, open-source project and is not affiliated with, endorsed by, or sponsored by Qoder or Alibaba. Qoder and QoderWork are trademarks of their respective owners. This is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Own your design workflow — end to end.',
          ctaBody:
            'SankiWork runs on the coding agent you already use and writes files you actually own. No closed vendor, no credit meter, no canvas you can\'t leave.',
          ctaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      trae: {
        title: 'Best Trae alternative for design — SankiWork',
        description:
          'Looking for a Trae alternative for design? SankiWork is an open-source, local-first design agent that runs on your own coding agent and keeps your design system as files you own. Many teams run both.',
        breadcrumb: 'Best Trae alternative',
        label: 'Alternative · Trae',
        heading: 'Best Trae alternative for design.',
        lead:
          'Trae is ByteDance\'s free, VS Code–based AI IDE — strong at turning screenshots and Figma frames into UI, and at SOLO full-stack generation. SankiWork is a design-first agent that owns your design system as portable files — they sit at different layers, and many teams run both.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Trae is ByteDance\'s free, VS Code–based AI IDE; design-to-code (screenshot/Figma → React/Tailwind) and SOLO full-stack generation are features inside it. SankiWork is design-first: it owns your design system (DESIGN.md) as files, is open source (Apache-2.0) and local-first, and runs on the coding agent you already use. They are complementary — Trae writes code, SankiWork governs the design system.',
        ...
        reasons: [
          ...
          { label: 'Open source.', body: 'Trae is closed-source; SankiWork is Apache-2.0 — read, fork, run it locally.' },
          { label: 'Agent freedom + BYOK.', body: 'Drive it with the coding agent you already use, with your own key — not one bundled model.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Local-first means the work product lives with you: a portable DESIGN.md plus the design artifacts SankiWork generates, committed to your repo, reviewable in pull requests, yours to keep.',
          'BYOK means SankiWork doesn\'t ship its own model. Point it at the coding agent you already trust (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with your own key — you control the model, cost, and data path.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateLead: 'For many teams the answer is both — Trae writes and ships the code, SankiWork owns the design system that feeds it:',
        migrateSteps: [
          'Keep Trae as your IDE for writing, refactoring, and shipping code (including SOLO and design-to-code).',
          'Add SankiWork as your design layer; point it at your coding agent with your own key.',
          'Make DESIGN.md the source of truth — every SankiWork skill follows it.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Isn\'t Trae an IDE? What\'s its relationship to SankiWork?', text: 'Yes — Trae is an AI-native IDE (a code editor forked from the VS Code core) from ByteDance, and design-to-code is a feature inside it. SankiWork is a design-first agent that owns your design system as files. They are complementary and sit at different layers, not direct competitors.' },
          { name: 'Can I use Trae and SankiWork together?', text: 'Yes, and many teams do. Trae writes and ships code (including SOLO and design-to-code); SankiWork owns the design system (DESIGN.md) the code consumes. SankiWork produces files in your repo, so any IDE — Trae included — picks them up.' },
          { name: 'Is Trae free? How does its pricing work?', text: 'Trae has a free tier (around 5,000 autocompletions/month and limited premium-model requests) plus paid tiers — as of early 2026 roughly Lite $3, Pro $10, Pro+ $30, and Ultra $100 per month — on a token-based Basic+Bonus usage model. SankiWork is free and open-source; you pay only for your own model usage via BYOK.' },
          { name: 'Is SankiWork open source?', text: 'Yes — Apache-2.0. Read it, fork it, self-host it, run it locally. Trae is closed-source and hosted.' },
          { name: 'Which AI agent or model does SankiWork use?', text: 'Whichever you choose — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, using your own key. Trae instead bundles models (Claude Sonnet, GPT-4o, Gemini 2.5 Pro, DeepSeek, and ByteDance\'s own) that you switch between in-product.' },
          { name: 'Is SankiWork affiliated with Trae or ByteDance?', text: 'No. SankiWork is an independent, open-source project, not affiliated with Trae or ByteDance. Trae is a ByteDance product and trademark. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your design system, on your own terms.',
        ctaBody:
          'SankiWork is the open-source, local-first design agent that runs on the coding agent you already use — and pairs cleanly with an IDE like Trae. Keep your design system as portable files you control.',
        rich: {
          heroCtaLead:
            'SankiWork is the open-source, local-first, design-first alternative to Trae for design — it owns your design system as portable files, runs on your own coding agent (BYOK), and pairs cleanly with the IDE you already use.',
          heroCtaActions: [
            { label: 'Download SankiWork', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'SankiWork vs Trae, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Trae'], rows: [
                ...
                { kind: 'p', text: 'Where Trae wins: for several jobs it is the better pick and it is not close. It is a complete, polished AI IDE — if you want one environment to write and ship code, Trae does that and SankiWork does not. Its design-to-code is first-class, SOLO\'s end-to-end full-stack generation has no equivalent in SankiWork, and it is free to start. If those are your core needs, choose Trae. SankiWork instead owns the design system as <b>files you own</b> — <b>open-source</b>, <b>local-first</b>, driven by <b>your own coding agent</b>.' },
              ],
            },
            {
              id: 'why-switch',
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/trae/trae-design-systems.webp', alt: 'The SankiWork design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in SankiWork — portable, versioned, rendered by every skill.' }, text: [
                  '<b>Local-first</b> means the work product lives with you, not in someone else\'s cloud. SankiWork produces a portable <b>DESIGN.md</b> plus design artifacts directly in <b>your repository</b> — committed alongside your code, reviewable in pull requests, yours even if you stop using the tool.',
                  '<b>BYOK</b> means SankiWork doesn\'t ship or lock you into a model. Point it at the <b>coding agent you already trust</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all SankiWork comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download SankiWork</a>.' },
              ],
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want…', 'Pick'], rows: [
                  ['A design-first workflow, not a code editor', 'SankiWork'],
                  ['To own your design system as files (DESIGN.md)', 'SankiWork'],
                  ['Open source you can self-host and fork', 'SankiWork'],
                  ['To bring your own coding agent and key (BYOK)', 'SankiWork'],
                ...
                { kind: 'p', text: 'Most teams find these rows are not in conflict: Trae owns the rows about writing and shipping code, SankiWork owns the rows about the design system itself. That is exactly why so many run both.' },
              ],
            },
            {
              id: 'migrate',
              heading: 'Using Trae and SankiWork together',
              blocks: [
                { kind: 'p', text: 'A common setup runs both — Trae as the IDE, SankiWork as the design layer:' },
                { kind: 'ol', items: [
                  'Keep Trae for writing, refactoring, and shipping code (including SOLO and design-to-code).',
                  'Add SankiWork; point it at the coding agent you already use with your own key.',
                  'Make DESIGN.md the source of truth — every SankiWork skill follows it.',
                  'Loop them: reconcile Trae\'s UI against your design system; commit design-system changes as files Trae picks up.',
                ] },
      ...
      'claude-design': {
        title: 'Open-source Claude Design alternative — SankiWork (BYOK, local-first)',
        description:
          'SankiWork is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your skills and DESIGN.md live in your repo.',
        breadcrumb: 'Open-source Claude Design alternative',
        label: 'Alternative · Claude Design',
        heading: 'Open-source Claude Design alternative.',
        lead:
          'SankiWork is the open-source, local-first alternative to Claude Design. Same use case — prompt to design artifact — different posture: BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        faq: [
          { name: 'Is SankiWork really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
          { name: 'Can I use Claude as my agent in SankiWork?', text: 'Yes. SankiWork supports Claude Code and Anthropic API BYOK flows; credentials are never proxied through us.' },
          { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside SankiWork; migration is manual today.' },
          { name: 'Does SankiWork generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
          { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is SankiWork affiliated with Anthropic or Claude?', text: 'No. SankiWork is an independent, open-source project. Claude is a trademark of Anthropic; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Switch in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'SankiWork vs Claude Design — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Claude Design is a hosted, vendor-managed product for prompt-to-design work. SankiWork is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — that keeps your skills and a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'SankiWork is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on the prompt-to-design-artifact job, not on being a hosted product.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'SankiWork runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — SankiWork never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'SankiWork vs Claude Design, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'SankiWork', 'Claude Design'], rows: [
                  ['License', 'Apache-2.0, full source on GitHub', 'Closed-source, hosted product'],
                  ['Runtime', 'Local daemon on your machine', 'Vendor cloud'],
                ...
                { kind: 'p', text: 'Where Claude Design wins: zero local setup, one vendor bill, and a hosted UI. If that convenience is the priority, a hosted product is hard to beat — SankiWork trades it for ownership, BYOK, and open source.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Claude Design into SankiWork',
              blocks: [
          ...
          faq: [
            { name: 'Is SankiWork really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
            { name: 'Is Claude Design free?', text: 'Claude Design is a paid hosted product. SankiWork is free and open source (Apache-2.0) — you only pay for your own agent API usage (BYOK), with nothing bundled into a subscription.' },
            { name: 'Is there a free Claude Design alternative?', text: 'Yes — SankiWork is a free, open-source (Apache-2.0) alternative. Download the desktop app, bring your own agent key, and design locally with no seat or subscription fee.' },
            { name: 'Does Claude Design have templates — and does SankiWork?', text: 'SankiWork ships composable SKILL.md skills and portable DESIGN.md design systems you can fork, instead of fixed built-in templates — so a template becomes a file you own and version in your repo.' },
            { name: 'Is Claude Design open source or on GitHub?', text: 'Claude Design is a closed-source hosted product. If you want an open-source design tool you can read, fork, self-host, or download, SankiWork is on GitHub at github.com/nexu-io/open-design under Apache-2.0.' },
            { name: 'Can I use Claude as my agent in SankiWork?', text: 'Yes. SankiWork supports Claude Code and Anthropic API BYOK flows; credentials are never proxied through us.' },
            { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside SankiWork; migration is manual today.' },
            { name: 'Does SankiWork generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
            { name: 'Is SankiWork really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
    ...
    download: {
      title: 'Download SankiWork — Free Desktop App (macOS, Windows, Linux)',
      description:
        'Download the latest SankiWork desktop app — free and open-source (Apache-2.0). Install, sign in once, and start designing without configuring a model key. macOS (Apple Silicon & Intel), Windows, and Linux.',
      breadcrumb: 'Download',
      label: 'Download',
      heading: 'Download SankiWork for free. Design with your agent.',
      lead:
      ...
      heroVisualAlt:
        'SankiWork desktop workspace creating a website with a local agent and a curated design system.',
      mobileDesktopNotice: 'SankiWork is a desktop app. Please open this page on a computer to download.',
      autoCtaPrefix: 'Download free for',
      autoCtaFallback: 'Download SankiWork free',
      ...
      allReleasesBody:
        'Every build and past version lives on GitHub Releases and releases.sanki-ai.cloud.',
      ctaTitle: 'Prefer the terminal?',
      ctaBody:
        'Install from source in three commands, or drive SankiWork headlessly from your existing coding agent.',
    },
  },
};
...
const COMPACT_DOWNLOAD_COPY: Partial<Record<LandingLocaleCode, DownloadCopy>> = {
  ja: {
    ...
    title: 'SankiWork をダウンロード — 無料のオープンソース デスクトップアプリ（macOS / Windows / Linux）',
    description:
      '最新の SankiWork デスクトップアプリをダウンロード——無料でオープンソース（Apache-2.0）。インストールして一度サインインすれば、モデルキーの設定なしで始められます。macOS（Apple Silicon と Intel）、Windows、Linux に対応。',
    breadcrumb: 'ダウンロード',
    label: 'ダウンロード',
    heading: 'SankiWork を無料でダウンロード。エージェントと一緒にデザインしよう。',
    lead:
      'Codex、Claude Code などのローカルエージェントを厳選されたデザインシステムと連携し、プロトタイプ、Web サイト、スライド、HTML 動画を作成できます。',
    heroVisualAlt:
      'ローカルエージェントと厳選されたデザインシステムを使って Web サイトを作成する SankiWork のデスクトップワークスペース。',
    autoCtaPrefix: '無料ダウンロード:',
    autoCtaFallback: 'SankiWork を無料でダウンロード',
    recommended: 'おすすめ',
    publishedPrefix: '公開日',
    ...
    allReleasesBody:
      'すべてのビルドと過去のバージョンは GitHub Releases と releases.sanki-ai.cloud にあります。',
    ctaTitle: 'ターミナル派ですか？',
    ctaBody:
      '3 つのコマンドでソースからインストール、または既存のコーディングエージェントから SankiWork をヘッドレスで動かせます。',
  },
  ko: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'SankiWork 다운로드 — 무료 오픈소스 데스크톱 앱 (macOS, Windows, Linux)',
    description:
      '최신 SankiWork 데스크톱 앱을 다운로드하세요 — 무료 오픈소스(Apache-2.0). 설치 후 한 번 로그인하면 모델 키 설정 없이 바로 시작할 수 있습니다. macOS(Apple Silicon 및 Intel), Windows, Linux 지원.',
    breadcrumb: '다운로드',
    label: '다운로드',
    heading: 'SankiWork을 무료로 다운로드하고 에이전트와 함께 디자인하세요.',
    lead:
      'Codex, Claude Code 등의 로컬 에이전트를 엄선된 디자인 시스템과 연결해 프로토타입, 웹사이트, 슬라이드, HTML 영상을 만드세요.',
    heroVisualAlt:
      '로컬 에이전트와 엄선된 디자인 시스템으로 웹사이트를 만드는 SankiWork 데스크톱 워크스페이스.',
    autoCtaPrefix: '무료 다운로드:',
    autoCtaFallback: 'SankiWork 무료 다운로드',
    recommended: '추천',
    publishedPrefix: '출시일',
    releaseNotes: '릴리스 노트',
    ...
    allReleasesBody:
      '모든 빌드와 이전 버전은 GitHub Releases와 releases.sanki-ai.cloud에 있습니다.',
    ctaTitle: '터미널이 더 편하세요?',
    ctaBody:
      '세 개의 명령으로 소스에서 설치하거나, 기존 코딩 에이전트에서 SankiWork을 헤드리스로 구동하세요.',
  },
  de: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'SankiWork herunterladen — kostenlose Open-Source-Desktop-App (macOS, Windows, Linux)',
    description:
      'Lade die neueste SankiWork-Desktop-App herunter — kostenlos und Open Source (Apache-2.0). Installieren, einmal anmelden und ohne Modellschlüssel loslegen. Für macOS (Apple Silicon & Intel), Windows und Linux.',
    breadcrumb: 'Download',
    label: 'Download',
    heading: 'SankiWork kostenlos herunterladen. Mit deinem Agenten designen.',
    lead:
    ...
    heroVisualAlt:
      'Der SankiWork Desktop-Workspace erstellt mit einem lokalen Agenten und einem kuratierten Design-System eine Website.',
    autoCtaPrefix: 'Kostenlos herunterladen für',
    autoCtaFallback: 'SankiWork kostenlos herunterladen',
    ...
    allReleasesBody:
      'Jeder Build und alle früheren Versionen liegen auf GitHub Releases und releases.sanki-ai.cloud.',
    ctaTitle: 'Lieber das Terminal?',
    ctaBody:
      'Installiere aus dem Quellcode mit drei Befehlen oder steuere SankiWork headless aus deinem bestehenden Coding-Agent.',
  },
  fr: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Télécharger SankiWork — application de bureau gratuite et open source (macOS, Windows, Linux)',
    description:
      'Téléchargez la dernière application de bureau SankiWork — gratuite et open source (Apache-2.0). Installez-la, connectez-vous une fois et commencez sans configurer de clé de modèle. Pour macOS (Apple Silicon et Intel), Windows et Linux.',
    breadcrumb: 'Télécharger',
    label: 'Télécharger',
    heading: 'Téléchargez SankiWork gratuitement. Concevez avec votre agent.',
    lead:
    ...
    heroVisualAlt:
      'L’espace de travail desktop SankiWork crée un site avec un agent local et un système de design sélectionné.',
    autoCtaPrefix: 'Télécharger gratuitement pour',
    autoCtaFallback: 'Télécharger SankiWork gratuitement',
    ...
    allReleasesBody:
      'Chaque build et chaque version passée se trouvent sur GitHub Releases et releases.sanki-ai.cloud.',
    ctaTitle: 'Vous préférez le terminal ?',
    ctaBody:
      'Installez depuis les sources en trois commandes, ou pilotez SankiWork en mode headless depuis votre agent de code existant.',
  },
  ru: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Скачать SankiWork — бесплатное десктопное приложение с открытым исходным кодом (macOS, Windows, Linux)',
    description:
      'Скачайте последнее десктопное приложение SankiWork — бесплатное и с открытым исходным кодом (Apache-2.0). Установите, войдите один раз и начните работу без настройки ключа модели. Для macOS (Apple Silicon и Intel), Windows и Linux.',
    breadcrumb: 'Скачать',
    label: 'Скачать',
    heading: 'Скачайте SankiWork бесплатно. Создавайте дизайн вместе со своим агентом.',
    lead:
    ...
    heroVisualAlt:
      'Десктопное рабочее пространство SankiWork создаёт сайт с помощью локального агента и тщательно отобранной дизайн-системы.',
    autoCtaPrefix: 'Скачать бесплатно для',
    autoCtaFallback: 'Скачать SankiWork бесплатно',
    ...
    allReleasesBody:
      'Все сборки и прошлые версии — на GitHub Releases и releases.sanki-ai.cloud.',
    ctaTitle: 'Предпочитаете терминал?',
    ctaBody:
      'Установите из исходников тремя командами или управляйте SankiWork в headless-режиме из вашего существующего агента для кода.',
  },
  es: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Descargar SankiWork — app de escritorio gratuita y de código abierto (macOS, Windows, Linux)',
    description:
      'Descarga la última app de escritorio de SankiWork: gratis y de código abierto (Apache-2.0). Instálala, inicia sesión una vez y empieza sin configurar claves de modelo. Para macOS (Apple Silicon e Intel), Windows y Linux.',
    breadcrumb: 'Descargar',
    label: 'Descargar',
    heading: 'Descarga SankiWork gratis. Diseña con tu agente.',
    lead:
    ...
    heroVisualAlt:
      'El espacio de trabajo de escritorio de SankiWork crea un sitio web con un agente local y un sistema de diseño seleccionado.',
    autoCtaPrefix: 'Descarga gratis para',
    autoCtaFallback: 'Descarga SankiWork gratis',
    ...
    allReleasesBody:
      'Cada compilación y versión anterior está en GitHub Releases y releases.sanki-ai.cloud.',
    ctaTitle: '¿Prefieres la terminal?',
    ctaBody:
      'Instala desde el código fuente con tres comandos, o controla SankiWork en modo headless desde tu agente de código actual.',
  },
  'pt-br': {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Baixar SankiWork — app de desktop gratuito e open source (macOS, Windows, Linux)',
    description:
      'Baixe o app de desktop mais recente do SankiWork — gratuito e open source (Apache-2.0). Instale, entre uma vez e comece sem configurar chaves de modelo. Para macOS (Apple Silicon e Intel), Windows e Linux.',
    breadcrumb: 'Baixar',
    label: 'Baixar',
    heading: 'Baixe o SankiWork grátis. Crie designs com seu agente.',
    lead:
    ...
    heroVisualAlt:
      'O workspace para desktop do SankiWork cria um site com um agente local e um sistema de design selecionado.',
    autoCtaPrefix: 'Baixe grátis para',
    autoCtaFallback: 'Baixe o SankiWork grátis',
    recommended: 'Recomendado',
    ...
    allReleasesBody:
      'Cada build e versão anterior fica no GitHub Releases e em releases.sanki-ai.cloud.',
    ctaTitle: 'Prefere o terminal?',
    ctaBody:
      'Instale a partir do código-fonte com três comandos, ou controle o SankiWork em modo headless pelo seu agente de código atual.',
  },
  it: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Scarica SankiWork — app desktop gratuita e open source (macOS, Windows, Linux)',
    description:
      'Scarica l’ultima app desktop di SankiWork — gratuita e open source (Apache-2.0). Installa, accedi una volta e inizia senza configurare chiavi del modello. Per macOS (Apple Silicon e Intel), Windows e Linux.',
    breadcrumb: 'Scarica',
    label: 'Scarica',
    heading: 'Scarica SankiWork gratis. Progetta con il tuo agente.',
    lead:
      'Collega Codex, Claude Code e altri agenti locali a design system selezionati per creare prototipi, siti, slide e video HTML.',
    heroVisualAlt:
      'Il workspace desktop di SankiWork crea un sito con un agente locale e un design system selezionato.',
    autoCtaPrefix: 'Scarica gratis per',
    autoCtaFallback: 'Scarica SankiWork gratis',
    ...
    allReleasesBody:
      'Ogni build e versione precedente si trova su GitHub Releases e releases.sanki-ai.cloud.',
    ctaTitle: 'Preferisci il terminale?',
    ctaBody:
      'Installa dai sorgenti con tre comandi, oppure pilota SankiWork in modalità headless dal tuo agente di coding esistente.',
  },
  vi: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Tải SankiWork — ứng dụng máy tính cho macOS, Windows và Linux',
    description:
      'Tải bản dựng máy tính SankiWork mới nhất. Cài đặt là tạo được ngay — đăng nhập một lần, chọn mô hình và bắt đầu thiết kế. macOS (Apple Silicon và Intel), Windows và Linux.',
    breadcrumb: 'Tải xuống',
    label: 'Tải xuống',
    heading: 'Tải SankiWork.',
    lead:
    ...
    allReleasesBody:
      'Mọi bản dựng và phiên bản trước đều có trên GitHub Releases và releases.sanki-ai.cloud.',
    ctaTitle: 'Thích dùng terminal hơn?',
    ctaBody:
      'Cài đặt từ mã nguồn bằng ba lệnh, hoặc điều khiển SankiWork ở chế độ headless từ agent lập trình hiện có của bạn.',
  },
  pl: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Pobierz SankiWork — aplikacja desktopowa na macOS, Windows i Linux',
    description:
      'Pobierz najnowszą wersję desktopową SankiWork. Zainstaluj i twórz — zaloguj się raz, wybierz model i zacznij projektować. macOS (Apple Silicon i Intel), Windows oraz Linux.',
    breadcrumb: 'Pobierz',
    label: 'Pobierz',
    heading: 'Pobierz SankiWork.',
    lead:
    ...
    autoCtaFallback: 'Pobierz SankiWork',
    ...
    allReleasesBody:
      'Każda kompilacja i poprzednia wersja są na GitHub Releases i releases.sanki-ai.cloud.',
    ctaTitle: 'Wolisz terminal?',
    ctaBody:
      'Zainstaluj ze źródeł trzema poleceniami albo steruj SankiWork w trybie headless ze swojego agenta do kodowania.',
  },
  id: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Unduh SankiWork — aplikasi desktop untuk macOS, Windows & Linux',
    description:
      'Unduh build desktop SankiWork terbaru. Pasang lalu berkarya — masuk sekali, pilih model, mulai mendesain. macOS (Apple Silicon & Intel), Windows, dan Linux.',
    breadcrumb: 'Unduh',
    label: 'Unduh',
    heading: 'Unduh SankiWork.',
    lead:
    ...
    autoCtaFallback: 'Unduh SankiWork',
    ...
    allReleasesBody:
      'Setiap build dan versi lampau ada di GitHub Releases dan releases.sanki-ai.cloud.',
    ctaTitle: 'Lebih suka terminal?',
    ctaBody:
      'Pasang dari sumber dengan tiga perintah, atau jalankan SankiWork secara headless dari agen coding Anda yang sudah ada.',
  },
  nl: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'SankiWork downloaden — desktop-app voor macOS, Windows en Linux',
    description:
      'Download de nieuwste SankiWork desktop-build. Installeren en maken — één keer inloggen, een model kiezen en beginnen met ontwerpen. macOS (Apple Silicon en Intel), Windows en Linux.',
    breadcrumb: 'Downloaden',
    label: 'Downloaden',
    heading: 'SankiWork downloaden.',
    lead:
    ...
    autoCtaFallback: 'SankiWork downloaden',
    ...
    allReleasesTitle: 'Alle releases',
    allReleasesBody:
      'Elke build en eerdere versie staat op GitHub Releases en releases.sanki-ai.cloud.',
    ctaTitle: 'Liever de terminal?',
    ctaBody:
      'Installeer vanuit de broncode met drie commando’s, of stuur SankiWork headless aan vanuit je bestaande coding-agent.',
  },
  ar: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'تنزيل SankiWork — تطبيق سطح المكتب لنظام macOS وWindows وLinux',
    description:
      'نزّل أحدث إصدار سطح مكتب من SankiWork. ثبّت وابدأ الإنشاء — سجّل الدخول مرة واحدة، اختر نموذجًا، وابدأ التصميم. يدعم macOS (Apple Silicon وIntel) وWindows وLinux.',
    breadcrumb: 'تنزيل',
    label: 'تنزيل',
    heading: 'تنزيل SankiWork.',
    lead:
    ...
    autoCtaFallback: 'تنزيل SankiWork',
    recommended: 'موصى به',
    ...
    allReleasesBody:
      'كل بناء وإصدار سابق موجود على GitHub Releases وعلى releases.sanki-ai.cloud.',
    ctaTitle: 'تفضّل الطرفية؟',
    ctaBody:
      'ثبّت من المصدر بثلاثة أوامر، أو شغّل SankiWork بوضع headless من وكيل البرمجة الحالي لديك.',
  },
  tr: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'SankiWork’i indir — ücretsiz ve açık kaynak masaüstü uygulaması (macOS, Windows, Linux)',
    description:
      'En son SankiWork masaüstü uygulamasını indirin — ücretsiz ve açık kaynak (Apache-2.0). Kurun, bir kez giriş yapın ve model anahtarı yapılandırmadan başlayın. macOS (Apple Silicon ve Intel), Windows ve Linux için.',
    breadcrumb: 'İndir',
    label: 'İndir',
    heading: 'SankiWork uygulamasını ücretsiz indirin. Ajanınızla tasarlayın.',
    lead:
    ...
    heroVisualAlt:
      'Yerel bir ajan ve özenle seçilmiş bir tasarım sistemiyle web sitesi oluşturan SankiWork masaüstü çalışma alanı.',
    autoCtaPrefix: 'Ücretsiz indirin:',
    autoCtaFallback: 'SankiWork uygulamasını ücretsiz indirin',
    ...
    allReleasesBody:
      'Her derleme ve geçmiş sürüm GitHub Releases ve releases.sanki-ai.cloud üzerindedir.',
    ctaTitle: 'Terminali mi tercih edersiniz?',
    ctaBody:
      'Kaynaktan üç komutla kurun veya SankiWork’i mevcut kodlama aracınızdan headless olarak çalıştırın.',
  },
  uk: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Завантажити SankiWork — десктопний застосунок для macOS, Windows і Linux',
    description:
      'Завантажте найновішу десктопну збірку SankiWork. Встановіть і творіть — увійдіть один раз, виберіть модель, почніть проєктувати. macOS (Apple Silicon та Intel), Windows і Linux.',
    breadcrumb: 'Завантажити',
    label: 'Завантажити',
    heading: 'Завантажити SankiWork.',
    lead:
    ...
    autoCtaFallback: 'Завантажити SankiWork',
    ...
    allReleasesBody:
      'Кожна збірка й попередня версія — на GitHub Releases і releases.sanki-ai.cloud.',
    ctaTitle: 'Надаєте перевагу терміналу?',
    ctaBody:
      'Встановіть із джерел трьома командами або керуйте SankiWork у headless-режимі з наявного агента для кодування.',
  },
};
...
INFO_PAGE_COPY.zh = {
  ...
  official: {
    ...
    title: '官方 SankiWork —— 来源页、GitHub、发布与别名',
    description:
      'SankiWork 官方来源页：canonical 网站、GitHub 仓库、发布、Discord、许可证和维护者身份都集中在这里。',
    breadcrumb: '官方',
    label: '来源 · Nº 00',
    heading: '官方 SankiWork 来源页。',
    lead:
      'SankiWork（也会被搜索为 SankiWork、sankiwork、sankiwork 或 SankiWork AI）是 nexu-io/open-design 项目的官方开源 AI 设计工作台。这个页面列出所有 canonical 入口，方便你自行核验来源。',
    canonicalTitle: 'Canonical 入口',
    canonicalBody: '请收藏 sanki-ai.cloud 和 GitHub 仓库。其它入口都应回到这两个来源之一。',
    sources: [
      { label: '官方网站', name: 'sanki-ai.cloud' },
    ...
    aliases: [
      { label: 'SankiWork', body: '产品 UI、博客和 README 中的展示名。' },
      { label: 'SankiWork', body: '常见的连写搜索变体，指向同一个项目。' },
      { label: 'sankiwork', body: '仓库和包名 slug。' },
      { label: 'sankiwork', body: 'URL 和 CLI 调用中的小写别名。' },
      { label: 'SankiWork AI', body: '用于区分通用 open design 话题的长尾搜索词。' },
      { label: 'OD', body: 'runtime 和 CLI bin 的内部缩写。' },
    ],
    aliasesClosing: '这六个名称都指向同一个项目。canonical URL 始终是 sanki-ai.cloud。',
    maintainerTitle: '维护者与许可证',
    maintainerBody:
      'SankiWork 在 github.com/nexu-io/open-design 公开开发，并以 Apache-2.0 发布。Issue、RFC 和路线图讨论都在 GitHub Issues 与 Discord 进行。',
    runtimeTitle: '你的机器上运行什么',
    runtimeBody: 'SankiWork 提供三个可运行表面，全部开源、全部本地优先：',
    runtimeItems: [
  ...
  quickstart: {
    ...
    title: 'SankiWork 快速开始 —— 三条命令安装（Node 24、pnpm）',
    description:
      '用三条命令在本地安装 SankiWork。包含 Node 24、pnpm 10.33.2 要求、命令、预期输出、排障和首次生成设计 artifact 的步骤。',
    breadcrumb: '快速开始',
    label: '安装 · Nº 01',
    heading: 'SankiWork 快速开始。',
    lead: 'SankiWork 完全运行在你的机器上。三条命令就能从干净 checkout 到本地 daemon、Web UI 和第一个设计 artifact。',
    ...
    steps: [
      {
        name: '克隆并安装',
        text: '克隆 sankiwork 仓库，并用 pnpm 安装 workspace 依赖。需要 Node 24 和 pnpm 10.33.2。',
        code: QUICKSTART_CODE.install,
      },
      {
    ...
    troubleshooting: [
      ...
      { label: 'Agent 没出现', body: '检查 /agents/ 以及 .sankiwork/media-config.json 中的凭据。' },
    ...
    nextItems: [
      ...
      { label: '比较 SankiWork', body: '了解它和 Claude Design、Figma Make、v0、Lovable 的差异。' },
  ...
  agents: {
    ...
    title: 'SankiWork Agent —— {count} 个 BYOK 适配器',
    description: 'SankiWork 内置 {count} 个 BYOK 适配器。直接用你写代码时已经在用的 Agent 来驱动设计，无需额外厂商登录。',
    breadcrumb: 'Agent',
    label: '适配器 · Nº 04',
    heading: (count) => `${count} 个 BYOK Agent，一套 Skill 协议。`,
    lead: (count) =>
      `SankiWork 内置 ${count} 个一方适配器。同一套可组合 Skill 和可移植 DESIGN.md 系统可以用于每一个 Agent。全程 BYOK：你的密钥、你的成本、你的数据。`,
    adaptersTitle: '适配器如何接入',
    adaptersBody:
      '每个适配器都是很薄的一层 shim，把 Agent 原生消息格式翻译成 SankiWork Skill 协议。新增适配器通常只是一个文件，不需要 fork 整个产品。',
    tiers: [
      { label: 'Tier 1 —— 一方日常验证', blurb: 'SankiWork 维护者每天使用的适配器。支持时会使用 Stream-JSON IPC、AskUserQuestion 中途交互和 Skill-aware system prompt。' },
    ...
    byokLead: 'SankiWork 中的 BYOK（bring your own key）意味着凭据和成本都留在你这一侧：',
    byokItems: [
      '凭据存放在 .sankiwork/media-config.json 或 shell env 中。',
    ...
    ctaBody: '选择你电脑上已有的 Agent，把 SankiWork 指向它，然后开始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.en!.compare,
    title: 'SankiWork vs Claude Design、Figma Make、v0、Lovable —— 诚实对比',
    description:
      '比较 SankiWork 与主流 AI 设计工具：云端托管 vs 本地优先、BYOK vs 厂商锁定、一次性生成 vs 可移植 DESIGN.md 系统。',
    breadcrumb: '对比',
    label: '评估 · Nº 02',
    heading: 'SankiWork 与其它工具的对比。',
    lead: '这里用简短、诚实的摘要说明 SankiWork 与你可能正在评估的其它 AI 设计工具之间的关系。',
    toc: ['vs Claude Design', 'vs Figma Make', 'vs v0', 'vs Lovable / Bolt', 'vs Open CoDesign', '真实限制'],
    comparisons: [
      { competitor: 'Claude Design', summary: '绑定单一厂商的云端产品。SankiWork 本地优先、BYOK、Apache-2.0，Skill 与 DESIGN.md 都留在你的 repo。', cta: '阅读完整对比 ->' },
      { competitor: 'Figma Make', summary: 'Figma Make 侧重在 Figma 内 prompt-to-mockup。SankiWork 把可移植 artifact 直接交付到你的项目。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'v0 by Vercel', summary: 'v0 在云端 runtime 生成 React 组件。SankiWork 在本地生成 deck、dashboard、landing page 和品牌系统。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Lovable / Bolt', summary: 'Lovable 和 Bolt 侧重云端 prompt-to-app。SankiWork 是给你已有 Agent 使用的设计 Skill 层。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Open CoDesign', summary: 'Open CoDesign 是同领域开源项目。SankiWork 可以通过 Skill 协议包装 codesign 类型工作流。', cta: '查看仓库中的迁移说明 ->' },
    ],
    limitsTitle: '真实限制 —— SankiWork 不是什么',
    limitsBody: 'SankiWork 不试图成为所有云端 AI 设计工具。下面的问题说明实际取舍，而不是把限制包装掉。',
    limitsFaq: [
      { name: 'SankiWork 有云端 Web sandbox 吗？', text: '没有。SankiWork 的设计目标就是本地优先。' },
      { name: '不安装任何东西可以使用 SankiWork 吗？', text: '目前不行。最小形态是本地 daemon 加一个 coding agent。' },
      { name: 'SankiWork 是 v0 / Lovable / Bolt 替代品吗？', text: '取决于场景。SankiWork 聚焦通过可 fork 的 Skill 协议生成设计 artifact。' },
      { name: 'SankiWork 会把我的数据发给 Anthropic、OpenAI 或 Google 吗？', text: '只会把 prompt 与 Skill 上下文发给你自己带 key 的 provider。' },
      { name: '可以把 SankiWork 自托管到自己的基础设施吗？', text: '可以。Apache-2.0、Node 24 daemon、没有必需 SaaS。' },
    ],
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.en!.claudeAlternative,
    title: 'Claude Design 开源替代方案 —— SankiWork（BYOK、本地优先）',
    description:
      'SankiWork 是 Claude Design 的开源、本地优先替代方案。支持 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 开源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的开源替代方案。',
    lead:
      'SankiWork 是官方开源、本地优先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存为可移植 DESIGN.md 文件，并把 artifact 作为项目文件交付。',
    tldrTitle: '简版结论',
    ...
    localByokBody: [
      'SankiWork 在你的机器上运行桌面应用、本地 daemon，以及 Markdown 形式的 Skill/System 目录。',
    ...
    pickOpenTitle: '适合 SankiWork 的情况',
    ...
    migrateSteps: ['按快速开始安装 SankiWork。', '打开 Web UI，让 Agent 查看一个你喜欢的 Claude Design artifact。', '让 Agent 把品牌提取成 DESIGN.md 文件。', '选择一个 Skill，用新品牌渲染。'],
    migrateClosing: '之后每个 Skill 都能沿用你的品牌，不需要反复重新提示。',
    faqTitle: 'FAQ',
    faq: [
      { name: 'SankiWork 真的是 Claude Design 的 drop-in 替代吗？', text: '不是字面上的 drop-in，但它们都覆盖 prompt-to-design-artifact 这个用途。' },
      { name: '可以在 SankiWork 中使用 Claude 作为 Agent 吗？', text: '可以。SankiWork 支持 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 设计怎么办？', text: '你可以继续并行使用 Claude Design；目前迁移是手动的。' },
      { name: 'SankiWork 能生成相同类型的 artifact 吗？', text: '常见类型可以：落地页、演示文稿、仪表盘、社交内容、品牌系统和原型。' },
      { name: '为什么说 open-source Claude Design，而不是 open-source AI design tool？', text: '因为很多用户就是用这个形状来描述他们在找的产品。' },
      { name: '谁在构建和维护 SankiWork？', text: '项目位于 github.com/nexu-io/open-design，许可证为 Apache-2.0。' },
    ],
    ctaTitle: '三条命令切换。',
  ...
  download: {
    ...INFO_PAGE_COPY.en!.download,
    title: '下载 SankiWork —— 免费开源桌面客户端（macOS / Windows / Linux）',
    description:
      '下载最新版 SankiWork 桌面客户端——免费、开源（Apache-2.0）。安装后登录一次即可开始设计，无需配置模型密钥。支持 macOS（Apple Silicon 与 Intel）、Windows、Linux。',
    breadcrumb: '下载',
    label: '下载',
    heading: '免费下载 SankiWork，用你的 Agent 开始设计。',
    lead: '连接本地 Codex、Claude Code 等编程助手，调用精选设计系统，生成原型、网页、演示文稿和 HTML 视频。',
    heroVisualAlt: 'SankiWork 桌面工作区使用本地 Agent 和精选设计系统创建网站。',
    mobileDesktopNotice: 'SankiWork 是桌面客户端，请在电脑上下载。',
    autoCtaPrefix: '免费下载',
    autoCtaFallback: '免费下载 SankiWork',
    recommended: '推荐',
    publishedPrefix: '发布于',
    releaseNotes: '更新日志',
    platformsTitle: '全部平台',
    ...
    allReleasesBody: '每个构建与历史版本都在 GitHub Releases 与 releases.sanki-ai.cloud 上。',
    ctaTitle: '更喜欢用终端？',
    ctaBody: '三条命令从源码安装，或用你现有的编码 agent 以 headless 方式驱动 SankiWork。',
  },
};
...
INFO_PAGE_COPY['zh-tw'] = {
  ...
  official: {
    ...
    title: '官方 SankiWork —— 來源頁、GitHub、發布與別名',
    description:
      'SankiWork 官方來源頁：canonical 網站、GitHub repo、發布、Discord、授權與維護者身份都集中在這裡。',
    breadcrumb: '官方',
    heading: '官方 SankiWork 來源頁。',
    lead:
      'SankiWork（也會被搜尋為 SankiWork、sankiwork、sankiwork 或 SankiWork AI）是 nexu-io/open-design 專案的官方開源 AI 設計工作台。這個頁面列出所有 canonical 入口，方便你自行核驗來源。',
    canonicalBody: '請收藏 sanki-ai.cloud 與 GitHub repo。其他入口都應回到這兩個來源之一。',
    aliasesTitle: '命名與別名',
    aliasesLead: '不同工具、受眾與語言環境裡，這個專案會以幾種方式被搜尋和書寫：',
    aliases: [
      { label: 'SankiWork', body: '產品 UI、部落格與 README 中的展示名。' },
      { label: 'SankiWork', body: '常見的連寫搜尋變體，指向同一個專案。' },
      { label: 'sankiwork', body: 'repo 與 package slug。' },
      { label: 'sankiwork', body: 'URL 與 CLI 呼叫中的小寫別名。' },
      { label: 'SankiWork AI', body: '用來區分通用 open design 話題的長尾搜尋詞。' },
      { label: 'OD', body: 'runtime 與 CLI bin 的內部縮寫。' },
    ],
    aliasesClosing: '這六個名稱都指向同一個專案。canonical URL 永遠是 sanki-ai.cloud。',
    maintainerBody:
      'SankiWork 在 github.com/nexu-io/open-design 公開開發，並以 Apache-2.0 發布。Issue、RFC 與路線圖討論都在 GitHub Issues 與 Discord 進行。',
    runtimeTitle: '你的機器上執行什麼',
    runtimeBody: 'SankiWork 提供三個可執行表面，全部開源、全部本地優先：',
    runtimeItems: [
  ...
  quickstart: {
    ...
    title: 'SankiWork 快速開始 —— 三條命令安裝（Node 24、pnpm）',
    description:
      '用三條命令在本地安裝 SankiWork。包含 Node 24、pnpm 10.33.2 要求、命令、預期輸出、排障與首次生成設計 artifact 的步驟。',
    breadcrumb: '快速開始',
    heading: 'SankiWork 快速開始。',
    lead: 'SankiWork 完全執行在你的機器上。三條命令就能從乾淨 checkout 到本地 daemon、Web UI 和第一個設計 artifact。',
    ...
    steps: [
      {
        name: 'clone 並安裝',
        text: 'clone sankiwork repo，並用 pnpm 安裝 workspace 依賴。需要 Node 24 與 pnpm 10.33.2。',
        code: QUICKSTART_CODE.install,
      },
      {
    ...
    troubleshooting: [
      ...
      { label: 'Agent 沒出現', body: '檢查 /agents/ 以及 .sankiwork/media-config.json 中的憑據。' },
  ...
  agents: {
    ...
    title: 'SankiWork Agent —— {count} 個 BYOK adapter',
    description: 'SankiWork 內建 {count} 個 BYOK adapter。直接用你寫程式時已經在用的 Agent 來驅動設計，無需額外供應商登入。',
    breadcrumb: 'Agent',
    heading: (count) => `${count} 個 BYOK Agent，一套 Skill 協議。`,
    lead: (count) =>
      `SankiWork 內建 ${count} 個一方 adapter。同一套可組合 Skill 與可移植 DESIGN.md 系統可以用於每一個 Agent。全程 BYOK：你的密鑰、你的成本、你的資料。`,
    adaptersTitle: 'Adapter 如何接入',
    adaptersBody:
      '每個 adapter 都是很薄的一層 shim，把 Agent 原生訊息格式翻譯成 SankiWork Skill 協議。新增 adapter 通常只是一個檔案，不需要 fork 整個產品。',
    vendor: '供應商',
    credential: '憑據',
    byokTitle: '這裡的 BYOK 是什麼意思',
    byokLead: 'SankiWork 中的 BYOK（bring your own key）意味著憑據和成本都留在你這一側：',
    byokItems: [
      '憑據存放在 .sankiwork/media-config.json 或 shell env 中。',
    ...
    ctaBody: '選擇你電腦上已有的 Agent，把 SankiWork 指向它，然後開始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.zh!.compare,
    title: 'SankiWork vs Claude Design、Figma Make、v0、Lovable —— 誠實比較',
    breadcrumb: '比較',
    label: '評估 · Nº 02',
    heading: 'SankiWork 與其他工具的比較。',
    lead: '這裡用簡短、誠實的摘要說明 SankiWork 與你可能正在評估的其他 AI 設計工具之間的關係。',
    limitsTitle: '真實限制 —— SankiWork 不是什麼',
    limitsBody: 'SankiWork 不試圖成為所有雲端 AI 設計工具。下面的問題說明實際取捨，而不是把限制包裝掉。',
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.zh!.claudeAlternative,
    title: 'Claude Design 開源替代方案 —— SankiWork（BYOK、本地優先）',
    description:
      'SankiWork 是 Claude Design 的開源、本地優先替代方案。支援 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 開源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的開源替代方案。',
    lead:
      'SankiWork 是官方開源、本地優先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存為可移植 DESIGN.md 檔案，並把 artifact 作為專案檔案交付。',
    tldrTitle: '簡版結論',
    ...
    pickOpenTitle: '適合 SankiWork 的情況',
    migrateTitle: '遷移 / 首次執行',
    faqTitle: 'FAQ',
    faq: [
      { name: 'SankiWork 真的是 Claude Design 的 drop-in 替代嗎？', text: '不是字面上的 drop-in，但它們都覆蓋 prompt-to-design-artifact 這個用途。' },
      { name: '可以在 SankiWork 中使用 Claude 作為 Agent 嗎？', text: '可以。SankiWork 支援 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 設計怎麼辦？', text: '你可以繼續並行使用 Claude Design；目前遷移是手動的。' },
      { name: 'SankiWork 能生成相同類型的 artifact 嗎？', text: '常見類型可以：落地頁、簡報、儀表板、社群內容、品牌系統和原型。' },
      { name: '為什麼說 open-source Claude Design，而不是 open-source AI design tool？', text: '因為很多使用者就是用這個形狀來描述他們在找的產品。' },
      { name: '誰在構建和維護 SankiWork？', text: '專案位於 github.com/nexu-io/open-design，授權為 Apache-2.0。' },
    ],
    ctaTitle: '三條命令切換。',
...
> = {
  ja: {
    ...
    reusable: {
      sourceBody: 'この項目は SankiWork の正規の入口と同じプロジェクトを指します。',
    ...
    official: {
      title: '公式 SankiWork — 出典、GitHub、リリース、別名',
      description: 'SankiWork の正規ページ、GitHub、リリース、コミュニティ、ライセンスをまとめた確認用ページです。',
      breadcrumb: '公式',
      label: '出典 · Nº 00',
      heading: '公式 SankiWork 出典ページ。',
      lead: 'SankiWork は nexu-io/open-design プロジェクトのオープンソース AI デザインワークスペースです。',
    },
    quickstart: {
      title: 'SankiWork クイックスタート — Node 24 と pnpm で開始',
      description: 'SankiWork をローカルに入れ、daemon、Web UI、最初の artifact まで進む手順です。',
      breadcrumb: 'クイックスタート',
      label: 'インストール · Nº 01',
      heading: 'SankiWork クイックスタート。',
      lead: 'ローカル環境だけで起動し、既存のエージェントからデザイン生成を始められます。',
      ctaTitle: 'ローカルで始める。',
    },
    agents: {
      title: 'SankiWork エージェント — {count} 個の BYOK アダプター',
      description: '普段使っているコーディングエージェントから SankiWork のスキルを実行できます。',
      breadcrumb: 'エージェント',
      label: 'アダプター · Nº 04',
      heading: '{count} 個の BYOK エージェント、1 つのスキルプロトコル。',
      lead: 'SankiWork は {count} 個のアダプターで、同じスキルと DESIGN.md を複数のエージェントから使えます。',
      ctaTitle: '{count} 個のアダプター。あなたのエージェント。',
    },
    compare: {
      title: 'SankiWork と主要 AI デザインツールの比較',
      description: 'ローカル優先、BYOK、オープンソース、ポータブルな DESIGN.md という観点で比較します。',
      breadcrumb: '比較',
      label: '評価 · Nº 02',
      heading: 'SankiWork と他の選択肢。',
      lead: 'SankiWork はホスト型ツールではなく、エージェントで動かすローカル優先のデザイン層です。',
    },
    claudeAlternative: {
      title: 'Claude Design のオープンソース代替 — SankiWork',
      description: 'SankiWork は BYOK とローカル優先を軸にした Claude Design 代替です。',
...
function compactInfoTextFromHome(locale: LandingLocaleCode): CompactInfoPageText {
  ...
  return {
    ...
    official: {
      title: `${labels.official} · SankiWork`,
      description: summary,
      breadcrumb: labels.official,
      label: labels.official,
      heading: `${labels.official} · SankiWork`,
      lead,
    },
    quickstart: {
      title: `${labels.quickstart} · SankiWork`,
      description: lead,
      breadcrumb: labels.quickstart,
      label: labels.quickstart,
      heading: `${labels.quickstart} · SankiWork`,
      lead,
      ctaTitle: labels.next,
    },
    agents: {
      title: `${labels.agents} · SankiWork`,
      description: lead,
    ...
    compare: {
      title: `${labels.compare} · SankiWork`,
      description: summary,
      breadcrumb: labels.compare,
      label: labels.compare,
      heading: `${labels.compare} · SankiWork`,
      lead,
    },
    claudeAlternative: {
      title: `${labels.alternative} · SankiWork`,
      description: summary,
      breadcrumb: labels.alternative,
      label: labels.alternative,
      heading: `${labels.alternative} · SankiWork`,
