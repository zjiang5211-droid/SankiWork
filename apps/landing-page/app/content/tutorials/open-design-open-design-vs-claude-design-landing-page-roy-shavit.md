...
summary: A cost-first guide to SankiWork — escape the token cap by running design through the agent you already pay for (or your own key), build a full landing page, even generate a video, and deploy. Plus an honest "when to use which tool" call. Based on Roy Shavit's walkthrough.
date: 2026-06-14
category: Demo
durationSeconds: 866
...
This guide takes the cost angle head-on: if you've used a closed cloud design tool, you know the magic — and you know the tokens run out fast. SankiWork lets you design at a similar quality by running the work through **any model you want** — the agent you already pay for, or your own key — so you're not rationing a separate design budget. It follows the build **Roy Shavit** runs in [his walkthrough](https://www.youtube.com/watch?v=17Wbq5r8tzA), rewritten in English and brought up to date with the current release. Watch the video above for the live run, or read on for the written version.

![The HyperFrames motion and video gallery in SankiWork.](/tutorials/open-design-open-design-vs-claude-design-landing-page-roy-shavit/motion-gallery.webp)
*The HyperFrames gallery: code-driven motion and video pieces you can fork and remix.*

## What is SankiWork?

SankiWork is an open-source, local-first design platform. Like the closed cloud tool, you give it a prompt and get back a real artifact — a landing page, app, or deck — as editable HTML you can keep working on in VS Code or your editor. Three things set it apart, and the first two are why it's cheaper to run:
...
Open the local URL it prints (a dynamic port — don't hardcode one). In settings, SankiWork **immediately recognizes the models installed locally** — Roy has Codex and Claude, and it would pick up OpenCode or others too. Set a default, or bring your own key from any provider so you don't even need a CLI installed. This is the uniqueness: you're not forced onto one vendor.

![Slide-deck mode in SankiWork with example decks.](/tutorials/open-design-open-design-vs-claude-design-landing-page-roy-shavit/slide-deck-creator.webp)
...
![A real prototype generated in SankiWork.](/tutorials/open-design-open-design-vs-claude-design-landing-page-roy-shavit/generated-prototype.webp)
