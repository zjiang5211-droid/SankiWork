...
thumbnail: /tutorials/sankiwork-ai-ppt-tutorial-cover.webp
official: true
---
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-image-mode-entry.webp" alt="SankiWork Image Mode entry in the prompt composer" width="1600" height="824" loading="lazy" />
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-style-light.webp" alt="A light SankiWork slide image generated in Image Mode" width="1600" height="958" loading="lazy" />
  <figcaption>One reference image can explore a clean, bright presentation style before the deck is built.</figcaption>
</figure>

<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-style-dark.webp" alt="A dark SankiWork slide image generated in Image Mode" width="1600" height="958" loading="lazy" />
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-deck-mode-entry.png" alt="SankiWork Deck Mode selected in the prompt composer" width="2754" height="1576" loading="lazy" />
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-brand-assets.webp" alt="A deck slide using real agent and model logos" width="1600" height="964" loading="lazy" />
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-ai-visual-example.webp" alt="A slide using AI-generated visual material to support the presentation argument" width="1800" height="1087" loading="lazy" />
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-echarts-example.webp" alt="A presentation slide with an embedded chart module" width="1600" height="901" loading="lazy" />
...
<figure class="ppt-media">
  <video src="/tutorials/sankiwork-ai-ppt-threejs-demo.mp4" controls playsinline preload="metadata"></video>
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-comment-tool.png" alt="SankiWork comment box attached to a selected slide element" width="2154" height="1206" loading="lazy" />
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-mark-tool.png" alt="SankiWork Mark tool highlighting a slide header area" width="2158" height="1210" loading="lazy" />
...
<figure class="ppt-media">
  <img src="/tutorials/sankiwork-ai-ppt-edit-tool.png" alt="SankiWork Edit panel editing selected slide text" width="2156" height="1206" loading="lazy" />
...
<figure class="ppt-media">
  <video src="/tutorials/sankiwork-ai-ppt-motion-demo.mp4" controls playsinline preload="metadata" poster="/tutorials/sankiwork-ai-ppt-tutorial-cover.webp"></video>
