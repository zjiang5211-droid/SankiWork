---
title: 'SankiWork in 20 Minutes — Full Setup + Demo'
youtubeId: QOqWZzecjuY
summary: A complete getting-started walkthrough — install SankiWork, connect your coding agent, tour the workspace, and build your first high-fidelity prototype. Based on CodingMenace's hands-on first-impressions video.
date: 2026-05-05
...
This guide walks you through your first 20 minutes with SankiWork — from a clean install to your first generated prototype. It follows the path CodingMenace (Dennis) took in [his hands-on first-impressions video](https://www.youtube.com/watch?v=QOqWZzecjuY), rewritten and updated to match the current release so you can follow along step by step. Watch the video above for the live walkthrough, or read on for the written version.

![The SankiWork home page — an open-source, local, agent-native Claude Design alternative.](/tutorials/sankiwork-in-20-minutes/01-open-design-home.webp)
*SankiWork positions itself as the open-source Claude Design alternative — desktop-first, agent-native, Apache-2.0.*
...
If you have used Claude Design, the look and feel will be instantly familiar — SankiWork deliberately keeps the same calm aesthetic, then adds capabilities on top.
...
Then, inside the agent, just ask: `Use sankiwork to generate a landing page with the Linear design system`.

## Step 2 — First run: connect your coding agent

The first time you launch SankiWork, it scans your machine and shows you every local CLI it found — Claude Code, OpenCode, Copilot CLI, and others. This is the "bring your own agent" step.
...
SankiWork keeps your work **project-scoped**: when you run it against a folder, the designs you create live inside that project directory. Switch folders and you switch projects.
...
One key difference from Claude Design: you are **not forced to define a design system first**. SankiWork ships sensible defaults and a gallery of starting points, so you can begin from an existing design system — or none at all.

![The SankiWork design-systems library — real brand starting points you can preview and reuse.](/tutorials/sankiwork-in-20-minutes/03-design-systems.webp)
...
![The SankiWork templates library, with prototype, image, and video starting points.](/tutorials/sankiwork-in-20-minutes/04-templates.webp)
...
Now the fun part. In the video, Dennis imports an existing Claude Design project and asks SankiWork to build a new page for it. Here is the same flow:

1. **Create a new prototype.** Give it a name (Dennis calls his "Expensely") and choose **High fidelity**.
2. **Import your design system.** SankiWork can import an existing Claude Design ZIP, so your tokens and components carry over. The imported design files appear in the workspace alongside a live preview.
...
- **You do not need a design system to start.** Begin from a built-in one, import a Claude Design ZIP, or let SankiWork infer defaults.
...
21+ agents, including Claude Code, Codex, Cursor, GitHub Copilot, OpenCode, and Qwen. SankiWork detects the supported CLIs already installed on your machine.

**Do I have to create a design system before I can design?**
No. Unlike Claude Design, SankiWork gives you working defaults and a gallery of starting points. You can bring your own design system when you want one.
