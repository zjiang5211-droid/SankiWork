...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <h2>延伸阅读</h2>
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0：一体化设计工作空间</a> —— 本次发布所开放的那次单窗口发布</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0：人人皆可设计</a> —— 欢迎流程底下那次「安装即创作」发布</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0：万物皆插件</a> —— 画廊所构建于其上的那个插件引擎</li>
      </ul>
  ja:
    ...
    bodyHtml: |
      ...
      <h2>関連記事</h2>
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0：オールインワンのデザインワークスペース</a> — 今回が切り開く、そのワンウィンドウのリリース</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0：すべての人のためのデザイン</a> — ウェルカムの下にある、インストールして作るリリース</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0：すべてはプラグイン</a> — ギャラリーが築かれている、そのプラグインエンジン</li>
      </ul>
  ko:
    ...
    bodyHtml: |
      ...
      <h2>함께 읽기</h2>
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: 올인원 디자인 워크스페이스</a> — 이번 릴리스가 열어젖히는 단일 창 릴리스</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0: 모두를 위한 디자인</a> — 환영 밑에 자리한 설치-그리고-생성 릴리스</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0: 만물은 플러그인</a> — 갤러리가 그 위에 지어진 플러그인 엔진</li>
      </ul>
  de:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: der All-in-One-Design-Workspace</a> — das Ein-Fenster-Release, das dieses hier weiter öffnet</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0: Design für alle</a> — das Installieren-und-Erstellen-Release unter dem Willkommen</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0: alles ist ein Plugin</a> — die Plugin-Engine, auf der die Galerie aufbaut</li>
      </ul>
  fr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0 : l'espace de travail de conception tout-en-un</a> — la version une seule fenêtre que celle-ci ouvre</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0 : la conception pour tous</a> — la version installer-et-créer sous l'accueil</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0 : tout est un plugin</a> — le moteur de plugins sur lequel la galerie est bâtie</li>
      </ul>
  ru:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: единое рабочее пространство для дизайна</a> — релиз одного окна, который этот раскрывает</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0: дизайн для всех</a> — релиз «установи-и-создавай» под этим приветствием</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0: всё — это плагин</a> — движок плагинов, на котором построена галерея</li>
      </ul>
  es:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: el espacio de trabajo de diseño todo en uno</a> — la versión de una sola ventana que esta abre</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0: diseño para todos</a> — la versión de instalar y crear que está debajo de la bienvenida</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0: todo es un plugin</a> — el motor de plugins sobre el que está construida la galería</li>
      </ul>
  pt-br:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: o espaço de trabalho de design tudo-em-um</a> — a versão de janela única que esta aqui abre</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0: design para todos</a> — a versão de instalar-e-criar por baixo do acolhimento</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0: tudo é um plugin</a> — o motor de plugins sobre o qual a galeria é construída</li>
      </ul>
  it:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: lo spazio di lavoro per il design tutto-in-uno</a> — la release a finestra unica che questa apre</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0: design per tutti</a> — la release "installa-e-crea" che sta sotto al benvenuto</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0: tutto è un plugin</a> — il motore di plugin su cui è costruita la galleria</li>
      </ul>
  tr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: hepsi bir arada tasarım çalışma alanı</a> — bunun açtığı tek pencere sürümü</li>
        <li><a href="/blog/open-design-0-9-0-design-for-everyone/">SankiWork 0.9.0: herkes için tasarım</a> — karşılamanın altındaki kur-ve-yarat sürümü</li>
        <li><a href="/blog/open-design-0-8-0-everything-is-a-plugin/">SankiWork 0.8.0: her şey bir eklenti</a> — galerinin üzerine inşa edildiği eklenti motoru</li>
      </ul>
---
...
- [SankiWork 0.10.0: the all-in-one design workspace](/blog/open-design-0-10-0-all-in-one-workspace/) — the one-window release this one opens up
- [SankiWork 0.9.0: design for everyone](/blog/open-design-0-9-0-design-for-everyone/) — the install-and-create release underneath the welcome
- [SankiWork 0.8.0: everything is a plugin](/blog/open-design-0-8-0-everything-is-a-plugin/) — the plugin engine the gallery is built on
