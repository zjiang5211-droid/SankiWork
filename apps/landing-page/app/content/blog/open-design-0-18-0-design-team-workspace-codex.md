...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <p>如果你从 0.16.x 直接升级到这个版本，<a href="/blog/open-design-0-17-0-open-design-for-codex/">0.17.0 版本</a>的内容也包含在这次升级中——SankiWork 已经成为 Codex 可以直接触达的设计层。</p>
      ...
      <h2>相关阅读</h2>
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">SankiWork 0.17.0：为 Codex 打造的设计工作区</a></li>
        <li><a href="/blog/open-design-0-16-0-reliable-delivery/">SankiWork 0.16.0：可靠交付</a></li>
        <li><a href="/blog/open-design-0-15-1/">SankiWork 0.15.1：视野更清晰，流程更持久</a></li>
      </ul>
  ja:
    ...
    bodyHtml: |
      ...
      <p>0.16.x からこのリリースへ移るなら、<a href="/blog/open-design-0-17-0-open-design-for-codex/">0.17.0 リリース</a>もアップグレードに含まれます。SankiWork は Codex が直接アクセスできるデザインレイヤーになりました。</p>
      ...
      <h2>関連記事</h2>
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">SankiWork 0.17.0：Codex のための SankiWork</a></li>
        <li><a href="/blog/open-design-0-16-0-reliable-delivery/">SankiWork 0.16.0 — 確実に届く</a></li>
  ...
  ko:
    ...
    bodyHtml: |
      ...
      <p>0.16.x에서 이 릴리스로 바로 넘어왔다면 <a href="/blog/open-design-0-17-0-open-design-for-codex/">0.17.0 릴리스</a>도 이번 업그레이드에 포함됩니다. SankiWork은 Codex가 직접 닿을 수 있는 디자인 레이어가 됐습니다.</p>
      ...
      <h2>함께 읽기</h2>
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">SankiWork 0.17.0: Codex를 위한 SankiWork</a></li>
  ...
  de:
    ...
    bodyHtml: |
      ...
      <p>Wenn Sie von 0.16.x direkt zu diesem Release gewechselt sind, gehört das <a href="/blog/open-design-0-17-0-open-design-for-codex/">Release 0.17.0</a> ebenfalls zu Ihrem Upgrade — SankiWork ist zur Designschicht geworden, die Codex direkt erreichen kann.</p>
      ...
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">Release Notes zu SankiWork 0.17.0: SankiWork für Codex</a></li>
  ...
  fr:
    ...
    bodyHtml: |
      ...
      <p>Si vous êtes passé directement de 0.16.x à cette version, la <a href="/blog/open-design-0-17-0-open-design-for-codex/">version 0.17.0</a> fait également partie de votre mise à niveau — SankiWork est devenu la couche design à laquelle Codex peut accéder directement.</p>
      ...
      <h2>À lire aussi</h2>
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">Notes de version d'SankiWork 0.17.0 : SankiWork pour Codex</a></li>
  ...
  ru:
    ...
    bodyHtml: |
      ...
      <p>Если вы перешли на этот релиз сразу с 0.16.x, <a href="/blog/open-design-0-17-0-open-design-for-codex/">релиз 0.17.0</a> тоже является частью обновления — SankiWork стал дизайн-слоем, к которому Codex может обращаться напрямую.</p>
      ...
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">Примечания к релизу SankiWork 0.17.0: SankiWork для Codex</a></li>
  ...
  es:
    ...
    bodyHtml: |
      ...
      <p>Si saltaste de 0.16.x a esta versión, la <a href="/blog/open-design-0-17-0-open-design-for-codex/">versión 0.17.0</a> también forma parte de tu actualización: SankiWork se ha convertido en la capa de diseño a la que Codex puede acceder directamente.</p>
      ...
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">Notas de la versión SankiWork 0.17.0: SankiWork para Codex</a></li>
  ...
  pt-br:
    ...
    bodyHtml: |
      ...
      <p>Se você pulou do 0.16.x para esta versão, a <a href="/blog/open-design-0-17-0-open-design-for-codex/">versão 0.17.0</a> também faz parte da sua atualização — o SankiWork se tornou a camada de design que o Codex consegue acessar diretamente.</p>
      ...
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">Notas da versão SankiWork 0.17.0: SankiWork para Codex</a></li>
  ...
  it:
    ...
    bodyHtml: |
      ...
      <p>Se sei passato da 0.16.x direttamente a questa release, anche la <a href="/blog/open-design-0-17-0-open-design-for-codex/">release 0.17.0</a> fa parte del tuo aggiornamento: SankiWork è diventato il livello di design che Codex può raggiungere direttamente.</p>
      ...
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">Note di rilascio di SankiWork 0.17.0: SankiWork per Codex</a></li>
  ...
  tr:
    ...
    bodyHtml: |
      ...
      <p>0.16.x'ten doğrudan bu sürüme geçtiyseniz <a href="/blog/open-design-0-17-0-open-design-for-codex/">0.17.0 sürümü</a> de yükseltmenizin bir parçası: SankiWork, Codex'in doğrudan erişebildiği tasarım katmanına dönüştü.</p>
      ...
      <ul>
        <li><a href="/blog/open-design-0-17-0-open-design-for-codex/">SankiWork 0.17.0 sürüm notları: Codex için SankiWork</a></li>
...
If you jumped from 0.16.x to this release, the [0.17.0 release](/blog/open-design-0-17-0-open-design-for-codex/) is part of your upgrade too — SankiWork has become the design layer Codex can reach directly.
...
- [SankiWork 0.17.0 release notes: SankiWork for Codex](/blog/open-design-0-17-0-open-design-for-codex/)
