...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <h2>延伸阅读</h2>
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0：保持心流</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0：你的品牌就是一套设计系统</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0：集市</a></li>
      </ul>
  ja:
    ...
    bodyHtml: |
      ...
      <h2>関連記事</h2>
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0：フローにとどまる</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0：あなたのブランドはデザインシステムである</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0：バザール</a></li>
      </ul>
  ko:
    ...
    bodyHtml: |
      ...
      <h2>함께 읽기</h2>
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0: 흐름 속에 머물기</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: 당신의 브랜드가 곧 디자인 시스템</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: 바자르</a></li>
      </ul>
  de:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0: im Flow bleiben</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: deine Marke ist ein Designsystem</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: der Basar</a></li>
      </ul>
  fr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0 : rester dans le flow</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0 : votre marque est un système de design</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0 : le Bazar</a></li>
      </ul>
  ru:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0: оставаться в потоке</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: ваш бренд — это дизайн-система</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: базар</a></li>
      </ul>
  es:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0: mantente en el flow</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: tu marca es un sistema de diseño</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: el Bazar</a></li>
      </ul>
  pt-br:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0: continue no flow</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: sua marca é um sistema de design</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: o Bazar</a></li>
      </ul>
  it:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0: resta nel flow</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: il tuo brand è un design system</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: il Bazaar</a></li>
      </ul>
  tr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-13-0-stay-in-flow/">SankiWork 0.13.0: akışta kalın</a></li>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: markanız bir tasarım sistemidir</a></li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: Pazar Yeri</a></li>
      </ul>
---
...
- [SankiWork 0.13.0: stay in flow](/blog/open-design-0-13-0-stay-in-flow/)
- [SankiWork 0.12.0: your brand is a design system](/blog/open-design-0-12-0-brand-backed-design-system/)
- [SankiWork 0.11.0: the Bazaar](/blog/open-design-0-11-0-the-bazaar/)
