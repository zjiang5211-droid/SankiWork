...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <h2>延伸阅读</h2>
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0：你的品牌就是一套设计系统</a> —— 本次发布让你在其之上保持心流的那次品牌捕获发布</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0：集市</a> —— 底下那次「画廊与欢迎」发布</li>
  ...
  ja:
    ...
    bodyHtml: |
      ...
      <h2>関連記事</h2>
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0：あなたのブランドはデザインシステムである</a> — 今回がその上でフローにとどまらせてくれる、ブランドキャプチャのリリース</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0：バザール</a> — その下にある、ギャラリーとウェルカムのリリース</li>
  ...
  ko:
    ...
    bodyHtml: |
      ...
      <h2>함께 읽기</h2>
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: 당신의 브랜드가 곧 디자인 시스템</a> — 이번 릴리스가 그 위에서 당신을 흐름 속에 머물게 해주는, 브랜드 캡처 릴리스</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: 바자르</a> — 그 아래에 있는 갤러리-그리고-환영 릴리스</li>
  ...
  de:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: deine Marke ist ein Designsystem</a> — das Marken-Erfassungs-Release, auf dem dieses aufbaut, um dich im Flow zu halten</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: der Basar</a> — das darunterliegende Galerie-und-Willkommen-Release</li>
  ...
  fr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0 : votre marque est un système de design</a> — la version de capture de marque sur laquelle celle-ci s'appuie pour vous garder dans le flow</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0 : le Bazar</a> — la version galerie-et-accueil en dessous</li>
  ...
  ru:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: ваш бренд — это дизайн-система</a> — релиз захвата бренда, на основе которого этот держит вас в потоке</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: базар</a> — релиз галереи-и-приветствия под ним</li>
  ...
  es:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: tu marca es un sistema de diseño</a>: la versión de captura de marca sobre la que esta te mantiene en el flow</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: el Bazar</a>: la versión de galería y bienvenida debajo</li>
  ...
  pt-br:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: sua marca é um sistema de design</a> — a versão de captura de marca sobre a qual esta mantém você no flow</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: o Bazar</a> — a versão de galeria-e-acolhimento por baixo</li>
  ...
  it:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: il tuo brand è un design system</a> — la release di cattura del brand su cui questa ti mantiene nel flow</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: il Bazaar</a> — la release galleria-e-benvenuto sottostante</li>
  ...
  tr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-12-0-brand-backed-design-system/">SankiWork 0.12.0: markanız bir tasarım sistemidir</a> — bunun üzerine sizi akışta tuttuğu marka yakalama sürümü</li>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: Pazar Yeri</a> — altındaki galeri-ve-karşılama sürümü</li>
...
- [SankiWork 0.12.0: your brand is a design system](/blog/open-design-0-12-0-brand-backed-design-system/) — the brand-capture release this one keeps you in flow on top of
- [SankiWork 0.11.0: the Bazaar](/blog/open-design-0-11-0-the-bazaar/) — the gallery-and-welcome release underneath
