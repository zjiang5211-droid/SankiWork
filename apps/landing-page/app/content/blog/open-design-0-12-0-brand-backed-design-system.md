...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <h2>延伸阅读</h2>
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0：集市</a> —— 本次发布所立足的那次「画廊与欢迎」发布</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0：一体化设计工作空间</a> —— 构建闭环底下那次单窗口发布</li>
  ...
  ja:
    ...
    bodyHtml: |
      ...
      <h2>関連記事</h2>
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0：バザール</a> — 今回がその上に築かれる、ギャラリーとウェルカムのリリース</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0：オールインワンのデザインワークスペース</a> — ビルドループの下にある、ワンウィンドウのリリース</li>
  ...
  ko:
    ...
    bodyHtml: |
      ...
      <h2>함께 읽기</h2>
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: 바자르</a> — 이번 릴리스가 그 위에 쌓아 올린 갤러리-그리고-환영 릴리스</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: 올인원 디자인 워크스페이스</a> — 빌드 루프 밑에 자리한 단일 창 릴리스</li>
  ...
  de:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: der Basar</a> — das Galerie-und-Willkommen-Release, auf dem dieses aufbaut</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: der All-in-One-Design-Workspace</a> — das Ein-Fenster-Release unter der Build-Schleife</li>
  ...
  fr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0 : le Bazar</a> — la version galerie-et-accueil sur laquelle celle-ci s'appuie</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0 : l'espace de travail de conception tout-en-un</a> — la version une seule fenêtre sous la boucle de build</li>
  ...
  ru:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: базар</a> — релиз галереи-и-приветствия, на котором строится этот</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: единое рабочее пространство для дизайна</a> — релиз одного окна под циклом сборки</li>
  ...
  es:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: el Bazar</a> — la versión de galería y bienvenida sobre la que esta se construye</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: el espacio de trabajo de diseño todo en uno</a> — la versión de una sola ventana que está debajo del ciclo de construcción</li>
  ...
  pt-br:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: o Bazar</a> — a versão de galeria-e-acolhimento sobre a qual esta se constrói</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: o espaço de trabalho de design tudo-em-um</a> — a versão de janela única por baixo do ciclo de build</li>
  ...
  it:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: il Bazaar</a> — la release galleria-e-benvenuto su cui questa si basa</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: lo spazio di lavoro per il design tutto-in-uno</a> — la release a finestra unica sotto al ciclo di build</li>
  ...
  tr:
    ...
    bodyHtml: |
      ...
      <ul>
        <li><a href="/blog/open-design-0-11-0-the-bazaar/">SankiWork 0.11.0: Pazar Yeri</a> — bunun üzerine inşa edildiği galeri-ve-karşılama sürümü</li>
        <li><a href="/blog/open-design-0-10-0-all-in-one-workspace/">SankiWork 0.10.0: hepsi bir arada tasarım çalışma alanı</a> — inşa döngüsünün altındaki tek pencere sürümü</li>
...
- [SankiWork 0.11.0: the Bazaar](/blog/open-design-0-11-0-the-bazaar/) — the gallery-and-welcome release this one builds on
- [SankiWork 0.10.0: the all-in-one design workspace](/blog/open-design-0-10-0-all-in-one-workspace/) — the one-window release underneath the build loop
