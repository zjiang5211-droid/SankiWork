---
title: "SankiWork 0.18.0: design team workspace, now in Codex"
date: 2026-08-05
category: "Product"
readingTime: 7
summary: "open-design-v0.18.0 — 115 PRs from 22 contributors in two days. Codename \"Design Team Workspace. Now in Codex.\" SankiWork gives design teams a shared home for projects, comments, design systems, plugins, skills, and workspace billing — then brings that creative engine directly into Codex."
socialImage: "/blog/sankiwork-0-18-0-design-team-workspace-codex-cover-v2.webp"
ctaKind: download-app
i18n:
  zh:
    title: 'SankiWork 0.18.0：设计团队工作区，现已进入 Codex'
    summary: 'open-design-v0.18.0 —— 两天内 22 位贡献者提交了 115 个 PR。代号「Design Team Workspace. Now in Codex.」。SankiWork 为设计团队提供了一个共享空间，用来管理项目、评论、设计系统、插件、技能和工作区账单——并将同一套创作引擎直接带入 Codex。'
    category: '产品'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>，于 2026 年 8 月 5 日发布。<strong>两天内 22 位贡献者提交了 115 个 PR。</strong>代号「Design Team Workspace. Now in Codex.」。SankiWork 曾经是一个让个人尽情创作的强大空间。这个版本为整个设计团队提供了一个共同的家——并把同一套创作引擎放进 Codex。</p>
      ...
      <p>过去，协作往往从离开 SankiWork 开始：导出文件，把截图贴进聊天，询问哪版文案才是最新的，然后为下一个人重复同样的设置。到了 0.18.0，<strong>你的个人工作区旁边有了 Team workspace</strong>。创建一个、切换进去，再通过感知席位的流程邀请同事并分配角色。所有人都通过同一个 SankiWork Cloud 账号体系登录，并来到同一个地方。</p>
      <p>边界依然清晰。个人工作仍属于个人；团队项目、共享资源和支出属于当前启用的 Team workspace。方案铭牌会显示你正在使用哪个工作区，因此共享工作时不必再猜究竟涉及哪个账号或余额。</p>
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="近白色编辑背景上，一个共享设计工作区以中央项目画布为核心，周围分布着多个协作者光标和评论标记，整体被精准的绿色选区框包围" />
        <figcaption>Team workspace 把项目、成员、评论和当前方案放在同一个共享空间里——就在你的个人工作旁边。</figcaption>
      </figure>

      <h2>SankiWork 现在可以在 Codex 中使用</h2>
      <p>0.17.0 打开了入口；0.18.0 则确保没有人会错过。<strong>Codex Desktop 和 CLI 可以把 SankiWork 作为一套完整的创作引擎来调用。</strong>确认视觉简报，选择 SankiWork Cloud 或受支持的本地运行时，就能获得真正的 Preview 或 Studio 成果，无需手动再搭一套技术栈。</p>
      <p>当 Codex 需要时，已签名的 SankiWork 运行时会以无头模式启动，因此不必再盯着一个额外的应用窗口。外部 MCP 主机也不会因为本地服务重启后换了端口就失去 SankiWork：连接会自动找到归途，<code>@sankiwork</code> 无需重新设置便能继续工作。</p>
      <p>如果你从 0.16.x 直接升级到这个版本，<a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">0.17.0 版本</a>的内容也包含在这次升级中——SankiWork 已经成为 Codex 可以直接触达的设计层。</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="一个模块化设计系统卡片、插件磁贴和技能卡片接入同一个共享团队工作区，组合后的工具包被精准的绿色选区框包围，置于近白色编辑背景上" />
      ...
      <ul>
        ...
        <li><strong>插件目录有了正式入口</strong>——独立落地页会在用户安装应用之前介绍 SankiWork 插件。</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>已经在使用 Codex</td><td>安装或更新 SankiWork 插件，然后让 Codex 生成一份视觉简报，并在 Preview 或 Studio 中打开结果</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">下载 SankiWork</a>。</p>
      <p>两天内 115 个 PR，来自 22 位贡献者。他们把 SankiWork 从个人工作区变成团队可以共同身处的空间——也让 Codex 能够调用这个空间。协作不是一个分享按钮，而是工作、上下文和工具一同抵达。我们看到你们了。🚀</p>

      <h2>相关阅读</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">SankiWork 0.17.0：为 Codex 打造的设计工作区</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0：可靠交付</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1：视野更清晰，流程更持久</a></li>
      </ul>
  ja:
    title: 'SankiWork 0.18.0 — デザインチームのワークスペースが Codex に'
    summary: 'open-design-v0.18.0 — 2 日間で 22 人のコントリビューターから 115 の PR。コードネームは「Design Team Workspace. Now in Codex.」。SankiWork は、プロジェクト、コメント、デザインシステム、プラグイン、スキル、ワークスペース請求をまとめる共有の場をデザインチームに提供し、そのクリエイティブエンジンを直接 Codex に届けます。'
    category: 'プロダクト'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>、2026 年 8 月 5 日公開。<strong>2 日間で 22 人のコントリビューターから 115 の PR。</strong>コードネームは「Design Team Workspace. Now in Codex.」。SankiWork はこれまで、一人がものを作るための強力な場所でした。このリリースはデザインチーム全体に居場所をつくり、同じクリエイティブエンジンを Codex の中に置きます。</p>
      ...
      <p>これまでのコラボレーションは、SankiWork を離れるところから始まっていました。ファイルを書き出し、スクリーンショットをチャットに貼り、どのコピーが最新かを尋ね、次の人のために同じセットアップを繰り返す。0.18.0 では、<strong>個人ワークスペースの隣に Team workspace が並びます</strong>。作成して切り替え、席数を踏まえたフローで役割を付けて同僚を招待できます。全員が同じ SankiWork Cloud のアカウント基盤からサインインし、同じ場所にたどり着きます。</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="オフホワイトのエディトリアルな背景に、中央のプロジェクトキャンバス、複数の共同編集カーソルとコメントピンを備え、精密な緑の選択枠に収められた共有デザインワークスペース" />
        <figcaption>Team workspace は、プロジェクト、メンバー、コメント、現在のプランを一つの共有空間に置きます。個人の作業のすぐ隣に。</figcaption>
      </figure>

      <h2>SankiWork が Codex の中で動く</h2>
      <p>0.17.0 が扉を開き、0.18.0 は誰もその扉を見落とさないようにします。<strong>Codex Desktop と CLI は、SankiWork を完全なクリエイティブエンジンとして呼び出せます。</strong>ビジュアルブリーフを確認し、SankiWork Cloud または対応するローカルランタイムを選べば、別のスタックを手作業で組むことなく、本物の Preview または Studio の成果を受け取れます。</p>
      <p>署名済みの SankiWork ランタイムは Codex が必要とするときにヘッドレスで起動するため、もう一つのアプリウィンドウを見張る必要はありません。また、再起動後にローカルサービスが別のポートで戻っても、外部 MCP ホストが SankiWork を見失うことはなくなりました。接続は自動で帰り道を見つけ、<code>@sankiwork</code> は一から設定し直さなくても動き続けます。</p>
      <p>0.16.x からこのリリースへ移るなら、<a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">0.17.0 リリース</a>もアップグレードに含まれます。SankiWork は Codex が直接アクセスできるデザインレイヤーになりました。</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="モジュール式のデザインシステムカード、プラグインタイル、スキルカードが一つの共有チームワークスペースに接続され、まとまったツールキットがオフホワイトのエディトリアルな背景上で精密な緑の選択枠に収められている" />
      ...
      <ul>
        ...
        <li><strong>プラグインカタログに入口ができた</strong> — 専用のランディングページが、アプリをインストールする前に SankiWork プラグインを紹介します。</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>すでに Codex を使っているなら</td><td>SankiWork プラグインをインストールまたは更新し、Codex にビジュアルブリーフを依頼して、結果を Preview または Studio で開く</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">SankiWork をダウンロード</a>。</p>
      <p>2 日間で 115 の PR。SankiWork を個人のワークスペースからチームが共に過ごせる場所へ変え、その場所を Codex から呼び出せるようにした 22 人から。コラボレーションは共有ボタンではありません。仕事、コンテキスト、ツールが一緒に届くことです。見ています。🚀</p>

      <h2>関連記事</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">SankiWork 0.17.0：Codex のための SankiWork</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0 — 確実に届く</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1 — より鮮明な視界、より長いフロー</a></li>
      </ul>
  ko:
    title: 'SankiWork 0.18.0: 디자인 팀 워크스페이스가 Codex에'
    summary: 'open-design-v0.18.0 — 이틀 동안 22명의 기여자가 115개의 PR을 보냈습니다. 코드명 “Design Team Workspace. Now in Codex.” SankiWork은 프로젝트, 댓글, 디자인 시스템, 플러그인, 스킬, 워크스페이스 청구를 위한 공동의 공간을 디자인 팀에 제공하고, 그 크리에이티브 엔진을 Codex 안으로 직접 가져옵니다.'
    category: '제품'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, 2026년 8월 5일 공개. <strong>이틀 동안 22명의 기여자가 115개의 PR을 보냈습니다.</strong> 코드명 “Design Team Workspace. Now in Codex.” SankiWork은 지금까지 한 사람이 무언가를 만드는 강력한 공간이었습니다. 이번 릴리스는 디자인 팀 전체에 하나의 집을 마련하고, 같은 크리에이티브 엔진을 Codex 안에 놓습니다.</p>
      ...
      <p>예전에는 SankiWork을 떠나는 순간부터 협업이 시작됐습니다. 파일을 내보내고, 스크린샷을 채팅에 붙이고, 어떤 문구가 최신인지 물은 다음, 다음 사람을 위해 같은 설정을 반복했습니다. 0.18.0에서는 <strong>개인 워크스페이스 옆에 Team workspace가 자리합니다.</strong> 하나를 만들고 전환한 뒤, 좌석 수를 반영하는 흐름에서 역할과 함께 동료를 초대하세요. 모두 같은 SankiWork Cloud 계정 체계로 로그인해 같은 장소에 도착합니다.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="미색의 편집 배경 위에 중앙 프로젝트 캔버스, 여러 협업자 커서와 댓글 핀이 놓이고 정밀한 초록색 선택 프레임으로 둘러싸인 공유 디자인 워크스페이스" />
        <figcaption>Team workspace는 프로젝트, 사람, 댓글, 현재 플랜을 하나의 공유 공간에 둡니다. 개인 작업 바로 옆에.</figcaption>
      </figure>

      <h2>이제 SankiWork이 Codex 안에서 동작합니다</h2>
      <p>0.17.0이 문을 열었고, 0.18.0은 아무도 그 문을 놓치지 않게 합니다. <strong>Codex Desktop과 CLI는 SankiWork을 완전한 크리에이티브 엔진으로 호출할 수 있습니다.</strong> 비주얼 브리프를 확인하고 SankiWork Cloud 또는 지원되는 로컬 런타임을 선택하면, 두 번째 스택을 손으로 조립하지 않고 실제 Preview 또는 Studio 결과를 받을 수 있습니다.</p>
      <p>서명된 SankiWork 런타임은 Codex가 필요로 할 때 헤드리스로 시작되므로, 별도의 앱 창을 지켜볼 필요가 없습니다. 다시 시작한 로컬 서비스가 다른 포트로 돌아와도 외부 MCP 호스트가 더는 SankiWork을 잃지 않습니다. 연결은 자동으로 돌아갈 길을 찾고, <code>@sankiwork</code>은 모든 설정을 다시 하지 않아도 계속 동작합니다.</p>
      <p>0.16.x에서 이 릴리스로 바로 넘어왔다면 <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">0.17.0 릴리스</a>도 이번 업그레이드에 포함됩니다. SankiWork은 Codex가 직접 닿을 수 있는 디자인 레이어가 됐습니다.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="모듈식 디자인 시스템 카드, 플러그인 타일, 스킬 카드가 하나의 공유 팀 워크스페이스에 연결되고, 묶인 툴킷이 미색의 편집 배경 위 정밀한 초록색 선택 프레임에 담겨 있는 모습" />
      ...
      <ul>
        ...
        <li><strong>플러그인 카탈로그에 정문이 생겼습니다</strong> — 전용 랜딩 페이지가 앱을 설치하기 전에 SankiWork 플러그인을 소개합니다.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>이미 Codex를 쓰고 있다면</td><td>SankiWork 플러그인을 설치하거나 업데이트하고, Codex에 비주얼 브리프를 요청한 뒤 결과를 Preview 또는 Studio에서 여세요</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">SankiWork 다운로드</a>.</p>
      <p>이틀 동안 115개의 PR. SankiWork을 개인 워크스페이스에서 팀이 함께 머물 수 있는 장소로 바꾸고, 그 장소를 Codex가 호출할 수 있게 만든 22명에게서 왔습니다. 협업은 공유 버튼이 아닙니다. 작업, 컨텍스트, 도구가 함께 도착하는 것입니다. 보고 있습니다. 🚀</p>

      <h2>함께 읽기</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">SankiWork 0.17.0: Codex를 위한 SankiWork</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0: 확실한 전달</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1: 더 또렷한 시야, 더 긴 몰입</a></li>
      </ul>
  de:
    title: 'SankiWork 0.18.0: der Workspace fürs Designteam, jetzt in Codex'
    summary: 'open-design-v0.18.0 — 115 PRs von 22 Mitwirkenden in zwei Tagen. Codename „Design Team Workspace. Now in Codex.“ SankiWork gibt Designteams einen gemeinsamen Ort für Projekte, Kommentare, Designsysteme, Plugins, Skills und Workspace-Abrechnung — und bringt diese Kreativ-Engine direkt in Codex.'
    category: 'Produkt'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, veröffentlicht am 5. August 2026. <strong>115 PRs von 22 Mitwirkenden in zwei Tagen.</strong> Codename „Design Team Workspace. Now in Codex.“ SankiWork war bisher ein leistungsstarker Ort, an dem eine Person gestalten konnte. Dieses Release gibt dem gesamten Designteam ein Zuhause — und bringt dieselbe Kreativ-Engine in Codex.</p>
      ...
      <p>Zusammenarbeit begann bisher damit, SankiWork zu verlassen: eine Datei exportieren, einen Screenshot in den Chat kopieren, fragen, welche Fassung aktuell ist, und dann dieselbe Einrichtung für die nächste Person wiederholen. In 0.18.0 <strong>liegt ein Team-Workspace direkt neben Ihrem persönlichen Workspace</strong>. Erstellen Sie einen, wechseln Sie hinein und laden Sie Kolleginnen und Kollegen in einem sitzplatzbewussten Ablauf mit einer Rolle ein. Alle melden sich über dasselbe SankiWork Cloud-Konto an und landen am selben Ort.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="Ein gemeinsamer Design-Workspace mit einer zentralen Projekt-Canvas, mehreren Cursors von Mitwirkenden und Kommentar-Pins, eingefasst von einem präzisen grünen Auswahlrahmen auf nahezu weißem redaktionellem Grund" />
      ...
      <h2>SankiWork arbeitet jetzt innerhalb von Codex</h2>
      <p>0.17.0 öffnete die Tür; 0.18.0 sorgt dafür, dass sie niemand übersieht. <strong>Codex Desktop und CLI können SankiWork als vollständige Kreativ-Engine aufrufen.</strong> Bestätigen Sie ein visuelles Briefing, wählen Sie SankiWork Cloud oder eine unterstützte lokale Runtime und erhalten Sie ein echtes Ergebnis in Preview oder Studio, ohne von Hand einen zweiten Stack zusammenzustellen.</p>
      <p>Die signierte SankiWork-Runtime startet ohne Oberfläche, wenn Codex sie braucht; es gibt also kein zusätzliches App-Fenster, das beaufsichtigt werden muss. Und externe MCP-Hosts verlieren SankiWork nicht mehr, wenn der lokale Dienst nach einem Neustart auf einem anderen Port zurückkehrt: Die Verbindung findet automatisch nach Hause, und <code>@sankiwork</code> funktioniert weiter, ohne dass alles noch einmal eingerichtet werden muss.</p>
      <p>Wenn Sie von 0.16.x direkt zu diesem Release gewechselt sind, gehört das <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">Release 0.17.0</a> ebenfalls zu Ihrem Upgrade — SankiWork ist zur Designschicht geworden, die Codex direkt erreichen kann.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="Eine modulare Designsystem-Karte, eine Plugin-Kachel und eine Skill-Karte docken an einen gemeinsamen Team-Workspace an; das gruppierte Toolkit liegt in einem präzisen grünen Auswahlrahmen auf nahezu weißem redaktionellem Grund" />
      ...
      <ul>
        ...
        <li><strong>Der Plugin-Katalog hat einen eigenen Eingang</strong> — eine eigene Landingpage stellt SankiWork-Plugins vor, bevor jemand die App installiert.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Codex bereits verwenden</td><td>Installieren oder aktualisieren Sie das SankiWork-Plugin, bitten Sie Codex dann um ein visuelles Briefing und öffnen Sie das Ergebnis in Preview oder Studio.</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">SankiWork herunterladen</a>.</p>
      <p>115 PRs in zwei Tagen von 22 Menschen, die SankiWork von einem persönlichen Workspace in einen Ort verwandelt haben, den ein Team bewohnen kann — und diesen Ort aus Codex aufrufbar gemacht haben. Zusammenarbeit ist kein Teilen-Button. Sie bedeutet, dass die Arbeit, der Kontext und die Werkzeuge gemeinsam ankommen. Wir sehen Sie. 🚀</p>

      <h2>Weiterführende Lektüre</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">Release Notes zu SankiWork 0.17.0: SankiWork für Codex</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0: verlässliche Auslieferung</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1: schärfere Sicht, längerer Flow</a></li>
      </ul>
  fr:
    title: 'SankiWork 0.18.0 : l''espace de l''équipe design, désormais dans Codex'
    summary: 'open-design-v0.18.0 — 115 PR de 22 contributeurs en deux jours. Nom de code « Design Team Workspace. Now in Codex. » SankiWork offre aux équipes design un espace commun pour les projets, les commentaires, les systèmes de design, les plugins, les skills et la facturation de l''espace de travail — puis apporte ce même moteur créatif directement dans Codex.'
    category: 'Produit'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, publié le 5 août 2026. <strong>115 PR de 22 contributeurs en deux jours.</strong> Nom de code « Design Team Workspace. Now in Codex. » SankiWork était déjà un endroit puissant où une personne pouvait créer. Cette version offre un espace à toute l'équipe design — et place ce même moteur créatif dans Codex.</p>
      ...
      <p>Jusqu'ici, collaborer commençait par quitter SankiWork : exporter un fichier, coller une capture d'écran dans le chat, demander quelle copie était à jour, puis recommencer la même configuration pour la personne suivante. Dans 0.18.0, <strong>un espace de travail Team se trouve à côté de votre espace personnel</strong>. Créez-en un, basculez dessus et invitez des collègues avec un rôle via un parcours tenant compte des sièges. Tout le monde se connecte avec le même compte SankiWork Cloud et arrive au même endroit.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="Un espace de design partagé avec un canvas de projet central, plusieurs curseurs de collaborateurs et des repères de commentaires, contenus dans un cadre de sélection vert précis sur un fond éditorial presque blanc" />
      ...
      <h2>SankiWork fonctionne désormais dans Codex</h2>
      <p>0.17.0 a ouvert la porte ; 0.18.0 veille à ce que personne ne la manque. <strong>Codex Desktop et CLI peuvent appeler SankiWork comme un moteur créatif complet.</strong> Validez un brief visuel, choisissez SankiWork Cloud ou un runtime local pris en charge et obtenez un véritable résultat dans Preview ou Studio sans assembler une seconde stack à la main.</p>
      <p>Le runtime SankiWork signé démarre sans interface lorsque Codex en a besoin : aucune fenêtre d'app supplémentaire à surveiller. Et les hôtes MCP externes ne perdent plus SankiWork lorsque son service local revient sur un autre port après un redémarrage : la connexion retrouve automatiquement son chemin, et <code>@sankiwork</code> continue de fonctionner sans tout reconfigurer.</p>
      <p>Si vous êtes passé directement de 0.16.x à cette version, la <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">version 0.17.0</a> fait également partie de votre mise à niveau — SankiWork est devenu la couche design à laquelle Codex peut accéder directement.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="Une carte de système de design modulaire, une tuile de plugin et une carte de skill viennent s'ancrer dans un espace de travail d'équipe partagé ; la boîte à outils regroupée est contenue dans un cadre de sélection vert précis sur un fond éditorial presque blanc" />
      ...
      <ul>
        ...
        <li><strong>Le catalogue de plugins a sa propre porte d'entrée</strong> — une landing page dédiée présente les plugins SankiWork avant même d'installer l'app.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Déjà utilisateur de Codex</td><td>Installez ou mettez à jour le plugin SankiWork, demandez ensuite à Codex un brief visuel et ouvrez le résultat dans Preview ou Studio.</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">Télécharger SankiWork</a>.</p>
      <p>115 PR en deux jours, par 22 personnes qui ont transformé SankiWork : d'un espace personnel, il devient un lieu qu'une équipe peut habiter — et ce lieu peut désormais être appelé depuis Codex. La collaboration n'est pas un bouton Partager. C'est le travail, le contexte et les outils qui arrivent ensemble. Nous vous voyons. 🚀</p>

      <h2>À lire aussi</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">Notes de version d'SankiWork 0.17.0 : SankiWork pour Codex</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0 : une livraison fiable</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1 : une vision plus nette, un flow plus long</a></li>
      </ul>
  ru:
    title: 'SankiWork 0.18.0: рабочее пространство дизайн-команды — теперь в Codex'
    summary: 'open-design-v0.18.0 — 115 PR от 22 участников за два дня. Кодовое имя «Design Team Workspace. Now in Codex.» SankiWork даёт дизайн-командам общее пространство для проектов, комментариев, дизайн-систем, плагинов, skills и оплаты рабочего пространства, а затем переносит этот творческий движок прямо в Codex.'
    category: 'Продукт'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, опубликован 5 августа 2026 года. <strong>115 PR от 22 участников за два дня.</strong> Кодовое имя «Design Team Workspace. Now in Codex.» Раньше SankiWork был мощным местом, где мог творить один человек. Этот релиз даёт общий дом всей дизайн-команде — и помещает тот же творческий движок внутрь Codex.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="Общее пространство для дизайна с центральным холстом проекта, несколькими курсорами участников и метками комментариев, заключёнными в точную зелёную рамку выделения на почти белом редакционном фоне" />
      ...
      <h2>SankiWork теперь работает внутри Codex</h2>
      <p>0.17.0 открыл дверь; 0.18.0 не даёт никому её не заметить. <strong>Codex Desktop и CLI могут вызывать SankiWork как полноценный творческий движок.</strong> Подтвердите визуальный бриф, выберите SankiWork Cloud или поддерживаемый локальный runtime и получите настоящий результат в Preview или Studio, не собирая второй стек вручную.</p>
      <p>Подписанный runtime SankiWork запускается без интерфейса, когда он нужен Codex, поэтому следить за лишним окном приложения не приходится. А внешние хосты MCP больше не теряют SankiWork, если после перезапуска локальный сервис возвращается на другом порту: соединение автоматически находит путь домой, и <code>@sankiwork</code> продолжает работать без повторной настройки.</p>
      <p>Если вы перешли на этот релиз сразу с 0.16.x, <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">релиз 0.17.0</a> тоже является частью обновления — SankiWork стал дизайн-слоем, к которому Codex может обращаться напрямую.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="Модульная карточка дизайн-системы, плитка плагина и карточка skill присоединяются к общему рабочему пространству команды; сгруппированный набор инструментов заключён в точную зелёную рамку выделения на почти белом редакционном фоне" />
      ...
      <ul>
        ...
        <li><strong>У каталога плагинов появился парадный вход</strong> — отдельная landing page знакомит с плагинами SankiWork ещё до установки приложения.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Уже используете Codex</td><td>Установите или обновите плагин SankiWork, затем попросите Codex составить визуальный бриф и откройте результат в Preview или Studio.</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">Скачать SankiWork</a>.</p>
      <p>115 PR за два дня от 22 человек, превративших SankiWork из личного рабочего пространства в место, где может жить команда, — и сделавших это место доступным для вызова из Codex. Совместная работа — не кнопка «Поделиться». Это работа, контекст и инструменты, которые приходят вместе. Мы вас видим. 🚀</p>

      <h2>Дополнительные материалы</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">Примечания к релизу SankiWork 0.17.0: SankiWork для Codex</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0: надёжная доставка</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1: более чёткое зрение, более длинный поток</a></li>
      </ul>
  es:
    title: 'SankiWork 0.18.0: el espacio de trabajo del equipo de diseño, ahora en Codex'
    summary: 'open-design-v0.18.0 — 115 PR de 22 personas en dos días. Nombre en clave «Design Team Workspace. Now in Codex». SankiWork ofrece a los equipos de diseño un hogar compartido para proyectos, comentarios, sistemas de diseño, plugins, skills y facturación del espacio de trabajo, y lleva después ese motor creativo directamente a Codex.'
    category: 'Producto'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, publicado el 5 de agosto de 2026. <strong>115 PR de 22 personas en dos días.</strong> Nombre en clave «Design Team Workspace. Now in Codex». SankiWork ya era un lugar potente para que una persona creara. Esta versión da un hogar a todo el equipo de diseño y pone ese mismo motor creativo dentro de Codex.</p>
      ...
      <p>Antes, colaborar empezaba saliendo de SankiWork: exportar un archivo, pegar una captura en el chat, preguntar qué texto era el vigente y repetir la misma configuración para la siguiente persona. En 0.18.0, <strong>un espacio de trabajo Team vive junto a tu espacio personal</strong>. Créalo, entra en él e invita a colegas con un rol mediante un flujo que tiene en cuenta las plazas. Todo el mundo inicia sesión con la misma cuenta de SankiWork Cloud y llega al mismo lugar.</p>
      ...
      <h2>SankiWork ahora funciona dentro de Codex</h2>
      <p>0.17.0 abrió la puerta; 0.18.0 se asegura de que nadie la pase por alto. <strong>Codex Desktop y CLI pueden llamar a SankiWork como un motor creativo completo.</strong> Confirma un brief visual, elige SankiWork Cloud o un runtime local compatible y recibe un resultado real en Preview o Studio sin montar a mano un segundo stack.</p>
      <p>El runtime firmado de SankiWork arranca sin interfaz cuando Codex lo necesita, así que no hay otra ventana de la app que vigilar. Además, los hosts MCP externos ya no pierden SankiWork cuando su servicio local vuelve en otro puerto después de reiniciar: la conexión encuentra el camino de vuelta automáticamente y <code>@sankiwork</code> sigue funcionando sin repetir toda la configuración.</p>
      <p>Si saltaste de 0.16.x a esta versión, la <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">versión 0.17.0</a> también forma parte de tu actualización: SankiWork se ha convertido en la capa de diseño a la que Codex puede acceder directamente.</p>
      ...
      <ul>
        ...
        <li><strong>El catálogo de plugins ya tiene puerta de entrada</strong>: una landing page específica presenta los plugins de SankiWork antes de que alguien instale la app.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>usuario de Codex</td><td>Instala o actualiza el plugin de SankiWork, pide después a Codex un brief visual y abre el resultado en Preview o Studio</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">Descargar SankiWork</a>.</p>
      <p>115 PR en dos días, de 22 personas que convirtieron SankiWork de un espacio personal en un lugar que un equipo puede habitar y que hicieron que Codex pudiera llamar a ese lugar. La colaboración no es un botón de compartir. Es el trabajo, el contexto y las herramientas llegando juntos. Os vemos. 🚀</p>

      <h2>Lecturas relacionadas</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">Notas de la versión SankiWork 0.17.0: SankiWork para Codex</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0: entrega fiable</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1: visión más nítida, flow más largo</a></li>
      </ul>
  pt-br:
    title: 'SankiWork 0.18.0: o workspace da equipe de design, agora no Codex'
    summary: 'open-design-v0.18.0 — 115 PRs de 22 pessoas em dois dias. Codinome “Design Team Workspace. Now in Codex”. O SankiWork oferece às equipes de design uma casa compartilhada para projetos, comentários, design systems, plugins, skills e faturamento do workspace — e depois leva esse motor criativo diretamente para o Codex.'
    category: 'Produto'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, publicado em 5 de agosto de 2026. <strong>115 PRs de 22 pessoas em dois dias.</strong> Codinome “Design Team Workspace. Now in Codex”. O SankiWork já era um lugar poderoso para uma pessoa criar. Esta versão dá uma casa à equipe de design inteira — e coloca o mesmo motor criativo dentro do Codex.</p>
      ...
      <p>Antes, colaborar começava saindo do SankiWork: exportar um arquivo, colar uma captura no chat, perguntar qual texto era o atual e repetir a mesma configuração para a próxima pessoa. No 0.18.0, <strong>um workspace Team fica ao lado do seu workspace pessoal</strong>. Crie um, entre nele e convide colegas com uma função por um fluxo que considera as vagas. Todo mundo entra pela mesma conta do SankiWork Cloud e chega ao mesmo lugar.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="Um workspace de design compartilhado com um canvas de projeto central, vários cursores de colaboradores e marcadores de comentários, contido em uma moldura de seleção verde precisa sobre um fundo editorial quase branco" />
      ...
      <h2>O SankiWork agora funciona dentro do Codex</h2>
      <p>O 0.17.0 abriu a porta; o 0.18.0 garante que ninguém deixe de vê-la. <strong>O Codex Desktop e a CLI podem chamar o SankiWork como um motor criativo completo.</strong> Confirme um brief visual, escolha o SankiWork Cloud ou um runtime local compatível e receba um resultado real no Preview ou Studio sem montar uma segunda stack na mão.</p>
      <p>O runtime assinado do SankiWork inicia sem interface quando o Codex precisa dele, então não há outra janela do app para ficar vigiando. E hosts MCP externos não perdem mais o SankiWork quando o serviço local volta em outra porta após reiniciar: a conexão encontra o caminho de casa automaticamente e <code>@sankiwork</code> continua funcionando sem refazer toda a configuração.</p>
      <p>Se você pulou do 0.16.x para esta versão, a <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">versão 0.17.0</a> também faz parte da sua atualização — o SankiWork se tornou a camada de design que o Codex consegue acessar diretamente.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="Um card modular de design system, uma peça de plugin e um card de skill encaixando em um workspace de equipe compartilhado, com o kit agrupado dentro de uma moldura de seleção verde precisa sobre um fundo editorial quase branco" />
      ...
      <ul>
        ...
        <li><strong>O catálogo de plugins ganhou uma porta de entrada</strong> — uma landing page dedicada apresenta os plugins do SankiWork antes de alguém instalar o app.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>já usa o Codex</td><td>Instale ou atualize o plugin do SankiWork, peça ao Codex um brief visual e abra o resultado no Preview ou Studio</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">Baixar o SankiWork</a>.</p>
      <p>115 PRs em dois dias, de 22 pessoas que transformaram o SankiWork de um workspace pessoal em um lugar que uma equipe pode habitar — e fizeram esse lugar poder ser chamado pelo Codex. Colaboração não é um botão de compartilhar. É o trabalho, o contexto e as ferramentas chegando juntos. A gente vê vocês. 🚀</p>

      <h2>Leitura relacionada</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">Notas da versão SankiWork 0.17.0: SankiWork para Codex</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0: entrega confiável</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1: visão mais nítida, flow mais longo</a></li>
      </ul>
  it:
    title: 'SankiWork 0.18.0: lo spazio di lavoro del team di design, ora in Codex'
    summary: 'open-design-v0.18.0 — 115 PR da 22 contributori in due giorni. Nome in codice «Design Team Workspace. Now in Codex». SankiWork offre ai team di design una casa condivisa per progetti, commenti, design system, plugin, skill e fatturazione dello spazio di lavoro, poi porta quel motore creativo direttamente in Codex.'
    category: 'Prodotto'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, pubblicato il 5 agosto 2026. <strong>115 PR da 22 contributori in due giorni.</strong> Nome in codice «Design Team Workspace. Now in Codex». SankiWork era già un luogo potente in cui una persona poteva creare. Questa release dà una casa all'intero team di design e mette lo stesso motore creativo dentro Codex.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="Uno spazio di lavoro di design condiviso con una canvas di progetto centrale, diversi cursori dei collaboratori e pin dei commenti, racchiuso in una precisa cornice di selezione verde su uno sfondo editoriale quasi bianco" />
      ...
      <h2>SankiWork ora funziona dentro Codex</h2>
      <p>0.17.0 ha aperto la porta; 0.18.0 fa in modo che nessuno se la perda. <strong>Codex Desktop e CLI possono chiamare SankiWork come motore creativo completo.</strong> Conferma un brief visivo, scegli SankiWork Cloud o un runtime locale supportato e ricevi un vero risultato in Preview o Studio senza assemblare a mano un secondo stack.</p>
      <p>Il runtime firmato di SankiWork parte senza interfaccia quando Codex ne ha bisogno, quindi non c'è un'altra finestra dell'app da sorvegliare. Inoltre, gli host MCP esterni non perdono più SankiWork quando il servizio locale torna su una porta diversa dopo un riavvio: la connessione ritrova automaticamente la strada di casa e <code>@sankiwork</code> continua a funzionare senza rifare tutta la configurazione.</p>
      <p>Se sei passato da 0.16.x direttamente a questa release, anche la <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">release 0.17.0</a> fa parte del tuo aggiornamento: SankiWork è diventato il livello di design che Codex può raggiungere direttamente.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="Una scheda modulare di design system, una tessera di plugin e una scheda di skill che si agganciano a uno spazio di lavoro condiviso del team, con il kit raggruppato dentro una precisa cornice di selezione verde su uno sfondo editoriale quasi bianco" />
      ...
      <ul>
        ...
        <li><strong>Il catalogo dei plugin ha una porta d'ingresso</strong> — una landing page dedicata presenta i plugin di SankiWork prima che qualcuno installi l'app.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>già su Codex</td><td>Installa o aggiorna il plugin SankiWork, poi chiedi a Codex un brief visivo e apri il risultato in Preview o Studio</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">Scarica SankiWork</a>.</p>
      <p>115 PR in due giorni, da 22 persone che hanno trasformato SankiWork da uno spazio personale in un luogo che un team può abitare e hanno reso quel luogo richiamabile da Codex. Collaborare non è un pulsante di condivisione. È il lavoro, il contesto e gli strumenti che arrivano insieme. Vi vediamo. 🚀</p>

      <h2>Letture correlate</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">Note di rilascio di SankiWork 0.17.0: SankiWork per Codex</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0: consegna affidabile</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1: sguardo più nitido, flow più lungo</a></li>
      </ul>
  tr:
    title: 'SankiWork 0.18.0: tasarım ekibi çalışma alanı, şimdi Codex içinde'
    summary: 'open-design-v0.18.0 — iki günde 22 katkıcıdan 115 PR. Kod adı “Design Team Workspace. Now in Codex”. SankiWork; tasarım ekiplerine projeler, yorumlar, tasarım sistemleri, eklentiler, skill''ler ve çalışma alanı faturalandırması için ortak bir yuva sunuyor, ardından bu yaratıcı motoru doğrudan Codex içine getiriyor.'
    category: 'Ürün'
    bodyHtml: |
      <p><code>open-design-v0.18.0</code>, 5 Ağustos 2026'da yayımlandı. <strong>İki günde 22 katkıcıdan 115 PR.</strong> Kod adı “Design Team Workspace. Now in Codex”. SankiWork zaten tek bir kişinin üretmesi için güçlü bir yerdi. Bu sürüm tüm tasarım ekibine bir yuva veriyor ve aynı yaratıcı motoru Codex'in içine yerleştiriyor.</p>
      ...
      <p>Eskiden iş birliği SankiWork'dan çıkarak başlardı: bir dosyayı dışa aktarır, ekran görüntüsünü sohbete yapıştırır, hangi metnin güncel olduğunu sorar, ardından aynı kurulumu sıradaki kişi için tekrarlardınız. 0.18.0'da <strong>kişisel çalışma alanınızın yanında bir Team çalışma alanı yer alıyor</strong>. Bir tane oluşturun, ona geçin ve kontenjanı dikkate alan akış üzerinden iş arkadaşlarınızı bir rolle davet edin. Herkes aynı SankiWork Cloud hesabıyla oturum açıp aynı yere varıyor.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="Ortada tek bir proje tuvali, çevresinde birkaç iş birliği imleci ve yorum iğnesi bulunan, neredeyse beyaz editoryal zemin üzerinde hassas yeşil bir seçim çerçevesi içine alınmış ortak tasarım çalışma alanı" />
      ...
      <h2>SankiWork artık Codex'in içinde çalışıyor</h2>
      <p>0.17.0 kapıyı açtı; 0.18.0 ise kimsenin bunu gözden kaçırmamasını sağlıyor. <strong>Codex Desktop ve CLI, SankiWork'ı eksiksiz bir yaratıcı motor olarak çağırabiliyor.</strong> Görsel brief'i onaylayın, SankiWork Cloud'u ya da desteklenen yerel bir runtime'ı seçin ve ikinci bir stack'i elle kurmadan gerçek bir Preview veya Studio sonucu alın.</p>
      <p>İmzalı SankiWork runtime'ı Codex ihtiyaç duyduğunda arayüzsüz olarak başlıyor; dolayısıyla göz kulak olmanız gereken ek bir uygulama penceresi yok. Ayrıca dış MCP host'ları, yerel servis yeniden başlatıldıktan sonra farklı bir porttan döndüğünde SankiWork'ı artık kaybetmiyor: bağlantı evinin yolunu otomatik olarak buluyor ve <code>@sankiwork</code> baştan kurulum gerektirmeden çalışmayı sürdürüyor.</p>
      <p>0.16.x'ten doğrudan bu sürüme geçtiyseniz <a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">0.17.0 sürümü</a> de yükseltmenizin bir parçası: SankiWork, Codex'in doğrudan erişebildiği tasarım katmanına dönüştü.</p>
      ...
      <figure>
        <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="Modüler bir tasarım sistemi kartı, eklenti kutucuğu ve skill kartının ortak ekip çalışma alanına kenetlenmesi; gruplanmış araç seti neredeyse beyaz editoryal zemin üzerinde hassas yeşil bir seçim çerçevesi içinde" />
      ...
      <ul>
        ...
        <li><strong>Eklenti kataloğunun artık bir giriş kapısı var</strong> — özel bir landing page, birisi uygulamayı yüklemeden önce SankiWork eklentilerini tanıtıyor.</li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>zaten Codex kullanıyorsanız</td><td>SankiWork eklentisini yükleyin veya güncelleyin, ardından Codex'ten bir görsel brief isteyin ve sonucu Preview ya da Studio'da açın</td></tr>
      ...
      <p><a href="/download/?utm_source=blog&amp;utm_medium=docs&amp;utm_campaign=202608_0_18_0&amp;utm_content=official">SankiWork'ı indir</a>.</p>
      <p>İki günde 115 PR; SankiWork'ı kişisel bir çalışma alanından ekibin yaşayabileceği bir yere dönüştüren ve bu yeri Codex tarafından çağrılabilir hâle getiren 22 kişiden. İş birliği bir paylaş düğmesi değildir. İşin, bağlamın ve araçların birlikte varmasıdır. Sizi görüyoruz. 🚀</p>

      <h2>İlgili okumalar</h2>
      <ul>
        <li><a href="/blog/sankiwork-0-17-0-sankiwork-for-codex/">SankiWork 0.17.0 sürüm notları: Codex için SankiWork</a></li>
        <li><a href="/blog/sankiwork-0-16-0-reliable-delivery/">SankiWork 0.16.0: güvenilir teslimat</a></li>
        <li><a href="/blog/sankiwork-0-15-1/">SankiWork 0.15.1: daha keskin görüş, daha uzun akış</a></li>
      </ul>
---

`open-design-v0.18.0`, published on August 5, 2026. **115 PRs from 22 contributors in two days.** Codename "Design Team Workspace. Now in Codex." SankiWork used to be a powerful place for one person to make. This release gives the whole design team a home — and puts that same creative engine inside Codex.
...
Collaboration used to start by leaving SankiWork: export a file, paste a screenshot into chat, ask which copy is current, then repeat the same setup for the next person. In 0.18.0, **a Team workspace lives beside your personal workspace**. Create one, switch into it, and invite colleagues with a role through a seat-aware flow. Everyone signs in through the same SankiWork Cloud account and lands in the same place.
...
<figure>
  <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-collaboration.webp" alt="A shared design workspace with one central project canvas, several collaborator cursors and comment pins, held inside a precise green selection frame on a near-white editorial ground" />
...
## SankiWork now works inside Codex

0.17.0 opened the door; 0.18.0 makes sure nobody misses it. **Codex Desktop and CLI can call SankiWork as a complete creative engine.** Confirm a visual brief, choose SankiWork Cloud or a supported local runtime, and receive a real Preview or Studio result without assembling a second stack by hand.

The signed SankiWork runtime starts headlessly when Codex needs it, so there is no extra app window to babysit. And external MCP hosts no longer lose SankiWork when its local service returns on a different port after a restart: the connection finds its way home automatically, and `@sankiwork` keeps working without setup all over again.

If you jumped from 0.16.x to this release, the [0.17.0 release](/blog/sankiwork-0-17-0-sankiwork-for-codex/) is part of your upgrade too — SankiWork has become the design layer Codex can reach directly.
...
<figure>
  <img src="/blog/sankiwork-0-18-0-design-team-workspace-codex-toolkit.webp" alt="A modular design system card, plugin tile and skill card docking into one shared team workspace, with the grouped toolkit held in a precise green selection frame on a near-white editorial ground" />
...
- **The plugin catalog has a front door** — a dedicated landing page introduces SankiWork plugins before someone installs the app.
...
| Already using Codex | Install or update the SankiWork plugin, then ask Codex for a visual brief and open the result in Preview or Studio |
...
[Download SankiWork](/download/?utm_source=blog&utm_medium=docs&utm_campaign=202608_0_18_0&utm_content=official).

115 PRs in two days, from 22 people who turned SankiWork from a personal workspace into a place a team can inhabit — and made that place callable from Codex. Collaboration is not a share button. It is the work, the context, and the tools arriving together. We see you. 🚀

## Related reading

- [SankiWork 0.17.0 release notes: SankiWork for Codex](/blog/sankiwork-0-17-0-sankiwork-for-codex/)
- [SankiWork 0.16.0: reliable delivery](/blog/sankiwork-0-16-0-reliable-delivery/)
- [SankiWork 0.15.1: sharper vision, longer flow](/blog/sankiwork-0-15-1/)
