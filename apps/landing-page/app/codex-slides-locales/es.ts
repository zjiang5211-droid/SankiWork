...
const es: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: "Descargar SankiWork",
  heroAlt:
  ...
  schemaRelationQuestion: "¿Codex Slides tiene relación con SankiWork?",
  schemaRelationAnswer:
    "Sí. Codex Slides es un proyecto hermano del equipo que hay detrás de SankiWork: el mismo enfoque abierto, local-first y agent-native aplicado a las presentaciones en lugar de a los archivos de diseño.",
};
