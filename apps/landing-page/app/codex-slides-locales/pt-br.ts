...
const ptBr: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: "Baixar o SankiWork",
  heroAlt:
  ...
  tiebackTitle: "Da família SankiWork",
  tiebackBody:
    "O SankiWork é o espaço de design aberto e local-first que fica do lado de fora do agente de código que você já usa. O Codex Slides é a mesma ideia apontada para apresentações: seu agente faz o trabalho às claras, o projeto continua na sua máquina e nada fica trancado atrás de uma assinatura. Para o kit de design completo além dos slides, baixe o app do SankiWork.",
  ...
  schemaRelationQuestion: "O Codex Slides tem relação com o SankiWork?",
  schemaRelationAnswer:
    "Sim. O Codex Slides é um projeto irmão feito pelo time por trás do SankiWork — a mesma abordagem aberta, local-first e agent-native aplicada a apresentações em vez de arquivos de design.",
};
