...
const it: DeepPartial<CodexSlidesCopy> = {
  ...
  tiebackTitle: "Dalla famiglia SankiWork",
  tiebackBody:
    "SankiWork è lo spazio di design aperto e local-first che sta fuori dal coding agent che già usi. Codex Slides è la stessa idea puntata sulle presentazioni: il tuo agente lavora allo scoperto, il progetto resta sulla tua macchina e nulla finisce chiuso dietro un abbonamento. Per l'intero toolkit di design oltre le slide, scarica l'app SankiWork.",
  ...
  schemaRelationQuestion: "Codex Slides ha a che fare con SankiWork?",
  schemaRelationAnswer:
    "Sì. Codex Slides è un progetto gemello nato dal team dietro SankiWork: lo stesso approccio aperto, local-first e agent-native applicato alle presentazioni invece che ai file di design.",
};
