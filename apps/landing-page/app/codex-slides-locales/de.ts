...
const de: DeepPartial<CodexSlidesCopy> = {
  ...
  downloadCta: 'SankiWork herunterladen',
  heroAlt:
  ...
  schemaRelationQuestion: 'Hat Codex Slides mit SankiWork zu tun?',
  schemaRelationAnswer:
    'Ja. Codex Slides ist ein Schwesterprojekt des Teams hinter SankiWork — derselbe offene, local-first, agent-native Ansatz, angewandt auf Präsentationen statt auf Designdateien.',
};
