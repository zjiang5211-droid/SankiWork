...
> = {
  fr: homeFallbackCopy({
    railRight: 'SankiWork — vol. 01 · no 26 · Apache-2.0',
    railLeft: 'Skills · systèmes · agents · BYOK · local d’abord',
    discordAria: 'Rejoindre le Discord SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork est l’alternative officielle, local-first, à Claude Design. Votre agent de code — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design avec ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    officialAria: 'Source officielle SankiWork',
    officialLabel: 'Source officielle',
    officialItems: [
      { label: 'Site officiel', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Études de forme · perception · imagination machinique. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacités · skills · systèmes',
      surfaces: '4 surfaces / 1 boucle',
      ribbon: 'SANKIWORK · MATRICE DES CAPACITÉS · OD/26',
      label: 'Capacités',
    ...
    testimonial: {
      ...
      quote: '« SankiWork a transformé des idées IA floues en un système visuel net, crédible et réellement nouveau. »',
    ...
    cta: {
      ...
      live: 'En ligne',
      ribbon: 'SANKIWORK · TERMINÉ.',
    },
  }),
  ru: homeFallbackCopy({
    railRight: 'SankiWork — том 01 · выпуск № 26 · Apache-2.0',
    railLeft: 'Skills · системы · агенты · BYOK · local-first',
    discordAria: 'Присоединиться к Discord SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится дизайн-движком с ${skills} составными skills и ${systems} переносимыми DESIGN.md-системами.`,
    ...
    officialAria: 'Официальный источник SankiWork',
    officialLabel: 'Официальный источник',
    officialItems: [
      { label: 'Официальный сайт', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Исследования формы · восприятия · машинного воображения. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Возможности · skills · системы',
      surfaces: '4 поверхности / 1 цикл',
      ribbon: 'SANKIWORK · МАТРИЦА ВОЗМОЖНОСТЕЙ · OD/26',
      label: 'Возможности',
    ...
    testimonial: {
      ...
      label: 'Соавторы',
      quote: '«SankiWork помог превратить расплывчатые AI-идеи в четкую, надежную и действительно новую визуальную систему.»',
    ...
    cta: {
      ...
      issue: 'Открыть issue',
      live: 'В сети',
      ribbon: 'SANKIWORK · ФИНАЛ.',
    },
  }),
  es: homeFallbackCopy({
    railRight: 'SankiWork — vol. 01 · número 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Unirse al Discord de SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork es la alternativa oficial, local-first, a Claude Design. Tu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en un motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    officialAria: 'Fuente oficial de SankiWork',
    officialLabel: 'Fuente oficial',
    officialItems: [
      { label: 'Sitio oficial', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Estudios de forma · percepción · imaginación maquínica. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
      surfaces: '4 superficies / 1 bucle',
      ribbon: 'SANKIWORK · MATRIZ DE CAPACIDADES · OD/26',
      label: 'Capacidades',
    ...
    work: {
      ...
      editedBy: 'Editado por SankiWork',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '«SankiWork convirtió ideas de IA borrosas en un sistema visual nítido, creíble y realmente nuevo.»',
    ...
    cta: {
      ...
      issue: 'Abrir issue',
      live: 'En línea',
      ribbon: 'SANKIWORK · CIERRE.',
    },
  }),
  'pt-br': homeFallbackCopy({
    railRight: 'SankiWork — vol. 01 · edição nº 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork é a alternativa oficial, local-first, ao Claude Design. Seu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    officialAria: 'Fonte oficial do SankiWork',
    officialLabel: 'Fonte oficial',
    officialItems: [
      { label: 'Site oficial', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Estudos de forma · percepção · imaginação maquínica. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '“SankiWork transformou ideias vagas de IA em um sistema visual nítido, confiável e realmente novo.”',
    ...
    cta: {
      ...
      issue: 'Abrir issue',
      live: 'No ar',
      ribbon: 'SANKIWORK · FIM.',
    },
  }),
  it: homeFallbackCopy({
    railRight: 'SankiWork — vol. 01 · numero 26 · Apache-2.0',
    railLeft: 'Skill · sistemi · agenti · BYOK · local-first',
    discordAria: 'Entra nel Discord di SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork è l’alternativa ufficiale, local-first, a Claude Design. Il tuo agente di codice — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    officialAria: 'Fonte ufficiale SankiWork',
    officialLabel: 'Fonte ufficiale',
    officialItems: [
      { label: 'Sito ufficiale', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Studi di forma · percezione · immaginazione macchinica. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacità · skill · sistemi',
      surfaces: '4 superfici / 1 loop',
      ribbon: 'SANKIWORK · MATRICE CAPACITÀ · OD/26',
      label: 'Capacità',
    ...
    testimonial: {
      ...
      label: 'Collaboratori',
      quote: '“SankiWork ha trasformato idee AI vaghe in un sistema visivo nitido, credibile e davvero nuovo.”',
    ...
    cta: {
      ...
      issue: 'Apri issue',
      live: 'Online',
      ribbon: 'SANKIWORK · FINE.',
    },
  }),
  vi: homeFallbackCopy({
    railRight: 'SankiWork — tập 01 · số 26 · Apache-2.0',
    railLeft: 'Skill · hệ thống · agent · BYOK · ưu tiên local',
    discordAria: 'Tham gia Discord SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork là lựa chọn chính thức, ưu tiên local, thay Claude Design. Agent viết code bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    officialAria: 'Nguồn chính thức của SankiWork',
    officialLabel: 'Nguồn chính thức',
    officialItems: [
      { label: 'Trang chính thức', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Nghiên cứu hình thái · tri giác · tưởng tượng máy. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Năng lực · skill · hệ thống',
      surfaces: '4 bề mặt / 1 vòng lặp',
      ribbon: 'SANKIWORK · MA TRẬN NĂNG LỰC · OD/26',
      label: 'Năng lực',
    ...
    work: {
      ...
      editedBy: 'Biên tập bởi SankiWork',
    ...
    testimonial: {
      ...
      label: 'Cộng tác viên',
      quote: '“SankiWork biến ý tưởng AI mơ hồ thành một hệ thị giác sắc nét, đáng tin và thật sự mới.”',
    ...
    cta: {
      ...
      issue: 'Mở issue',
      live: 'Đang chạy',
      ribbon: 'SANKIWORK · KẾT.',
    },
  }),
  pl: homeFallbackCopy({
    railRight: 'SankiWork — tom 01 · wydanie nr 26 · Apache-2.0',
    railLeft: 'Skills · systemy · agenci · BYOK · lokalnie najpierw',
    discordAria: 'Dołącz do Discorda SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork to oficjalna, lokalna z założenia alternatywa dla Claude Design. Twój agent do kodu — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    officialAria: 'Oficjalne źródło SankiWork',
    officialLabel: 'Oficjalne źródło',
    officialItems: [
      { label: 'Oficjalna strona', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Studia formy · percepcji · wyobraźni maszynowej. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Możliwości · skills · systemy',
      surfaces: '4 powierzchnie / 1 pętla',
      ribbon: 'SANKIWORK · MACIERZ MOŻLIWOŚCI · OD/26',
      label: 'Możliwości',
    ...
    testimonial: {
      ...
      quote: '„SankiWork zmienił niejasne idee AI w ostry, wiarygodny i naprawdę nowy system wizualny.”',
    ...
    cta: {
      ...
      issue: 'Otwórz issue',
      live: 'Online',
      ribbon: 'SANKIWORK · KONIEC.',
    },
  }),
  id: homeFallbackCopy({
    railRight: 'SankiWork — vol. 01 · edisi nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Bergabung ke Discord SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork adalah alternatif resmi, local-first, untuk Claude Design. Agent coding yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    officialAria: 'Sumber resmi SankiWork',
    officialLabel: 'Sumber resmi',
    officialItems: [
      { label: 'Situs resmi', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Studi bentuk · persepsi · imajinasi mesin. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Kapabilitas · skill · sistem',
      surfaces: '4 permukaan / 1 loop',
      ribbon: 'SANKIWORK · MATRIKS KAPABILITAS · OD/26',
      label: 'Kapabilitas',
    ...
    testimonial: {
      ...
      label: 'Kolaborator',
      quote: '“SankiWork mengubah ide AI yang samar menjadi sistem visual yang tajam, dapat dipercaya, dan benar-benar baru.”',
    ...
    cta: {
      ...
      issue: 'Buka issue',
      live: 'Aktif',
      ribbon: 'SANKIWORK · SELESAI.',
    },
  }),
  nl: homeFallbackCopy({
    railRight: 'SankiWork — deel 01 · nummer 26 · Apache-2.0',
    railLeft: 'Skills · systemen · agents · BYOK · local-first',
    discordAria: 'Word lid van SankiWork Discord',
    ...
    heroLead: (skills, systems) =>
      `SankiWork is het officiële local-first alternatief voor Claude Design. Je bestaande code-agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
    ...
    officialAria: 'Officiële bron van SankiWork',
    officialLabel: 'Officiële bron',
    officialItems: [
      { label: 'Officiële site', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Studies naar vorm · perceptie · machinale verbeelding. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Mogelijkheden · skills · systemen',
      surfaces: '4 oppervlakken / 1 loop',
      ribbon: 'SANKIWORK · MOGELIJKHEDENMATRIX · OD/26',
      label: 'Mogelijkheden',
    ...
    testimonial: {
      ...
      label: 'Samenwerkers',
      quote: '“SankiWork veranderde vage AI-ideeën in een scherp, geloofwaardig en echt nieuw visueel systeem.”',
    ...
    cta: {
      ...
      issue: 'Open issue',
      live: 'Live',
      ribbon: 'SANKIWORK · EINDE.',
    },
  }),
  ar: homeFallbackCopy({
    railRight: 'SankiWork — المجلد 01 · العدد 26 · Apache-2.0',
    railLeft: 'Skills · أنظمة · Agents · BYOK · محلي أولاً',
    discordAria: 'الانضمام إلى Discord الخاص بـ SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول agent البرمجة الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم يعتمد على ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    officialAria: 'المصدر الرسمي لـ SankiWork',
    officialLabel: 'المصدر الرسمي',
    officialItems: [
      { label: 'الموقع الرسمي', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'دراسات في الشكل · الإدراك · الخيال الآلي. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'القدرات · skills · الأنظمة',
      surfaces: '4 أسطح / حلقة واحدة',
      ribbon: 'SANKIWORK · مصفوفة القدرات · OD/26',
      label: 'القدرات',
    ...
    testimonial: {
      ...
      label: 'المتعاونون',
      quote: '“حوّل SankiWork أفكار AI الغامضة إلى نظام بصري حاد وموثوق وجديد فعلاً.”',
    ...
    cta: {
      ...
      issue: 'افتح issue',
      live: 'مباشر',
      ribbon: 'SANKIWORK · النهاية.',
    },
  }),
  tr: homeFallbackCopy({
    railRight: 'SankiWork — cilt 01 · sayı nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'SankiWork Discord’a katıl',
    ...
    heroLead: (skills, systems) =>
      `SankiWork, Claude Design’ın resmi local-first alternatifidir. Kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle bir tasarım motoruna dönüşür.`,
    ...
    officialAria: 'SankiWork resmi kaynağı',
    officialLabel: 'Resmi kaynak',
    officialItems: [
      { label: 'Resmi site', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Form · algı · makine imgelemi çalışmaları. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Yetenekler · skill · sistem',
      surfaces: '4 yüzey / 1 döngü',
      ribbon: 'SANKIWORK · YETENEK MATRİSİ · OD/26',
      label: 'Yetenekler',
    ...
    testimonial: {
      ...
      label: 'İşbirlikçiler',
      quote: '“SankiWork belirsiz AI fikirlerini keskin, güvenilir ve gerçekten yeni bir görsel sisteme dönüştürdü.”',
    ...
    cta: {
      ...
      issue: 'Issue aç',
      live: 'Canlı',
      ribbon: 'SANKIWORK · SON.',
    },
  }),
  uk: homeFallbackCopy({
    railRight: 'SankiWork — том 01 · випуск № 26 · Apache-2.0',
    railLeft: 'Skills · системи · агенти · BYOK · local-first',
    discordAria: 'Приєднатися до Discord SankiWork',
    ...
    heroLead: (skills, systems) =>
      `SankiWork — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine із ${skills} composable skills та ${systems} portable DESIGN.md systems.`,
    ...
    officialAria: 'Офіційне джерело SankiWork',
    officialLabel: 'Офіційне джерело',
    officialItems: [
      { label: 'Офіційний сайт', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: 'Дослідження форми · сприйняття · машинної уяви. (SankiWork, MMXXVI)',
    },
    capabilities: {
      rule: 'Можливості · skills · системи',
      surfaces: '4 поверхні / 1 цикл',
      ribbon: 'SANKIWORK · МАТРИЦЯ МОЖЛИВОСТЕЙ · OD/26',
      label: 'Можливості',
    ...
    testimonial: {
      ...
      label: 'Співтворці',
      quote: '«SankiWork допоміг перетворити нечіткі AI-ідеї на гостру, надійну й справді нову візуальну систему.»',
