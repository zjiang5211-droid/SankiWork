...
const fr: DeepPartial<CommunityCopy> = {
  hub: {
    title: "Communauté — SankiWork",
    desc: "La communauté SankiWork : des contributeurs qui livrent en public, des ambassadeurs qui animent des ateliers locaux et des modérateurs qui gardent le Discord chaleureux.",
    heroTitle: "L'open design <em>prend forme</em><br/>quand vous le livrez.",
    heroLead:
      "SankiWork est construit par des personnes, en public. Skills, systèmes DESIGN.md, plugins, docs : chaque commit est un coup de pinceau. Choisissez une porte ci-dessous, trouvez votre salle.",
    cardMetaH: "Frappée automatiquement au premier merge",
    cardMetaS: "PNG · partagée sur X",
    cardHeroAlt:
      "Carte d'honneur d'un contributeur SankiWork — @dev-kp-eloper, top 99,9 %, palier Giotto",
    cards: [
      {
        ord: "I",
        title: "Contributeurs",
      ...
      },
      {
        ord: "II",
        title: "Ambassadeurs",
        sub: "La <em>voix</em> d'SankiWork dans votre ville.",
  ...
  contributors: {
    title: "Contributeurs — SankiWork",
    desc: "Contribuez à SankiWork : mainteneurs, classements hebdomadaires et de tous les temps, good first issues et un chemin sans code pour livrer votre première pièce.",
    heroTitle: "Les mains qui <em>livrent</em> le travail.",
    heroLead:
      "SankiWork est construit par des personnes, en public. Skills, systèmes DESIGN.md, plugins, docs : chaque commit est un coup de pinceau. Choisissez une issue, envoyez une PR et gagnez une carte d'honneur unique dès l'instant où vous êtes mergé.",
    showcase: {
      kicker: "Tout devient un plugin",
      h2: "SankiWork comme une scène. <em>Votre travail</em> comme le spectacle.",
      intro:
      ...
      tenets: [
        ...
        },
        {
          ...
          body: "Le registre à <a href=\"https://sanki-ai.cloud/plugins/\" target=\"_blank\" rel=\"noopener\">sanki-ai.cloud/plugins</a> n'est que le seuil. De là, les pièces les plus fortes sont portées vers l'extérieur : vers X, vers le <span class=\"num\">#showcase</span> de Discord, vers la newsletter, vers les bobines vidéo. Chaque relais élargit la salle ; le monde rencontre votre main.",
        },
        {
          h3: "Besoin d'un <em>premier coup de pinceau</em> ?",
          body: "Parcourez le <a href=\"https://sanki-ai.cloud/plugins/\" target=\"_blank\" rel=\"noopener\">registre de plugins</a>. Les œuvres qui y sont accrochées sont le petit bois pour les vôtres. Empruntez l'étincelle, puis faites la pièce que seule votre main pouvait faire.",
        },
      ],
      pane: {
        kicker: "Le skill",
        ...
        steps: [
          {
            ...
            body: "Collez la commande ci-dessus dans l'agent au sein d'SankiWork, ou dans celui que vous gardez déjà sous la main : Claude Code, Codex, Cursor. Il s'installe tout seul.",
          },
          {
    ...
    maintainers: {
      ...
      intro:
        "Les mainteneurs protègent la direction et la qualité d'SankiWork : ils relisent les contributions, maintiennent la cohérence du standard et font de la place pour que davantage de contributeurs gagnent leur place dans le projet.",
      role: "Mainteneur",
      bios: {
        'Nagendhra-web':
          "Nagendhra apporte l'instinct d'un ingénieur des données pour la vérité en production : trouver la panne, mesurer le cas limite et le corriger correctement. Dans SankiWork, cela se traduit par le travail de préparation des déploiements, le durcissement de l'empaquetage des assets et des correctifs Windows qui rendent le projet digne de confiance quand les contributeurs livrent.",
        'Sid-Qin':
          "Sid est l'ingénieur généraliste doté de l'œil d'un designer pour le détail : le genre de mainteneur qui remarque à la fois le chemin CLI cassé et l'affordance d'interaction de travers. Dans SankiWork, Sid garde les flux d'export, les actions de plugins, les shims Windows, la gestion des MIME et la tuyauterie des agents assez nets pour qu'une communauté puisse bâtir dessus.",
      },
    },
    allTime: {
      ...
      intro:
        "Un registre au long cours de contributeurs talentueux qui continuent de transformer idées, correctifs et savoir-faire en standard SankiWork partagé.",
    ...
    weekly: {
      ...
      intro:
        "Un instantané de contributeurs affûtés qui livrent des PR, améliorent le produit et rendent SankiWork vivant.",
      rankLabel: "Leader de cette semaine",
      week: "7 derniers jours",
      handleSuffix: "· en tête cette semaine",
      blurbTemplate:
        "{name} donne le rythme cette semaine avec {prs} PR mergées et ce savoir-faire régulier qui fait avancer SankiWork.",
      statRank: "Rang",
      statPrs: "PR · 7 j",
      headContributor: "Contributeur",
      headPrs: "PR",
    ...
    issues: {
      ...
      intro:
        "En direct depuis <span class=\"num\">label:&ldquo;good first issue&rdquo;</span> sur le dépôt SankiWork. Commentez une issue pour la réclamer, et un mainteneur vous l'assignera dans la journée.",
    ...
    onboard: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Le bot frappe votre carte d'honneur dès l'instant où vous êtes mergé et la pousse sur la branche bot-cards. Partagez-la sur X avec #SankiWork, et nous republions les meilleures.",
        },
      ],
  ...
  ambassadors: {
    title: "Ambassadeurs — SankiWork",
    desc: "Devenez ambassadeur SankiWork : ouvrez un atelier local, animez des rencontres et des critiques, et obtenez un budget, du matériel et un canal privé vers l'équipe centrale.",
    heroTitle: "Soyez la <em>voix</em> d'SankiWork dans votre ville.",
    heroLead:
    ...
    program: {
      ...
      applyNote:
        "Les ambassadeurs transforment SankiWork d'un dépôt en quelque chose que les contributeurs peuvent rencontrer dans une salle, avec de l'encre sur la table et le café refroidi.",
      cols: [
        {
          n: "I · Vocation",
    ...
    roster: {
      ...
      intro:
        "Des organisateurs locaux, des créateurs et des bâtisseurs de communauté qui aident SankiWork à toucher davantage de designers et d'équipes.",
      places: [
  ...
  moderators: {
    title: "Modérateurs — SankiWork",
    desc: "Rencontrez les modérateurs du Discord SankiWork et rejoignez la salle où les designers IA-natifs livrent leur travail, ouvrent des plugins, cassent des bêtas et se débloquent mutuellement.",
      ...
      cards: [
        {
          ...
          bio: "De l'équipe fondatrice d'SankiWork. Espère que le Discord reste un bon endroit où être. Faites signe à tout moment, sur n'importe quelle question.",
        },
        {
          role: "Gardien de la salle",
          bio: "Une main aguerrie sur Discord et dans l'animation de communauté. Garde la salle chaleureuse, les portes ouvertes, la conversation fluide. Passionné par SankiWork.",
        },
      ],
