...
const it: DeepPartial<CommunityCopy> = {
  hub: {
    ...
    desc: "La community di SankiWork: contributor che pubblicano in pubblico, ambassador che ospitano atelier locali e moderator che tengono viva la Discord.",
    heroTitle: "SankiWork <em>prende forma</em><br/>quando lo pubblichi.",
    heroLead:
      "SankiWork è costruito dalle persone, in pubblico. Skill, sistemi DESIGN.md, plugin, documentazione: ogni commit è una pennellata. Scegli una porta qui sotto, trova la tua stanza.",
    cardMetaH: "Coniata automaticamente al primo merge",
    cardMetaS: "PNG · condivisa su X",
    cardHeroAlt:
      "Carta d'onore del contributor di SankiWork — @dev-kp-eloper, top 99.9%, livello Giotto",
    cards: [
      {
        ord: "I",
        title: "Contributors",
      ...
      },
      {
        ord: "II",
        title: "Ambassadors",
        sub: "La <em>voce</em> di SankiWork nella tua città.",
  ...
  contributors: {
    ...
    desc: "Contribuisci a SankiWork: maintainer, classifiche settimanali e di sempre dei contributor, good first issue e un percorso senza codice per pubblicare il tuo primo pezzo.",
    heroTitle: "Le mani che <em>pubblicano</em> il lavoro.",
    heroLead:
      "SankiWork è costruito dalle persone, in pubblico. Skill, sistemi DESIGN.md, plugin, documentazione: ogni commit è una pennellata. Scegli una issue, invia una PR e guadagna una carta d'onore unica nel momento in cui viene fatto il merge.",
    showcase: {
      kicker: "Plugin everything",
      h2: "SankiWork come palco. <em>Il tuo lavoro</em> come spettacolo.",
      intro:
      ...
      tenets: [
        ...
        },
        {
          ...
          body: "Il registry su <a href=\"https://sanki-ai.cloud/plugins/\" target=\"_blank\" rel=\"noopener\">sanki-ai.cloud/plugins</a> è solo la soglia. Da lì i pezzi più forti vengono portati all'esterno: su X, sulla <span class=\"num\">#showcase</span> di Discord, nella newsletter, nei video reel. Ogni passaggio allarga la stanza; il mondo incontra la tua mano.",
        },
        {
          h3: "Ti serve una <em>prima pennellata</em>?",
          body: "Percorri il <a href=\"https://sanki-ai.cloud/plugins/\" target=\"_blank\" rel=\"noopener\">registry dei plugin</a>. Le opere appese lì sono esca per la tua. Prendi in prestito la scintilla, poi crea il pezzo che solo la tua mano potrebbe.",
        },
      ],
      pane: {
        kicker: "The skill",
        ...
        steps: [
          {
            ...
            body: "Incolla il comando qui sopra nell'agent dentro SankiWork, o in quello che già tieni a portata di mano: Claude Code, Codex, Cursor. Si installa da solo.",
          },
          {
            h4: "Risveglia la skill",
            body: "Digita <code>/sw-contribute</code>, o semplicemente di' all'agent di eseguire ciò che hai appena installato. Entrambe le frasi aprono la porta.",
          },
          {
    ...
    allTime: {
      ...
      intro:
        "Un registro di lungo corso di contributor di talento che continuano a trasformare idee, fix e mestiere nello standard condiviso di SankiWork.",
    ...
    weekly: {
      ...
      intro:
        "Un'istantanea di contributor brillanti che fanno atterrare PR, migliorano il prodotto e fanno sentire vivo SankiWork.",
      rankLabel: "Leader di questa settimana",
      week: "Ultimi 7 giorni",
      handleSuffix: "· in testa questa settimana",
      blurbTemplate:
        "{name} sta dettando il ritmo questa settimana con {prs} PR mergiate e quel tipo di mestiere costante che tiene SankiWork in movimento.",
      statRank: "Posizione",
      statPrs: "PR · 7g",
      headContributor: "Contributor",
      headPrs: "PR",
    ...
    issues: {
      ...
      intro:
        "In diretta da <span class=\"num\">label:&ldquo;good first issue&rdquo;</span> sul repo di SankiWork. Commenta una issue per reclamarla, e un maintainer te la assegnerà entro un giorno.",
    ...
    onboard: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Il bot conia la tua carta d'onore nel momento del merge e la pubblica sul branch bot-cards. Condividila su X con #SankiWork, e noi ripubblichiamo le migliori.",
        },
      ],
  ...
  ambassadors: {
    ...
    desc: "Diventa un ambassador di SankiWork: apri un atelier locale, ospita meetup e critiche, e ottieni budget, materiali e un canale privato con il core team.",
    heroTitle: "Sii la <em>voce</em> di SankiWork nella tua città.",
    heroLead:
    ...
    program: {
      ...
      applyNote:
        "Gli ambassador trasformano SankiWork da repository in qualcosa che i contributor possono incontrare in una stanza, con l'inchiostro sul tavolo e il caffè ormai freddo.",
      cols: [
        {
          n: "I · Vocazione",
    ...
    roster: {
      ...
      intro:
        "Organizzatori locali, creator e community builder che aiutano SankiWork a raggiungere più designer e team.",
      places: [
  ...
  moderators: {
    ...
    desc: "Conosci i moderator della Discord di SankiWork e unisciti alla stanza dove i designer AI-native pubblicano lavoro, aprono plugin, testano le beta e si aiutano a vicenda a sbloccarsi.",
    ...
    discord: {
      ...
      cards: [
        {
          role: "Dallo studio",
          bio: "Dal team fondatore di SankiWork. Spera che la Discord resti un bel posto in cui stare. Saluta in qualsiasi momento, per qualsiasi domanda.",
        },
        {
          role: "Custode della stanza",
          bio: "Mano esperta di Discord e di cura della community. Tiene viva la stanza, le porte aperte, la conversazione che scorre. Appassionato di SankiWork.",
        },
      ],
