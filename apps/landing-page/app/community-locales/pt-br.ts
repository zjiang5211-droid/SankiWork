...
const ptBr: DeepPartial<CommunityCopy> = {
  hub: {
    title: 'Comunidade — SankiWork',
    desc: 'A comunidade SankiWork: contribuidores que publicam em público, embaixadores que hospedam ateliês locais e moderadores que mantêm o Discord acolhedor.',
    heroTitle: 'O open design <em>ganha forma</em><br/>quando você o publica.',
    heroLead:
      'SankiWork é construído por pessoas, em público. Skills, sistemas DESIGN.md, plugins, docs: cada commit é uma pincelada. Escolha uma porta abaixo e encontre a sua sala.',
    cardMetaH: 'Cunhado automaticamente no primeiro merge',
    cardMetaS: 'PNG · compartilhado no X',
    cardHeroAlt:
      'Cartão de honra de contribuidor do SankiWork — @dev-kp-eloper, top 99,9%, nível Giotto',
    cards: [
      {
        ord: 'I',
      ...
      },
      {
        ord: 'II',
        title: 'Embaixadores',
        sub: 'A <em>voz</em> do SankiWork na sua cidade.',
  ...
  contributors: {
    title: 'Contribuidores — SankiWork',
    desc: 'Contribua com o SankiWork: mantenedores, rankings semanais e de todos os tempos, good first issues e um caminho sem código para publicar sua primeira peça.',
    heroTitle: 'As mãos que <em>entregam</em> o trabalho.',
    heroLead:
      'SankiWork é construído por pessoas, em público. Skills, sistemas DESIGN.md, plugins, docs: cada commit é uma pincelada. Escolha uma issue, envie um PR e ganhe um cartão de honra único no instante em que seu código for aceito.',
    showcase: {
      kicker: 'Plugin em tudo',
      h2: 'SankiWork como palco. <em>Seu trabalho</em> como o espetáculo.',
      intro:
      ...
      tenets: [
        ...
        },
        {
          ...
          body: 'O registro em <a href="https://sanki-ai.cloud/plugins/" target="_blank" rel="noopener">sanki-ai.cloud/plugins</a> é apenas o limiar. Dali as peças mais fortes são levadas adiante: ao X, ao <span class="num">#showcase</span> do Discord, à newsletter, aos reels de vídeo. Cada passagem alarga a sala; o mundo conhece sua mão.',
        },
        {
          h3: 'Precisa de uma <em>primeira pincelada</em>?',
          body: 'Percorra o <a href="https://sanki-ai.cloud/plugins/" target="_blank" rel="noopener">registro de plugins</a>. As obras ali penduradas são a lenha para a sua. Tome emprestada a faísca e faça então a peça que só a sua mão poderia.',
        },
      ],
      pane: {
        kicker: 'A skill',
        ...
        steps: [
          {
            ...
            body: 'Cole o comando acima no agente dentro do SankiWork, ou naquele que você já mantém à mão: Claude Code, Codex, Cursor. Ele se instala sozinho.',
          },
          {
            h4: 'Desperte a skill',
    ...
    maintainers: {
      ...
      intro:
        'Os mantenedores protegem a direção e a qualidade do SankiWork: revisam contribuições, mantêm o padrão coerente e abrem espaço para que mais contribuidores conquistem seu lugar no projeto.',
      role: 'Mantenedor',
      bios: {
        'Nagendhra-web':
          'Nagendhra traz o instinto de engenheiro de dados para a verdade em produção: encontrar a falha, medir o caso extremo e corrigi-lo direito. No SankiWork, isso aparece no trabalho de pré-checagem de deploy, no reforço do empacotamento de assets e em correções para Windows que fazem o projeto parecer confiável quando os contribuidores publicam.',
        'Sid-Qin':
          'Sid é o engenheiro generalista com o olhar de designer para os detalhes: o tipo de mantenedor que percebe tanto o caminho quebrado da CLI quanto a affordance de interação torta. No SankiWork, Sid mantém os fluxos de exportação, as ações de plugin, os shims de Windows, o tratamento de MIME e o encanamento do agente afiados o bastante para uma comunidade construir em cima.',
      },
    },
    allTime: {
      ...
      intro:
        'Um registro de longa data de contribuidores talentosos que seguem transformando ideias, correções e ofício no padrão compartilhado do SankiWork.',
    ...
    weekly: {
      ...
      intro:
        'Um retrato de contribuidores afiados que estão fazendo merge de PRs, melhorando o produto e deixando o SankiWork vivo.',
      rankLabel: 'Líder desta semana',
      week: 'Últimos 7 dias',
      handleSuffix: '· liderando esta semana',
      blurbTemplate:
        '{name} está ditando o ritmo esta semana com {prs} PRs aceitos e aquele tipo de ofício constante que mantém o SankiWork em movimento.',
      statRank: 'Posição',
      statPrs: 'PRs · 7d',
      headContributor: 'Contribuidor',
      headPrs: 'PRs',
    ...
    issues: {
      ...
      intro:
        'Ao vivo de <span class="num">label:&ldquo;good first issue&rdquo;</span> no repositório do SankiWork. Comente numa issue para reivindicá-la, e um mantenedor a atribuirá a você em um dia.',
    ...
    onboard: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: 'O bot cunha seu cartão de honra no instante em que seu código é aceito e o envia ao branch bot-cards. Compartilhe no X com #SankiWork, e nós repostamos os melhores.',
        },
      ],
  ...
  ambassadors: {
    title: 'Embaixadores — SankiWork',
    desc: 'Torne-se um embaixador do SankiWork: abra um ateliê local, hospede encontros e críticas, e receba orçamento, materiais e um canal privado com o time central.',
    heroTitle: 'Seja a <em>voz</em> do SankiWork na sua cidade.',
    heroLead:
    ...
    program: {
      ...
      applyNote:
        'Os embaixadores transformam o SankiWork de um repositório em algo que os contribuidores podem encontrar numa sala, com tinta na mesa e o café já frio.',
      cols: [
        {
          n: 'I · Vocação',
    ...
    roster: {
      ...
      intro:
        'Organizadores locais, criadores e construtores de comunidade que ajudam o SankiWork a alcançar mais designers e times.',
      places: [
  ...
  moderators: {
    ...
    desc: 'Conheça os moderadores do Discord do SankiWork e entre na sala onde designers AI-native publicam trabalho, abrem plugins, testam betas e se desatolam uns aos outros.',
    ...
    discord: {
      ...
      cards: [
        {
          role: 'Do estúdio',
          bio: 'Do time fundador do SankiWork. Torce para que o Discord siga sendo um bom lugar para estar. Acene a qualquer momento, sobre qualquer pergunta.',
        },
        {
          role: 'Guardião da sala',
          bio: 'Uma mão experiente em Discord e no cuidado com a comunidade. Mantém a sala acolhedora, as portas abertas, a conversa fluindo. Apaixonado pelo SankiWork.',
        },
      ],
