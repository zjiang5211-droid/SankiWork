...
const zh: DeepPartial<CommunityCopy> = {
  hub: {
    title: '社区 — SankiWork',
    desc: 'SankiWork 社区：在公开场合交付作品的贡献者、在本地主理工坊的大使，以及让 Discord 始终热络的版主。',
    heroTitle: '开放的设计，<em>在你交付时</em><br/>才真正成形。',
    heroLead:
      'SankiWork 由人构建，在公开场合完成。Skills、DESIGN.md 系统、插件、文档：每一次提交都是一笔。选下面的一扇门，找到属于你的房间。',
    cardMetaH: '首次合并时自动铸造',
    cardMetaS: 'PNG · 分享到 X',
    cardHeroAlt:
      'SankiWork 贡献者荣誉卡 — @dev-kp-eloper，前 99.9%，Giotto 级',
    cards: [
      {
        ord: 'I',
        title: '贡献者',
  ...
  contributors: {
    title: '贡献者 — SankiWork',
    desc: '为 SankiWork 做贡献：维护者、每周与历史贡献者榜单、good first issue，以及一条交付第一件作品的零代码路径。',
    heroTitle: '<em>交付</em>作品的那双手。',
    heroLead:
      'SankiWork 由人构建，在公开场合完成。Skills、DESIGN.md 系统、插件、文档：每一次提交都是一笔。挑一个 issue，发一个 PR，合并的那一刻，就赢得一张独一无二的荣誉卡。',
    showcase: {
      kicker: '万物皆可插件',
      h2: 'SankiWork 是舞台。<em>你的作品</em>是演出。',
      intro:
      ...
      tenets: [
        ...
        {
          h3: '一旦进来，<em>它就会远行</em>。',
          body: '位于 <a href="https://sanki-ai.cloud/plugins/" target="_blank" rel="noopener">sanki-ai.cloud/plugins</a> 的注册表只是门槛。从那里出发，最出色的作品会被向外带出：带到 X，带到 Discord 的 <span class="num">#showcase</span>，带到 newsletter，带到视频合集。每一次传递都让这间屋子更大；全世界与你的手相遇。',
        },
        {
          h3: '需要<em>第一笔</em>吗？',
          body: '去逛逛<a href="https://sanki-ai.cloud/plugins/" target="_blank" rel="noopener">插件注册表</a>。挂在那里的作品，是你自己作品的火种。借来那点火花，再做一件只有你的手才能做出的作品。',
        },
      ],
      pane: {
        kicker: '这个 skill',
        ...
        steps: [
          {
            h4: '把这行交给 agent',
            body: '把上面这条命令粘贴进 SankiWork 里的 agent，或粘进你手边惯用的那个：Claude Code、Codex、Cursor。它会自行安装。',
          },
          {
            h4: '唤醒这个 skill',
    ...
    maintainers: {
      ...
      h2: '这些<em>维护者</em>。',
      intro:
        '维护者守护 SankiWork 的方向与质量：他们审阅贡献，让标准保持一致，并为更多贡献者腾出空间、赢得自己在项目里的位置。',
      role: '维护者',
      bios: {
        'Nagendhra-web':
          'Nagendhra 带着数据工程师对生产真相的本能：找到故障、量化边界情况、把它彻底修好。在 SankiWork 里，这体现为部署预检工作、资产打包的加固，以及那些让贡献者交付时对项目更放心的 Windows 修复。',
        'Sid-Qin':
          'Sid 是一位有着设计师般细节眼光的全能工程师：既会注意到断掉的 CLI 路径，也会留意到歪掉的交互细节。在 SankiWork 里，Sid 让导出流程、插件动作、Windows 垫片、MIME 处理和 agent 管道保持足够锋利，让一整个社区可以在其上构建。',
      },
    },
    allTime: {
      kicker: '历史信号',
      h2: '扎根<em>最深</em>的贡献者。',
      intro:
        '一份长期累积的记录，记下那些不断把想法、修复与匠心，化为 SankiWork 共享标准的杰出贡献者。',
      rankLabel: '历史贡献者',
      week: '仓库历史',
      quote:
    ...
    weekly: {
      ...
      intro:
        '一份快照，记录那些敏锐的贡献者：他们合入 PR、改进产品，让 SankiWork 充满生气。',
      rankLabel: '本周领跑者',
      week: '最近 7 天',
      handleSuffix: '· 本周领跑',
      blurbTemplate:
        '{name} 本周以 {prs} 个已合并的 PR 定下节奏，那份稳定的匠心让 SankiWork 持续向前。',
      statRank: '排名',
      statPrs: 'PR · 7 天',
      headContributor: '贡献者',
      headPrs: 'PR',
    ...
    issues: {
      ...
      intro:
        '实时来自 SankiWork 仓库上 <span class="num">label:&ldquo;good first issue&rdquo;</span> 的标签。在某个 issue 下留言即可认领，维护者会在一天内把它分配给你。',
    ...
    onboard: {
      ...
      steps: [
        ...
        },
        {
          n: '步骤 04',
          h3: '合并 → <em>卡片</em>。',
          body: '合并的那一刻，bot 会为你铸造荣誉卡，并推送到 bot-cards 分支。带上 #SankiWork 分享到 X，我们会转发其中最出色的。',
        },
      ],
      cta: '阅读贡献指南',
    },
  ...
  ambassadors: {
    title: '大使 — SankiWork',
    desc: '成为 SankiWork 大使：开设一间本地工坊，主持聚会与评图，并获得预算、物料，以及一条直通核心团队的私密通道。',
    heroTitle: '成为 SankiWork 在你城市里的<em>声音</em>。',
    heroLead:
    ...
    program: {
      ...
      applyNote:
        '大使让 SankiWork 从一个仓库，变成贡献者能在同一间屋子里相遇的东西——桌上有墨，咖啡已凉。',
      cols: [
        {
          n: 'I · 志业',
          h3: '<em>本地场景</em>的绘制者。',
    ...
    roster: {
      ...
      h2: '认识这些<em>大使</em>。',
      intro:
        '本地组织者、创作者和社区建设者，帮助 SankiWork 触及更多设计师与团队。',
      places: [
        '澳大利亚，阳光海岸',
        '马来西亚，吉隆坡',
        '日本',
  ...
  moderators: {
    title: '版主 — SankiWork',
    desc: '认识 SankiWork 的 Discord 版主，加入这间屋子——AI 原生设计师在这里交付作品、开放插件、试破 Beta，并把彼此从卡点里拉出来。',
    ...
    discord: {
      ...
      cards: [
        {
          role: '来自工作室',
          bio: '来自 SankiWork 创始团队。希望 Discord 一直是个待着舒服的地方。任何时候、任何问题，尽管打招呼。',
        },
        {
          role: '这间屋子的守护者',
          bio: '一位在 Discord 和社区照料上经验老到的人。让屋子温暖、门常开、对话流动。对 SankiWork 充满热情。',
        },
      ],
