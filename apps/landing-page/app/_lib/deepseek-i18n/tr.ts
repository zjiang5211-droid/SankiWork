...
export const tr: DeepseekCopyOverride = {
  ...
  collectionCloserHeading: 'Kurulumu atlayın: DeepSeek Harness ile SankiWork içinde tasarlayın',
  filterAll: 'Tümü',
  collectionCloserBody:
    'SankiWork, DeepSeek Harness’in etrafında çalışan açık kaynaklı, agent-native tasarım çalışma alanıdır. Sistemlerinizi, skill’lerinizi ve şablonlarınızı tutarlı tutar; ajan da sahibi olduğunuz işi çıkarır.',
  ...
  detailCloserBody:
    'Bu eklentiyi kendiniz kurun ya da SankiWork ile DeepSeek Harness’in etrafına baştan sona küratörlü bir tasarım katmanı geçirin. Kendi anahtarınızı getirin, çıktınızın sahibi olun.',
