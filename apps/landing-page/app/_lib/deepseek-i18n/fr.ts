...
export const fr: DeepseekCopyOverride = {
  ...
  collectionCloserHeading: 'Passez la config. Designez avec DeepSeek Harness dans SankiWork',
  filterAll: 'Tout',
  collectionCloserBody:
    'SankiWork est le workspace de design open source et agent-native qui tourne autour de DeepSeek Harness. Il garde vos systèmes, vos skills et vos templates cohérents pour que l’agent livre un travail qui vous appartient.',
  ...
  detailCloserBody:
    'Installez ce plugin vous-même, ou faites tourner toute une couche design sélectionnée autour de DeepSeek Harness avec SankiWork. Apportez votre clé, gardez la main sur ce que vous produisez.',
