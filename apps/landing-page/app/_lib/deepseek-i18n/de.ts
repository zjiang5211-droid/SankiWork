...
export const de: DeepseekCopyOverride = {
  ...
  collectionCloserHeading: 'Spar dir das Setup. Designe mit DeepSeek Harness in SankiWork',
  filterAll: 'Alle',
  collectionCloserBody:
    'SankiWork ist der quelloffene, agent-native Design-Workspace rund um DeepSeek Harness. Er hält Systeme, Skills und Templates konsistent, damit der Agent Arbeit liefert, die dir gehört.',
  ...
  detailCloserBody:
    'Installiere dieses Plugin selbst, oder leg mit SankiWork eine ganze kuratierte Design-Ebene um DeepSeek Harness. Eigener Key, eigenes Ergebnis.',
