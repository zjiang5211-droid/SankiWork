...
//
// The marketing site must NOT import `@sankiwork/contracts` (see
...
// `sankiwork/Hero Deck` -> `hero-deck`. This is what `/plugins/[slug]/` uses.
...
// `sankiwork/Hero Deck` -> `sankiwork/hero-deck`.
