...
export const de: CodexCopyOverride = {
  ...
  collectionLede:
    'OpenAI Codex schreibt funktionierenden Code. Sich selbst überlassen landet er bei sicheren Fonts, mittelmäßigen Abständen und zentrierter Helvetica. Diese Plugins geben ihm Geschmack: ästhetische Skills und Design-System-Regeln. Installiere eins davon, oder nutze alle in SankiWork.',
  collectionStats: [
  ...
  collectionCloserHeading: 'Spar dir das Setup. Designe mit Codex in SankiWork',
  filterAll: 'Alle',
  collectionCloserBody:
    'SankiWork ist der quelloffene, agent-native Design-Workspace rund um Codex. Er hält Systeme, Skills und Templates konsistent, damit der Agent Arbeit liefert, die dir gehört.',
  categoryFrontend: 'Frontend & UI',
  categoryDesignSystems: 'Design-Systeme',
  ctaDownload: 'SankiWork herunterladen',
  ...
  detailCloserHeading: 'Mit SankiWork designen, ohne Setup',
  detailCloserBody:
    'Installiere dieses Plugin selbst, oder leg mit SankiWork eine ganze kuratierte Design-Ebene um Codex. Eigener Key, eigenes Ergebnis.',
  skills: {
    'gpt-taste': {
