...
export const it: CodexCopyOverride = {
  ...
  collectionLede:
    'OpenAI Codex scrive codice funzionante. Lasciato a sé stesso ripiega su font sicuri, spaziature medie e Helvetica centrato. Questi sono i plugin che gli danno gusto: skill estetiche e regole di design system. Installane uno, oppure usali tutti dentro SankiWork.',
  collectionStats: [
  ...
  collectionCloserHeading: 'Salta il setup. Progetta con Codex dentro SankiWork',
  filterAll: 'Tutti',
  collectionCloserBody:
    'SankiWork è il design workspace open source e agent-native che lavora attorno a Codex. Tiene coerenti sistemi, skill e template, così l’agente consegna lavoro che ti appartiene.',
  ...
  detailCloserBody:
    'Installa questo plugin da solo, oppure porta attorno a Codex un intero strato di design curato con SankiWork. Usa la tua chiave, resta padrone dell’output.',
  skills: {
    'gpt-taste': {
      tagline:
