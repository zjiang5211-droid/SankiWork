...
export const es: CodexCopyOverride = {
  ...
  collectionLede:
    'OpenAI Codex escribe código que funciona. Por su cuenta recurre a tipografías seguras, espaciados del montón y Helvetica centrada. Estos plugins le dan criterio: skills de estética y reglas de sistema de diseño. Instala uno, o ejecútalos todos dentro de SankiWork.',
  collectionStats: [
  ...
  collectionCloserHeading: 'Sáltate la configuración: diseña con Codex dentro de SankiWork',
  filterAll: 'Todos',
  collectionCloserBody:
    'SankiWork es el espacio de trabajo de diseño de código abierto y nativo para agentes que envuelve a Codex. Mantiene coherentes tus sistemas, skills y plantillas para que el agente entregue trabajo que es tuyo.',
  ...
  detailCloserBody:
    'Instálalo tú mismo, o ejecuta toda una capa de diseño curada alrededor de Codex con SankiWork. Trae tu propia key: lo que produzcas es tuyo.',
  skills: {
    'gpt-taste': {
      tagline:
