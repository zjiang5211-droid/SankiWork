...
export const DEEPSEEK_BINDING: CuratedBinding = {
  ...
  downloadUrl: DEEPSEEK_SW_DOWNLOAD_URL,
  ...
  hubTitle: (copy) => `${copy.collectionHeading} · SankiWork`,
  // The hero's secondary CTA sends readers to the "design with DeepSeek
  // Harness inside SankiWork" guide instead of the upstream repo.
