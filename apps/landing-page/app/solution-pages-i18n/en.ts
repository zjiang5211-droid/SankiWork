...
export const EN: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'AI Wireframe Generator — prompt to wireframe with SankiWork',
    description:
      'A free, open-source AI wireframe generator that turns a prompt into editable, multi-screen wireframes — and takes them all the way to shipped code. SankiWork runs inside the coding agent you already use, so the wireframe and the real product share one source.',
    ...
    tldrBody:
      'Most AI wireframe generators hand you a picture you rebuild later. SankiWork generates the wireframe inside your coding agent and carries it from prompt to shipped code — no export step, no handoff gap, no per-seat meter.',
    stepsTitle: 'How the AI wireframe generator works',
    steps: [
      {
        title: 'Describe the screen',
        body: 'Tell your agent what to wireframe in plain language — "a dashboard with a sidebar, a stats row, and a recent-activity table." SankiWork loads the wireframe skill so the agent lays out structure and hierarchy, not just a single static image.',
    ...
    tableTitle: 'SankiWork vs. typical AI wireframe generators',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Wireframes built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own provider keys — there is no per-seat or per-credit meter on the wireframe generator itself.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork works with Claude Code, Codex, Cursor Agent, Gemini CLI, and a dozen more first-party adapters. You bring your own provider keys; nothing is hosted for you.',
      },
    ],
    ctaTitle: 'Generate your first wireframe tonight',
    ctaBody:
      'Star the repo, install SankiWork, and turn your next screen idea into an editable wireframe — and then into shipped code — in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'AI UI generator' },
      { href: '/solutions/design-to-code/', label: 'Design to code with SankiWork' },
      { href: '/blog/design-to-code-tools/', label: 'Best design-to-code tools' },
      { href: '/solutions/prototype/', label: 'Prototyping with SankiWork' },
    ],
  },
  aiUiGenerator: {
    title: 'AI UI Generator — prompt to production UI with SankiWork',
    description:
      'A free, open-source AI UI generator that turns a prompt into a real, component-based interface — and takes it all the way to shipped code. SankiWork runs inside the coding agent you already use, so the generated UI and the production code are the same artifact.',
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'Most AI UI generators give you a mockup or a throwaway React snippet. SankiWork generates the UI inside your coding agent and carries it from prompt to shipped code — real components, your design system, no export step, no per-seat meter.',
    stepsTitle: 'How the AI UI generator works',
    steps: [
      {
        title: 'Describe the interface',
        body: 'Tell your agent what to build in plain language — "a settings page with a sidebar, tabbed sections, and a save bar." SankiWork loads the UI skill so the agent reaches for real components and a design system, not a one-off screen.',
    ...
    tableTitle: 'SankiWork vs. typical AI UI generators',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'UI built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own provider keys — there is no per-seat or per-credit meter on the UI generator itself.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your next interface idea into a real, component-based UI — and then into shipped code — in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      ...
      { href: '/solutions/designer/', label: 'SankiWork for designers' },
    ],
  },
  designToCode: {
    title: 'Design to Code — turn a design into shipped code with SankiWork',
    description:
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'Most design-to-code tools export a one-time snapshot you then babysit. SankiWork keeps the design and the code as one living artifact inside your agent — iterate by talking, ship code you own, no per-seat meter.',
    stepsTitle: 'How design to code works',
    steps: [
      {
        title: 'Start from a prompt or a design',
        body: 'Describe the screen in plain language, or point your agent at a design direction. SankiWork loads the right skill so the agent builds structure and components, not a brittle one-off conversion.',
    ...
    tableTitle: 'SankiWork vs. typical design-to-code tools',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Shipped from design with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own provider keys — there is no per-seat or per-credit meter on the design-to-code workflow itself.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your next screen — prompt, wireframe, or design — into clean, shippable code in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'AI wireframe generator' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI generator' },
      { href: '/blog/design-to-code-tools/', label: 'Best design-to-code tools' },
      { href: '/solutions/engineering/', label: 'SankiWork for engineering' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'AI Landing Page Generator — prompt to a landing page you ship',
    description:
      'A free, open-source AI landing page generator that turns a prompt into a real, responsive landing page — and takes it all the way to shipped code. SankiWork runs inside the coding agent you already use, so the generated page and the deployed page are the same artifact you own.',
    ...
    heroImageAlt:
      'Real responsive landing page generated with SankiWork, showing the Qelora project homepage',
    tldrTitle: 'In one line',
    tldrBody:
      'Most AI landing page builders lock your page inside their editor and meter it per seat. SankiWork generates the landing page inside your coding agent and carries it from prompt to shipped code — real sections, your brand, no export step, no per-seat meter.',
    stepsTitle: 'How the AI landing page generator works',
    steps: [
      {
        title: 'Describe the page',
        body: 'Tell your agent what to build in plain language — "a launch page for a note-taking app: hero, three features, pricing, and a waitlist form." SankiWork loads the landing-page skill so the agent lays out real sections with clear hierarchy.',
    ...
    tableTitle: 'SankiWork vs. typical AI landing page builders',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Landing pages built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own provider keys — there is no per-seat or per-page meter on the landing page generator itself.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your next launch idea into a real, responsive landing page — and then into shipped code — in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'AI UI generator' },
      { href: '/solutions/design-to-code/', label: 'Design to code with SankiWork' },
      { href: '/solutions/marketing/', label: 'SankiWork for marketing' },
      { href: '/blog/best-ai-design-tools/', label: 'Best AI design tools' },
    ],
  },
  figmaToCode: {
    title: 'Figma to Code — turn Figma designs into shipped code with SankiWork',
    description:
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'Most Figma-to-code plugins export a one-time snapshot of absolute-positioned markup you then rewrite. SankiWork keeps the design and the code as one living artifact inside your agent — pull frames through the Figma MCP, iterate by talking, ship code you own.',
    stepsTitle: 'How Figma to code works',
    steps: [
      {
        title: 'Connect Figma to your agent',
        body: 'With the Figma MCP set up, your coding agent — Claude Code, Codex, Cursor Agent — can read a Figma file or a selected frame directly. SankiWork loads the right skill so the agent turns design intent into structure, not a brittle pixel copy.',
    ...
    tableTitle: 'SankiWork vs. typical Figma-to-code tools',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Shipped from Figma with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'How does SankiWork turn Figma into code?',
      ...
      {
        q: 'Is it free?',
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own provider keys — there is no per-seat or per-export meter on the Figma-to-code workflow itself.',
      },
      {
        q: 'Which agents does it work with?',
        a: 'SankiWork works with Claude Code, Codex, Cursor Agent, Gemini CLI, and a dozen more first-party adapters. You bring your own provider keys and your own Figma MCP setup; nothing is hosted for you.',
      },
    ],
    ctaTitle: 'Turn your next Figma frame into code tonight',
    ctaBody:
      'Star the repo, install SankiWork, connect the Figma MCP, and turn your next Figma design into clean, shippable code in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      { href: '/solutions/design-to-code/', label: 'Design to code with SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI generator' },
      { href: '/agents/claude-code-design/', label: 'SankiWork for Claude Code' },
      { href: '/solutions/engineering/', label: 'SankiWork for engineering' },
    ],
  },
  screenshotToCode: {
    title: 'Screenshot to Code — turn a screenshot into code with SankiWork',
    description:
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'Most screenshot-to-code tools spit out one-time, absolute-positioned markup you then rewrite. SankiWork rebuilds the screenshot inside your coding agent as clean, component-based code — real structure, your design system, no export step, no per-seat meter.',
    stepsTitle: 'How screenshot to code works',
    steps: [
      {
        title: 'Drop in the screenshot',
        body: 'Give your agent an image of the screen you want — a screenshot of an app, a website, or a design. SankiWork loads the right skill so the agent reads the layout and intent, not just pixels.',
    ...
    tableTitle: 'SankiWork vs. typical screenshot-to-code tools',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Rebuilt from a screenshot with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'How does SankiWork turn a screenshot into code?',
        a: 'You give your coding agent an image of the screen and SankiWork loads the right skill so the agent rebuilds it as clean, component-based code — reading layout and intent, not just tracing pixels.',
      },
      {
        q: 'What kind of code does it produce?',
      ...
      {
        q: 'Is it free?',
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own provider keys — there is no per-seat or per-credit meter on the screenshot-to-code workflow itself.',
      },
      {
        q: 'Which agents does it work with?',
        a: 'SankiWork works with Claude Code, Codex, Cursor Agent, Gemini CLI, and a dozen more first-party adapters. You bring your own provider keys; nothing is hosted for you.',
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn a screenshot of the screen you want into clean, shippable code in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      { href: '/solutions/figma-to-code/', label: 'Figma to code with SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Design to code with SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI generator' },
      { href: '/solutions/engineering/', label: 'SankiWork for engineering' },
    ],
  ...
  htmlToPpt: {
    title: 'HTML to PPT — turn HTML into an editable PowerPoint with SankiWork',
    description:
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'Most HTML-to-PPT converters flatten your page into static slide images you cannot edit. SankiWork builds the deck as HTML inside your coding agent and exports a real, editable .pptx — native text and shapes, your design system, no per-seat meter, no vendor lock.',
    stepsTitle: 'How HTML to PPT works',
    steps: [
      {
        title: 'Start from HTML, a doc, or a prompt',
        body: 'Point your agent at an HTML page, a markdown doc, or just describe the deck. SankiWork loads the right skill so the agent reads structure and intent — headings, sections, data — not just raw markup.',
      ...
      },
      {
        ...
        body: 'SankiWork’s pptx-generator turns the HTML deck into a real PowerPoint — native shapes, editable text, and charts you can still change — with an HTML-to-PPTX fidelity audit, not a flat image per slide.',
    ...
    tableTitle: 'SankiWork vs. typical HTML-to-PPT converters',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryLead:
      'Real decks rendered by SankiWork, ready to export to an editable .pptx. Pick a theme close to your content, describe your variation, and the agent builds the deck — then hands you the PowerPoint you own.',
    gallery: [
    ...
    faq: [
      {
        q: 'How does SankiWork turn HTML into a PPT?',
        a: 'Your coding agent builds the content into a clean HTML deck, then SankiWork’s pptx-generator skill exports it to a real, editable .pptx — native shapes and text, audited for HTML-to-PPTX fidelity, not a flat image per slide.',
      },
      {
      ...
      {
        q: 'Is it free?',
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own keys — there is no per-file or per-credit meter on the HTML-to-PPT workflow.',
      },
      {
        q: 'What’s the difference from generating slides?',
        a: 'Generating a deck usually starts from a prompt or outline; HTML to PPT starts from HTML or markdown you already have and focuses on the editable .pptx export. Both use the same SankiWork deck engine — see the slides use case for the outline-first flow.',
      },
    ],
    ctaTitle: 'Turn your next HTML deck into an editable PPT',
    ctaBody:
      'Star the repo, install SankiWork, and turn HTML — or a prompt — into a clean deck and a real, editable .pptx, in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    lead: 'Describe the flow and let your agent generate a real, clickable prototype — linked screens, consistent styles, working interactions. Unlike prototype generators that stop at a mockup, SankiWork carries the same artifact to shipped code, in the agent you already run.',
    heroImageAlt:
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'Most AI prototype generators (Figma, Cursor, Penpot) stop at a clickable mockup you then rebuild. SankiWork generates the prototype inside your coding agent and carries it from prompt to shipped code — no export step, no handoff gap, no per-seat meter.',
    stepsTitle: 'How the AI prototype generator works',
    steps: [
      {
        title: 'Describe the flow',
        body: 'Tell your agent the journey in plain language — "an onboarding flow: sign-up, plan picker, and a dashboard." SankiWork loads the prototype skill so the agent lays out linked screens, not a single static frame.',
    ...
    tableTitle: 'SankiWork vs. typical AI prototype generators',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Prototypes built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Yes. SankiWork is open source and runs inside the coding agent you already use with your own provider keys — there is no per-seat or per-credit meter on the prototype generator itself.',
      },
      {
        q: 'How is it different from Figma, Cursor, or Penpot prototype generators?',
        a: 'Those stop at a clickable mockup inside their app. SankiWork generates the prototype in your coding agent and carries the same artifact all the way to shipped code you own — no export, no rebuild for production.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your next flow into a clickable prototype — and then into shipped code — in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      { href: '/solutions/prototype/', label: 'Prototyping with SankiWork' },
      { href: '/solutions/ai-wireframe-generator/', label: 'AI wireframe generator' },
  ...
  prototype: {
    title: 'Build interactive prototypes with SankiWork + Claude Code',
    description:
      'Turn a prompt into a clickable, multi-screen prototype without leaving your terminal. SankiWork gives your coding agent the design skills, templates, and design system to ship real prototypes you can open in a browser.',
    ...
    heroImageAlt:
      'Real web prototype generated with SankiWork, showing the responsive Qelora project homepage',
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork is the design layer for the coding agent you already use. For prototyping, that means going from a one-paragraph idea to a navigable, styled prototype in a single session — no design tool, no export step, no handoff gap.',
    stepsTitle: 'How prototyping works with SankiWork',
    steps: [
      {
        title: 'Describe the flow',
        body: 'Tell your agent what you are building in plain language — "an onboarding flow with a welcome screen, a plan picker, and a confirmation." SankiWork loads the prototype skill so the agent knows to produce screens, not a single page.',
        imageAlt:
          'Illustration of a person typing a plain-language description of an app flow into a terminal',
      },
      {
        title: 'Generate styled screens',
        body: 'The agent applies a design system and prototype templates from SankiWork, so every screen shares typography, spacing, and components instead of looking like a rough draft. You get a coherent set of screens, not disconnected mockups.',
        imageAlt:
    ...
    tableTitle: 'Prototyping with SankiWork vs. the old way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Prototypes people built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Do I need a design tool like Figma to prototype with SankiWork?',
        a: 'No. SankiWork runs inside your coding agent and renders prototypes to HTML. You describe the flow in language; the agent produces the screens. There is no separate canvas tool to learn or pay for.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your next "what if" into something you can click — in the agent you already use.',
  },
  dashboard: {
    title: 'Generate data dashboards with SankiWork + Claude Code',
    description:
    ...
    lead: 'Tell your agent what to show and how it should feel. SankiWork supplies the chart patterns, layout system, and visual language so you get a coherent, presentable dashboard — not a wall of default-styled widgets.',
    heroImageAlt:
      'Editorial illustration of raw numbers on the left flowing into a clean dashboard of charts and KPI cards on the right',
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork turns a plain-language spec of your metrics into a styled dashboard your agent renders to HTML — versioned in your repo, hostable anywhere, with no per-seat BI subscription.',
    stepsTitle: 'How dashboards work with SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork ships chart and layout templates, so trends become line charts, breakdowns become bars, and ratios become the right visual — consistent typography and spacing throughout instead of mismatched defaults.',
    ...
    tableTitle: 'Dashboards with SankiWork vs. the old way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Dashboards people built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork renders dashboards to HTML inside your coding agent. You describe the metrics and point it at your data; there is no separate BI platform to license or learn.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your metrics into a dashboard you can host anywhere — in the agent you already use.',
  },
  slides: {
    title: 'Generate presentation decks with SankiWork + Claude Code',
    description:
      'Turn an outline into a designed, on-brand slide deck without opening a presentation app. SankiWork gives your coding agent deck templates and a visual system, rendering slides to HTML you can present, export, or share.',
    breadcrumb: 'Slides',
    label: 'Use case · Slides',
    heading: 'Decks that look designed, written by a prompt',
    lead: 'Hand your agent an outline and a tone. SankiWork applies a deck template and visual system so every slide is laid out, typeset, and on-brand — not a bullet list on a blank background.',
    heroImageAlt:
      'SankiWork generating a real twelve-slide presentation with speaker notes and an editable HTML source file',
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork turns an outline into a designed HTML deck your agent renders in one session — present it in the browser, export to PDF or PPTX, and keep the source in your repo.',
    stepsTitle: 'How decks work with SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork ships deck templates — editorial, Swiss-international, dark technical, and more. The agent applies one so typography, grid, and accents stay consistent across every slide.',
    ...
    tableTitle: 'Decks with SankiWork vs. the old way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Decks people built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork renders decks to HTML inside your coding agent and can export to PDF or PPTX. You present from the browser or hand off a file — no presentation app required to build it.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. SankiWork’s pptx-generator exports the deck to a real .pptx with native, editable text and shapes — audited for HTML-to-PPTX fidelity, not flat slide images — plus PDF and the HTML you present from. See the HTML to PPT tool for the conversion-first flow.',
      },
      {
        q: 'Which agents can I use?',
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your outline into a designed deck — in the agent you already use.',
    relatedTitle: 'Related tools & guides',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'HTML to PPT with SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Design to code with SankiWork' },
      { href: '/plugins/templates/', label: 'Browse deck templates' },
      { href: '/solutions/marketing/', label: 'SankiWork for marketing' },
    ],
  ...
  image: {
    title: 'Generate on-brand graphics with SankiWork + Claude Code',
    description:
    ...
    lead: 'Describe the card or cover you need. SankiWork composes it with real type, grid, and your brand colors — then renders to HTML you can export as an image, instead of wrestling a design app or a generic template.',
    heroImageAlt:
      'Editorial illustration of a prompt turning into a set of laid-out social cards and article covers',
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork turns a prompt into a typeset, on-brand graphic your agent renders to HTML and exports to PNG — repeatable, versioned, and free of per-seat design tools.',
    stepsTitle: 'How graphics work with SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork pulls your colors, type, and spacing from a reusable design system, so every card matches the rest of your brand instead of looking like a one-off.',
    ...
    tableTitle: 'Graphics with SankiWork vs. the old way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Graphics people built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork composes graphics with real layout and typography — your headline, your brand, exact dimensions — and renders to HTML you export as PNG. It is design composition, not pixel generation.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn a prompt into an on-brand graphic — in the agent you already use.',
  },
  video: {
    title: 'Generate motion graphics & short video with SankiWork + Claude Code',
    description:
    ...
    lead: 'Describe the moment you want — a title reveal, a data animation, a logo outro. SankiWork composes animated frames with your brand system and renders them to video, no motion-graphics suite required.',
    heroImageAlt:
      'Editorial illustration of a script turning into a sequence of animated video frames',
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork turns a script into animated, on-brand frames your agent renders to short-form video — composed from HTML, versioned in your repo, with no timeline editor to learn.',
    stepsTitle: 'How motion works with SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork supplies frame templates — cinematic light leaks, glitch titles, logo outros — and applies your colors and type, so the motion looks intentional and on-brand.',
    ...
    tableTitle: 'Motion with SankiWork vs. the old way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Motion people built with SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork composes animated frames in HTML and renders them to video inside your coding agent. There is no timeline editor to learn or license.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn a script into motion — in the agent you already use.',
  },
  designSystem: {
    title: 'Build and apply a design system with SankiWork + Claude Code',
    description:
    ...
    lead: 'Define your brand once and SankiWork carries it into every output — prototypes, decks, dashboards, graphics. The system lives in your repo as a DESIGN.md the agent reads, so consistency is automatic, not manual.',
    heroImageAlt:
      'Editorial illustration of a single design system radiating into many on-brand artifacts',
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork captures your brand as a portable design system your agent applies to every artifact — defined once in your repo, enforced everywhere, with no central design tool to gate-keep it.',
    stepsTitle: 'How design systems work with SankiWork',
    steps: [
      {
        title: 'Capture the system',
        body: 'Describe your brand — colors, type, spacing, voice — or point the agent at an existing site to extract it. SankiWork writes it into a DESIGN.md that lives in your project.',
        imageAlt: 'Illustration of a brand being captured into a single design-system file',
      },
      {
        title: 'Start from a proven base',
        body: 'SankiWork ships 140+ reference design systems — from Apple and Linear to editorial and brutalist. Fork one close to your brand instead of starting from a blank page.',
    ...
    tableTitle: 'Design systems with SankiWork vs. the old way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Design systems in SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'A DESIGN.md file in your repo that captures colors, type, spacing, components, and voice. Every SankiWork skill reads it, so your brand is applied automatically to whatever the agent produces.',
      },
      {
        q: 'Do I have to start from scratch?',
        a: 'No. SankiWork ships 140+ reference design systems you can fork — from Apple and Linear to editorial and brutalist — then adapt to your brand.',
      },
      {
    ...
    ctaBody:
      'Star the repo, install SankiWork, and give your agent one brand to apply everywhere — in the agent you already use.',
  },
  roleSoloBuilder: {
    title: 'SankiWork for solo builders & indie hackers',
    description:
      'Ship like a team of one. SankiWork turns your coding agent into the design half of your startup — prototypes, landing pages, dashboards, and brand visuals, all from a prompt, all on brand, all in your repo.',
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork is the design department a solo founder never had: prompt-to-artifact across every surface your product needs, on one brand, with zero handoff and no extra tools.',
    stepsTitle: 'How a solo builder uses SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Solo building with SankiWork vs. doing it the hard way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Built solo with SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Star the repo, install SankiWork, and let one agent be your design team — in the agent you already use.',
  },
  roleDesigner: {
    title: 'SankiWork for designers',
    description:
      'Spend your time on taste, not toil. SankiWork lets your agent handle the repetitive production work — variants, states, full design systems — while you direct the look and keep final say.',
    breadcrumb: 'Designer',
    label: 'For · Designers',
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork is the production assistant that never tires: you define the design system and call the taste; the agent generates the rest, on system, in your repo.',
    stepsTitle: 'How a designer uses SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Designing with SankiWork vs. the manual way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Directed with SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Star the repo, install SankiWork, and let the agent handle production while you call the taste — in the agent you already use.',
  },
  roleEngineering: {
    title: 'SankiWork for engineers',
    description:
      'Skip the design handoff. SankiWork turns a DESIGN.md into real front-end your coding agent writes directly — on-system UI, prototypes, and dashboards, in the repo, no Figma round-trip.',
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork closes the designer-to-engineer gap by making the design system machine-readable: the same agent that writes your code applies the system and renders real UI.',
    stepsTitle: 'How an engineer uses SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Front-end with SankiWork vs. the handoff way',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Built by engineers with SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn a DESIGN.md into front-end — in the agent you already use.',
  },
  roleProductManagers: {
    title: 'SankiWork for product managers',
    description:
      'Stop waiting on design bandwidth to communicate an idea. SankiWork lets a PM turn a prompt into a clickable prototype or wireframe — to align stakeholders and brief the team, without a design ticket.',
    ...
    heroImageAlt:
      'Real interactive team dashboard artifact generated with SankiWork for stakeholder review',
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork gives a PM a design-free way to make ideas tangible: prompt-to-prototype for alignment and briefs, without spending the team’s design budget.',
    stepsTitle: 'How a PM uses SankiWork',
    steps: [
      {
        title: 'Describe the flow',
    ...
    tableTitle: 'PM work with SankiWork vs. waiting on design',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    ...
    galleryTitle: 'Prototyped by PMs with SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn your next spec into something people can click — in the agent you already use.',
  },
  roleMarketing: {
    title: 'SankiWork for marketing teams',
    description:
      'Ship campaigns at content speed. SankiWork lets your agent produce landing pages, social cards, and campaign visuals from a prompt — on brand, on demand, without queuing design.',
    ...
    tldrTitle: 'In one line',
    tldrBody:
      'SankiWork is the always-on design resource for marketing: prompt-to-asset for landing pages and social, on brand, so campaigns ship at the speed you write copy.',
    stepsTitle: 'How a marketing team uses SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Marketing with SankiWork vs. the usual scramble',
    tableColCapability: 'What you need',
    tableColWithOd: 'With SankiWork',
    tableColWithout: 'Without it today',
    tableRows: [
    ...
    galleryTitle: 'Shipped by marketing with SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Star the repo, install SankiWork, and turn briefs into on-brand assets — in the agent you already use.',
  },
};
