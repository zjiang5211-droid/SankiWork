...
export const PL: SolutionLocaleCopy = {
  prototype: {
    title: 'Buduj interaktywne prototypy z SankiWork + Claude Code',
    description:
      'Zamień polecenie w klikalny, wieloekranowy prototyp bez opuszczania terminala. SankiWork daje Twojemu coding agentowi umiejętności projektowe, szablony i system projektowy, by tworzyć prawdziwe prototypy, które otworzysz w przeglądarce.',
    breadcrumb: 'Prototyp',
    ...
    tldrBody:
      'SankiWork to warstwa projektowa dla coding agenta, którego już używasz. W prototypowaniu oznacza to przejście od pomysłu opisanego w jednym akapicie do nawigowalnego, ostylowanego prototypu w jednej sesji — bez narzędzia projektowego, bez kroku eksportu, bez luki przy przekazywaniu.',
    stepsTitle: 'Jak działa prototypowanie z SankiWork',
    steps: [
      {
        title: 'Opisz przepływ',
        body: 'Powiedz agentowi prostym językiem, co budujesz — „przepływ onboardingu z ekranem powitalnym, wyborem planu i potwierdzeniem”. SankiWork ładuje umiejętność prototypowania, więc agent wie, że ma stworzyć ekrany, a nie pojedynczą stronę.',
        imageAlt:
          'Ilustracja osoby wpisującej w terminalu opis przepływu aplikacji prostym językiem',
      },
      {
        title: 'Wygeneruj ostylowane ekrany',
        body: 'Agent stosuje system projektowy i szablony prototypów z SankiWork, więc każdy ekran dzieli typografię, odstępy i komponenty, zamiast wyglądać jak zgrubny szkic. Otrzymujesz spójny zestaw ekranów, a nie rozłączne makiety.',
        imageAlt:
    ...
    tableTitle: 'Prototypowanie z SankiWork kontra dawny sposób',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Prototypy, które ludzie zbudowali z SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Czy potrzebuję narzędzia projektowego jak Figma, by prototypować z SankiWork?',
        a: 'Nie. SankiWork działa wewnątrz Twojego coding agenta i renderuje prototypy do HTML. Opisujesz przepływ językiem; agent tworzy ekrany. Nie ma osobnego narzędzia z płótnem, którego trzeba się uczyć lub za które trzeba płacić.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork współpracuje z Claude Code, Codex, Cursor Agent, Gemini CLI i kilkunastoma innymi natywnymi adapterami. Korzystasz z własnych kluczy dostawcy; nic nie jest hostowane za Ciebie.',
      },
      {
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień swoje kolejne „a gdyby” w coś, co możesz kliknąć — w agencie, którego już używasz.',
  },
  dashboard: {
    title: 'Generuj dashboardy danych z SankiWork + Claude Code',
    description:
    ...
    lead: 'Powiedz agentowi, co pokazać i jak ma to wyglądać. SankiWork dostarcza wzorce wykresów, system układu i język wizualny, więc otrzymujesz spójny, prezentowalny dashboard — a nie ścianę domyślnie ostylowanych widżetów.',
    heroImageAlt:
      'Redakcyjna ilustracja surowych liczb po lewej, które przepływają w czysty dashboard z wykresami i kartami KPI po prawej',
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork zamienia opisaną prostym językiem specyfikację Twoich metryk w ostylowany dashboard, który agent renderuje do HTML — wersjonowany w Twoim repozytorium, hostowalny gdziekolwiek, bez abonamentu BI za stanowisko.',
    stepsTitle: 'Jak działają dashboardy z SankiWork',
    steps: [
      {
        title: 'Opisz metryki',
      ...
      },
      {
        ...
        body: 'SankiWork dostarcza szablony wykresów i układów, więc trendy stają się wykresami liniowymi, podziały słupkami, a proporcje właściwą wizualizacją — spójna typografia i odstępy w całości, zamiast niedopasowanych domyślnych ustawień.',
    ...
    tableTitle: 'Dashboardy z SankiWork kontra dawny sposób',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Dashboardy, które ludzie zbudowali z SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nie. SankiWork renderuje dashboardy do HTML wewnątrz Twojego coding agenta. Opisujesz metryki i wskazujesz mu swoje dane; nie ma osobnej platformy BI, którą trzeba licencjonować lub poznawać.',
      },
      {
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień swoje metryki w dashboard, który zahostujesz gdziekolwiek — w agencie, którego już używasz.',
  },
  slides: {
    title: 'Generuj prezentacje z SankiWork + Claude Code',
    description:
      'Zamień konspekt w zaprojektowaną, zgodną z marką prezentację bez otwierania aplikacji do prezentacji. SankiWork daje Twojemu coding agentowi szablony slajdów i system wizualny, renderując slajdy do HTML, które zaprezentujesz, wyeksportujesz lub udostępnisz.',
    breadcrumb: 'Slajdy',
    label: 'Przypadek użycia · Slajdy',
    heading: 'Prezentacje, które wyglądają na zaprojektowane, napisane poleceniem',
    lead: 'Przekaż agentowi konspekt i ton. SankiWork stosuje szablon prezentacji i system wizualny, więc każdy slajd jest rozłożony, złożony typograficznie i zgodny z marką — a nie listą punktowaną na pustym tle.',
    heroImageAlt:
      'Redakcyjna ilustracja konspektu po lewej, który zamienia się w sekwencję zaprojektowanych slajdów prezentacji po prawej',
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork zamienia konspekt w zaprojektowaną prezentację HTML, którą agent renderuje w jednej sesji — zaprezentuj ją w przeglądarce, wyeksportuj do PDF lub PPTX i zachowaj źródło w swoim repozytorium.',
    stepsTitle: 'Jak działają prezentacje z SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork dostarcza szablony prezentacji — redakcyjny, szwajcarski międzynarodowy, ciemny techniczny i więcej. Agent stosuje jeden, więc typografia, siatka i akcenty pozostają spójne na każdym slajdzie.',
    ...
    tableTitle: 'Prezentacje z SankiWork kontra dawny sposób',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Prezentacje, które ludzie zbudowali z SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nie. SankiWork renderuje prezentacje do HTML wewnątrz Twojego coding agenta i może eksportować do PDF lub PPTX. Prezentujesz z przeglądarki lub przekazujesz plik — by ją zbudować, nie potrzeba aplikacji do prezentacji.',
      },
      {
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień swój konspekt w zaprojektowaną prezentację — w agencie, którego już używasz.',
  },
  image: {
    title: 'Generuj grafiki zgodne z marką z SankiWork + Claude Code',
    description:
    ...
    lead: 'Opisz kartę lub okładkę, której potrzebujesz. SankiWork komponuje ją z prawdziwą typografią, siatką i Twoimi kolorami marki — a potem renderuje do HTML, który wyeksportujesz jako obraz, zamiast mocować się z aplikacją projektową lub ogólnym szablonem.',
    heroImageAlt:
      'Redakcyjna ilustracja polecenia, które zamienia się w zestaw rozłożonych kart społecznościowych i okładek artykułów',
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork zamienia polecenie w złożoną typograficznie, zgodną z marką grafikę, którą agent renderuje do HTML i eksportuje do PNG — powtarzalną, wersjonowaną i wolną od narzędzi projektowych rozliczanych za stanowisko.',
    stepsTitle: 'Jak działają grafiki z SankiWork',
    steps: [
      {
        title: 'Opisz grafikę',
      ...
      },
      {
        ...
        body: 'SankiWork czerpie Twoje kolory, typografię i odstępy z wielokrotnego systemu projektowego, więc każda karta pasuje do reszty Twojej marki, zamiast wyglądać na jednorazową.',
    ...
    tableTitle: 'Grafiki z SankiWork kontra dawny sposób',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Grafiki, które ludzie zbudowali z SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nie. SankiWork komponuje grafiki z prawdziwym układem i typografią — Twój nagłówek, Twoja marka, dokładne wymiary — i renderuje do HTML, który eksportujesz jako PNG. To kompozycja projektowa, a nie generowanie pikseli.',
      },
      {
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień polecenie w grafikę zgodną z marką — w agencie, którego już używasz.',
  },
  video: {
    title: 'Generuj grafikę ruchomą i krótkie wideo z SankiWork + Claude Code',
    description:
    ...
    lead: 'Opisz moment, którego chcesz — odsłonięcie tytułu, animację danych, końcówkę z logo. SankiWork komponuje animowane klatki z Twoim systemem marki i renderuje je do wideo, bez potrzeby pakietu do grafiki ruchomej.',
    heroImageAlt:
      'Redakcyjna ilustracja scenariusza, który zamienia się w sekwencję animowanych klatek wideo',
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork zamienia scenariusz w animowane, zgodne z marką klatki, które agent renderuje do krótkiego wideo — skomponowane z HTML, wersjonowane w Twoim repozytorium, bez edytora osi czasu, którego trzeba się uczyć.',
    stepsTitle: 'Jak działa ruch z SankiWork',
    steps: [
      {
        title: 'Opisz moment',
      ...
      },
      {
        ...
        body: 'SankiWork dostarcza szablony klatek — filmowe rozbłyski światła, glitchowe tytuły, końcówki z logo — i nakłada Twoje kolory oraz typografię, więc ruch wygląda na zamierzony i zgodny z marką.',
    ...
    tableTitle: 'Ruch z SankiWork kontra dawny sposób',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Ruch, który ludzie zbudowali z SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nie. SankiWork komponuje animowane klatki w HTML i renderuje je do wideo wewnątrz Twojego coding agenta. Nie ma edytora osi czasu, którego trzeba się uczyć lub który trzeba licencjonować.',
      },
      {
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień scenariusz w ruch — w agencie, którego już używasz.',
  },
  designSystem: {
    title: 'Zbuduj i zastosuj system projektowy z SankiWork + Claude Code',
    description:
    ...
    lead: 'Zdefiniuj swoją markę raz, a SankiWork przenosi ją do każdego efektu — prototypów, prezentacji, dashboardów, grafik. System żyje w Twoim repozytorium jako DESIGN.md, który agent czyta, więc spójność jest automatyczna, a nie ręczna.',
    heroImageAlt:
      'Redakcyjna ilustracja pojedynczego systemu projektowego promieniującego na wiele artefaktów zgodnych z marką',
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork ujmuje Twoją markę jako przenośny system projektowy, który agent stosuje do każdego artefaktu — zdefiniowany raz w Twoim repozytorium, egzekwowany wszędzie, bez centralnego narzędzia projektowego, które by go strzegło.',
    stepsTitle: 'Jak działają systemy projektowe z SankiWork',
    steps: [
      {
        title: 'Uchwyć system',
        body: 'Opisz swoją markę — kolory, typografię, odstępy, głos — albo wskaż agentowi istniejącą stronę, by ją wyodrębnił. SankiWork zapisuje to w DESIGN.md, który żyje w Twoim projekcie.',
        imageAlt: 'Ilustracja marki ujmowanej w pojedynczy plik systemu projektowego',
      },
      {
        title: 'Zacznij od sprawdzonej bazy',
        body: 'SankiWork dostarcza ponad 140 referencyjnych systemów projektowych — od Apple i Linear po redakcyjne i brutalistyczne. Sforkuj jeden bliski Twojej marce zamiast zaczynać od pustej strony.',
    ...
    tableTitle: 'Systemy projektowe z SankiWork kontra dawny sposób',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Systemy projektowe w SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Plikiem DESIGN.md w Twoim repozytorium, który ujmuje kolory, typografię, odstępy, komponenty i głos. Każda umiejętność SankiWork go czyta, więc Twoja marka jest stosowana automatycznie do wszystkiego, co tworzy agent.',
      },
      {
        q: 'Czy muszę zaczynać od zera?',
        a: 'Nie. SankiWork dostarcza ponad 140 referencyjnych systemów projektowych, które możesz sforkować — od Apple i Linear po redakcyjne i brutalistyczne — a potem dostosować do swojej marki.',
      },
      {
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i daj swojemu agentowi jedną markę do stosowania wszędzie — w agencie, którego już używasz.',
  },
  roleSoloBuilder: {
    title: 'SankiWork dla samodzielnych twórców i indie hackerów',
    description:
      'Twórz jak cały zespół w pojedynkę. SankiWork zamienia Twojego agenta kodującego w projektową połowę Twojego startupu — prototypy, strony docelowe, pulpity i materiały marki, wszystko z jednego polecenia, wszystko spójne z marką, wszystko w Twoim repozytorium.',
    ...
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork to dział projektowy, którego samodzielny założyciel nigdy nie miał: od polecenia do gotowego materiału na każdej powierzchni, jakiej potrzebuje Twój produkt, na jednej marce, bez przekazywania prac i bez dodatkowych narzędzi.',
    stepsTitle: 'Jak samodzielny twórca korzysta z SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Tworzenie w pojedynkę z SankiWork vs robienie tego na trudniejszy sposób',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Zbudowane w pojedynkę z SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i pozwól jednemu agentowi być Twoim zespołem projektowym — w agencie, którego już używasz.',
  },
  roleDesigner: {
    title: 'SankiWork dla projektantów',
    description:
      'Poświęcaj czas na smak, nie na mozół. SankiWork pozwala Twojemu agentowi zająć się powtarzalną pracą produkcyjną — wariantami, stanami, całymi systemami projektowymi — podczas gdy Ty kierujesz wyglądem i masz ostatnie słowo.',
    ...
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork to asystent produkcji, który nigdy się nie męczy: Ty definiujesz system projektowy i wyrokujesz o smaku; agent generuje resztę, zgodnie z systemem, w Twoim repozytorium.',
    stepsTitle: 'Jak projektant korzysta z SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Projektowanie z SankiWork vs sposób ręczny',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Kierowane z SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i pozwól agentowi zająć się produkcją, podczas gdy Ty wyrokujesz o smaku — w agencie, którego już używasz.',
  },
  roleEngineering: {
    title: 'SankiWork dla inżynierów',
    description:
      'Pomiń przekazywanie projektu. SankiWork zamienia DESIGN.md w prawdziwy front-end, który Twój agent kodujący pisze bezpośrednio — zgodny z systemem interfejs, prototypy i pulpity, w repozytorium, bez podróży tam i z powrotem do Figmy.',
    ...
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork domyka lukę między projektantem a inżynierem, czyniąc system projektowy odczytywalnym maszynowo: ten sam agent, który pisze Twój kod, stosuje system i renderuje prawdziwy interfejs.',
    stepsTitle: 'Jak inżynier korzysta z SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Front-end z SankiWork vs sposób z przekazywaniem prac',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Zbudowane przez inżynierów z SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień DESIGN.md we front-end — w agencie, którego już używasz.',
  },
  roleProductManagers: {
    title: 'SankiWork dla menedżerów produktu',
    description:
      'Przestań czekać na przepustowość projektową, by zakomunikować pomysł. SankiWork pozwala PM-owi zamienić polecenie w klikalny prototyp lub szkielet — by uzgodnić stanowiska interesariuszy i poinstruować zespół, bez zgłoszenia projektowego.',
    ...
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork daje PM-owi sposób bez projektowania, by uczynić pomysły namacalnymi: od polecenia do prototypu dla uzgodnień i instrukcji, bez wydawania budżetu projektowego zespołu.',
    stepsTitle: 'Jak PM korzysta z SankiWork',
    steps: [
      {
        title: 'Opisz przepływ',
    ...
    tableTitle: 'Praca PM-a z SankiWork vs czekanie na projekt',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    ...
    galleryTitle: 'Prototypowane przez PM-ów z SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień swoją kolejną specyfikację w coś, co ludzie mogą kliknąć — w agencie, którego już używasz.',
  },
  roleMarketing: {
    title: 'SankiWork dla zespołów marketingu',
    description:
      'Wydawaj kampanie w tempie treści. SankiWork pozwala Twojemu agentowi tworzyć strony docelowe, karty społecznościowe i materiały kampanijne z jednego polecenia — zgodne z marką, na żądanie, bez kolejkowania projektu.',
    ...
    tldrTitle: 'W jednym zdaniu',
    tldrBody:
      'SankiWork to zawsze dostępny zasób projektowy dla marketingu: od polecenia do materiału na strony docelowe i media społecznościowe, zgodnego z marką, by kampanie wychodziły w tempie, w jakim piszesz teksty.',
    stepsTitle: 'Jak zespół marketingu korzysta z SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Marketing z SankiWork vs zwykła gonitwa',
    tableColCapability: 'Czego potrzebujesz',
    tableColWithOd: 'Z SankiWork',
    tableColWithout: 'Bez tego dzisiaj',
    tableRows: [
    ...
    galleryTitle: 'Wydane przez marketing z SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Daj gwiazdkę repozytorium, zainstaluj SankiWork i zamień briefy w zgodne z marką materiały — w agencie, którego już używasz.',
  },
};
