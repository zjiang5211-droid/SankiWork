...
export const ES: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'Generador de wireframes con IA — del prompt al wireframe con SankiWork',
    description:
      'Un generador de wireframes con IA, gratuito y de código abierto, que convierte un prompt en wireframes editables de varias pantallas — y los lleva hasta el código listo para lanzar. SankiWork funciona dentro del agente de programación que ya usas, así que el wireframe y el producto real comparten una sola fuente.',
    ...
    tldrBody:
      'La mayoría de los generadores de wireframes con IA te entregan una imagen que luego reconstruyes. SankiWork genera el wireframe dentro de tu agente de programación y lo lleva del prompt al código listo para lanzar — sin paso de exportación, sin brecha de entrega, sin medidor por licencia.',
    stepsTitle: 'Cómo funciona el generador de wireframes con IA',
    steps: [
      {
        title: 'Describe la pantalla',
        body: 'Dile a tu agente qué quieres convertir en wireframe en lenguaje sencillo — «un panel con una barra lateral, una fila de estadísticas y una tabla de actividad reciente». SankiWork carga la habilidad de wireframe para que el agente disponga estructura y jerarquía, no solo una imagen estática.',
    ...
    tableTitle: 'SankiWork frente a los generadores de wireframes con IA habituales',
    ...
    galleryTitle: 'Wireframes creados con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves de proveedor — no hay medidor por licencia ni por crédito sobre el generador de wireframes en sí.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork funciona con Claude Code, Codex, Cursor Agent, Gemini CLI y una docena más de adaptadores nativos. Usas tus propias claves de proveedor; nada se aloja por ti.',
      },
    ],
    ctaTitle: 'Genera tu primer wireframe esta noche',
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tu próxima idea de pantalla en un wireframe editable — y luego en código listo para lanzar — en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Generador de UI con IA' },
      { href: '/solutions/design-to-code/', label: 'De diseño a código con SankiWork' },
      { href: '/blog/design-to-code-tools/', label: 'Las mejores herramientas de diseño a código' },
      { href: '/solutions/prototype/', label: 'Prototipado con SankiWork' },
    ],
  },
  aiUiGenerator: {
    title: 'Generador de UI con IA — del prompt a la UI de producción con SankiWork',
    description:
      'Un generador de UI con IA, gratuito y de código abierto, que convierte un prompt en una interfaz real basada en componentes — y la lleva hasta el código listo para lanzar. SankiWork funciona dentro del agente de programación que ya usas, así que la UI generada y el código de producción son el mismo artefacto.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'La mayoría de los generadores de UI con IA te dan una maqueta o un fragmento de React desechable. SankiWork genera la UI dentro de tu agente de programación y la lleva del prompt al código listo para lanzar — componentes reales, tu sistema de diseño, sin paso de exportación, sin medidor por licencia.',
    stepsTitle: 'Cómo funciona el generador de UI con IA',
    steps: [
      {
        title: 'Describe la interfaz',
        body: 'Dile a tu agente qué construir en lenguaje sencillo — «una página de ajustes con una barra lateral, secciones con pestañas y una barra de guardado». SankiWork carga la habilidad de UI para que el agente recurra a componentes reales y a un sistema de diseño, no a una pantalla improvisada.',
    ...
    tableTitle: 'SankiWork frente a los generadores de UI con IA habituales',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'UI creada con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves de proveedor — no hay medidor por licencia ni por crédito sobre el generador de UI en sí.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tu próxima idea de interfaz en una UI real basada en componentes — y luego en código listo para lanzar — en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      ...
      { href: '/solutions/designer/', label: 'SankiWork para diseñadores' },
    ],
  },
  designToCode: {
    title: 'De diseño a código — convierte un diseño en código listo para lanzar con SankiWork',
    description:
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'La mayoría de las herramientas de diseño a código exportan una instantánea de una sola vez que luego tienes que cuidar. SankiWork mantiene el diseño y el código como un solo artefacto vivo dentro de tu agente — itera hablando, lanza código que es tuyo, sin medidor por licencia.',
    stepsTitle: 'Cómo funciona de diseño a código',
    steps: [
      {
        title: 'Empieza desde un prompt o un diseño',
        body: 'Describe la pantalla en lenguaje sencillo, o señala a tu agente una dirección de diseño. SankiWork carga la habilidad adecuada para que el agente construya estructura y componentes, no una conversión frágil e improvisada.',
    ...
    tableTitle: 'SankiWork frente a las herramientas de diseño a código habituales',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Lanzado desde el diseño con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves de proveedor — no hay medidor por licencia ni por crédito sobre el flujo de diseño a código en sí.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tu próxima pantalla — prompt, wireframe o diseño — en código limpio y listo para lanzar en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'Generador de wireframes con IA' },
      { href: '/solutions/ai-ui-generator/', label: 'Generador de UI con IA' },
      { href: '/blog/design-to-code-tools/', label: 'Las mejores herramientas de diseño a código' },
      { href: '/solutions/engineering/', label: 'SankiWork para ingeniería' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'Generador de páginas de aterrizaje con IA — del prompt a una página de aterrizaje que lanzas',
    description:
      'Un generador de páginas de aterrizaje con IA, gratuito y de código abierto, que convierte un prompt en una página de aterrizaje real y adaptable — y la lleva hasta el código listo para lanzar. SankiWork funciona dentro del agente de programación que ya usas, así que la página generada y la página desplegada son el mismo artefacto que es tuyo.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'La mayoría de los creadores de páginas de aterrizaje con IA encierran tu página dentro de su editor y la miden por licencia. SankiWork genera la página de aterrizaje dentro de tu agente de programación y la lleva del prompt al código listo para lanzar — secciones reales, tu marca, sin paso de exportación, sin medidor por licencia.',
    stepsTitle: 'Cómo funciona el generador de páginas de aterrizaje con IA',
    steps: [
      {
        title: 'Describe la página',
        body: 'Dile a tu agente qué construir en lenguaje sencillo — «una página de lanzamiento para una app de notas: hero, tres características, precios y un formulario de lista de espera». SankiWork carga la habilidad de página de aterrizaje para que el agente disponga secciones reales con una jerarquía clara.',
    ...
    tableTitle: 'SankiWork frente a los creadores de páginas de aterrizaje con IA habituales',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Páginas de aterrizaje creadas con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves de proveedor — no hay medidor por licencia ni por página sobre el generador de páginas de aterrizaje en sí.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tu próxima idea de lanzamiento en una página de aterrizaje real y adaptable — y luego en código listo para lanzar — en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Generador de UI con IA' },
      { href: '/solutions/design-to-code/', label: 'De diseño a código con SankiWork' },
  ...
  figmaToCode: {
    title: 'De Figma a código — convierte diseños de Figma en código listo para lanzar con SankiWork',
    description:
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'La mayoría de los plugins de Figma a código exportan una instantánea de una sola vez de marcado de posición absoluta que luego reescribes. SankiWork mantiene el diseño y el código como un solo artefacto vivo dentro de tu agente — trae los marcos a través del Figma MCP, itera hablando, lanza código que es tuyo.',
    stepsTitle: 'Cómo funciona de Figma a código',
    steps: [
      {
        title: 'Conecta Figma a tu agente',
        body: 'Con el Figma MCP configurado, tu agente de programación — Claude Code, Codex, Cursor Agent — puede leer un archivo de Figma o un marco seleccionado directamente. SankiWork carga la habilidad adecuada para que el agente convierta la intención de diseño en estructura, no una copia frágil píxel a píxel.',
    ...
    tableTitle: 'SankiWork frente a las herramientas de Figma a código habituales',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Lanzado desde Figma con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: '¿Cómo convierte SankiWork Figma en código?',
      ...
      {
        q: '¿Es gratuito?',
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves de proveedor — no hay medidor por licencia ni por exportación sobre el flujo de Figma a código en sí.',
      },
      {
        q: '¿Con qué agentes funciona?',
        a: 'SankiWork funciona con Claude Code, Codex, Cursor Agent, Gemini CLI y una docena más de adaptadores nativos. Usas tus propias claves de proveedor y tu propia configuración del Figma MCP; nada se aloja por ti.',
      },
    ],
    ctaTitle: 'Convierte tu próximo marco de Figma en código esta noche',
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork, conecta el Figma MCP y convierte tu próximo diseño de Figma en código limpio y listo para lanzar en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      { href: '/solutions/design-to-code/', label: 'De diseño a código con SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'Generador de UI con IA' },
  ...
  screenshotToCode: {
    title: 'De captura de pantalla a código — convierte una captura en código con SankiWork',
    description:
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'La mayoría de las herramientas de captura de pantalla a código escupen marcado de posición absoluta de una sola vez que luego reescribes. SankiWork reconstruye la captura dentro de tu agente de programación como código limpio y basado en componentes — estructura real, tu sistema de diseño, sin paso de exportación, sin medidor por licencia.',
    stepsTitle: 'Cómo funciona de captura de pantalla a código',
    steps: [
      {
        title: 'Suelta la captura de pantalla',
        body: 'Dale a tu agente una imagen de la pantalla que quieres — una captura de una app, un sitio web o un diseño. SankiWork carga la habilidad adecuada para que el agente lea el diseño y la intención, no solo los píxeles.',
    ...
    tableTitle: 'SankiWork frente a las herramientas de captura de pantalla a código habituales',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Reconstruido desde una captura de pantalla con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: '¿Cómo convierte SankiWork una captura de pantalla en código?',
        a: 'Le das a tu agente de programación una imagen de la pantalla y SankiWork carga la habilidad adecuada para que el agente la reconstruya como código limpio y basado en componentes — leyendo el diseño y la intención, no solo calcando píxeles.',
      },
      {
        q: '¿Qué tipo de código produce?',
      ...
      {
        q: '¿Es gratuito?',
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves de proveedor — no hay medidor por licencia ni por crédito sobre el flujo de captura de pantalla a código en sí.',
      },
      {
        q: '¿Con qué agentes funciona?',
        a: 'SankiWork funciona con Claude Code, Codex, Cursor Agent, Gemini CLI y una docena más de adaptadores nativos. Usas tus propias claves de proveedor; nada se aloja por ti.',
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte una captura de la pantalla que quieres en código limpio y listo para lanzar en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      { href: '/solutions/figma-to-code/', label: 'De Figma a código con SankiWork' },
      { href: '/solutions/design-to-code/', label: 'De diseño a código con SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'Generador de UI con IA' },
      { href: '/solutions/engineering/', label: 'SankiWork para ingeniería' },
    ],
  ...
  htmlToPpt: {
    title: 'De HTML a PPT — convierte HTML en un PowerPoint editable con SankiWork',
    description:
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'La mayoría de los conversores de HTML a PPT aplanan tu página en imágenes de diapositivas estáticas que no puedes editar. SankiWork construye la presentación como HTML dentro de tu agente de programación y exporta un .pptx real y editable — texto y formas nativos, tu sistema de diseño, sin medidor por licencia, sin dependencia del proveedor.',
    stepsTitle: 'Cómo funciona de HTML a PPT',
    steps: [
      {
        title: 'Empieza desde HTML, un documento o un prompt',
        body: 'Apunta tu agente a una página HTML, un documento markdown o simplemente describe la presentación. SankiWork carga la habilidad adecuada para que el agente lea la estructura y la intención — títulos, secciones, datos — no solo el marcado en bruto.',
      ...
      },
      {
        ...
        body: 'El pptx-generator de SankiWork convierte la presentación HTML en un PowerPoint real — formas nativas, texto editable y gráficos que aún puedes cambiar — con una auditoría de fidelidad de HTML-to-PPTX, no una imagen plana por diapositiva.',
    ...
    tableTitle: 'SankiWork frente a los conversores típicos de HTML a PPT',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryLead:
      'Presentaciones reales renderizadas por SankiWork, listas para exportar a un .pptx editable. Elige un tema cercano a tu contenido, describe tu variación y el agente construye la presentación — luego te entrega el PowerPoint que te pertenece.',
    gallery: [
    ...
    faq: [
      {
        q: '¿Cómo convierte SankiWork HTML en un PPT?',
        a: 'Tu agente de programación convierte el contenido en una presentación HTML limpia, luego la habilidad pptx-generator de SankiWork la exporta a un .pptx real y editable — formas y texto nativos, auditado para la fidelidad de HTML-to-PPTX, no una imagen plana por diapositiva.',
      },
      {
      ...
      {
        q: '¿Es gratis?',
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves — no hay medidor por archivo ni por crédito en el flujo de HTML a PPT.',
      },
      {
        q: '¿Cuál es la diferencia con generar diapositivas?',
        a: 'Generar una presentación normalmente parte de un prompt o un esquema; de HTML a PPT parte de HTML o markdown que ya tienes y se centra en la exportación editable a .pptx. Ambos usan el mismo motor de presentaciones de SankiWork — consulta el caso de uso de diapositivas para el flujo que empieza por el esquema.',
      },
    ],
    ctaTitle: 'Convierte tu próxima presentación HTML en un PPT editable',
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte HTML — o un prompt — en una presentación limpia y un .pptx real y editable, en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'La mayoría de los generadores de prototipos con IA (Figma, Cursor, Penpot) se detienen en una maqueta clicable que luego reconstruyes. SankiWork genera el prototipo dentro de tu agente de programación y lo lleva del prompt al código listo para lanzar — sin paso de exportación, sin brecha de entrega, sin medidor por licencia.',
    stepsTitle: 'Cómo funciona el generador de prototipos con IA',
    steps: [
      {
        title: 'Describe el flujo',
        body: 'Cuéntale a tu agente el recorrido en lenguaje natural — «un flujo de onboarding: registro, selector de plan y un panel». SankiWork carga la habilidad de prototipo para que el agente disponga pantallas enlazadas, no un solo marco estático.',
    ...
    tableTitle: 'SankiWork frente a los generadores de prototipos con IA habituales',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Prototipos creados con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sí. SankiWork es de código abierto y funciona dentro del agente de programación que ya usas con tus propias claves de proveedor — no hay medidor por licencia ni por crédito sobre el generador de prototipos en sí.',
      },
      {
        q: '¿En qué se diferencia de los generadores de prototipos de Figma, Cursor o Penpot?',
        a: 'Esos se detienen en una maqueta clicable dentro de su app. SankiWork genera el prototipo en tu agente de programación y lleva el mismo artefacto hasta el código listo para lanzar que es tuyo — sin exportación, sin reconstruir para producción.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tu próximo flujo en un prototipo clicable — y luego en código listo para lanzar — en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      { href: '/solutions/prototype/', label: 'Prototipado con SankiWork' },
      { href: '/solutions/ai-wireframe-generator/', label: 'Generador de wireframes con IA' },
  ...
  prototype: {
    title: 'Crea prototipos interactivos con SankiWork + Claude Code',
    description:
      'Convierte un prompt en un prototipo de varias pantallas y navegable sin salir de tu terminal. SankiWork dota a tu agente de programación de las habilidades de diseño, las plantillas y el sistema de diseño para entregar prototipos reales que puedes abrir en un navegador.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork es la capa de diseño para el agente de programación que ya usas. Para prototipar, eso significa pasar de una idea de un párrafo a un prototipo navegable y con estilo en una sola sesión — sin herramienta de diseño, sin paso de exportación, sin brecha de entrega.',
    stepsTitle: 'Cómo funciona prototipar con SankiWork',
    steps: [
      {
        title: 'Describe el flujo',
        body: 'Dile a tu agente qué estás construyendo en lenguaje sencillo — «un flujo de onboarding con una pantalla de bienvenida, un selector de planes y una confirmación». SankiWork carga la habilidad de prototipo para que el agente sepa que debe producir pantallas, no una sola página.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'El agente aplica un sistema de diseño y plantillas de prototipo de SankiWork, así cada pantalla comparte tipografía, espaciado y componentes en lugar de parecer un borrador. Obtienes un conjunto coherente de pantallas, no maquetas inconexas.',
        imageAlt:
    ...
    tableTitle: 'Prototipar con SankiWork frente al método tradicional',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Prototipos que la gente creó con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: '¿Necesito una herramienta de diseño como Figma para prototipar con SankiWork?',
        a: 'No. SankiWork funciona dentro de tu agente de programación y renderiza prototipos a HTML. Describes el flujo con palabras; el agente produce las pantallas. No hay una herramienta de lienzo aparte que aprender o pagar.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork funciona con Claude Code, Codex, Cursor Agent, Gemini CLI y una docena más de adaptadores nativos. Aportas tus propias claves de proveedor; nada se aloja por ti.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tu próximo «¿y si...?» en algo que puedas recorrer — en el agente que ya usas.',
  },
  dashboard: {
    title: 'Genera paneles de datos con SankiWork + Claude Code',
    description:
    ...
    lead: 'Dile a tu agente qué mostrar y cómo debe sentirse. SankiWork aporta los patrones de gráficos, el sistema de maquetación y el lenguaje visual para que obtengas un panel coherente y presentable — no un muro de widgets con estilos por defecto.',
    heroImageAlt:
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork convierte una especificación en lenguaje sencillo de tus métricas en un panel con estilo que tu agente renderiza a HTML — versionado en tu repositorio, alojable donde sea, sin suscripción de BI por licencia.',
    stepsTitle: 'Cómo funcionan los paneles con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork incluye plantillas de gráficos y maquetación, así las tendencias se vuelven gráficos de líneas, los desgloses se vuelven barras y los ratios la visualización adecuada — tipografía y espaciado consistentes en todo en lugar de valores por defecto dispares.',
    ...
    tableTitle: 'Paneles con SankiWork frente al método tradicional',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Paneles que la gente creó con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork renderiza paneles a HTML dentro de tu agente de programación. Describes las métricas y lo apuntas a tus datos; no hay una plataforma de BI aparte que licenciar o aprender.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tus métricas en un panel que puedas alojar donde sea — en el agente que ya usas.',
  },
  slides: {
    title: 'Genera presentaciones con SankiWork + Claude Code',
    description:
      'Convierte un esquema en una presentación diseñada y fiel a tu marca sin abrir una app de presentaciones. SankiWork da a tu agente de programación plantillas de diapositivas y un sistema visual, renderizando las diapositivas a HTML que puedes presentar, exportar o compartir.',
    breadcrumb: 'Diapositivas',
    label: 'Caso de uso · Diapositivas',
    heading: 'Presentaciones que parecen diseñadas, escritas con un prompt',
    lead: 'Entrega a tu agente un esquema y un tono. SankiWork aplica una plantilla de presentación y un sistema visual para que cada diapositiva quede maquetada, compuesta y fiel a tu marca — no una lista de viñetas sobre un fondo en blanco.',
    heroImageAlt:
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork convierte un esquema en una presentación HTML diseñada que tu agente renderiza en una sola sesión — preséntala en el navegador, expórtala a PDF o PPTX y guarda la fuente en tu repositorio.',
    stepsTitle: 'Cómo funcionan las presentaciones con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork incluye plantillas de presentación — editorial, suizo-internacional, técnico oscuro y más. El agente aplica una para que la tipografía, la cuadrícula y los acentos se mantengan consistentes en cada diapositiva.',
    ...
    tableTitle: 'Presentaciones con SankiWork frente al método tradicional',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Presentaciones que la gente creó con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork renderiza presentaciones a HTML dentro de tu agente de programación y puede exportar a PDF o PPTX. Presentas desde el navegador o entregas un archivo — no hace falta una app de presentaciones para crearla.',
      },
      {
      ...
      },
      {
        ...
        a: 'Sí. El pptx-generator de SankiWork exporta la presentación a un .pptx real con texto y formas nativos y editables — auditado para la fidelidad de HTML-to-PPTX, no imágenes de diapositivas planas — además de PDF y el HTML desde el que presentas. Consulta la herramienta de HTML a PPT para el flujo que empieza por la conversión.',
      },
      {
        q: '¿Qué agentes puedo usar?',
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte tu esquema en una presentación diseñada — en el agente que ya usas.',
    relatedTitle: 'Herramientas y guías relacionadas',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'De HTML a PPT con SankiWork' },
      { href: '/solutions/design-to-code/', label: 'De diseño a código con SankiWork' },
      { href: '/plugins/templates/', label: 'Explorar plantillas de presentación' },
      { href: '/solutions/marketing/', label: 'SankiWork para marketing' },
    ],
  ...
  image: {
    title: 'Genera gráficos fieles a tu marca con SankiWork + Claude Code',
    description:
    ...
    lead: 'Describe la tarjeta o portada que necesitas. SankiWork la compone con tipografía, cuadrícula y los colores de tu marca reales — luego la renderiza a HTML que puedes exportar como imagen, en vez de pelearte con una app de diseño o una plantilla genérica.',
    heroImageAlt:
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork convierte un prompt en un gráfico compuesto y fiel a tu marca que tu agente renderiza a HTML y exporta a PNG — repetible, versionado y libre de herramientas de diseño por licencia.',
    stepsTitle: 'Cómo funcionan los gráficos con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork toma tus colores, tipografía y espaciado de un sistema de diseño reutilizable, así cada tarjeta cuadra con el resto de tu marca en vez de parecer algo aislado.',
    ...
    tableTitle: 'Gráficos con SankiWork frente al método tradicional',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Gráficos que la gente creó con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork compone gráficos con maquetación y tipografía reales — tu titular, tu marca, dimensiones exactas — y los renderiza a HTML que exportas como PNG. Es composición de diseño, no generación de píxeles.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte un prompt en un gráfico fiel a tu marca — en el agente que ya usas.',
  },
  video: {
    title: 'Genera motion graphics y vídeo corto con SankiWork + Claude Code',
    description:
    ...
    lead: 'Describe el momento que quieres — una aparición de título, una animación de datos, un cierre con logo. SankiWork compone cuadros animados con tu sistema de marca y los renderiza a vídeo, sin suite de motion graphics.',
    heroImageAlt:
      'Ilustración editorial de un guion convirtiéndose en una secuencia de cuadros de vídeo animados',
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork convierte un guion en cuadros animados y fieles a tu marca que tu agente renderiza a vídeo de formato corto — compuestos desde HTML, versionados en tu repositorio, sin editor de línea de tiempo que aprender.',
    stepsTitle: 'Cómo funciona el movimiento con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork aporta plantillas de cuadro — fugas de luz cinematográficas, títulos con glitch, cierres con logo — y aplica tus colores y tipografía, así el movimiento se ve intencionado y fiel a la marca.',
    ...
    tableTitle: 'Movimiento con SankiWork frente al método tradicional',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Movimiento que la gente creó con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork compone cuadros animados en HTML y los renderiza a vídeo dentro de tu agente de programación. No hay editor de línea de tiempo que aprender ni que licenciar.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y convierte un guion en movimiento — en el agente que ya usas.',
  },
  designSystem: {
    title: 'Crea y aplica un sistema de diseño con SankiWork + Claude Code',
    description:
    ...
    lead: 'Define tu marca una vez y SankiWork la lleva a cada salida — prototipos, presentaciones, paneles, gráficos. El sistema vive en tu repositorio como un DESIGN.md que el agente lee, así la consistencia es automática, no manual.',
    heroImageAlt:
      'Ilustración editorial de un único sistema de diseño irradiando hacia muchos artefactos fieles a la marca',
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork captura tu marca como un sistema de diseño portátil que tu agente aplica a cada artefacto — definido una vez en tu repositorio, aplicado en todas partes, sin una herramienta de diseño central que haga de guardián.',
    stepsTitle: 'Cómo funcionan los sistemas de diseño con SankiWork',
    steps: [
      {
        title: 'Captura el sistema',
        body: 'Describe tu marca — colores, tipografía, espaciado, voz — o apunta el agente a un sitio existente para extraerla. SankiWork lo escribe en un DESIGN.md que vive en tu proyecto.',
      ...
      },
      {
        ...
        body: 'SankiWork incluye más de 140 sistemas de diseño de referencia — de Apple y Linear a editoriales y brutalistas. Haz un fork de uno cercano a tu marca en vez de empezar desde una página en blanco.',
    ...
    tableTitle: 'Sistemas de diseño con SankiWork frente al método tradicional',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Sistemas de diseño en SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Un archivo DESIGN.md en tu repositorio que captura colores, tipografía, espaciado, componentes y voz. Cada habilidad de SankiWork lo lee, así que tu marca se aplica automáticamente a lo que produzca el agente.',
      },
      {
        q: '¿Tengo que empezar desde cero?',
        a: 'No. SankiWork incluye más de 140 sistemas de diseño de referencia que puedes forkear — de Apple y Linear a editoriales y brutalistas — y luego adaptar a tu marca.',
      },
      {
    ...
    ctaBody:
      'Dale una estrella al repositorio, instala SankiWork y dale a tu agente una sola marca que aplicar en todas partes — en el agente que ya usas.',
  },
  roleSoloBuilder: {
    title: 'SankiWork para creadores en solitario e indie hackers',
    description:
      'Lanza como un equipo de una sola persona. SankiWork convierte tu agente de programación en la mitad de diseño de tu startup: prototipos, landing pages, dashboards y gráficos de marca, todo a partir de un prompt, todo dentro de la marca, todo en tu repositorio.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork es el departamento de diseño que un fundador en solitario nunca tuvo: del prompt al artefacto en cada superficie que tu producto necesita, dentro de una sola marca, sin traspasos y sin herramientas adicionales.',
    stepsTitle: 'Cómo usa SankiWork un creador en solitario',
    steps: [
      {
    ...
    tableTitle: 'Construir en solitario con SankiWork frente a hacerlo por las malas',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Construido en solitario con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Marca el repositorio con una estrella, instala SankiWork y deja que un agente sea tu equipo de diseño, dentro del agente que ya usas.',
  },
  roleDesigner: {
    title: 'SankiWork para diseñadores',
    description:
      'Dedica tu tiempo al criterio, no a la faena. SankiWork deja que tu agente se encargue del trabajo de producción repetitivo —variantes, estados, sistemas de diseño completos— mientras tú diriges el aspecto y tienes la última palabra.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork es el asistente de producción que nunca se cansa: tú defines el sistema de diseño y aplicas el criterio; el agente genera el resto, dentro del sistema, en tu repositorio.',
    stepsTitle: 'Cómo usa SankiWork un diseñador',
    steps: [
      {
    ...
    tableTitle: 'Diseñar con SankiWork frente a la forma manual',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Dirigido con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Marca el repositorio con una estrella, instala SankiWork y deja que el agente se encargue de la producción mientras tú aplicas el criterio, dentro del agente que ya usas.',
  },
  roleEngineering: {
    title: 'SankiWork para ingenieros',
    description:
      'Sáltate el traspaso de diseño. SankiWork convierte un DESIGN.md en front-end real que tu agente de programación escribe directamente: UI dentro del sistema, prototipos y dashboards, en el repositorio, sin viajes de ida y vuelta a Figma.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork cierra la brecha de diseñador a ingeniero haciendo legible por máquina el sistema de diseño: el mismo agente que escribe tu código aplica el sistema y renderiza UI real.',
    stepsTitle: 'Cómo usa SankiWork un ingeniero',
    steps: [
      {
    ...
    tableTitle: 'Front-end con SankiWork frente a la vía del traspaso',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Construido por ingenieros con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Marca el repositorio con una estrella, instala SankiWork y convierte un DESIGN.md en front-end, dentro del agente que ya usas.',
  },
  roleProductManagers: {
    title: 'SankiWork para product managers',
    description:
      'Deja de esperar al ancho de banda de diseño para comunicar una idea. SankiWork permite a un PM convertir un prompt en un prototipo navegable o un wireframe, para alinear a las partes interesadas e informar al equipo, sin un ticket de diseño.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork le da a un PM una forma sin diseño de hacer tangibles las ideas: del prompt al prototipo para alinear e informar, sin gastar el presupuesto de diseño del equipo.',
    stepsTitle: 'Cómo usa SankiWork un PM',
    steps: [
      {
        title: 'Describe el flujo',
    ...
    tableTitle: 'Trabajo de PM con SankiWork frente a esperar a diseño',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Prototipado por PMs con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Marca el repositorio con una estrella, instala SankiWork y convierte tu próxima especificación en algo en lo que la gente pueda hacer clic, dentro del agente que ya usas.',
  },
  roleMarketing: {
    title: 'SankiWork para equipos de marketing',
    description:
      'Lanza campañas a velocidad de contenido. SankiWork permite a tu agente producir landing pages, tarjetas para redes y visuales de campaña a partir de un prompt: dentro de la marca, bajo demanda, sin hacer cola en diseño.',
    ...
    tldrTitle: 'En una línea',
    tldrBody:
      'SankiWork es el recurso de diseño siempre disponible para marketing: del prompt al activo para landing pages y redes, dentro de la marca, para que las campañas salgan a la velocidad a la que escribes el copy.',
    stepsTitle: 'Cómo usa SankiWork un equipo de marketing',
    steps: [
      {
        title: 'Fija la marca',
    ...
    tableTitle: 'Marketing con SankiWork frente al apuro de siempre',
    tableColCapability: 'Lo que necesitas',
    tableColWithOd: 'Con SankiWork',
    tableColWithout: 'Sin él hoy',
    tableRows: [
    ...
    galleryTitle: 'Lanzado por marketing con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Marca el repositorio con una estrella, instala SankiWork y convierte los briefs en activos dentro de la marca, dentro del agente que ya usas.',
  },
};
