...
export const DE: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'KI-Wireframe-Generator — vom Prompt zum Wireframe mit SankiWork',
    description:
      'Ein kostenloser, quelloffener KI-Wireframe-Generator, der einen Prompt in bearbeitbare Multi-Screen-Wireframes verwandelt — und sie den ganzen Weg bis zum ausgelieferten Code bringt. SankiWork läuft in dem Coding-Agent, den du bereits nutzt, sodass das Wireframe und das echte Produkt eine Quelle teilen.',
    ...
    tldrBody:
      'Die meisten KI-Wireframe-Generatoren reichen dir ein Bild, das du später neu baust. SankiWork generiert das Wireframe in deinem Coding-Agent und trägt es vom Prompt bis zum ausgelieferten Code — kein Export-Schritt, keine Übergabelücke, kein Zähler pro Platz.',
    stepsTitle: 'So funktioniert der KI-Wireframe-Generator',
    steps: [
      {
        title: 'Beschreibe den Screen',
        body: 'Sag deinem Agent in klarer Sprache, was du als Wireframe willst — "ein Dashboard mit Seitenleiste, einer Statistik-Zeile und einer Tabelle der letzten Aktivitäten." SankiWork lädt die Wireframe-Fähigkeit, sodass der Agent Struktur und Hierarchie anlegt, nicht nur ein einzelnes statisches Bild.',
    ...
    tableTitle: 'SankiWork vs. typische KI-Wireframe-Generatoren',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Mit SankiWork gebaute Wireframes',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Ja. SankiWork ist quelloffen und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Anbieter-Schlüsseln — es gibt keinen Zähler pro Platz oder pro Credit für den Wireframe-Generator selbst.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork funktioniert mit Claude Code, Codex, Cursor Agent, Gemini CLI und einem Dutzend weiterer hauseigener Adapter. Du bringst deine eigenen Anbieter-Schlüssel mit; nichts wird für dich gehostet.',
      },
    ],
    ctaTitle: 'Generiere dein erstes Wireframe noch heute Abend',
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deine nächste Screen-Idee in ein bearbeitbares Wireframe — und dann in ausgelieferten Code — im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'KI-UI-Generator' },
      { href: '/solutions/design-to-code/', label: 'Design zu Code mit SankiWork' },
      { href: '/blog/design-to-code-tools/', label: 'Beste Design-zu-Code-Tools' },
      { href: '/solutions/prototype/', label: 'Prototyping mit SankiWork' },
    ],
  },
  aiUiGenerator: {
    title: 'KI-UI-Generator — vom Prompt zur produktionsreifen UI mit SankiWork',
    description:
      'Ein kostenloser, quelloffener KI-UI-Generator, der einen Prompt in eine echte, komponentenbasierte Oberfläche verwandelt — und sie den ganzen Weg bis zum ausgelieferten Code bringt. SankiWork läuft in dem Coding-Agent, den du bereits nutzt, sodass die generierte UI und der Produktionscode dasselbe Artefakt sind.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Die meisten KI-UI-Generatoren geben dir ein Mockup oder ein wegwerfbares React-Snippet. SankiWork generiert die UI in deinem Coding-Agent und trägt sie vom Prompt bis zum ausgelieferten Code — echte Komponenten, dein Designsystem, kein Export-Schritt, kein Zähler pro Platz.',
    stepsTitle: 'So funktioniert der KI-UI-Generator',
    steps: [
      {
        title: 'Beschreibe die Oberfläche',
        body: 'Sag deinem Agent in klarer Sprache, was er bauen soll — "eine Einstellungsseite mit Seitenleiste, Tab-Abschnitten und einer Speicherleiste." SankiWork lädt die UI-Fähigkeit, sodass der Agent zu echten Komponenten und einem Designsystem greift, nicht zu einem Einzel-Screen.',
    ...
    tableTitle: 'SankiWork vs. typische KI-UI-Generatoren',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Mit SankiWork gebaute UI',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Ja. SankiWork ist quelloffen und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Anbieter-Schlüsseln — es gibt keinen Zähler pro Platz oder pro Credit für den UI-Generator selbst.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deine nächste Oberflächen-Idee in eine echte, komponentenbasierte UI — und dann in ausgelieferten Code — im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      ...
      { href: '/solutions/designer/', label: 'SankiWork für Designer' },
    ],
  },
  designToCode: {
    title: 'Design zu Code — ein Design mit SankiWork in ausgelieferten Code verwandeln',
    description:
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Die meisten Design-zu-Code-Tools exportieren eine einmalige Momentaufnahme, die du dann hütest. SankiWork hält das Design und den Code als ein lebendiges Artefakt in deinem Agent — iteriere im Gespräch, liefere Code aus, der dir gehört, kein Zähler pro Platz.',
    stepsTitle: 'So funktioniert Design zu Code',
    steps: [
      {
        title: 'Starte von einem Prompt oder einem Design',
        body: 'Beschreibe den Screen in klarer Sprache oder weise deinen Agent auf eine Design-Richtung. SankiWork lädt die passende Fähigkeit, sodass der Agent Struktur und Komponenten baut, keine brüchige Einmal-Umwandlung.',
    ...
    tableTitle: 'SankiWork vs. typische Design-zu-Code-Tools',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Aus Design mit SankiWork ausgeliefert',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Ja. SankiWork ist quelloffen und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Anbieter-Schlüsseln — es gibt keinen Zähler pro Platz oder pro Credit für den Design-zu-Code-Workflow selbst.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deinen nächsten Screen — Prompt, Wireframe oder Design — in sauberen, auslieferbaren Code im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'KI-Wireframe-Generator' },
      { href: '/solutions/ai-ui-generator/', label: 'KI-UI-Generator' },
      { href: '/blog/design-to-code-tools/', label: 'Beste Design-zu-Code-Tools' },
      { href: '/solutions/engineering/', label: 'SankiWork für Engineering' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'KI-Landingpage-Generator — vom Prompt zu einer Landingpage, die du auslieferst',
    description:
      'Ein kostenloser, quelloffener KI-Landingpage-Generator, der einen Prompt in eine echte, responsive Landingpage verwandelt — und sie den ganzen Weg bis zum ausgelieferten Code bringt. SankiWork läuft in dem Coding-Agent, den du bereits nutzt, sodass die generierte Seite und die veröffentlichte Seite dasselbe Artefakt sind, das dir gehört.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Die meisten KI-Landingpage-Builder sperren deine Seite in ihren Editor und rechnen pro Platz ab. SankiWork generiert die Landingpage in deinem Coding-Agent und trägt sie vom Prompt bis zum ausgelieferten Code — echte Abschnitte, deine Marke, kein Export-Schritt, kein Zähler pro Platz.',
    stepsTitle: 'So funktioniert der KI-Landingpage-Generator',
    steps: [
      {
        title: 'Beschreibe die Seite',
        body: 'Sag deinem Agent in klarer Sprache, was er bauen soll — "eine Launch-Seite für eine Notiz-App: Hero, drei Features, Preise und ein Warteliste-Formular." SankiWork lädt die Landingpage-Fähigkeit, sodass der Agent echte Abschnitte mit klarer Hierarchie anlegt.',
    ...
    tableTitle: 'SankiWork vs. typische KI-Landingpage-Builder',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Mit SankiWork gebaute Landingpages',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Ja. SankiWork ist quelloffen und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Anbieter-Schlüsseln — es gibt keinen Zähler pro Platz oder pro Seite für den Landingpage-Generator selbst.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deine nächste Launch-Idee in eine echte, responsive Landingpage — und dann in ausgelieferten Code — im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'KI-UI-Generator' },
      { href: '/solutions/design-to-code/', label: 'Design zu Code mit SankiWork' },
      { href: '/solutions/marketing/', label: 'SankiWork für Marketing' },
      { href: '/blog/best-ai-design-tools/', label: 'Beste KI-Design-Tools' },
    ],
  },
  figmaToCode: {
    title: 'Figma zu Code — Figma-Designs mit SankiWork in ausgelieferten Code verwandeln',
    description:
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Die meisten Figma-zu-Code-Plugins exportieren eine einmalige Momentaufnahme aus absolut positioniertem Markup, das du dann neu schreibst. SankiWork hält das Design und den Code als ein lebendiges Artefakt in deinem Agent — zieh Frames über das Figma MCP heran, iteriere im Gespräch, liefere Code aus, der dir gehört.',
    stepsTitle: 'So funktioniert Figma zu Code',
    steps: [
      {
        title: 'Verbinde Figma mit deinem Agent',
        body: 'Ist das Figma MCP eingerichtet, kann dein Coding-Agent — Claude Code, Codex, Cursor Agent — eine Figma-Datei oder einen ausgewählten Frame direkt lesen. SankiWork lädt die passende Fähigkeit, sodass der Agent die Design-Absicht in Struktur verwandelt, keine brüchige Pixel-Kopie.',
    ...
    tableTitle: 'SankiWork vs. typische Figma-zu-Code-Tools',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Aus Figma mit SankiWork ausgeliefert',
    galleryLead:
    ...
    faq: [
      {
        q: 'Wie verwandelt SankiWork Figma in Code?',
      ...
      {
        q: 'Ist es kostenlos?',
        a: 'Ja. SankiWork ist quelloffen und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Anbieter-Schlüsseln — es gibt keinen Zähler pro Platz oder pro Export für den Figma-zu-Code-Workflow selbst.',
      },
      {
        q: 'Mit welchen Agents funktioniert es?',
        a: 'SankiWork funktioniert mit Claude Code, Codex, Cursor Agent, Gemini CLI und einem Dutzend weiterer hauseigener Adapter. Du bringst deine eigenen Anbieter-Schlüssel und dein eigenes Figma-MCP-Setup mit; nichts wird für dich gehostet.',
      },
    ],
    ctaTitle: 'Verwandle deinen nächsten Figma-Frame noch heute Abend in Code',
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork, verbinde das Figma MCP und verwandle dein nächstes Figma-Design in sauberen, auslieferbaren Code im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      { href: '/solutions/design-to-code/', label: 'Design zu Code mit SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'KI-UI-Generator' },
      { href: '/agents/claude-code-design/', label: 'SankiWork für Claude Code' },
      { href: '/solutions/engineering/', label: 'SankiWork für Engineering' },
    ],
  },
  screenshotToCode: {
    title: 'Screenshot zu Code — einen Screenshot mit SankiWork in Code verwandeln',
    description:
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Die meisten Screenshot-zu-Code-Tools spucken einmaliges, absolut positioniertes Markup aus, das du dann neu schreibst. SankiWork baut den Screenshot in deinem Coding-Agent als sauberen, komponentenbasierten Code neu — echte Struktur, dein Designsystem, kein Export-Schritt, kein Zähler pro Platz.',
    stepsTitle: 'So funktioniert Screenshot zu Code',
    steps: [
      {
        title: 'Leg den Screenshot ab',
        body: 'Gib deinem Agent ein Bild des Screens, den du willst — einen Screenshot einer App, einer Website oder eines Designs. SankiWork lädt die passende Fähigkeit, sodass der Agent das Layout und die Absicht liest, nicht nur die Pixel.',
    ...
    tableTitle: 'SankiWork vs. typische Screenshot-zu-Code-Tools',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Aus einem Screenshot mit SankiWork neu gebaut',
    galleryLead:
    ...
    faq: [
      {
        q: 'Wie verwandelt SankiWork einen Screenshot in Code?',
        a: 'Du gibst deinem Coding-Agent ein Bild des Screens, und SankiWork lädt die passende Fähigkeit, sodass der Agent es als sauberen, komponentenbasierten Code neu baut — es liest Layout und Absicht, statt nur Pixel nachzuzeichnen.',
      },
      {
        q: 'Welche Art von Code erzeugt es?',
      ...
      {
        q: 'Ist es kostenlos?',
        a: 'Ja. SankiWork ist quelloffen und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Anbieter-Schlüsseln — es gibt keinen Zähler pro Platz oder pro Credit für den Screenshot-zu-Code-Workflow selbst.',
      },
      {
        q: 'Mit welchen Agents funktioniert es?',
        a: 'SankiWork funktioniert mit Claude Code, Codex, Cursor Agent, Gemini CLI und einem Dutzend weiterer hauseigener Adapter. Du bringst deine eigenen Anbieter-Schlüssel mit; nichts wird für dich gehostet.',
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle einen Screenshot des Screens, den du willst, in sauberen, auslieferbaren Code im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      { href: '/solutions/figma-to-code/', label: 'Figma zu Code mit SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Design zu Code mit SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'KI-UI-Generator' },
      { href: '/solutions/engineering/', label: 'SankiWork für Engineering' },
    ],
  ...
  htmlToPpt: {
    title: 'HTML to PPT — HTML mit SankiWork in ein bearbeitbares PowerPoint verwandeln',
    description:
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Die meisten HTML-to-PPT-Konverter flachen deine Seite in statische Slide-Bilder ab, die du nicht bearbeiten kannst. SankiWork baut das Deck als HTML in deinem Coding-Agent und exportiert ein echtes, bearbeitbares .pptx — nativer Text und Formen, dein Designsystem, keine Pro-Sitz-Gebühr, kein Vendor-Lock.',
    stepsTitle: 'So funktioniert HTML to PPT',
    steps: [
      {
        title: 'Starte von HTML, einem Dokument oder einem Prompt',
        body: 'Richte deinen Agent auf eine HTML-Seite, ein markdown-Dokument oder beschreibe einfach das Deck. SankiWork lädt die passende Skill, sodass der Agent Struktur und Absicht liest — Überschriften, Abschnitte, Daten — nicht nur rohes Markup.',
      ...
      },
      {
        ...
        body: 'Der pptx-generator von SankiWork verwandelt das HTML-Deck in ein echtes PowerPoint — native Formen, bearbeitbarer Text und Diagramme, die du weiterhin ändern kannst — mit einer HTML-to-PPTX-Treueprüfung, kein flaches Bild pro Slide.',
    ...
    tableTitle: 'SankiWork vs. typische HTML-to-PPT-Konverter',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryLead:
      'Echte Decks, gerendert von SankiWork, bereit zum Export in ein bearbeitbares .pptx. Wähle ein Theme, das deinem Inhalt nahekommt, beschreibe deine Variante, und der Agent baut das Deck — dann übergibt er dir das PowerPoint, das dir gehört.',
    gallery: [
    ...
    faq: [
      {
        q: 'Wie verwandelt SankiWork HTML in ein PPT?',
        a: 'Dein Coding-Agent baut die Inhalte in ein sauberes HTML-Deck, dann exportiert die pptx-generator-Skill von SankiWork es in ein echtes, bearbeitbares .pptx — native Formen und Text, auf HTML-to-PPTX-Treue geprüft, kein flaches Bild pro Slide.',
      },
      {
      ...
      {
        q: 'Ist es kostenlos?',
        a: 'Ja. SankiWork ist Open Source und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Schlüsseln — es gibt keine Pro-Datei- oder Pro-Credit-Gebühr für den HTML-to-PPT-Workflow.',
      },
      {
        q: 'Was ist der Unterschied zum Generieren von Slides?',
        a: 'Ein Deck zu generieren startet meist von einem Prompt oder einer Gliederung; HTML to PPT startet von HTML oder markdown, das du bereits hast, und konzentriert sich auf den bearbeitbaren .pptx-Export. Beide nutzen dieselbe Deck-Engine von SankiWork — siehe den Slides-Anwendungsfall für den gliederungsorientierten Ablauf.',
      },
    ],
    ctaTitle: 'Verwandle dein nächstes HTML-Deck in ein bearbeitbares PPT',
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle HTML — oder einen Prompt — in ein sauberes Deck und ein echtes, bearbeitbares .pptx, im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'Die meisten KI-Prototyp-Generatoren (Figma, Cursor, Penpot) hören bei einem klickbaren Mockup auf, das du dann neu baust. SankiWork generiert den Prototyp in deinem Coding-Agent und trägt ihn vom Prompt bis zum ausgelieferten Code — kein Export-Schritt, keine Übergabelücke, kein Zähler pro Platz.',
    stepsTitle: 'So funktioniert der KI-Prototyp-Generator',
    steps: [
      {
        title: 'Beschreibe den Flow',
        body: 'Erzähl deinem Agent die Reise in einfacher Sprache — "ein Onboarding-Flow: Registrierung, Plan-Auswahl und ein Dashboard." SankiWork lädt die Prototyp-Fähigkeit, sodass der Agent verlinkte Screens auslegt, keinen einzelnen statischen Frame.',
    ...
    tableTitle: 'SankiWork vs. typische KI-Prototyp-Generatoren',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Mit SankiWork gebaute Prototypen',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Ja. SankiWork ist quelloffen und läuft in dem Coding-Agent, den du bereits nutzt, mit deinen eigenen Anbieter-Schlüsseln — es gibt keinen Zähler pro Platz oder pro Credit für den Prototyp-Generator selbst.',
      },
      {
        q: 'Wie unterscheidet er sich von den Prototyp-Generatoren von Figma, Cursor oder Penpot?',
        a: 'Diese hören bei einem klickbaren Mockup in ihrer App auf. SankiWork generiert den Prototyp in deinem Coding-Agent und trägt dasselbe Artefakt den ganzen Weg bis zum ausgelieferten Code, der dir gehört — kein Export, kein Neubau für die Produktion.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deinen nächsten Flow in einen klickbaren Prototyp — und dann in ausgelieferten Code — im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      { href: '/solutions/prototype/', label: 'Prototyping mit SankiWork' },
      { href: '/solutions/ai-wireframe-generator/', label: 'KI-Wireframe-Generator' },
  ...
  prototype: {
    title: 'Interaktive Prototypen mit SankiWork + Claude Code bauen',
    description:
      'Verwandle einen Prompt in einen klickbaren Multi-Screen-Prototypen, ohne dein Terminal zu verlassen. SankiWork gibt deinem Coding-Agent die Design-Fähigkeiten, Vorlagen und das Designsystem, um echte Prototypen auszuliefern, die du im Browser öffnen kannst.',
    breadcrumb: 'Prototyp',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork ist die Design-Ebene für den Coding-Agent, den du bereits nutzt. Fürs Prototyping heißt das: von einer Idee in einem Absatz zu einem navigierbaren, gestalteten Prototypen in einer einzigen Session — kein Design-Tool, kein Export-Schritt, keine Übergabelücke.',
    stepsTitle: 'So funktioniert Prototyping mit SankiWork',
    steps: [
      {
        title: 'Beschreibe den Flow',
        body: 'Sag deinem Agent in klarer Sprache, was du baust — "ein Onboarding-Flow mit Willkommens-Screen, Tarifauswahl und Bestätigung." SankiWork lädt die Prototyp-Fähigkeit, damit der Agent weiß, dass er Screens produzieren soll, nicht eine einzelne Seite.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'Der Agent wendet ein Designsystem und Prototyp-Vorlagen von SankiWork an, sodass jeder Screen Typografie, Abstände und Komponenten teilt, statt wie ein grober Entwurf auszusehen. Du bekommst ein zusammenhängendes Set von Screens, keine zusammenhanglosen Mockups.',
        imageAlt:
    ...
    tableTitle: 'Prototyping mit SankiWork vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Prototypen, die Menschen mit SankiWork gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        q: 'Brauche ich ein Design-Tool wie Figma, um mit SankiWork zu prototypisieren?',
        a: 'Nein. SankiWork läuft in deinem Coding-Agent und rendert Prototypen als HTML. Du beschreibst den Flow in Sprache; der Agent produziert die Screens. Es gibt kein separates Canvas-Tool zu lernen oder zu bezahlen.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle dein nächstes "Was wäre wenn" in etwas Klickbares — im Agent, den du bereits nutzt.',
  },
  dashboard: {
    title: 'Daten-Dashboards mit SankiWork + Claude Code erstellen',
    description:
    ...
    lead: 'Sag deinem Agent, was er zeigen soll und wie es wirken soll. SankiWork liefert die Diagrammmuster, das Layoutsystem und die visuelle Sprache, sodass du ein zusammenhängendes, vorzeigbares Dashboard bekommst — keine Wand aus Widgets im Standardstil.',
    heroImageAlt:
      'Redaktionelle Illustration: rohe Zahlen links fließen in ein sauberes Dashboard aus Diagrammen und KPI-Karten rechts',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork verwandelt eine in klarer Sprache verfasste Spezifikation deiner Kennzahlen in ein gestaltetes Dashboard, das dein Agent als HTML rendert — versioniert in deinem Repo, überall hostbar, ohne BI-Abo pro Platz.',
    stepsTitle: 'So funktionieren Dashboards mit SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork liefert Diagramm- und Layout-Vorlagen, sodass Trends zu Liniendiagrammen, Aufschlüsselungen zu Balken und Verhältnisse zur richtigen Visualisierung werden — durchgängig einheitliche Typografie und Abstände statt nicht zusammenpassender Standards.',
    ...
    tableTitle: 'Dashboards mit SankiWork vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Dashboards, die Menschen mit SankiWork gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. SankiWork rendert Dashboards als HTML in deinem Coding-Agent. Du beschreibst die Kennzahlen und richtest es auf deine Daten; es gibt keine separate BI-Plattform zu lizenzieren oder zu lernen.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deine Kennzahlen in ein Dashboard, das du überall hosten kannst — im Agent, den du bereits nutzt.',
  },
  slides: {
    title: 'Präsentations-Decks mit SankiWork + Claude Code erstellen',
    description:
      'Verwandle eine Gliederung in ein gestaltetes, markengerechtes Slide-Deck, ohne eine Präsentations-App zu öffnen. SankiWork gibt deinem Coding-Agent Deck-Vorlagen und ein visuelles System und rendert Slides als HTML, das du präsentieren, exportieren oder teilen kannst.',
    breadcrumb: 'Slides',
    label: 'Anwendungsfall · Slides',
    heading: 'Decks, die gestaltet aussehen, von einem Prompt geschrieben',
    lead: 'Gib deinem Agent eine Gliederung und einen Ton. SankiWork wendet eine Deck-Vorlage und ein visuelles System an, sodass jede Slide angeordnet, gesetzt und markengerecht ist — keine Aufzählung auf leerem Hintergrund.',
    heroImageAlt:
      'Redaktionelle Illustration: eine Gliederung links verwandelt sich in eine Folge gestalteter Präsentations-Slides rechts',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork verwandelt eine Gliederung in ein gestaltetes HTML-Deck, das dein Agent in einer Session rendert — präsentiere es im Browser, exportiere nach PDF oder PPTX und behalte die Quelle in deinem Repo.',
    stepsTitle: 'So funktionieren Decks mit SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork liefert Deck-Vorlagen — redaktionell, Swiss-International, dunkel-technisch und mehr. Der Agent wendet eine an, sodass Typografie, Raster und Akzente über jede Slide hinweg einheitlich bleiben.',
    ...
    tableTitle: 'Decks mit SankiWork vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Decks, die Menschen mit SankiWork gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. SankiWork rendert Decks als HTML in deinem Coding-Agent und kann nach PDF oder PPTX exportieren. Du präsentierst aus dem Browser oder übergibst eine Datei — keine Präsentations-App nötig, um es zu bauen.',
      },
      {
      ...
      },
      {
        ...
        a: 'Ja. Der pptx-generator von SankiWork exportiert das Deck in ein echtes .pptx mit nativem, bearbeitbarem Text und Formen — auf HTML-to-PPTX-Treue geprüft, keine flachen Slide-Bilder — plus PDF und das HTML, aus dem du präsentierst. Sieh dir das HTML to PPT tool für den konvertierungsorientierten Ablauf an.',
      },
      {
        q: 'Welche Agents kann ich nutzen?',
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deine Gliederung in ein gestaltetes Deck — im Agent, den du bereits nutzt.',
    relatedTitle: 'Verwandte Tools & Guides',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'HTML zu PPT mit SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Design zu Code mit SankiWork' },
      { href: '/plugins/templates/', label: 'Deck-Vorlagen durchsuchen' },
      { href: '/solutions/marketing/', label: 'SankiWork für Marketing' },
    ],
  ...
  image: {
    title: 'Markengerechte Grafiken mit SankiWork + Claude Code erstellen',
    description:
    ...
    lead: 'Beschreibe die Card oder das Cover, das du brauchst. SankiWork komponiert es mit echter Schrift, Raster und deinen Markenfarben — und rendert dann zu HTML, das du als Bild exportierst, statt mit einer Design-App oder einer generischen Vorlage zu ringen.',
    heroImageAlt:
      'Redaktionelle Illustration: ein Prompt verwandelt sich in ein Set angeordneter Social-Cards und Artikel-Cover',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork verwandelt einen Prompt in eine gesetzte, markengerechte Grafik, die dein Agent als HTML rendert und nach PNG exportiert — wiederholbar, versioniert und frei von Design-Tools pro Platz.',
    stepsTitle: 'So funktionieren Grafiken mit SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork zieht deine Farben, Schrift und Abstände aus einem wiederverwendbaren Designsystem, sodass jede Card zum Rest deiner Marke passt, statt wie ein Einzelstück auszusehen.',
    ...
    tableTitle: 'Grafiken mit SankiWork vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Grafiken, die Menschen mit SankiWork gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. SankiWork komponiert Grafiken mit echtem Layout und echter Typografie — deine Schlagzeile, deine Marke, exakte Maße — und rendert zu HTML, das du als PNG exportierst. Es ist Design-Komposition, keine Pixel-Generierung.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle einen Prompt in eine markengerechte Grafik — im Agent, den du bereits nutzt.',
  },
  video: {
    title: 'Motion-Grafiken & Kurzvideos mit SankiWork + Claude Code erstellen',
    description:
    ...
    lead: 'Beschreibe den Moment, den du willst — ein Titel-Reveal, eine Daten-Animation, ein Logo-Outro. SankiWork komponiert animierte Frames mit deinem Markensystem und rendert sie zu Video, keine Motion-Graphics-Suite nötig.',
    heroImageAlt:
      'Redaktionelle Illustration: ein Skript verwandelt sich in eine Folge animierter Video-Frames',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork verwandelt ein Skript in animierte, markengerechte Frames, die dein Agent zu Kurzvideo rendert — aus HTML komponiert, in deinem Repo versioniert, ohne Timeline-Editor zu lernen.',
    stepsTitle: 'So funktioniert Motion mit SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork liefert Frame-Vorlagen — filmische Light-Leaks, Glitch-Titel, Logo-Outros — und wendet deine Farben und Schrift an, sodass die Bewegung gewollt und markengerecht wirkt.',
    ...
    tableTitle: 'Motion mit SankiWork vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Motion, die Menschen mit SankiWork gebaut haben',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nein. SankiWork komponiert animierte Frames in HTML und rendert sie zu Video in deinem Coding-Agent. Es gibt keinen Timeline-Editor zu lernen oder zu lizenzieren.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle ein Skript in Motion — im Agent, den du bereits nutzt.',
  },
  designSystem: {
    title: 'Ein Designsystem mit SankiWork + Claude Code bauen und anwenden',
    description:
    ...
    lead: 'Definiere deine Marke einmal, und SankiWork trägt sie in jede Ausgabe — Prototypen, Decks, Dashboards, Grafiken. Das System liegt in deinem Repo als DESIGN.md, die der Agent liest, sodass Konsistenz automatisch entsteht, nicht von Hand.',
    heroImageAlt:
      'Redaktionelle Illustration eines einzelnen Designsystems, das in viele markengerechte Artefakte ausstrahlt',
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork erfasst deine Marke als portables Designsystem, das dein Agent auf jedes Artefakt anwendet — einmal in deinem Repo definiert, überall durchgesetzt, ohne zentrales Design-Tool, das den Zugang kontrolliert.',
    stepsTitle: 'So funktionieren Designsysteme mit SankiWork',
    steps: [
      {
        title: 'Erfasse das System',
        body: 'Beschreibe deine Marke — Farben, Schrift, Abstände, Stimme — oder richte den Agent auf eine bestehende Website, um sie zu extrahieren. SankiWork schreibt sie in eine DESIGN.md, die in deinem Projekt liegt.',
      ...
      },
      {
        ...
        body: 'SankiWork liefert über 140 Referenz-Designsysteme — von Apple und Linear bis redaktionell und brutalistisch. Forke eines nahe deiner Marke, statt von einer leeren Seite zu starten.',
    ...
    tableTitle: 'Designsysteme mit SankiWork vs. die alte Art',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Designsysteme in SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Eine DESIGN.md-Datei in deinem Repo, die Farben, Schrift, Abstände, Komponenten und Stimme erfasst. Jede SankiWork-Fähigkeit liest sie, sodass deine Marke automatisch auf alles angewendet wird, was der Agent produziert.',
      },
      {
        q: 'Muss ich bei null anfangen?',
        a: 'Nein. SankiWork liefert über 140 Referenz-Designsysteme, die du forken kannst — von Apple und Linear bis redaktionell und brutalistisch — und dann an deine Marke anpasst.',
      },
      {
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und gib deinem Agent eine Marke, die er überall anwendet — im Agent, den du bereits nutzt.',
  },
  roleSoloBuilder: {
    title: 'SankiWork für Solo-Builder und Indie-Hacker',
    description:
      'Liefere wie ein Ein-Personen-Team. SankiWork macht aus deinem Coding-Agenten die Design-Hälfte deines Start-ups – Prototypen, Landingpages, Dashboards und Brand-Visuals, alles aus einem Prompt, alles markenkonform, alles in deinem Repo.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork ist die Designabteilung, die ein Solo-Gründer nie hatte: vom Prompt zum Artefakt über jede Fläche, die dein Produkt braucht, in einer Marke, ohne Übergabe und ohne zusätzliche Tools.',
    stepsTitle: 'So nutzt ein Solo-Builder SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Solo bauen mit SankiWork vs. den harten Weg gehen',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Solo gebaut mit SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und lass einen Agenten dein Design-Team sein – in dem Agenten, den du ohnehin nutzt.',
  },
  roleDesigner: {
    title: 'SankiWork für Designer',
    description:
      'Verbring deine Zeit mit Geschmack, nicht mit Fleißarbeit. SankiWork lässt deinen Agenten die repetitive Produktionsarbeit erledigen – Varianten, Zustände, ganze Designsysteme – während du den Look führst und das letzte Wort behältst.',
    breadcrumb: 'Designer',
    label: 'Für · Designer',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork ist die Produktionsassistenz, die nie ermüdet: Du definierst das Designsystem und bringst den Geschmack ein; der Agent erzeugt den Rest, systemkonform, in deinem Repo.',
    stepsTitle: 'So nutzt ein Designer SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Gestalten mit SankiWork vs. der manuelle Weg',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Geführt mit SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und lass den Agenten die Produktion erledigen, während du den Geschmack bestimmst – in dem Agenten, den du ohnehin nutzt.',
  },
  roleEngineering: {
    title: 'SankiWork für Engineers',
    description:
      'Überspring die Design-Übergabe. SankiWork verwandelt eine DESIGN.md in echtes Frontend, das dein Coding-Agent direkt schreibt – systemkonforme UI, Prototypen und Dashboards, im Repo, ohne Figma-Hin-und-Her.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork schließt die Lücke zwischen Designer und Engineer, indem es das Designsystem maschinenlesbar macht: Derselbe Agent, der deinen Code schreibt, wendet das System an und rendert echte UI.',
    stepsTitle: 'So nutzt ein Engineer SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Frontend mit SankiWork vs. der Übergabeweg',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Von Engineers gebaut mit SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle eine DESIGN.md in Frontend – in dem Agenten, den du ohnehin nutzt.',
  },
  roleProductManagers: {
    title: 'SankiWork für Produktmanager',
    description:
      'Warte nicht länger auf Design-Kapazität, um eine Idee zu vermitteln. SankiWork lässt einen PM aus einem Prompt einen klickbaren Prototyp oder Wireframe machen – um Stakeholder auszurichten und das Team zu briefen, ohne Design-Ticket.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork gibt einem PM einen designfreien Weg, Ideen greifbar zu machen: vom Prompt zum Prototyp für Ausrichtung und Briefings, ohne das Design-Budget des Teams zu verbrauchen.',
    stepsTitle: 'So nutzt ein PM SankiWork',
    steps: [
      {
        title: 'Beschreibe den Flow',
    ...
    tableTitle: 'PM-Arbeit mit SankiWork vs. Warten aufs Design',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    ...
    galleryTitle: 'Von PMs prototypisiert mit SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle deine nächste Spec in etwas, das Leute anklicken können – in dem Agenten, den du ohnehin nutzt.',
  },
  roleMarketing: {
    title: 'SankiWork für Marketing-Teams',
    description:
      'Liefere Kampagnen im Content-Tempo. SankiWork lässt deinen Agenten Landingpages, Social-Cards und Kampagnen-Visuals aus einem Prompt erzeugen – markenkonform, auf Abruf, ohne sich beim Design anzustellen.',
    ...
    tldrTitle: 'In einem Satz',
    tldrBody:
      'SankiWork ist die Always-on-Design-Ressource fürs Marketing: vom Prompt zum Asset für Landingpages und Social, markenkonform, sodass Kampagnen im Tempo deines Textens ausgeliefert werden.',
    stepsTitle: 'So nutzt ein Marketing-Team SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Marketing mit SankiWork vs. das übliche Gewusel',
    tableColCapability: 'Was du brauchst',
    tableColWithOd: 'Mit SankiWork',
    tableColWithout: 'Heute ohne',
    tableRows: [
    ...
    galleryTitle: 'Vom Marketing ausgeliefert mit SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Gib dem Repo einen Stern, installiere SankiWork und verwandle Briefings in markenkonforme Assets – in dem Agenten, den du ohnehin nutzt.',
  },
};
