...
export const IT: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'Generatore di wireframe AI — dal prompt al wireframe con SankiWork',
    description:
      'Un generatore di wireframe AI gratuito e open-source che trasforma un prompt in wireframe modificabili e multi-schermata — e li porta fino al codice consegnato. SankiWork gira dentro l’agente di programmazione che già usi, così il wireframe e il prodotto reale condividono un’unica fonte.',
    ...
    tldrBody:
      'La maggior parte dei generatori di wireframe AI ti consegna un’immagine che poi ricostruisci. SankiWork genera il wireframe dentro il tuo agente di programmazione e lo porta dal prompt al codice consegnato — senza passaggio di esportazione, senza divario di consegna, senza contatore per postazione.',
    stepsTitle: 'Come funziona il generatore di wireframe AI',
    steps: [
      {
        title: 'Descrivi la schermata',
        body: 'Spiega al tuo agente cosa mettere a wireframe in linguaggio semplice — «una dashboard con una barra laterale, una riga di statistiche e una tabella delle attività recenti». SankiWork carica la skill di wireframe così l’agente imposta struttura e gerarchia, non solo una singola immagine statica.',
    ...
    tableTitle: 'SankiWork rispetto ai tipici generatori di wireframe AI',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Wireframe creati con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi di provider — non c’è alcun contatore per postazione o per credito sul generatore di wireframe stesso.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork funziona con Claude Code, Codex, Cursor Agent, Gemini CLI e una dozzina di altri adattatori nativi. Porti le tue chiavi di provider; nulla è ospitato per te.',
      },
    ],
    ctaTitle: 'Genera il tuo primo wireframe stasera',
    ctaBody:
      'Metti una stella al repo, installa SankiWork e trasforma la tua prossima idea di schermata in un wireframe modificabile — e poi in codice consegnato — nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Generatore di UI AI' },
      { href: '/solutions/design-to-code/', label: 'Dal design al codice con SankiWork' },
      { href: '/blog/design-to-code-tools/', label: 'I migliori strumenti dal design al codice' },
      { href: '/solutions/prototype/', label: 'Prototipazione con SankiWork' },
    ],
  },
  aiUiGenerator: {
    title: 'Generatore di UI AI — dal prompt alla UI di produzione con SankiWork',
    description:
      'Un generatore di UI AI gratuito e open-source che trasforma un prompt in un’interfaccia reale, basata su componenti — e la porta fino al codice consegnato. SankiWork gira dentro l’agente di programmazione che già usi, così la UI generata e il codice di produzione sono lo stesso artefatto.',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'La maggior parte dei generatori di UI AI ti dà un mockup o uno snippet React usa e getta. SankiWork genera la UI dentro il tuo agente di programmazione e la porta dal prompt al codice consegnato — componenti reali, il tuo design system, senza passaggio di esportazione, senza contatore per postazione.',
    stepsTitle: 'Come funziona il generatore di UI AI',
    steps: [
      {
        title: 'Descrivi l’interfaccia',
        body: 'Spiega al tuo agente cosa costruire in linguaggio semplice — «una pagina di impostazioni con una barra laterale, sezioni a schede e una barra di salvataggio». SankiWork carica la skill di UI così l’agente attinge a componenti reali e a un design system, non a una schermata isolata.',
    ...
    tableTitle: 'SankiWork rispetto ai tipici generatori di UI AI',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'UI create con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi di provider — non c’è alcun contatore per postazione o per credito sul generatore di UI stesso.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repo, installa SankiWork e trasforma la tua prossima idea di interfaccia in una UI reale, basata su componenti — e poi in codice consegnato — nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      ...
      { href: '/solutions/designer/', label: 'SankiWork per i designer' },
    ],
  },
  designToCode: {
    title: 'Dal design al codice — trasforma un design in codice consegnato con SankiWork',
    description:
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'La maggior parte degli strumenti dal design al codice esporta un’istantanea una tantum che poi devi accudire. SankiWork mantiene il design e il codice come un unico artefatto vivo dentro il tuo agente — itera parlando, consegna codice di cui sei proprietario, senza contatore per postazione.',
    stepsTitle: 'Come funziona il passaggio dal design al codice',
    steps: [
      {
        title: 'Parti da un prompt o da un design',
        body: 'Descrivi la schermata in linguaggio semplice, o indica al tuo agente una direzione di design. SankiWork carica la skill giusta così l’agente costruisce struttura e componenti, non una conversione fragile e isolata.',
    ...
    tableTitle: 'SankiWork rispetto ai tipici strumenti dal design al codice',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Consegnato dal design con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi di provider — non c’è alcun contatore per postazione o per credito sul flusso di lavoro dal design al codice stesso.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repo, installa SankiWork e trasforma la tua prossima schermata — prompt, wireframe o design — in codice pulito e pronto da consegnare nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'Generatore di wireframe AI' },
      { href: '/solutions/ai-ui-generator/', label: 'Generatore di UI AI' },
      { href: '/blog/design-to-code-tools/', label: 'I migliori strumenti dal design al codice' },
      { href: '/solutions/engineering/', label: 'SankiWork per l’ingegneria' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'Generatore di landing page AI — dal prompt a una landing page da consegnare',
    description:
      'Un generatore di landing page AI gratuito e open-source che trasforma un prompt in una landing page reale e responsive — e la porta fino al codice consegnato. SankiWork gira dentro l’agente di programmazione che già usi, così la pagina generata e la pagina pubblicata sono lo stesso artefatto che possiedi.',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'La maggior parte dei costruttori di landing page AI blocca la tua pagina dentro il loro editor e la contabilizza per postazione. SankiWork genera la landing page dentro il tuo agente di programmazione e la porta dal prompt al codice consegnato — sezioni reali, il tuo brand, nessun passaggio di esportazione, nessun contatore per postazione.',
    stepsTitle: 'Come funziona il generatore di landing page AI',
    steps: [
      {
        title: 'Descrivi la pagina',
        body: 'Spiega al tuo agente cosa costruire in linguaggio semplice — «una pagina di lancio per un’app di note: hero, tre funzionalità, prezzi e un modulo lista d’attesa». SankiWork carica la skill di landing page così l’agente imposta sezioni reali con una gerarchia chiara.',
    ...
    tableTitle: 'SankiWork vs. i tipici costruttori di landing page AI',
    ...
    galleryTitle: 'Landing page costruite con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi di provider — non c’è alcun contatore per postazione o per pagina sul generatore di landing page stesso.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repo, installa SankiWork e trasforma la tua prossima idea di lancio in una landing page reale e responsive — e poi in codice consegnato — nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Generatore di UI AI' },
      { href: '/solutions/design-to-code/', label: 'Dal design al codice con SankiWork' },
      { href: '/solutions/marketing/', label: 'SankiWork per il marketing' },
      { href: '/blog/best-ai-design-tools/', label: 'I migliori strumenti di design AI' },
    ],
  },
  figmaToCode: {
    title: 'Da Figma al codice — trasforma i design Figma in codice consegnato con SankiWork',
    description:
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'La maggior parte dei plugin da Figma al codice esporta un’istantanea una tantum di markup a posizionamento assoluto che poi riscrivi. SankiWork mantiene il design e il codice come un unico artefatto vivo dentro il tuo agente — recuperi i frame tramite il Figma MCP, iteri conversando, consegni codice che possiedi.',
    stepsTitle: 'Come funziona il passaggio da Figma al codice',
    steps: [
      {
        title: 'Collega Figma al tuo agente',
        body: 'Con il Figma MCP configurato, il tuo agente di programmazione — Claude Code, Codex, Cursor Agent — può leggere direttamente un file Figma o un frame selezionato. SankiWork carica la skill giusta così l’agente trasforma l’intento di design in struttura, non in una fragile copia a pixel.',
    ...
    tableTitle: 'SankiWork vs. i tipici strumenti da Figma al codice',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Consegnato da Figma con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Come trasforma SankiWork Figma in codice?',
      ...
      {
        q: 'È gratuito?',
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi di provider — non c’è alcun contatore per postazione o per esportazione sul workflow da Figma al codice stesso.',
      },
      {
        q: 'Con quali agenti funziona?',
        a: 'SankiWork funziona con Claude Code, Codex, Cursor Agent, Gemini CLI e una dozzina di altri adattatori nativi. Porti le tue chiavi di provider e la tua configurazione Figma MCP; nulla è ospitato per te.',
      },
    ],
    ctaTitle: 'Trasforma il tuo prossimo frame Figma in codice stasera',
    ctaBody:
      'Metti una stella al repo, installa SankiWork, collega il Figma MCP e trasforma il tuo prossimo design Figma in codice pulito e pronto da consegnare nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      { href: '/solutions/design-to-code/', label: 'Dal design al codice con SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'Generatore di UI AI' },
      { href: '/agents/claude-code-design/', label: 'SankiWork per Claude Code' },
      { href: '/solutions/engineering/', label: 'SankiWork per l’ingegneria' },
    ],
  },
  screenshotToCode: {
    title: 'Da screenshot al codice — trasforma uno screenshot in codice con SankiWork',
    description:
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'La maggior parte degli strumenti da screenshot al codice sputa fuori markup una tantum a posizionamento assoluto che poi riscrivi. SankiWork ricostruisce lo screenshot dentro il tuo agente di programmazione come codice pulito e basato su componenti — struttura reale, il tuo design system, nessun passaggio di esportazione, nessun contatore per postazione.',
    stepsTitle: 'Come funziona da screenshot al codice',
    steps: [
      {
        title: 'Trascina lo screenshot',
        body: 'Dai al tuo agente un’immagine della schermata che vuoi — lo screenshot di un’app, di un sito o di un design. SankiWork carica la skill giusta così l’agente legge il layout e l’intento, non solo i pixel.',
    ...
    tableTitle: 'SankiWork vs. i tipici strumenti da screenshot al codice',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Ricostruito da uno screenshot con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Come trasforma SankiWork uno screenshot in codice?',
        a: 'Dai al tuo agente di programmazione un’immagine della schermata e SankiWork carica la skill giusta così l’agente lo ricostruisce come codice pulito e basato su componenti — leggendo layout e intento, non limitandosi a ricalcare i pixel.',
      },
      {
        q: 'Che tipo di codice produce?',
      ...
      {
        q: 'È gratuito?',
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi di provider — non c’è alcun contatore per postazione o per credito sul workflow da screenshot al codice stesso.',
      },
      {
        q: 'Con quali agenti funziona?',
        a: 'SankiWork funziona con Claude Code, Codex, Cursor Agent, Gemini CLI e una dozzina di altri adattatori nativi. Porti le tue chiavi di provider; nulla è ospitato per te.',
    ...
    ctaBody:
      'Metti una stella al repo, installa SankiWork e trasforma lo screenshot della schermata che vuoi in codice pulito e pronto da consegnare nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      { href: '/solutions/figma-to-code/', label: 'Da Figma al codice con SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Dal design al codice con SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'Generatore di UI AI' },
      { href: '/solutions/engineering/', label: 'SankiWork per l’ingegneria' },
    ],
  ...
  htmlToPpt: {
    title: 'Da HTML a PPT — trasforma l’HTML in un PowerPoint modificabile con SankiWork',
    description:
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'La maggior parte dei convertitori da HTML a PPT appiattisce la tua pagina in immagini di slide statiche che non puoi modificare. SankiWork costruisce la presentazione come HTML dentro il tuo agente di programmazione ed esporta un vero .pptx modificabile — testo e forme nativi, il tuo design system, nessun contatore a postazione, nessun vincolo al fornitore.',
    stepsTitle: 'Come funziona il passaggio da HTML a PPT',
    steps: [
      {
        title: 'Parti da HTML, un documento o un prompt',
        body: 'Indica al tuo agente una pagina HTML, un documento markdown o descrivi semplicemente la presentazione. SankiWork carica la skill giusta così l’agente legge struttura e intento — titoli, sezioni, dati — non solo il markup grezzo.',
      ...
      },
      {
        ...
        body: 'Il pptx-generator di SankiWork trasforma la presentazione HTML in un vero PowerPoint — forme native, testo modificabile e grafici che puoi ancora cambiare — con una verifica della fedeltà HTML-to-PPTX, non un’immagine piatta per slide.',
    ...
    tableTitle: 'SankiWork vs. i tipici convertitori da HTML a PPT',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryLead:
      'Vere presentazioni renderizzate da SankiWork, pronte per l’esportazione in un .pptx modificabile. Scegli un tema vicino al tuo contenuto, descrivi la tua variazione e l’agente costruisce la presentazione — poi ti consegna il PowerPoint che possiedi.',
    gallery: [
    ...
    faq: [
      {
        q: 'Come fa SankiWork a trasformare l’HTML in un PPT?',
        a: 'Il tuo agente di programmazione costruisce il contenuto in una presentazione HTML pulita, poi la skill pptx-generator di SankiWork la esporta in un vero .pptx modificabile — forme e testo nativi, verificati per la fedeltà HTML-to-PPTX, non un’immagine piatta per slide.',
      },
      {
      ...
      {
        q: 'È gratuito?',
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi — non c’è alcun contatore per file o per credito sul workflow da HTML a PPT.',
      },
      {
        q: 'Qual è la differenza rispetto alla generazione di slide?',
        a: 'Generare una presentazione parte di solito da un prompt o una scaletta; il passaggio da HTML a PPT parte da HTML o markdown che hai già e si concentra sull’esportazione del .pptx modificabile. Entrambi usano lo stesso motore di presentazioni di SankiWork — guarda il caso d’uso delle slide per il flusso incentrato sulla scaletta.',
      },
    ],
    ctaTitle: 'Trasforma la tua prossima presentazione HTML in un PPT modificabile',
    ctaBody:
      'Metti una stella al repo, installa SankiWork e trasforma l’HTML — o un prompt — in una presentazione pulita e un vero .pptx modificabile, nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    lead: 'Descrivi il flusso e lascia che il tuo agente generi un prototipo reale e cliccabile — schermate collegate, stili coerenti, interazioni funzionanti. A differenza dei generatori di prototipi che si fermano a un mockup, SankiWork porta lo stesso artefatto fino al codice consegnato, nell’agente che già usi.',
    heroImageAlt:
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'La maggior parte dei generatori di prototipi AI (Figma, Cursor, Penpot) si ferma a un mockup cliccabile che poi ricostruisci. SankiWork genera il prototipo dentro il tuo agente di programmazione e lo porta dal prompt al codice consegnato — nessun passaggio di esportazione, nessun divario di consegna, nessun contatore per postazione.',
    stepsTitle: 'Come funziona il generatore di prototipi AI',
    steps: [
      {
        title: 'Descrivi il flusso',
        body: 'Racconta al tuo agente il percorso in linguaggio semplice — «un flusso di onboarding: registrazione, selettore di piani e una dashboard». SankiWork carica la skill di prototipo così l’agente dispone schermate collegate, non un singolo frame statico.',
    ...
    tableTitle: 'SankiWork vs. i tipici generatori di prototipi AI',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Prototipi costruiti con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sì. SankiWork è open source e gira dentro l’agente di programmazione che già usi con le tue chiavi di provider — non c’è alcun contatore per postazione o per credito sul generatore di prototipi stesso.',
      },
      {
        q: 'In cosa è diverso dai generatori di prototipi di Figma, Cursor o Penpot?',
        a: 'Quelli si fermano a un mockup cliccabile dentro la loro app. SankiWork genera il prototipo nel tuo agente di programmazione e porta lo stesso artefatto fino al codice consegnato che possiedi — nessuna esportazione, nessuna ricostruzione per la produzione.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repo, installa SankiWork e trasforma il tuo prossimo flusso in un prototipo cliccabile — e poi in codice consegnato — nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      { href: '/solutions/prototype/', label: 'Prototipazione con SankiWork' },
      { href: '/solutions/ai-wireframe-generator/', label: 'Generatore di wireframe AI' },
  ...
  prototype: {
    title: 'Crea prototipi interattivi con SankiWork + Claude Code',
    description:
      'Trasforma un prompt in un prototipo cliccabile e multi-schermata senza uscire dal terminale. SankiWork fornisce al tuo agente di programmazione le competenze di design, i template e il design system per consegnare prototipi reali che apri nel browser.',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork è il livello di design per l’agente di programmazione che già usi. Per la prototipazione significa passare da un’idea di un paragrafo a un prototipo navigabile e curato nello stile in una sola sessione — senza strumento di design, senza passaggio di esportazione, senza divario di consegna.',
    stepsTitle: 'Come funziona la prototipazione con SankiWork',
    steps: [
      {
        title: 'Descrivi il flusso',
        body: 'Spiega al tuo agente cosa stai costruendo in linguaggio semplice — «un flusso di onboarding con una schermata di benvenuto, un selettore di piani e una conferma». SankiWork carica la skill di prototipo così l’agente sa di dover produrre schermate, non una singola pagina.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'L’agente applica un design system e i template di prototipo di SankiWork, così ogni schermata condivide tipografia, spaziatura e componenti invece di sembrare una bozza. Ottieni un insieme coerente di schermate, non mockup scollegati.',
        imageAlt:
    ...
    tableTitle: 'Prototipazione con SankiWork rispetto al vecchio metodo',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Prototipi che le persone hanno creato con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Mi serve uno strumento di design come Figma per prototipare con SankiWork?',
        a: 'No. SankiWork gira dentro il tuo agente di programmazione e renderizza i prototipi in HTML. Descrivi il flusso a parole; l’agente produce le schermate. Non c’è uno strumento di canvas separato da imparare o pagare.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork funziona con Claude Code, Codex, Cursor Agent, Gemini CLI e una dozzina di altri adattatori nativi. Porti le tue chiavi del provider; nulla viene ospitato per te.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma il tuo prossimo «e se...» in qualcosa che puoi cliccare — nell’agente che già usi.',
  },
  dashboard: {
    title: 'Genera dashboard di dati con SankiWork + Claude Code',
    description:
    ...
    lead: 'Di’ al tuo agente cosa mostrare e che effetto deve fare. SankiWork fornisce i pattern dei grafici, il sistema di layout e il linguaggio visivo così ottieni una dashboard coerente e presentabile — non un muro di widget con lo stile predefinito.',
    heroImageAlt:
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork trasforma una specifica in linguaggio semplice delle tue metriche in una dashboard curata nello stile che il tuo agente renderizza in HTML — versionata nel tuo repository, ospitabile ovunque, senza abbonamento di BI a postazione.',
    stepsTitle: 'Come funzionano le dashboard con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork include template di grafico e layout, così i trend diventano grafici a linee, le suddivisioni diventano barre e i rapporti la visualizzazione giusta — tipografia e spaziatura coerenti ovunque invece di impostazioni predefinite disomogenee.',
    ...
    tableTitle: 'Dashboard con SankiWork rispetto al vecchio metodo',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Dashboard che le persone hanno creato con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork renderizza le dashboard in HTML dentro il tuo agente di programmazione. Descrivi le metriche e lo punti ai tuoi dati; non c’è una piattaforma di BI separata da licenziare o imparare.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma le tue metriche in una dashboard che puoi ospitare ovunque — nell’agente che già usi.',
  },
  slides: {
    title: 'Genera presentazioni con SankiWork + Claude Code',
    description:
      'Trasforma una scaletta in una presentazione progettata e in linea con il brand senza aprire un’app di presentazioni. SankiWork fornisce al tuo agente di programmazione template di slide e un sistema visivo, renderizzando le slide in HTML che puoi presentare, esportare o condividere.',
    breadcrumb: 'Slide',
    label: 'Caso d’uso · Slide',
    heading: 'Presentazioni dall’aria progettata, scritte da un prompt',
    lead: 'Consegna al tuo agente una scaletta e un tono. SankiWork applica un template di presentazione e un sistema visivo così ogni slide è impaginata, composta e in linea con il brand — non un elenco puntato su uno sfondo vuoto.',
    heroImageAlt:
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork trasforma una scaletta in una presentazione HTML progettata che il tuo agente renderizza in una sola sessione — presentala nel browser, esportala in PDF o PPTX e conserva la fonte nel tuo repository.',
    stepsTitle: 'Come funzionano le presentazioni con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork include template di presentazione — editoriale, svizzero-internazionale, tecnico scuro e altri. L’agente ne applica uno così tipografia, griglia e accenti restano coerenti su ogni slide.',
    ...
    tableTitle: 'Presentazioni con SankiWork rispetto al vecchio metodo',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Presentazioni che le persone hanno creato con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork renderizza le presentazioni in HTML dentro il tuo agente di programmazione e può esportare in PDF o PPTX. Presenti dal browser o consegni un file — non serve un’app di presentazioni per crearla.',
      },
      {
      ...
      },
      {
        ...
        a: 'Sì. Il pptx-generator di SankiWork esporta la presentazione in un vero .pptx con testo e forme nativi e modificabili — verificato per la fedeltà HTML-to-PPTX, non immagini piatte delle slide — più PDF e l’HTML da cui presenti. Guarda lo strumento HTML to PPT per il flusso incentrato sulla conversione.',
      },
      {
        q: 'Quali agenti posso usare?',
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma la tua scaletta in una presentazione progettata — nell’agente che già usi.',
    relatedTitle: 'Strumenti e guide correlati',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'Da HTML a PPT con SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Dal design al codice con SankiWork' },
      { href: '/plugins/templates/', label: 'Sfoglia i template di presentazione' },
      { href: '/solutions/marketing/', label: 'SankiWork per il marketing' },
    ],
  ...
  image: {
    title: 'Genera grafiche in linea con il brand con SankiWork + Claude Code',
    description:
    ...
    lead: 'Descrivi la card o la copertina che ti serve. SankiWork la compone con tipografia, griglia e i colori del tuo brand reali — poi la renderizza in HTML che puoi esportare come immagine, invece di combattere con un’app di design o un template generico.',
    heroImageAlt:
      'Illustrazione editoriale di un prompt che si trasforma in un insieme di card social e copertine di articoli impaginate',
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork trasforma un prompt in una grafica composta e in linea con il brand che il tuo agente renderizza in HTML ed esporta in PNG — ripetibile, versionata e libera da strumenti di design a postazione.',
    stepsTitle: 'Come funzionano le grafiche con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork preleva i tuoi colori, la tipografia e la spaziatura da un design system riutilizzabile, così ogni card si abbina al resto del tuo brand invece di sembrare un’occasione isolata.',
    ...
    tableTitle: 'Grafiche con SankiWork rispetto al vecchio metodo',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Grafiche che le persone hanno creato con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork compone grafiche con layout e tipografia reali — il tuo titolo, il tuo brand, dimensioni esatte — e le renderizza in HTML che esporti come PNG. È composizione di design, non generazione di pixel.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma un prompt in una grafica in linea con il brand — nell’agente che già usi.',
  },
  video: {
    title: 'Genera motion graphics e video brevi con SankiWork + Claude Code',
    description:
    ...
    lead: 'Descrivi il momento che vuoi — una comparsa del titolo, un’animazione di dati, una chiusura con logo. SankiWork compone fotogrammi animati con il tuo sistema di brand e li renderizza in video, senza suite di motion graphics.',
    heroImageAlt:
      'Illustrazione editoriale di una sceneggiatura che si trasforma in una sequenza di fotogrammi video animati',
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork trasforma una sceneggiatura in fotogrammi animati e in linea con il brand che il tuo agente renderizza in video di formato breve — composti da HTML, versionati nel tuo repository, senza editor di timeline da imparare.',
    stepsTitle: 'Come funziona il movimento con SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork fornisce template di fotogramma — light leak cinematografici, titoli con glitch, chiusure con logo — e applica i tuoi colori e la tua tipografia, così il movimento appare intenzionale e in linea con il brand.',
    ...
    tableTitle: 'Movimento con SankiWork rispetto al vecchio metodo',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Movimento che le persone hanno creato con SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'No. SankiWork compone fotogrammi animati in HTML e li renderizza in video dentro il tuo agente di programmazione. Non c’è un editor di timeline da imparare o licenziare.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma una sceneggiatura in movimento — nell’agente che già usi.',
  },
  designSystem: {
    title: 'Costruisci e applica un design system con SankiWork + Claude Code',
    description:
    ...
    lead: 'Definisci il tuo brand una volta e SankiWork lo porta in ogni output — prototipi, presentazioni, dashboard, grafiche. Il sistema vive nel tuo repository come un DESIGN.md che l’agente legge, così la coerenza è automatica, non manuale.',
    heroImageAlt:
      'Illustrazione editoriale di un singolo design system che si irradia in molti artefatti in linea con il brand',
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork cattura il tuo brand come un design system portabile che il tuo agente applica a ogni artefatto — definito una volta nel tuo repository, applicato ovunque, senza uno strumento di design centrale che faccia da controllore.',
    stepsTitle: 'Come funzionano i design system con SankiWork',
    steps: [
      {
        title: 'Cattura il sistema',
        body: 'Descrivi il tuo brand — colori, tipografia, spaziatura, voce — oppure punta l’agente a un sito esistente per estrarlo. SankiWork lo scrive in un DESIGN.md che vive nel tuo progetto.',
        imageAlt: 'Illustrazione di un brand catturato in un unico file di design system',
      },
      {
        title: 'Parti da una base collaudata',
        body: 'SankiWork include oltre 140 design system di riferimento — da Apple e Linear a quelli editoriali e brutalisti. Fai il fork di uno vicino al tuo brand invece di partire da una pagina bianca.',
    ...
    tableTitle: 'Design system con SankiWork rispetto al vecchio metodo',
    tableColCapability: 'Cosa ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Design system in SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Un file DESIGN.md nel tuo repository che cattura colori, tipografia, spaziatura, componenti e voce. Ogni skill di SankiWork lo legge, così il tuo brand viene applicato automaticamente a qualsiasi cosa l’agente produca.',
      },
      {
        q: 'Devo partire da zero?',
        a: 'No. SankiWork include oltre 140 design system di riferimento di cui puoi fare il fork — da Apple e Linear a quelli editoriali e brutalisti — per poi adattarli al tuo brand.',
      },
      {
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e dai al tuo agente un unico brand da applicare ovunque — nell’agente che già usi.',
  },
  roleSoloBuilder: {
    title: 'SankiWork per solo builder e indie hacker',
    description:
      'Spedisci come un team di una persona sola. SankiWork trasforma il tuo agente di coding nella metà di design della tua startup: prototipi, landing page, dashboard e visual di brand, tutto da un prompt, tutto in linea con il brand, tutto nel tuo repository.',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork è il reparto di design che un fondatore solitario non ha mai avuto: dal prompt all’artefatto su ogni superficie di cui il tuo prodotto ha bisogno, in un unico brand, con zero passaggi di consegna e nessuno strumento in più.',
    stepsTitle: 'Come un solo builder usa SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Costruire in solitaria con SankiWork vs. farlo nel modo difficile',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Costruito in solitaria con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e lascia che un agente sia il tuo team di design, dentro l’agente che già usi.',
  },
  roleDesigner: {
    title: 'SankiWork per designer',
    description:
      'Dedica il tuo tempo al gusto, non alla fatica. SankiWork lascia che il tuo agente gestisca il lavoro di produzione ripetitivo — varianti, stati, interi design system — mentre tu dirigi l’aspetto e mantieni l’ultima parola.',
    breadcrumb: 'Designer',
    label: 'Per · Designer',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork è l’assistente di produzione che non si stanca mai: tu definisci il design system e dai il gusto; l’agente genera il resto, in linea con il sistema, nel tuo repository.',
    stepsTitle: 'Come un designer usa SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Progettare con SankiWork vs. il modo manuale',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Diretto con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e lascia che l’agente gestisca la produzione mentre tu dai il gusto, dentro l’agente che già usi.',
  },
  roleEngineering: {
    title: 'SankiWork per ingegneri',
    description:
      'Salta il passaggio di consegna del design. SankiWork trasforma un DESIGN.md in front-end reale che il tuo agente di coding scrive direttamente: UI in linea con il sistema, prototipi e dashboard, nel repository, senza andata e ritorno su Figma.',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork chiude il divario tra designer e ingegnere rendendo il design system leggibile dalla macchina: lo stesso agente che scrive il tuo codice applica il sistema e renderizza UI reale.',
    stepsTitle: 'Come un ingegnere usa SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Front-end con SankiWork vs. il modo con passaggio di consegna',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Costruito dagli ingegneri con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma un DESIGN.md in front-end, dentro l’agente che già usi.',
  },
  roleProductManagers: {
    title: 'SankiWork per product manager',
    description:
      'Smetti di aspettare la banda di design per comunicare un’idea. SankiWork permette a un PM di trasformare un prompt in un prototipo cliccabile o in un wireframe, per allineare gli stakeholder e fare il brief al team, senza un ticket di design.',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork dà al PM un modo senza design di rendere tangibili le idee: dal prompt al prototipo per allineamento e brief, senza spendere il budget di design del team.',
    stepsTitle: 'Come un PM usa SankiWork',
    steps: [
      {
        title: 'Descrivi il flusso',
    ...
    tableTitle: 'Lavoro del PM con SankiWork vs. aspettare il design',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    ...
    galleryTitle: 'Prototipato dai PM con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma la tua prossima specifica in qualcosa su cui le persone possono cliccare, dentro l’agente che già usi.',
  },
  roleMarketing: {
    title: 'SankiWork per i team di marketing',
    description:
      'Spedisci campagne alla velocità dei contenuti. SankiWork permette al tuo agente di produrre landing page, card social e visual di campagna da un prompt: in linea con il brand, su richiesta, senza mettersi in coda dal design.',
    ...
    tldrTitle: 'In una riga',
    tldrBody:
      'SankiWork è la risorsa di design sempre attiva per il marketing: dal prompt all’asset per landing page e social, in linea con il brand, così le campagne escono alla velocità con cui scrivi i testi.',
    stepsTitle: 'Come un team di marketing usa SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Marketing con SankiWork vs. la solita corsa',
    tableColCapability: 'Ciò che ti serve',
    tableColWithOd: 'Con SankiWork',
    tableColWithout: 'Senza, oggi',
    tableRows: [
    ...
    galleryTitle: 'Spedito dal marketing con SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Metti una stella al repository, installa SankiWork e trasforma i brief in asset in linea con il brand, dentro l’agente che già usi.',
  },
};
