...
export const FR: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'Générateur de wireframes IA — de l’invite au wireframe avec SankiWork',
    description:
      'Un générateur de wireframes IA gratuit et open source qui transforme une invite en wireframes éditables et multi-écrans — et les mène jusqu’au code livré. SankiWork s’exécute dans l’agent de code que vous utilisez déjà, si bien que le wireframe et le vrai produit partagent une seule source.',
    ...
    tldrBody:
      'La plupart des générateurs de wireframes IA vous remettent une image que vous reconstruisez ensuite. SankiWork génère le wireframe dans votre agent de code et le porte de l’invite jusqu’au code livré — sans étape d’export, sans rupture de transmission, sans compteur par siège.',
    stepsTitle: 'Comment fonctionne le générateur de wireframes IA',
    steps: [
      {
        title: 'Décrivez l’écran',
        body: 'Dites à votre agent ce qu’il faut wireframer en langage clair — "un tableau de bord avec une barre latérale, une rangée de statistiques et une table d’activité récente." SankiWork charge la compétence de wireframe pour que l’agent organise structure et hiérarchie, pas seulement une image statique unique.',
    ...
    tableTitle: 'SankiWork vs les générateurs de wireframes IA classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Des wireframes créés avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Oui. SankiWork est open source et s’exécute dans l’agent de code que vous utilisez déjà avec vos propres clés de fournisseur — il n’y a aucun compteur par siège ou par crédit sur le générateur de wireframes lui-même.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork fonctionne avec Claude Code, Codex, Cursor Agent, Gemini CLI et une douzaine d’autres adaptateurs natifs. Vous apportez vos propres clés de fournisseur ; rien n’est hébergé pour vous.',
      },
    ],
    ctaTitle: 'Générez votre premier wireframe ce soir',
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, et transformez votre prochaine idée d’écran en un wireframe éditable — puis en code livré — dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides associés',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Générateur d’UI IA' },
      { href: '/solutions/design-to-code/', label: 'Du design au code avec SankiWork' },
      { href: '/blog/design-to-code-tools/', label: 'Meilleurs outils de design au code' },
      { href: '/solutions/prototype/', label: 'Prototypage avec SankiWork' },
    ],
  },
  aiUiGenerator: {
    title: 'Générateur d’UI IA — de l’invite à l’UI de production avec SankiWork',
    description:
      'Un générateur d’UI IA gratuit et open source qui transforme une invite en une vraie interface basée sur des composants — et la mène jusqu’au code livré. SankiWork s’exécute dans l’agent de code que vous utilisez déjà, si bien que l’UI générée et le code de production sont le même artefact.',
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'La plupart des générateurs d’UI IA vous donnent une maquette ou un extrait React jetable. SankiWork génère l’UI dans votre agent de code et la porte de l’invite jusqu’au code livré — de vrais composants, votre système de design, sans étape d’export, sans compteur par siège.',
    stepsTitle: 'Comment fonctionne le générateur d’UI IA',
    steps: [
      {
        title: 'Décrivez l’interface',
        body: 'Dites à votre agent quoi construire en langage clair — "une page de paramètres avec une barre latérale, des sections à onglets et une barre d’enregistrement." SankiWork charge la compétence d’UI pour que l’agent fasse appel à de vrais composants et à un système de design, pas à un écran unique.',
    ...
    tableTitle: 'SankiWork vs les générateurs d’UI IA classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Des UI créées avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Oui. SankiWork est open source et s’exécute dans l’agent de code que vous utilisez déjà avec vos propres clés de fournisseur — il n’y a aucun compteur par siège ou par crédit sur le générateur d’UI lui-même.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, et transformez votre prochaine idée d’interface en une vraie UI basée sur des composants — puis en code livré — dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides associés',
    related: [
      ...
      { href: '/solutions/designer/', label: 'SankiWork pour les designers' },
    ],
  },
  designToCode: {
    title: 'Du design au code — transformez un design en code livré avec SankiWork',
    description:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'La plupart des outils de design au code exportent un instantané unique que vous surveillez ensuite. SankiWork garde le design et le code comme un seul artefact vivant dans votre agent — itérez en parlant, livrez du code qui vous appartient, sans compteur par siège.',
    stepsTitle: 'Comment fonctionne le design au code',
    steps: [
      {
        title: 'Partez d’une invite ou d’un design',
        body: 'Décrivez l’écran en langage clair, ou orientez votre agent vers une direction de design. SankiWork charge la bonne compétence pour que l’agent construise structure et composants, pas une conversion ponctuelle et fragile.',
    ...
    tableTitle: 'SankiWork vs les outils de design au code classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Livré depuis le design avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Oui. SankiWork est open source et s’exécute dans l’agent de code que vous utilisez déjà avec vos propres clés de fournisseur — il n’y a aucun compteur par siège ou par crédit sur le workflow du design au code lui-même.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, et transformez votre prochain écran — invite, wireframe ou design — en code propre et livrable dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides associés',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'Générateur de wireframes IA' },
      { href: '/solutions/ai-ui-generator/', label: 'Générateur d’UI IA' },
      { href: '/blog/design-to-code-tools/', label: 'Meilleurs outils de design au code' },
      { href: '/solutions/engineering/', label: 'SankiWork pour l’ingénierie' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'Générateur de landing pages IA — de l’invite à une landing page à livrer',
    description:
      'Un générateur de landing pages IA gratuit et open source qui transforme une invite en une vraie landing page responsive — et la mène jusqu’au code livré. SankiWork s’exécute dans l’agent de code que vous utilisez déjà, si bien que la page générée et la page déployée sont un seul artefact qui vous appartient.',
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'La plupart des générateurs de landing pages IA enferment votre page dans leur éditeur et la facturent au siège. SankiWork génère la landing page dans votre agent de code et la porte de l’invite jusqu’au code livré — vraies sections, votre image de marque, sans étape d’export, sans compteur par siège.',
    stepsTitle: 'Comment fonctionne le générateur de landing pages IA',
    steps: [
      {
        title: 'Décrivez la page',
        body: 'Dites à votre agent quoi construire en langage clair — "une page de lancement pour une appli de prise de notes : hero, trois fonctionnalités, tarifs et un formulaire de liste d’attente." SankiWork charge la compétence landing-page pour que l’agent dispose de vraies sections avec une hiérarchie claire.',
    ...
    tableTitle: 'SankiWork vs les générateurs de landing pages IA classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Landing pages construites avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Oui. SankiWork est open source et s’exécute dans l’agent de code que vous utilisez déjà avec vos propres clés de fournisseur — il n’y a aucun compteur par siège ou par page sur le générateur de landing pages lui-même.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, et transformez votre prochaine idée de lancement en une vraie landing page responsive — puis en code livré — dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides connexes',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'Générateur d’UI IA' },
      { href: '/solutions/design-to-code/', label: 'Du design au code avec SankiWork' },
      { href: '/solutions/marketing/', label: 'SankiWork pour le marketing' },
      { href: '/blog/best-ai-design-tools/', label: 'Meilleurs outils de design IA' },
    ],
  },
  figmaToCode: {
    title: 'Figma vers code — transformez vos designs Figma en code livré avec SankiWork',
    description:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'La plupart des plugins Figma vers code exportent un instantané ponctuel de balisage positionné en absolu que vous réécrivez ensuite. SankiWork garde le design et le code comme un seul artefact vivant dans votre agent — récupérez les frames via le Figma MCP, itérez en parlant, livrez du code qui vous appartient.',
    stepsTitle: 'Comment fonctionne Figma vers code',
    steps: [
      {
        title: 'Connectez Figma à votre agent',
        body: 'Une fois le Figma MCP configuré, votre agent de code — Claude Code, Codex, Cursor Agent — peut lire un fichier Figma ou un frame sélectionné directement. SankiWork charge la bonne compétence pour que l’agent transforme l’intention de design en structure, pas en une copie de pixels fragile.',
    ...
    tableTitle: 'SankiWork vs les outils Figma vers code classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Livré depuis Figma avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Comment SankiWork transforme-t-il Figma en code ?',
      ...
      {
        q: 'Est-ce gratuit ?',
        a: 'Oui. SankiWork est open source et s’exécute dans l’agent de code que vous utilisez déjà avec vos propres clés de fournisseur — il n’y a aucun compteur par siège ou par export sur le workflow Figma vers code lui-même.',
      },
      {
        q: 'Avec quels agents fonctionne-t-il ?',
        a: 'SankiWork fonctionne avec Claude Code, Codex, Cursor Agent, Gemini CLI et une douzaine d’autres adaptateurs natifs. Vous apportez vos propres clés de fournisseur et votre propre configuration Figma MCP ; rien n’est hébergé pour vous.',
      },
    ],
    ctaTitle: 'Transformez votre prochain frame Figma en code ce soir',
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, connectez le Figma MCP, et transformez votre prochain design Figma en code propre et livrable dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides connexes',
    related: [
      { href: '/solutions/design-to-code/', label: 'Du design au code avec SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'Générateur d’UI IA' },
      { href: '/agents/claude-code-design/', label: 'SankiWork pour Claude Code' },
      { href: '/solutions/engineering/', label: 'SankiWork pour l’ingénierie' },
    ],
  },
  screenshotToCode: {
    title: 'Capture d’écran vers code — transformez une capture en code avec SankiWork',
    description:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'La plupart des outils capture d’écran vers code recrachent un balisage ponctuel et positionné en absolu que vous réécrivez ensuite. SankiWork reconstruit la capture à l’intérieur de votre agent de code en code propre, à base de composants — vraie structure, votre système de design, sans étape d’export, sans compteur par siège.',
    stepsTitle: 'Comment fonctionne la capture d’écran vers code',
    steps: [
      {
        title: 'Déposez la capture d’écran',
        body: 'Donnez à votre agent une image de l’écran que vous voulez — la capture d’une appli, d’un site web ou d’un design. SankiWork charge la bonne compétence pour que l’agent lise la mise en page et l’intention, pas seulement les pixels.',
    ...
    tableTitle: 'SankiWork vs les outils capture d’écran vers code classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Reconstruit depuis une capture d’écran avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Comment SankiWork transforme-t-il une capture d’écran en code ?',
        a: 'Vous donnez à votre agent de code une image de l’écran et SankiWork charge la bonne compétence pour que l’agent la reconstruise en code propre, à base de composants — en lisant la mise en page et l’intention, pas seulement en calquant les pixels.',
      },
      {
        q: 'Quel type de code produit-il ?',
      ...
      {
        q: 'Est-ce gratuit ?',
        a: 'Oui. SankiWork est open source et s’exécute dans l’agent de code que vous utilisez déjà avec vos propres clés de fournisseur — il n’y a aucun compteur par siège ou par crédit sur le workflow capture d’écran vers code lui-même.',
      },
      {
        q: 'Avec quels agents fonctionne-t-il ?',
        a: 'SankiWork fonctionne avec Claude Code, Codex, Cursor Agent, Gemini CLI et une douzaine d’autres adaptateurs natifs. Vous apportez vos propres clés de fournisseur ; rien n’est hébergé pour vous.',
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, et transformez la capture de l’écran que vous voulez en code propre et livrable dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides connexes',
    related: [
      { href: '/solutions/figma-to-code/', label: 'Figma vers code avec SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Du design au code avec SankiWork' },
      { href: '/solutions/ai-ui-generator/', label: 'Générateur d’UI IA' },
      { href: '/solutions/engineering/', label: 'SankiWork pour l’ingénierie' },
    ],
  ...
  htmlToPpt: {
    title: 'HTML to PPT — transformez du HTML en un PowerPoint modifiable avec SankiWork',
    description:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'La plupart des convertisseurs HTML-to-PPT aplatissent votre page en images de diapositives statiques que vous ne pouvez pas modifier. SankiWork construit la présentation en HTML à l’intérieur de votre agent de code et exporte un vrai .pptx modifiable — texte et formes natifs, votre système de design, pas de compteur par siège, pas de verrouillage fournisseur.',
    stepsTitle: 'Comment fonctionne HTML to PPT',
    steps: [
      {
        title: 'Partez de HTML, d’un document ou d’une invite',
        body: 'Pointez votre agent vers une page HTML, un document markdown, ou décrivez simplement la présentation. SankiWork charge la bonne compétence pour que l’agent lise la structure et l’intention — titres, sections, données — et pas seulement le balisage brut.',
      ...
      },
      {
        ...
        body: 'Le pptx-generator d’SankiWork transforme la présentation HTML en un vrai PowerPoint — formes natives, texte modifiable et graphiques que vous pouvez encore changer — avec un audit de fidélité HTML-to-PPTX, pas une image figée par diapositive.',
    ...
    tableTitle: 'SankiWork vs les convertisseurs HTML-to-PPT classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryLead:
      'De vraies présentations rendues par SankiWork, prêtes à être exportées en .pptx modifiable. Choisissez un thème proche de votre contenu, décrivez votre variation, et l’agent construit la présentation — puis vous remet le PowerPoint qui vous appartient.',
    gallery: [
    ...
    faq: [
      {
        q: 'Comment SankiWork transforme-t-il du HTML en PPT ?',
        a: 'Votre agent de code construit le contenu en une présentation HTML nette, puis la compétence pptx-generator d’SankiWork l’exporte vers un vrai .pptx modifiable — formes et texte natifs, audité pour la fidélité HTML-to-PPTX, pas une image figée par diapositive.',
      },
      {
      ...
      {
        q: 'Est-ce gratuit ?',
        a: 'Oui. SankiWork est open source et s’exécute à l’intérieur de l’agent de code que vous utilisez déjà avec vos propres clés — il n’y a pas de compteur par fichier ou par crédit sur le flux HTML-to-PPT.',
      },
      {
        q: 'Quelle est la différence avec la génération de diapositives ?',
        a: 'Générer une présentation part généralement d’une invite ou d’un plan ; HTML to PPT part d’un HTML ou d’un markdown que vous avez déjà et se concentre sur l’export .pptx modifiable. Les deux utilisent le même moteur de présentation d’SankiWork — voir le cas d’usage diapositives pour le flux orienté plan.',
      },
    ],
    ctaTitle: 'Transformez votre prochaine présentation HTML en un PPT modifiable',
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, et transformez du HTML — ou une invite — en une présentation nette et un vrai .pptx modifiable, dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides connexes',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    lead: 'Décrivez le parcours et laissez votre agent générer un vrai prototype cliquable — écrans liés, styles cohérents, interactions fonctionnelles. Contrairement aux générateurs de prototypes qui s’arrêtent à une maquette, SankiWork porte le même artefact jusqu’au code livré, dans l’agent que vous utilisez déjà.',
    heroImageAlt:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'La plupart des générateurs de prototypes IA (Figma, Cursor, Penpot) s’arrêtent à une maquette cliquable que vous reconstruisez ensuite. SankiWork génère le prototype à l’intérieur de votre agent de code et le porte de l’invite jusqu’au code livré — sans étape d’export, sans rupture de transmission, sans compteur par siège.',
    stepsTitle: 'Comment fonctionne le générateur de prototypes IA',
    steps: [
      {
        title: 'Décrivez le parcours',
        body: 'Décrivez le parcours à votre agent en langage clair — « un flux d’onboarding : inscription, sélecteur de forfait et tableau de bord ». SankiWork charge la compétence de prototype pour que l’agent dispose des écrans liés, pas un unique frame statique.',
    ...
    tableTitle: 'SankiWork vs les générateurs de prototypes IA classiques',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Prototypes construits avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Oui. SankiWork est open source et s’exécute dans l’agent de code que vous utilisez déjà avec vos propres clés de fournisseur — il n’y a aucun compteur par siège ou par crédit sur le générateur de prototypes lui-même.',
      },
      {
        q: 'En quoi diffère-t-il des générateurs de prototypes de Figma, Cursor ou Penpot ?',
        a: 'Ceux-ci s’arrêtent à une maquette cliquable dans leur appli. SankiWork génère le prototype dans votre agent de code et porte le même artefact jusqu’au code livré que vous possédez — sans export, sans reconstruction pour la production.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork, et transformez votre prochain parcours en un prototype cliquable — puis en code livré — dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides connexes',
    related: [
      { href: '/solutions/prototype/', label: 'Prototypage avec SankiWork' },
      { href: '/solutions/ai-wireframe-generator/', label: 'Générateur de wireframes IA' },
  ...
  prototype: {
    title: 'Créer des prototypes interactifs avec SankiWork + Claude Code',
    description:
      'Transformez une invite en un prototype cliquable et multi-écrans sans quitter votre terminal. SankiWork donne à votre agent de code les compétences de design, les modèles et le système de design pour livrer de vrais prototypes que vous pouvez ouvrir dans un navigateur.',
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'SankiWork est la couche de design de l’agent de code que vous utilisez déjà. Pour le prototypage, cela signifie passer d’une idée d’un paragraphe à un prototype navigable et stylé en une seule session — sans outil de design, sans étape d’export, sans rupture de transmission.',
    stepsTitle: 'Comment fonctionne le prototypage avec SankiWork',
    steps: [
      {
        title: 'Décrivez le parcours',
        body: 'Dites à votre agent ce que vous construisez en langage clair — "un parcours d’onboarding avec un écran de bienvenue, un sélecteur de forfait et une confirmation." SankiWork charge la compétence de prototype pour que l’agent sache produire des écrans, pas une seule page.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'L’agent applique un système de design et des modèles de prototype d’SankiWork, si bien que chaque écran partage typographie, espacements et composants au lieu de ressembler à un brouillon. Vous obtenez un ensemble d’écrans cohérent, pas des maquettes disparates.',
        imageAlt:
    ...
    tableTitle: 'Le prototypage avec SankiWork vs l’ancienne méthode',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Des prototypes créés avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        q: 'Ai-je besoin d’un outil de design comme Figma pour prototyper avec SankiWork ?',
        a: 'Non. SankiWork fonctionne à l’intérieur de votre agent de code et rend les prototypes en HTML. Vous décrivez le parcours en langage ; l’agent produit les écrans. Il n’y a aucun outil de canevas distinct à apprendre ou à payer.',
      },
      {
      ...
      },
      {
        ...
        a: 'SankiWork fonctionne avec Claude Code, Codex, Cursor Agent, Gemini CLI et une douzaine d’autres adaptateurs maison. Vous apportez vos propres clés de fournisseur ; rien n’est hébergé pour vous.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez votre prochain "et si" en quelque chose de cliquable — dans l’agent que vous utilisez déjà.',
  },
  dashboard: {
    title: 'Générer des tableaux de bord de données avec SankiWork + Claude Code',
    description:
    ...
    lead: 'Dites à votre agent quoi montrer et quelle impression donner. SankiWork fournit les motifs de graphiques, le système de mise en page et le langage visuel pour obtenir un tableau de bord cohérent et présentable — pas un mur de widgets au style par défaut.',
    heroImageAlt:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'SankiWork transforme une spécification en langage clair de vos indicateurs en un tableau de bord stylé que votre agent rend en HTML — versionné dans votre dépôt, hébergeable partout, sans abonnement BI par siège.',
    stepsTitle: 'Comment fonctionnent les tableaux de bord avec SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork livre des modèles de graphiques et de mise en page, si bien que les tendances deviennent des courbes, les répartitions des barres et les ratios la bonne visualisation — typographie et espacements cohérents partout au lieu de réglages par défaut disparates.',
    ...
    tableTitle: 'Les tableaux de bord avec SankiWork vs l’ancienne méthode',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Des tableaux de bord créés avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Non. SankiWork rend les tableaux de bord en HTML à l’intérieur de votre agent de code. Vous décrivez les indicateurs et le pointez vers vos données ; il n’y a aucune plateforme BI distincte à licencier ou à apprendre.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez vos indicateurs en un tableau de bord que vous pouvez héberger partout — dans l’agent que vous utilisez déjà.',
  },
  slides: {
    title: 'Générer des présentations avec SankiWork + Claude Code',
    description:
      'Transformez un plan en une présentation conçue et fidèle à la marque sans ouvrir d’application de présentation. SankiWork donne à votre agent de code des modèles de présentation et un système visuel, rendant les diapositives en HTML que vous pouvez présenter, exporter ou partager.',
    ...
    lead: 'Confiez à votre agent un plan et un ton. SankiWork applique un modèle de présentation et un système visuel pour que chaque diapositive soit disposée, composée et fidèle à la marque — pas une liste à puces sur un fond vide.',
    heroImageAlt:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'SankiWork transforme un plan en une présentation HTML conçue que votre agent rend en une session — présentez-la dans le navigateur, exportez en PDF ou PPTX et gardez la source dans votre dépôt.',
    stepsTitle: 'Comment fonctionnent les présentations avec SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork livre des modèles de présentation — éditorial, suisse-international, technique sombre, et plus. L’agent en applique un pour que typographie, grille et accents restent cohérents sur chaque diapositive.',
    ...
    tableTitle: 'Les présentations avec SankiWork vs l’ancienne méthode',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Des présentations créées avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Non. SankiWork rend les présentations en HTML à l’intérieur de votre agent de code et peut exporter en PDF ou PPTX. Vous présentez depuis le navigateur ou transmettez un fichier — aucune application de présentation requise pour la construire.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez votre plan en une présentation conçue — dans l’agent que vous utilisez déjà.',
    relatedTitle: 'Outils et guides connexes',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'HTML to PPT avec SankiWork' },
      { href: '/solutions/design-to-code/', label: 'Du design au code avec SankiWork' },
      { href: '/plugins/templates/', label: 'Parcourir les modèles de présentation' },
      { href: '/solutions/marketing/', label: 'SankiWork pour le marketing' },
    ],
  ...
  image: {
    title: 'Générer des visuels fidèles à la marque avec SankiWork + Claude Code',
    description:
    ...
    lead: 'Décrivez la carte ou la couverture dont vous avez besoin. SankiWork la compose avec une vraie typographie, une grille et vos couleurs de marque — puis la rend en HTML que vous exportez en image, au lieu de batailler avec une application de design ou un modèle générique.',
    heroImageAlt:
    ...
    tldrTitle: 'En une ligne',
    tldrBody:
      'SankiWork transforme une invite en un visuel composé et fidèle à la marque que votre agent rend en HTML et exporte en PNG — reproductible, versionné et libéré des outils de design par siège.',
    stepsTitle: 'Comment fonctionnent les visuels avec SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork tire vos couleurs, votre typographie et vos espacements d’un système de design réutilisable, si bien que chaque carte s’accorde au reste de votre marque au lieu d’avoir l’air d’un coup unique.',
    ...
    tableTitle: 'Les visuels avec SankiWork vs l’ancienne méthode',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Des visuels créés avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Non. SankiWork compose des visuels avec une vraie mise en page et une vraie typographie — votre titre, votre marque, des dimensions exactes — et les rend en HTML que vous exportez en PNG. C’est de la composition de design, pas de la génération de pixels.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez une invite en un visuel fidèle à la marque — dans l’agent que vous utilisez déjà.',
  },
  video: {
    title: 'Générer des motion graphics et des vidéos courtes avec SankiWork + Claude Code',
    description:
    ...
    lead: 'Décrivez le moment que vous voulez — une apparition de titre, une animation de données, un outro de logo. SankiWork compose des cadres animés avec votre système de marque et les rend en vidéo, sans suite de motion graphics requise.',
    heroImageAlt:
      'Illustration éditoriale d’un script se transformant en une séquence de cadres vidéo animés',
    tldrTitle: 'En une ligne',
    tldrBody:
      'SankiWork transforme un script en cadres animés et fidèles à la marque que votre agent rend en vidéo courte — composés à partir de HTML, versionnés dans votre dépôt, sans éditeur de timeline à apprendre.',
    stepsTitle: 'Comment fonctionne le motion avec SankiWork',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'SankiWork fournit des modèles de cadres — fuites de lumière cinématiques, titres glitch, outros de logo — et applique vos couleurs et votre typographie, pour que le mouvement semble intentionnel et fidèle à la marque.',
    ...
    tableTitle: 'Le motion avec SankiWork vs l’ancienne méthode',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Du motion créé avec SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Non. SankiWork compose des cadres animés en HTML et les rend en vidéo à l’intérieur de votre agent de code. Il n’y a aucun éditeur de timeline à apprendre ou à licencier.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez un script en motion — dans l’agent que vous utilisez déjà.',
  },
  designSystem: {
    title: 'Construire et appliquer un système de design avec SankiWork + Claude Code',
    description:
    ...
    lead: 'Définissez votre marque une fois et SankiWork la porte dans chaque sortie — prototypes, présentations, tableaux de bord, visuels. Le système vit dans votre dépôt sous forme de DESIGN.md que l’agent lit, donc la cohérence est automatique, pas manuelle.',
    heroImageAlt:
      'Illustration éditoriale d’un seul système de design rayonnant vers de nombreux artefacts fidèles à la marque',
    tldrTitle: 'En une ligne',
    tldrBody:
      'SankiWork capture votre marque comme un système de design portable que votre agent applique à chaque artefact — défini une fois dans votre dépôt, imposé partout, sans outil de design central qui en garde l’accès.',
    stepsTitle: 'Comment fonctionnent les systèmes de design avec SankiWork',
    steps: [
      {
        title: 'Capturez le système',
        body: 'Décrivez votre marque — couleurs, typographie, espacements, voix — ou pointez l’agent vers un site existant pour l’extraire. SankiWork l’écrit dans un DESIGN.md qui vit dans votre projet.',
        imageAlt: 'Illustration d’une marque capturée dans un seul fichier de système de design',
      },
      {
        title: 'Partez d’une base éprouvée',
        body: 'SankiWork livre plus de 140 systèmes de design de référence — d’Apple et Linear à l’éditorial et au brutaliste. Forkez-en un proche de votre marque au lieu de partir d’une page blanche.',
    ...
    tableTitle: 'Les systèmes de design avec SankiWork vs l’ancienne méthode',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Les systèmes de design dans SankiWork',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Un fichier DESIGN.md dans votre dépôt qui capture couleurs, typographie, espacements, composants et voix. Chaque compétence SankiWork le lit, donc votre marque est appliquée automatiquement à tout ce que l’agent produit.',
      },
      {
        q: 'Dois-je partir de zéro ?',
        a: 'Non. SankiWork livre plus de 140 systèmes de design de référence que vous pouvez forker — d’Apple et Linear à l’éditorial et au brutaliste — puis adapter à votre marque.',
      },
      {
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et donnez à votre agent une marque à appliquer partout — dans l’agent que vous utilisez déjà.',
  },
  roleSoloBuilder: {
    title: 'SankiWork pour les créateurs solo et indie hackers',
    description:
      'Livrez comme une équipe à vous tout seul. SankiWork transforme votre agent de code en la moitié design de votre startup — prototypes, landing pages, tableaux de bord et visuels de marque, le tout à partir d’un prompt, le tout dans votre charte, le tout dans votre dépôt.',
    ...
    tldrBody:
      'SankiWork est le département design qu’un fondateur solo n’a jamais eu : du prompt à l’artefact sur chaque surface dont votre produit a besoin, dans une seule marque, sans transmission ni outil supplémentaire.',
    stepsTitle: 'Comment un créateur solo utilise SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Construire en solo avec SankiWork vs. le faire à la dure',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Construit en solo avec SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et laissez un seul agent être votre équipe design — dans l’agent que vous utilisez déjà.',
  },
  roleDesigner: {
    title: 'SankiWork pour les designers',
    description:
      'Passez votre temps sur le goût, pas sur la corvée. SankiWork laisse votre agent gérer le travail de production répétitif — variantes, états, systèmes de design complets — pendant que vous dirigez le look et gardez le dernier mot.',
    breadcrumb: 'Designer',
    ...
    tldrTitle: 'En une phrase',
    tldrBody:
      'SankiWork est l’assistant de production qui ne se fatigue jamais : vous définissez le système de design et tranchez sur le goût ; l’agent génère le reste, dans le système, dans votre dépôt.',
    stepsTitle: 'Comment un designer utilise SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Concevoir avec SankiWork vs. la méthode manuelle',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Dirigé avec SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et laissez l’agent gérer la production pendant que vous tranchez sur le goût — dans l’agent que vous utilisez déjà.',
  },
  roleEngineering: {
    title: 'SankiWork pour les ingénieurs',
    description:
      'Sautez la transmission du design. SankiWork transforme un DESIGN.md en vrai front-end que votre agent de code écrit directement — UI conforme au système, prototypes et tableaux de bord, dans le dépôt, sans aller-retour Figma.',
    ...
    tldrTitle: 'En une phrase',
    tldrBody:
      'SankiWork comble l’écart designer-ingénieur en rendant le système de design lisible par la machine : le même agent qui écrit votre code applique le système et rend une vraie UI.',
    stepsTitle: 'Comment un ingénieur utilise SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Front-end avec SankiWork vs. la méthode de transmission',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Construit par des ingénieurs avec SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez un DESIGN.md en front-end — dans l’agent que vous utilisez déjà.',
  },
  roleProductManagers: {
    title: 'SankiWork pour les product managers',
    description:
      'Cessez d’attendre la disponibilité du design pour communiquer une idée. SankiWork laisse un PM transformer un prompt en prototype cliquable ou wireframe — pour aligner les parties prenantes et briefer l’équipe, sans ticket de design.',
    ...
    tldrTitle: 'En une phrase',
    tldrBody:
      'SankiWork donne au PM un moyen sans design de rendre les idées tangibles : du prompt au prototype pour l’alignement et les briefs, sans dépenser le budget design de l’équipe.',
    stepsTitle: 'Comment un PM utilise SankiWork',
    steps: [
      {
        title: 'Décrivez le parcours',
    ...
    tableTitle: 'Le travail de PM avec SankiWork vs. attendre le design',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    ...
    galleryTitle: 'Prototypé par des PM avec SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez votre prochaine spec en quelque chose que les gens peuvent cliquer — dans l’agent que vous utilisez déjà.',
  },
  roleMarketing: {
    title: 'SankiWork pour les équipes marketing',
    description:
      'Livrez des campagnes à la vitesse du contenu. SankiWork laisse votre agent produire landing pages, cartes sociales et visuels de campagne à partir d’un prompt — dans la charte, à la demande, sans faire la queue au design.',
    ...
    tldrTitle: 'En une phrase',
    tldrBody:
      'SankiWork est la ressource design toujours active du marketing : du prompt à l’asset pour landing pages et social, dans la charte, pour que les campagnes soient livrées à la vitesse où vous écrivez le texte.',
    stepsTitle: 'Comment une équipe marketing utilise SankiWork',
    steps: [
      {
    ...
    tableTitle: 'Le marketing avec SankiWork vs. la course habituelle',
    tableColCapability: 'Ce dont vous avez besoin',
    tableColWithOd: 'Avec SankiWork',
    tableColWithout: 'Sans, aujourd’hui',
    tableRows: [
    ...
    galleryTitle: 'Livré par le marketing avec SankiWork',
    galleryLead:
    ...
    ctaBody:
      'Mettez une étoile au dépôt, installez SankiWork et transformez les briefs en assets dans la charte — dans l’agent que vous utilisez déjà.',
  },
};
