...
export interface HeaderCopy {
  ...
  starTitle: string;
  starPrefix: string;
  /** SankiWork Cloud account entry — see header-enhancer.astro. */
  signIn: string;
...
export interface HeaderProductMenuCopy {
  ...
  product: string;
  sankiWorkName: string;
  sankiWorkBlurb: string;
  ...
  // nouns in the markup; everything below mirrors the live sanki-ai.cloud
...
const HEADER_PRODUCT_MENU_COPY: Record<LandingLocaleCode, HeaderProductMenuCopy> = {
  en: {
    ...
    product: 'Product',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'The agentic design surface: skills, systems, templates.',
  ...
  zh: {
    ...
    product: '产品',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agent 原生设计工作台：围绕 SKILL.md 工作流组织。',
    htmlAnythingName: 'HTML Anything',
  ...
  'zh-tw': {
    ...
    product: '產品',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agent 原生設計工作台：Skill、設計系統、模板。',
    htmlAnythingName: 'HTML Anything',
  ...
  ja: {
    ...
    product: 'プロダクト',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agent ネイティブのデザイン面: Skill、システム、テンプレート。',
    htmlAnythingName: 'HTML Anything',
  ...
  ko: {
    ...
    product: '제품',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agent 네이티브 디자인 작업면: Skill, 시스템, 템플릿.',
    htmlAnythingName: 'HTML Anything',
  ...
  de: {
    ...
    product: 'Produkt',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agentische Designoberfläche: Skills, Systeme, Vorlagen.',
    htmlAnythingName: 'HTML Anything',
  ...
  fr: {
    ...
    product: 'Produit',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Surface de design agentique : skills, systèmes, modèles.',
    htmlAnythingName: 'HTML Anything',
  ...
  ru: {
    ...
    product: 'Продукт',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agent-native дизайн-среда: skills, системы, шаблоны.',
    htmlAnythingName: 'HTML Anything',
  ...
  es: {
    ...
    product: 'Producto',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Superficie de diseño agentic: skills, sistemas, plantillas.',
    htmlAnythingName: 'HTML Anything',
  ...
  'pt-br': {
    ...
    product: 'Produto',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Superfície de design agentic: skills, sistemas, templates.',
    htmlAnythingName: 'HTML Anything',
  ...
  it: {
    ...
    product: 'Prodotto',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Superficie di design agentic: skill, sistemi, template.',
    htmlAnythingName: 'HTML Anything',
  ...
  vi: {
    ...
    product: 'Sản phẩm',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Bề mặt thiết kế agentic: skill, hệ thống, mẫu.',
    htmlAnythingName: 'HTML Anything',
  ...
  pl: {
    ...
    product: 'Produkt',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agentic powierzchnia projektowa: skills, systemy, szablony.',
    htmlAnythingName: 'HTML Anything',
  ...
  id: {
    ...
    product: 'Produk',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Ruang desain agentic: skill, sistem, template.',
    htmlAnythingName: 'HTML Anything',
  ...
  nl: {
    ...
    product: 'Product',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agentic designoppervlak: skills, systemen, templates.',
    htmlAnythingName: 'HTML Anything',
  ...
  ar: {
    ...
    product: 'المنتج',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'مساحة تصميم وكيلة: المهارات والأنظمة والقوالب.',
    htmlAnythingName: 'HTML Anything',
  ...
  tr: {
    ...
    product: 'Ürün',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agentic tasarım yüzeyi: skill, sistemler, şablonlar.',
    htmlAnythingName: 'HTML Anything',
  ...
  uk: {
    ...
    product: 'Продукт',
    sankiWorkName: 'SankiWork',
    sankiWorkBlurb: 'Agent-native дизайн-поверхня: skills, системи, шаблони.',
    htmlAnythingName: 'HTML Anything',
...
const COMMON_COPY: Record<LandingLocaleCode, CommonCopy> = {
  en: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'Download SankiWork desktop',
      downloadTitle: 'Download the desktop app',
      starAria: 'Star SankiWork on GitHub',
  ...
  zh: {
    ...
    header: {
      ...
      download: '下载',
      downloadAria: '下载 SankiWork 桌面端',
      downloadTitle: '下载桌面应用',
      starAria: '在 GitHub 为 SankiWork 点 Star',
  ...
  'zh-tw': {
    ...
    header: {
      ...
      download: '下載',
      downloadAria: '下載 SankiWork 桌面端',
      downloadTitle: '下載桌面應用',
      starAria: '在 GitHub 為 SankiWork 按 Star',
  ...
  ja: {
    ...
    header: {
      ...
      download: 'ダウンロード',
      downloadAria: 'SankiWork デスクトップをダウンロード',
      downloadTitle: 'デスクトップアプリをダウンロード',
      starAria: 'GitHub で SankiWork にスター',
  ...
  ko: {
    ...
    header: {
      ...
      download: '다운로드',
      downloadAria: 'SankiWork 데스크톱 다운로드',
      downloadTitle: '데스크톱 앱 다운로드',
      starAria: 'GitHub에서 SankiWork에 스타 주기',
  ...
  de: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'SankiWork Desktop herunterladen',
      downloadTitle: 'Desktop-App herunterladen',
      starAria: 'SankiWork auf GitHub mit Stern markieren',
  ...
  fr: {
    ...
    header: {
      ...
      download: 'Télécharger',
      downloadAria: 'Télécharger SankiWork Desktop',
      downloadTitle: "Télécharger l'application desktop",
      starAria: 'Ajouter une étoile à SankiWork sur GitHub',
  ...
  ru: {
    ...
    header: {
      ...
      download: 'Скачать',
      downloadAria: 'Скачать SankiWork Desktop',
      downloadTitle: 'Скачать desktop-приложение',
      starAria: 'Поставить звезду SankiWork на GitHub',
  ...
  es: {
    ...
    header: {
      ...
      download: 'Descargar',
      downloadAria: 'Descargar SankiWork Desktop',
      downloadTitle: 'Descargar la app de escritorio',
      starAria: 'Dar Star a SankiWork en GitHub',
  ...
  'pt-br': {
    ...
    header: {
      ...
      download: 'Baixar',
      downloadAria: 'Baixar SankiWork Desktop',
      downloadTitle: 'Baixar o app desktop',
      starAria: 'Dar Star no SankiWork no GitHub',
  ...
  it: {
    ...
    header: {
      ...
      download: 'Scarica',
      downloadAria: 'Scarica SankiWork Desktop',
      downloadTitle: "Scarica l'app desktop",
      starAria: 'Metti una Star a SankiWork su GitHub',
  ...
  vi: {
    ...
    header: {
      ...
      download: 'Tải xuống',
      downloadAria: 'Tải SankiWork Desktop',
      downloadTitle: 'Tải ứng dụng desktop',
      starAria: 'Star SankiWork trên GitHub',
  ...
  pl: {
    ...
    header: {
      ...
      download: 'Pobierz',
      downloadAria: 'Pobierz SankiWork Desktop',
      downloadTitle: 'Pobierz aplikację desktop',
      starAria: 'Daj gwiazdkę SankiWork na GitHubie',
  ...
  id: {
    ...
    header: {
      ...
      download: 'Unduh',
      downloadAria: 'Unduh SankiWork Desktop',
      downloadTitle: 'Unduh aplikasi desktop',
      starAria: 'Beri Star SankiWork di GitHub',
  ...
  nl: {
    ...
    header: {
      ...
      download: 'Download',
      downloadAria: 'SankiWork Desktop downloaden',
      downloadTitle: 'Desktop-app downloaden',
      starAria: 'Geef SankiWork een Star op GitHub',
  ...
  ar: {
    ...
    header: {
      ...
      download: 'تنزيل',
      downloadAria: 'تنزيل SankiWork Desktop',
      downloadTitle: 'تنزيل تطبيق سطح المكتب',
      starAria: 'ضع نجمة لـ SankiWork على GitHub',
  ...
  tr: {
    ...
    header: {
      ...
      download: 'İndir',
      downloadAria: 'SankiWork Desktop indir',
      downloadTitle: 'Desktop uygulamasını indir',
      starAria: "GitHub'da SankiWork'a Star ver",
  ...
  uk: {
    ...
    header: {
      ...
      download: 'Завантажити',
      downloadAria: 'Завантажити SankiWork Desktop',
      downloadTitle: 'Завантажити desktop-застосунок',
      starAria: 'Поставити зірку SankiWork на GitHub',
...
const HOME_SEO_COPY: Record<LandingLocaleCode, HomeSeoCopy> = {
  en: {
    title: 'SankiWork — Best Open Source Claude Design Alternative',
    description:
  ...
  zh: {
    title: 'SankiWork —— 最佳 Claude Design 开源替代',
    description:
      'SankiWork 是开源的 vibe design workspace，也是 Claude Design 的开源替代——用你自己的 coding agent 做原型、落地页、数据看板、Slides 和 HTML 视频。',
  },
  'zh-tw': {
    title: 'SankiWork —— 最佳 Claude Design 開源替代',
    description:
      'SankiWork 是最佳的開源、本地優先 Claude Design 替代方案。用 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 生成簡報、落地頁、儀表板與品牌系統，背後由 {skills} 個可組合 Skill 與 {systems} 套 DESIGN.md 系統驅動。',
  },
  ja: {
    title: 'SankiWork — 最高のオープンソース Claude Design 代替',
    description:
      'オープンソースの vibe design workspace であり Claude Design の代替。自分の coding agent でプロトタイプ、ランディングページ、ダッシュボード、スライド、HTML 動画を作成。',
  },
  ko: {
    title: 'SankiWork — 최고의 오픈소스 Claude Design 대안',
    description:
      '오픈소스 vibe design workspace이자 Claude Design 대안. 내 coding agent로 프로토타입, 랜딩 페이지, 대시보드, 슬라이드, HTML 비디오를 만드세요.',
  },
  de: {
    title: 'SankiWork — beste Open-Source-Alternative zu Claude Design',
    description:
  ...
  fr: {
    title: "SankiWork — la meilleure alternative open source à Claude Design",
    description:
  ...
  ru: {
    title: 'SankiWork — лучшая open-source альтернатива Claude Design',
    description:
  ...
  es: {
    title: 'SankiWork — la mejor alternativa open source a Claude Design',
    description:
  ...
  'pt-br': {
    title: 'SankiWork — a melhor alternativa open source ao Claude Design',
    description:
  ...
  it: {
    title: "SankiWork — la migliore alternativa open source a Claude Design",
    description:
  ...
  vi: {
    title: 'SankiWork — lựa chọn mã nguồn mở tốt nhất thay Claude Design',
    description:
      'SankiWork là lựa chọn mã nguồn mở, local-first tốt nhất thay Claude Design. Tạo deck, landing page, dashboard và hệ thống thương hiệu bằng Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen, với {skills} skill có thể ghép và {systems} hệ DESIGN.md di động.',
  },
  pl: {
    title: 'SankiWork — najlepsza open-source alternatywa dla Claude Design',
    description:
      'SankiWork to najlepsza, open-source i local-first alternatywa dla Claude Design. Twórz decki, landing page, dashboardy i systemy marki z Claude Code, Codex, Cursor, Gemini, OpenCode lub Qwen, używając {skills} kompozycyjnych skills i {systems} przenośnych systemów DESIGN.md.',
  },
  id: {
    title: 'SankiWork — alternatif open source terbaik untuk Claude Design',
    description:
      'SankiWork adalah alternatif terbaik, open source, dan local-first untuk Claude Design. Buat deck, landing page, dashboard, dan sistem merek dengan Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen, didukung {skills} skill komposable dan {systems} sistem DESIGN.md portabel.',
  },
  nl: {
    title: 'SankiWork — het beste open-source alternatief voor Claude Design',
    description:
      'SankiWork is het beste open-source en local-first alternatief voor Claude Design. Maak decks, landingspagina’s, dashboards en merksystemen met Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen, aangedreven door {skills} combineerbare skills en {systems} draagbare DESIGN.md-systemen.',
  },
  ar: {
    title: 'SankiWork — أفضل بديل مفتوح المصدر لـ Claude Design',
    description:
      'SankiWork هو أفضل بديل مفتوح المصدر والمحلي أولاً لـ Claude Design. أنشئ عروضاً وصفحات هبوط ولوحات بيانات وأنظمة علامة عبر Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen، مع {skills} مهارة قابلة للتركيب و {systems} نظام DESIGN.md قابل للنقل.',
  },
  tr: {
    title: "SankiWork — Claude Design'ın en iyi açık kaynak alternatifi",
    description:
  ...
  uk: {
    title: 'SankiWork — найкраща open-source альтернатива Claude Design',
    description:
      'SankiWork — найкраща open-source і local-first альтернатива Claude Design. Створюйте презентації, лендинги, дашборди та бренд-системи через Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen на базі {skills} skills і {systems} DESIGN.md-систем.',
  },
};
...
const HOME_FAQ_COPY: Record<LandingLocaleCode, HomeFaqTemplate[]> = {
  en: [
    {
      q: 'What is SankiWork?',
      a: 'SankiWork is the official open-source AI design workspace from the nexu-io/open-design project. It turns a local coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode, or Qwen — into a design engine driven by composable skills and portable DESIGN.md systems.',
    },
    {
      q: 'Is SankiWork official?',
      a: 'Yes. The canonical project lives at {origin} and the source is on GitHub at {repo}. "SankiWork", "SankiWork", "sankiwork", and "SankiWork AI" all refer to this same project.',
      official: true,
    },
    {
      q: 'How is SankiWork different from Claude Design?',
      a: 'Claude Design is a hosted product tied to a single vendor. SankiWork is local-first, open source under Apache-2.0, and BYOK: you bring your own agent, credentials, and DESIGN.md system.',
    },
    {
      q: 'Is SankiWork an open-source Claude Design alternative?',
      a: 'Yes — SankiWork is the open-source, local-first Claude Design alternative. Where Claude Design is closed, hosted, and locked to Anthropic models, SankiWork is Apache-2.0, runs on your own machine, and is BYOK, so you drive it with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen and keep every artifact as files you own.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'What is a vibe design workspace?',
      a: 'A vibe design workspace is where you design by describing intent to an AI agent — from prompt to prototype, web page, slides, or HTML video — instead of hand-placing every element. SankiWork is an open-source, agent-native vibe design workspace: it wires the coding agent you already run into a full design workflow, so one tool takes you from a rough idea to production-ready output you own.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Does SankiWork run locally?',
    ...
    {
      q: 'Which coding agents does SankiWork support?',
      a: 'SankiWork ships 17 first-party BYOK adapters out of the box: Claude Code, Codex, Cursor, Gemini CLI, GitHub Copilot CLI, Grok, Hermes, Kimi, Devin for Terminal, OpenCode, Qwen, DeepSeek, Pi, Mistral Vibe, Kiro, Kilo, and Qoder. Any adapter that speaks the same skill protocol works — switching agents is a config change, not a redesign.',
    },
    {
    ...
    // evaluator concerns), then workflow / roadmap. ----
    {
      ...
      a: 'Only your prompt and skill context goes to whichever provider you bring keys for (BYOK). SankiWork has no server of its own — the daemon talks to your provider directly. Generated artifacts land as files in your project directory, not in any vendor cloud.',
    },
    {
      q: 'Can I run SankiWork without installing the CLI or desktop app?',
      a: 'Not today. SankiWork is local-first by design — the minimum is a local daemon plus an agent (Claude Code, Codex, Cursor, Gemini CLI, or one of the 17 supported adapters). A hosted sandbox is on the roadmap but not the priority: artifacts in your repo beat documents in someone else\'s database.',
    },
    {
      q: 'How much does SankiWork cost?',
      a: 'The product is free and Apache-2.0 — there is no SankiWork subscription. You pay the API costs of whichever provider you use (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), billed directly to your account. BYOK keeps both the credentials and the spend on your side of the line.',
    },
    {
      q: 'Can I self-host SankiWork on Vercel, Cloudflare, or my own server?',
    ...
    {
      q: 'How do I move my brand into SankiWork?',
    ...
    {
      q: 'What\'s on the SankiWork roadmap?',
  ...
  zh: [
    {
      q: 'SankiWork 是开源的 Claude Design 替代品吗？',
      a: '是的——SankiWork 是开源、本地优先的 Claude Design 替代方案。Claude Design 闭源、托管、锁定 Anthropic 模型；SankiWork 是 Apache-2.0，跑在你自己的机器上，且 BYOK，你可以用 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 驱动它，产出的每个文件都归你所有。',
      href: '/alternatives/claude-design/',
    },
    {
      q: '什么是 vibe design workspace？',
      a: 'vibe design workspace 是通过向 AI agent 描述意图来做设计——从 prompt 到原型、网页、slides、HTML 视频——而不是手动摆放每个元素。SankiWork 是一个开源、agent-native 的 vibe design workspace：把你已经在用的 coding agent 接进完整设计工作流，一个工具就把你从粗略想法带到可交付、归你所有的成品。',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'SankiWork 是什么？',
      a: 'SankiWork 是 nexu-io/open-design 项目的官方开源 AI 设计工作台。它把本地编码 Agent（Claude Code、Codex、Cursor、Gemini CLI、OpenCode 或 Qwen）变成设计引擎，并由可组合 SKILL.md 工作流驱动。',
    },
    {
      q: 'SankiWork 是官方项目吗？',
      a: '是。官方站点是 {origin}，源代码在 GitHub：{repo}。"SankiWork"、"SankiWork"、"sankiwork" 和 "SankiWork AI" 都指向同一个项目。',
      official: true,
    },
    {
      q: '它和 Claude Design 有什么不同？',
      a: 'Claude Design 是绑定单一厂商的云端产品。SankiWork 本地优先、Apache-2.0 开源，并且 BYOK：你使用自己的 Agent、密钥和 Skill 规则。',
    },
    {
      q: 'SankiWork 可以本地运行吗？',
    ...
    },
    {
      ...
      a: '只有你的 prompt 和 Skill 上下文会发给你自带密钥（BYOK）的那家模型供应商。SankiWork 没有自己的服务器——daemon 直接与你的供应商通信，生成的 artifact 以文件形式落在你的项目目录里，不会进入任何厂商云端。',
    },
    {
      q: '不安装 CLI 或桌面端能用 SankiWork 吗？',
      a: '目前不行。SankiWork 的设计就是本地优先——最少需要一个本地 daemon 加一个 Agent（Claude Code、Codex、Cursor、Gemini CLI 或 17 个受支持适配器之一）。托管沙盒在路线图上但不是优先级：落在你仓库里的 artifact，胜过存在别人数据库里的文档。',
    },
    {
      q: 'SankiWork 要多少钱？',
      a: '产品本身免费且为 Apache-2.0 开源——不存在 SankiWork 订阅。你只需支付所用供应商（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot 等）的 API 费用，直接计入你自己的账户。BYOK 让密钥和开销都留在你这一侧。',
    },
    {
      q: '可以把 SankiWork 自托管到 Vercel、Cloudflare 或自己的服务器吗？',
  ...
  'zh-tw': [
    {
      q: 'SankiWork 是什麼？',
      a: 'SankiWork 是 nexu-io/open-design 專案的官方開源 AI 設計工作台。它把本地 coding agent（Claude Code、Codex、Cursor、Gemini CLI、OpenCode 或 Qwen）變成設計引擎，並由可組合 Skill 與可攜式 DESIGN.md 系統驅動。',
    },
    {
      q: 'SankiWork 是官方專案嗎？',
      a: '是。官方站點是 {origin}，原始碼在 GitHub：{repo}。"SankiWork"、"SankiWork"、"sankiwork" 與 "SankiWork AI" 都指同一個專案。',
      official: true,
    },
    {
      q: '它和 Claude Design 有什麼不同？',
      a: 'Claude Design 是綁定單一供應商的雲端產品。SankiWork 本地優先、Apache-2.0 開源，並且 BYOK：你使用自己的 agent、密鑰與 DESIGN.md 設計系統。',
    },
    {
      q: 'SankiWork 可以本地執行嗎？',
    ...
    },
    {
      ...
      a: '只有你的 prompt 與 Skill 上下文會送到你自帶密鑰（BYOK）的那家模型供應商。SankiWork 沒有自己的伺服器——daemon 直接與你的供應商通訊，生成的 artifact 以檔案形式落在你的專案目錄，不會進入任何廠商雲端。',
    },
    {
      q: '不安裝 CLI 或桌面端能用 SankiWork 嗎？',
      a: '目前不行。SankiWork 的設計就是本地優先——最少需要一個本地 daemon 加一個 agent（Claude Code、Codex、Cursor、Gemini CLI 或 17 個受支援 adapter 之一）。託管沙盒在路線圖上但不是優先事項：落在你 repo 裡的 artifact，勝過存在別人資料庫裡的文件。',
    },
    {
      q: 'SankiWork 要多少錢？',
      a: '產品本身免費且採 Apache-2.0——不存在 SankiWork 訂閱。你只需支付所用供應商（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot 等）的 API 費用，直接計入你自己的帳戶。BYOK 讓密鑰與開銷都留在你這一側。',
    },
    {
      q: '可以把 SankiWork 自架到 Vercel、Cloudflare 或自己的伺服器嗎？',
  ...
  ja: [
    {
      q: 'SankiWork はオープンソースの Claude Design 代替ですか？',
      a: 'はい——SankiWork はオープンソースかつローカル優先の Claude Design 代替です。Claude Design はクローズドでホスト型、Anthropic モデルに固定されていますが、SankiWork は Apache-2.0 で自分のマシン上で動き、BYOK。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen で駆動でき、生成物はすべて自分のファイルとして手元に残ります。',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'vibe design workspace とは？',
      a: 'vibe design workspace とは、要素を一つずつ手で配置する代わりに、AI エージェントに意図を伝えて設計する場です——prompt からプロトタイプ、Web ページ、スライド、HTML 動画まで。SankiWork はオープンソースで agent-native な vibe design workspace で、すでに使っているコーディングエージェントを完全な設計ワークフローに組み込み、ひとつのツールでラフなアイデアから自分のものになる完成物まで導きます。',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'SankiWork とは何ですか？',
      a: 'SankiWork は nexu-io/open-design プロジェクト公式のオープンソース AI デザインワークスペースです。Claude Code、Codex、Cursor、Gemini CLI、OpenCode、Qwen などのローカル coding agent を、スキルと DESIGN.md システムで動くデザインエンジンにします。',
    },
    {
      q: 'SankiWork は公式ですか？',
      a: 'はい。公式サイトは {origin}、ソースコードは GitHub の {repo} です。"SankiWork"、"SankiWork"、"sankiwork"、"SankiWork AI" は同じプロジェクトを指します。',
      official: true,
    },
    {
      q: 'Claude Design と何が違いますか？',
      a: 'Claude Design は単一ベンダーに紐づくホスト型製品です。SankiWork はローカル優先、Apache-2.0 のオープンソース、BYOK で、自分の agent、鍵、DESIGN.md を使います。',
    },
    {
      q: 'ローカルで動きますか？',
    ...
    },
    {
      ...
      a: '送られるのは、あなたが鍵を持ち込んだ（BYOK）プロバイダーへの prompt とスキルのコンテキストだけです。SankiWork 自身のサーバーはなく、daemon があなたのプロバイダーと直接通信します。生成物はベンダーのクラウドではなく、プロジェクトディレクトリにファイルとして保存されます。',
    },
    {
      q: 'CLI やデスクトップアプリなしで使えますか？',
      a: '現時点では使えません。SankiWork は設計からローカル優先で、最低限ローカル daemon と agent（Claude Code、Codex、Cursor、Gemini CLI、または対応する 17 の adapter のいずれか）が必要です。ホスト型サンドボックスはロードマップにありますが優先事項ではありません。自分の repo にある artifact は、他人のデータベースにあるドキュメントに勝ります。',
    },
    {
      q: 'SankiWork の料金は？',
      a: 'プロダクト自体は無料で Apache-2.0 です。SankiWork のサブスクリプションはありません。支払うのは利用するプロバイダー（Anthropic、OpenAI、Google、Mistral、xAI、Moonshot など）の API 料金だけで、あなたのアカウントに直接請求されます。BYOK により、鍵も支出もあなたの側に残ります。',
    },
    {
  ...
  ko: [
    {
      q: 'SankiWork은 오픈소스 Claude Design 대안인가요?',
      a: '네——SankiWork은 오픈소스, 로컬 우선 Claude Design 대안입니다. Claude Design은 폐쇄형·호스팅형이며 Anthropic 모델에 묶여 있지만, SankiWork은 Apache-2.0이고 내 컴퓨터에서 실행되며 BYOK입니다. Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen으로 구동할 수 있고 생성된 모든 산출물은 내 파일로 남습니다.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'vibe design workspace란 무엇인가요?',
      a: 'vibe design workspace는 모든 요소를 손으로 배치하는 대신 AI 에이전트에 의도를 설명해 디자인하는 공간입니다 — prompt에서 프로토타입, 웹 페이지, 슬라이드, HTML 비디오까지. SankiWork은 오픈소스이자 agent-native한 vibe design workspace로, 이미 쓰는 코딩 에이전트를 완전한 디자인 워크플로에 연결해 하나의 도구로 거친 아이디어에서 내 것이 되는 완성물까지 이끕니다.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'SankiWork은 무엇인가요?',
      a: 'SankiWork은 nexu-io/open-design 프로젝트의 공식 오픈소스 AI 디자인 워크스페이스입니다. Claude Code, Codex, Cursor, Gemini CLI, OpenCode, Qwen 같은 로컬 coding agent를 조합형 skill과 DESIGN.md 시스템으로 구동되는 디자인 엔진으로 바꿉니다.',
    },
    {
      q: 'SankiWork은 공식 프로젝트인가요?',
      a: '네. 공식 사이트는 {origin}이고 소스는 GitHub의 {repo}에 있습니다. "SankiWork", "SankiWork", "sankiwork", "SankiWork AI"는 같은 프로젝트를 가리킵니다.',
      official: true,
    },
    {
      q: 'Claude Design과 무엇이 다른가요?',
      a: 'Claude Design은 단일 벤더에 묶인 호스팅 제품입니다. SankiWork은 로컬 우선, Apache-2.0 오픈소스, BYOK이며 사용자의 agent, 키, DESIGN.md 시스템을 그대로 씁니다.',
    },
    {
      q: '로컬에서 실행되나요?',
    ...
    },
    {
      ...
      a: '키를 직접 가져온(BYOK) 프로바이더에게 prompt와 skill 컨텍스트만 전송됩니다. SankiWork은 자체 서버가 없으며 daemon이 프로바이더와 직접 통신합니다. 생성된 artifact는 벤더 클라우드가 아니라 프로젝트 디렉터리에 파일로 저장됩니다.',
    },
    {
      q: 'CLI나 데스크톱 앱 없이 쓸 수 있나요?',
      a: '아직은 안 됩니다. SankiWork은 설계부터 로컬 우선이라 최소한 로컬 daemon과 agent(Claude Code, Codex, Cursor, Gemini CLI 또는 지원되는 17개 adapter 중 하나)가 필요합니다. 호스팅 샌드박스는 로드맵에 있지만 우선순위는 아닙니다. 내 repo에 남는 artifact가 남의 데이터베이스에 있는 문서보다 낫기 때문입니다.',
    },
    {
      q: 'SankiWork 비용은 얼마인가요?',
      a: '제품은 무료이고 Apache-2.0입니다. SankiWork 구독은 없습니다. 사용하는 프로바이더(Anthropic, OpenAI, Google, Mistral, xAI, Moonshot 등)의 API 비용만 본인 계정으로 직접 결제하면 됩니다. BYOK 덕분에 키와 지출 모두 사용자 쪽에 남습니다.',
    },
    {
  ...
  de: [
    {
      q: 'Ist SankiWork eine quelloffene Claude-Design-Alternative?',
      a: 'Ja — SankiWork ist die quelloffene, lokale Claude-Design-Alternative. Wo Claude Design geschlossen, gehostet und an Anthropic-Modelle gebunden ist, ist SankiWork Apache-2.0, läuft auf deinem eigenen Rechner und ist BYOK: Du steuerst es mit Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen und behältst jedes Ergebnis als eigene Dateien.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Was ist ein Vibe Design Workspace?',
      a: 'Ein Vibe Design Workspace ist ein Ort, an dem du gestaltest, indem du einem KI-Agent deine Absicht beschreibst — vom Prompt zu Prototyp, Webseite, Slides oder HTML-Video — statt jedes Element von Hand zu platzieren. SankiWork ist ein quelloffener, agent-nativer Vibe Design Workspace: Er bindet den Coding-Agent, den du bereits nutzt, in einen vollständigen Design-Workflow ein, sodass ein Werkzeug dich von der groben Idee zum fertigen, dir gehörenden Ergebnis bringt.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Was ist SankiWork?',
      a: 'SankiWork ist der offizielle Open-Source-AI-Design-Workspace des Projekts nexu-io/open-design. Es macht lokale Coding-Agents wie Claude Code, Codex, Cursor, Gemini CLI, OpenCode oder Qwen zu einer Design-Engine auf Basis von Skills und DESIGN.md-Systemen.',
    },
    {
      q: 'Ist SankiWork offiziell?',
      a: 'Ja. Die kanonische Website ist {origin}, der Quellcode liegt auf GitHub unter {repo}. "SankiWork", "SankiWork", "sankiwork" und "SankiWork AI" meinen dasselbe Projekt.',
      official: true,
    },
    {
      q: 'Worin unterscheidet es sich von Claude Design?',
      a: 'Claude Design ist ein gehostetes Produkt eines einzelnen Anbieters. SankiWork ist local-first, Apache-2.0 Open Source und BYOK: Sie bringen Agent, Schlüssel und DESIGN.md-System selbst mit.',
    },
    {
      q: 'Läuft SankiWork lokal?',
    ...
    },
    {
      ...
      a: 'Nur Ihr Prompt und der Skill-Kontext gehen an den Provider, für den Sie eigene Schlüssel mitbringen (BYOK). SankiWork hat keinen eigenen Server — der Daemon spricht direkt mit Ihrem Provider. Generierte Artifacts landen als Dateien in Ihrem Projektverzeichnis, nicht in einer Vendor-Cloud.',
    },
    {
      q: 'Kann ich SankiWork ohne CLI oder Desktop-App nutzen?',
      a: 'Heute nicht. SankiWork ist bewusst local-first — das Minimum ist ein lokaler Daemon plus ein Agent (Claude Code, Codex, Cursor, Gemini CLI oder einer der 17 unterstützten Adapter). Eine gehostete Sandbox steht auf der Roadmap, hat aber keine Priorität: Artifacts in Ihrem Repo schlagen Dokumente in fremden Datenbanken.',
    },
    {
      q: 'Was kostet SankiWork?',
      a: 'Das Produkt ist kostenlos und Apache-2.0 — es gibt kein SankiWork-Abo. Sie zahlen nur die API-Kosten Ihres Providers (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot usw.), direkt über Ihr eigenes Konto. BYOK hält Schlüssel und Ausgaben auf Ihrer Seite.',
    },
    {
      q: 'Kann ich SankiWork auf Vercel, Cloudflare oder eigenen Servern hosten?',
    ...
    {
      q: 'Wie bringe ich meine Marke in SankiWork?',
    ...
    {
      q: 'Was steht auf der SankiWork-Roadmap?',
  ...
  fr: [
    {
      q: 'SankiWork est-il une alternative open source à Claude Design ?',
      a: 'Oui — SankiWork est l’alternative open source et locale à Claude Design. Là où Claude Design est fermé, hébergé et verrouillé aux modèles Anthropic, SankiWork est en Apache-2.0, s’exécute sur votre propre machine et fonctionne en BYOK : pilotez-le avec Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen et gardez chaque livrable sous forme de fichiers qui vous appartiennent.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Qu’est-ce qu’un vibe design workspace ?',
      a: 'Un vibe design workspace est un espace où l’on conçoit en décrivant son intention à un agent IA — du prompt au prototype, page web, slides ou vidéo HTML — plutôt qu’en plaçant chaque élément à la main. SankiWork est un vibe design workspace open source et agent-native : il intègre l’agent de code que vous utilisez déjà dans un flux de design complet, pour passer d’une idée brute à un résultat livrable et bien à vous.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: "Qu'est-ce qu'SankiWork ?",
      a: "SankiWork est l'espace de travail officiel et open source du projet nexu-io/open-design. Il transforme un agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode ou Qwen — en moteur de design piloté par des skills composables et des systèmes DESIGN.md portables.",
    },
    {
      q: 'SankiWork est-il officiel ?',
      a: 'Oui. Le site canonique est {origin} et le code source est sur GitHub à {repo}. "SankiWork", "SankiWork", "sankiwork" et "SankiWork AI" désignent le même projet.',
      official: true,
    },
    {
      q: 'Quelle différence avec Claude Design ?',
      a: 'Claude Design est un produit hébergé lié à un fournisseur unique. SankiWork est local-first, open source Apache-2.0 et BYOK : vous apportez votre agent, vos clés et votre système DESIGN.md.',
    },
    {
      q: 'SankiWork fonctionne-t-il en local ?',
    ...
    },
    {
      ...
      a: 'Seuls votre prompt et le contexte des skills partent vers le fournisseur dont vous apportez les clés (BYOK). SankiWork n\'a aucun serveur propre — le daemon parle directement à votre fournisseur. Les artifacts générés sont des fichiers dans votre répertoire de projet, pas dans le cloud d\'un vendeur.',
    },
    {
      q: 'Puis-je utiliser SankiWork sans installer la CLI ou l\'app desktop ?',
      a: 'Pas aujourd\'hui. SankiWork est local-first par conception — le minimum est un daemon local plus un agent (Claude Code, Codex, Cursor, Gemini CLI ou l\'un des 17 adaptateurs supportés). Une sandbox hébergée est sur la roadmap mais n\'est pas la priorité : des artifacts dans votre repo valent mieux que des documents dans la base de données de quelqu\'un d\'autre.',
    },
    {
      q: 'Combien coûte SankiWork ?',
      a: 'Le produit est gratuit et sous Apache-2.0 — il n\'existe pas d\'abonnement SankiWork. Vous payez les coûts d\'API du fournisseur que vous utilisez (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), facturés directement sur votre compte. Le BYOK garde les clés et la dépense de votre côté.',
    },
    {
      q: 'Puis-je auto-héberger SankiWork sur Vercel, Cloudflare ou mon propre serveur ?',
    ...
    {
      q: 'Comment importer ma marque dans SankiWork ?',
    ...
    {
      q: 'Qu\'y a-t-il sur la roadmap d\'SankiWork ?',
  ...
  ru: [
    {
      q: 'SankiWork — это open-source альтернатива Claude Design?',
      a: 'Да — SankiWork это открытая, локальная альтернатива Claude Design. Claude Design закрыт, работает в облаке и привязан к моделям Anthropic, а SankiWork — Apache-2.0, запускается на вашей машине и работает по BYOK: управляйте им через Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen и храните каждый результат как свои файлы.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Что такое vibe design workspace?',
      a: 'Vibe design workspace — это среда, где вы проектируете, описывая замысел ИИ-агенту — от промпта до прототипа, веб-страницы, слайдов или HTML-видео — вместо расстановки каждого элемента вручную. SankiWork это открытый, agent-native vibe design workspace: он встраивает кодинг-агента, которым вы уже пользуетесь, в полный дизайн-процесс, и один инструмент ведёт вас от черновой идеи к готовому результату, который принадлежит вам.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'Что такое SankiWork?',
      a: 'SankiWork — официальный open-source AI design workspace проекта nexu-io/open-design. Он превращает локальный coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode или Qwen — в design-движок на базе composable skills и переносимых DESIGN.md-систем.',
    },
    {
      q: 'SankiWork официальный?',
      a: 'Да. Канонический сайт — {origin}, исходный код — на GitHub: {repo}. "SankiWork", "SankiWork", "sankiwork" и "SankiWork AI" обозначают один проект.',
      official: true,
    },
    {
      q: 'Чем он отличается от Claude Design?',
      a: 'Claude Design — hosted-продукт одного вендора. SankiWork — local-first, Apache-2.0 open source и BYOK: вы используете своего agent, свои ключи и свою DESIGN.md-систему.',
    },
    {
      q: 'SankiWork запускается локально?',
    ...
    },
    {
      ...
      a: 'Провайдеру, чьи ключи вы принесли (BYOK), уходят только ваш prompt и контекст skills. У SankiWork нет собственного сервера — daemon общается с вашим провайдером напрямую. Generated artifacts сохраняются файлами в папке проекта, а не в облаке вендора.',
    },
    {
      q: 'Можно использовать SankiWork без установки CLI или desktop-приложения?',
      a: 'Пока нет. SankiWork по замыслу local-first — минимум это локальный daemon плюс agent (Claude Code, Codex, Cursor, Gemini CLI или один из 17 поддерживаемых adapters). Hosted-песочница есть в роадмапе, но не в приоритете: artifacts в вашем репозитории лучше документов в чужой базе данных.',
    },
    {
      q: 'Сколько стоит SankiWork?',
      a: 'Продукт бесплатный и под Apache-2.0 — подписки SankiWork не существует. Вы платите только за API того провайдера, которым пользуетесь (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot и др.), напрямую со своего аккаунта. BYOK оставляет и ключи, и расходы на вашей стороне.',
    },
    {
      q: 'Можно self-host SankiWork на Vercel, Cloudflare или своём сервере?',
    ...
    {
      q: 'Как перенести свой бренд в SankiWork?',
  ...
  es: [
    {
      q: '¿SankiWork es una alternativa open source a Claude Design?',
      a: 'Sí — SankiWork es la alternativa open source y local a Claude Design. Donde Claude Design es cerrado, alojado y atado a los modelos de Anthropic, SankiWork es Apache-2.0, se ejecuta en tu propia máquina y es BYOK: contrólalo con Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen y conserva cada resultado como archivos que son tuyos.',
      href: '/alternatives/claude-design/',
    },
    {
      q: '¿Qué es un vibe design workspace?',
      a: 'Un vibe design workspace es un espacio donde diseñas describiendo tu intención a un agente de IA — del prompt al prototipo, página web, slides o vídeo HTML — en lugar de colocar cada elemento a mano. SankiWork es un vibe design workspace open source y agent-native: conecta el agente de código que ya usas a un flujo de diseño completo, de modo que una sola herramienta te lleva de una idea en bruto a un resultado listo y tuyo.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: '¿Qué es SankiWork?',
      a: 'SankiWork es el workspace oficial y open source de IA de diseño del proyecto nexu-io/open-design. Convierte un coding agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode o Qwen — en un motor de diseño con skills componibles y sistemas DESIGN.md portables.',
    },
    {
      q: '¿SankiWork es oficial?',
      a: 'Sí. El sitio canónico es {origin} y el código fuente está en GitHub en {repo}. "SankiWork", "SankiWork", "sankiwork" y "SankiWork AI" apuntan al mismo proyecto.',
      official: true,
    },
    {
      q: '¿En qué se diferencia de Claude Design?',
      a: 'Claude Design es un producto alojado ligado a un solo proveedor. SankiWork es local-first, open source Apache-2.0 y BYOK: usas tu propio agent, claves y sistema DESIGN.md.',
    },
    {
      q: '¿SankiWork corre localmente?',
    ...
    },
    {
      ...
      a: 'Solo tu prompt y el contexto de skills van al proveedor cuyas claves aportas (BYOK). SankiWork no tiene servidor propio: el daemon habla directamente con tu proveedor. Los artifacts generados quedan como archivos en tu directorio de proyecto, no en la nube de ningún vendor.',
    },
    {
      q: '¿Puedo usar SankiWork sin instalar la CLI ni la app de escritorio?',
      a: 'Hoy no. SankiWork es local-first por diseño: el mínimo es un daemon local más un agent (Claude Code, Codex, Cursor, Gemini CLI o uno de los 17 adaptadores soportados). Un sandbox alojado está en el roadmap pero no es la prioridad: los artifacts en tu repo valen más que documentos en la base de datos de otro.',
    },
    {
      q: '¿Cuánto cuesta SankiWork?',
      a: 'El producto es gratuito y Apache-2.0: no existe una suscripción de SankiWork. Pagas los costes de API del proveedor que uses (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, etc.), facturados directamente a tu cuenta. BYOK mantiene las claves y el gasto de tu lado.',
    },
    {
      q: '¿Puedo autoalojar SankiWork en Vercel, Cloudflare o mi propio servidor?',
    ...
    {
      q: '¿Cómo llevo mi marca a SankiWork?',
    ...
    {
      q: '¿Qué hay en el roadmap de SankiWork?',
  ...
  'pt-br': [
    {
      q: 'O SankiWork é uma alternativa open source ao Claude Design?',
      a: 'Sim — o SankiWork é a alternativa open source e local ao Claude Design. Enquanto o Claude Design é fechado, hospedado e preso aos modelos da Anthropic, o SankiWork é Apache-2.0, roda na sua própria máquina e é BYOK: use Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen para conduzi-lo e mantenha cada entrega como arquivos que são seus.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'O que é um vibe design workspace?',
      a: 'Um vibe design workspace é onde você projeta descrevendo a intenção a um agente de IA — do prompt ao protótipo, página web, slides ou vídeo HTML — em vez de posicionar cada elemento à mão. O SankiWork é um vibe design workspace open source e agent-native: integra o coding agent que você já usa a um fluxo de design completo, então uma ferramenta leva você de uma ideia bruta a um resultado pronto e seu.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'O que é SankiWork?',
      a: 'SankiWork é o workspace oficial, open source, de design com IA do projeto nexu-io/open-design. Ele transforma um coding agent local — Claude Code, Codex, Cursor, Gemini CLI, OpenCode ou Qwen — em um motor de design movido por skills componíveis e sistemas DESIGN.md portáteis.',
    },
    {
      q: 'SankiWork é oficial?',
      a: 'Sim. O site canônico é {origin} e o código-fonte está no GitHub em {repo}. "SankiWork", "SankiWork", "sankiwork" e "SankiWork AI" apontam para o mesmo projeto.',
      official: true,
    },
    {
      q: 'Qual a diferença para o Claude Design?',
      a: 'Claude Design é um produto hospedado preso a um fornecedor. SankiWork é local-first, open source Apache-2.0 e BYOK: você traz seu agent, suas chaves e seu sistema DESIGN.md.',
    },
    {
      q: 'SankiWork roda localmente?',
    ...
    },
    {
      ...
      a: 'Só o seu prompt e o contexto de skills vão para o provedor cujas chaves você traz (BYOK). O SankiWork não tem servidor próprio — o daemon fala diretamente com o seu provedor. Os artifacts gerados ficam como arquivos no diretório do projeto, não na nuvem de nenhum vendor.',
    },
    {
      q: 'Posso usar o SankiWork sem instalar a CLI ou o app desktop?',
      a: 'Hoje não. O SankiWork é local-first por design — o mínimo é um daemon local mais um agent (Claude Code, Codex, Cursor, Gemini CLI ou um dos 17 adaptadores suportados). Um sandbox hospedado está no roadmap, mas não é prioridade: artifacts no seu repo valem mais que documentos no banco de dados de outra pessoa.',
    },
    {
      q: 'Quanto custa o SankiWork?',
      a: 'O produto é gratuito e Apache-2.0 — não existe assinatura do SankiWork. Você paga os custos de API do provedor que usar (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot etc.), cobrados direto na sua conta. O BYOK mantém as chaves e o gasto do seu lado.',
    },
    {
      q: 'Posso auto-hospedar o SankiWork na Vercel, Cloudflare ou no meu servidor?',
    ...
    {
      q: 'Como levo minha marca para o SankiWork?',
    ...
    {
      q: 'O que tem no roadmap do SankiWork?',
  ...
  it: [
    {
      q: 'SankiWork è un’alternativa open source a Claude Design?',
      a: 'Sì — SankiWork è l’alternativa open source e locale a Claude Design. Dove Claude Design è chiuso, ospitato e legato ai modelli Anthropic, SankiWork è Apache-2.0, gira sulla tua macchina ed è BYOK: guidalo con Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen e conserva ogni risultato come file tuoi.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Che cos’è un vibe design workspace?',
      a: 'Un vibe design workspace è uno spazio in cui progetti descrivendo l’intento a un agente IA — dal prompt al prototipo, pagina web, slide o video HTML — invece di posizionare ogni elemento a mano. SankiWork è un vibe design workspace open source e agent-native: collega il coding agent che già usi a un flusso di design completo, così un solo strumento ti porta da un’idea grezza a un risultato pronto e tuo.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: "Cos'è SankiWork?",
      a: 'SankiWork è il workspace ufficiale e open source di AI design del progetto nexu-io/open-design. Trasforma un coding agent locale — Claude Code, Codex, Cursor, Gemini CLI, OpenCode o Qwen — in un motore di design guidato da skill componibili e sistemi DESIGN.md portabili.',
    },
    {
      q: 'SankiWork è ufficiale?',
      a: 'Sì. Il sito canonico è {origin} e il codice sorgente è su GitHub in {repo}. "SankiWork", "SankiWork", "sankiwork" e "SankiWork AI" indicano lo stesso progetto.',
      official: true,
    },
    {
      q: 'In cosa differisce da Claude Design?',
      a: 'Claude Design è un prodotto hosted legato a un solo vendor. SankiWork è local-first, open source Apache-2.0 e BYOK: usi il tuo agent, le tue chiavi e il tuo sistema DESIGN.md.',
    },
    {
      q: 'SankiWork gira in locale?',
    ...
    },
    {
      ...
      a: 'Al provider di cui porti le chiavi (BYOK) arrivano solo il tuo prompt e il contesto delle skill. SankiWork non ha server propri — il daemon parla direttamente con il tuo provider. Gli artifact generati restano come file nella directory del progetto, non nel cloud di un vendor.',
    },
    {
      q: 'Posso usare SankiWork senza installare la CLI o l\'app desktop?',
      a: 'Oggi no. SankiWork è local-first per progettazione — il minimo è un daemon locale più un agent (Claude Code, Codex, Cursor, Gemini CLI o uno dei 17 adapter supportati). Una sandbox hosted è nella roadmap ma non è la priorità: gli artifact nel tuo repo battono i documenti nel database di qualcun altro.',
    },
    {
      q: 'Quanto costa SankiWork?',
      a: 'Il prodotto è gratuito e Apache-2.0 — non esiste un abbonamento SankiWork. Paghi solo i costi API del provider che usi (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, ecc.), addebitati direttamente sul tuo account. Il BYOK tiene chiavi e spesa dalla tua parte.',
    },
    {
      q: 'Posso self-hostare SankiWork su Vercel, Cloudflare o un mio server?',
    ...
    {
      q: 'Come porto il mio brand in SankiWork?',
    ...
    {
      q: 'Cosa c\'è nella roadmap di SankiWork?',
  ...
  vi: [
    {
      q: 'SankiWork là gì?',
      a: 'SankiWork là workspace thiết kế AI mã nguồn mở chính thức của dự án nexu-io/open-design. Nó biến coding agent chạy trên máy bạn — Claude Code, Codex, Cursor, Gemini CLI, OpenCode hoặc Qwen — thành engine thiết kế dựa trên skill ghép được và hệ DESIGN.md di động.',
    },
    {
      q: 'SankiWork có phải dự án chính thức không?',
      a: 'Có. Trang canonical là {origin}, mã nguồn ở GitHub: {repo}. "SankiWork", "SankiWork", "sankiwork" và "SankiWork AI" đều chỉ cùng một dự án.',
      official: true,
    },
    {
      q: 'Khác gì Claude Design?',
      a: 'Claude Design là sản phẩm hosted gắn với một nhà cung cấp. SankiWork local-first, open source Apache-2.0 và BYOK: bạn dùng agent, key và hệ DESIGN.md của chính mình.',
    },
    {
      q: 'SankiWork chạy local được không?',
    ...
    },
    {
      ...
      a: 'Chỉ prompt và ngữ cảnh skill của bạn được gửi tới nhà cung cấp mà bạn mang key tới (BYOK). SankiWork không có máy chủ riêng — daemon nói chuyện trực tiếp với nhà cung cấp của bạn. Artifact tạo ra nằm dưới dạng file trong thư mục dự án, không vào đám mây của vendor nào.',
    },
    {
      q: 'Có thể dùng SankiWork mà không cài CLI hay app desktop không?',
      a: 'Hiện chưa. SankiWork được thiết kế local-first — tối thiểu cần một daemon cục bộ cộng một agent (Claude Code, Codex, Cursor, Gemini CLI hoặc một trong 17 adapter được hỗ trợ). Sandbox hosted có trong roadmap nhưng không phải ưu tiên: artifact trong repo của bạn tốt hơn tài liệu trong cơ sở dữ liệu của người khác.',
    },
    {
      q: 'SankiWork giá bao nhiêu?',
      a: 'Sản phẩm miễn phí và theo Apache-2.0 — không có gói thuê bao SankiWork. Bạn chỉ trả chi phí API của nhà cung cấp mình dùng (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, v.v.), tính thẳng vào tài khoản của bạn. BYOK giữ cả key lẫn chi tiêu ở phía bạn.',
    },
    {
      q: 'Có thể self-host SankiWork trên Vercel, Cloudflare hay server riêng không?',
    ...
    {
      q: 'Làm sao đưa thương hiệu của tôi vào SankiWork?',
  ...
  pl: [
    {
      q: 'Czym jest SankiWork?',
      a: 'SankiWork to oficjalny, open-source workspace AI design projektu nexu-io/open-design. Zamienia lokalnego coding agenta — Claude Code, Codex, Cursor, Gemini CLI, OpenCode albo Qwen — w silnik designu oparty o kompozycyjne skills i przenośne systemy DESIGN.md.',
    },
    {
      q: 'Czy SankiWork jest oficjalne?',
      a: 'Tak. Kanoniczna strona to {origin}, a kod źródłowy jest na GitHubie: {repo}. "SankiWork", "SankiWork", "sankiwork" i "SankiWork AI" oznaczają ten sam projekt.',
      official: true,
    },
    {
      q: 'Czym różni się od Claude Design?',
      a: 'Claude Design to hostowany produkt jednego dostawcy. SankiWork jest local-first, open source Apache-2.0 i BYOK: używasz własnego agenta, kluczy i systemu DESIGN.md.',
    },
    {
      q: 'Czy SankiWork działa lokalnie?',
    ...
    },
    {
      ...
      a: 'Do dostawcy, którego klucze przynosisz (BYOK), trafia tylko Twój prompt i kontekst skills. SankiWork nie ma własnego serwera — daemon rozmawia z Twoim dostawcą bezpośrednio. Wygenerowane artifacts lądują jako pliki w katalogu projektu, a nie w chmurze żadnego vendora.',
    },
    {
      q: 'Czy mogę używać SankiWork bez instalowania CLI ani aplikacji desktop?',
      a: 'Dziś nie. SankiWork jest local-first z założenia — minimum to lokalny daemon plus agent (Claude Code, Codex, Cursor, Gemini CLI albo jeden z 17 wspieranych adapterów). Hostowany sandbox jest w roadmapie, ale nie jest priorytetem: artifacts w Twoim repo są lepsze niż dokumenty w cudzej bazie danych.',
    },
    {
      q: 'Ile kosztuje SankiWork?',
      a: 'Produkt jest darmowy i na licencji Apache-2.0 — nie istnieje subskrypcja SankiWork. Płacisz tylko koszty API dostawcy, którego używasz (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot itd.), rozliczane bezpośrednio na Twoim koncie. BYOK trzyma i klucze, i wydatki po Twojej stronie.',
    },
    {
      q: 'Czy mogę self-hostować SankiWork na Vercel, Cloudflare albo własnym serwerze?',
    ...
    {
      q: 'Jak przenieść moją markę do SankiWork?',
    ...
    {
      q: 'Co jest w roadmapie SankiWork?',
  ...
  id: [
    {
      q: 'Apa itu SankiWork?',
      a: 'SankiWork adalah workspace AI design resmi dan open source dari proyek nexu-io/open-design. Ia mengubah coding agent lokal — Claude Code, Codex, Cursor, Gemini CLI, OpenCode, atau Qwen — menjadi mesin desain berbasis skill komposable dan sistem DESIGN.md portabel.',
    },
    {
      q: 'Apakah SankiWork resmi?',
      a: 'Ya. Situs canonical ada di {origin} dan source code ada di GitHub: {repo}. "SankiWork", "SankiWork", "sankiwork", dan "SankiWork AI" merujuk ke proyek yang sama.',
      official: true,
    },
    {
      q: 'Apa bedanya dengan Claude Design?',
      a: 'Claude Design adalah produk hosted yang terikat pada satu vendor. SankiWork local-first, open source Apache-2.0, dan BYOK: Anda memakai agent, key, dan sistem DESIGN.md sendiri.',
    },
    {
      q: 'Apakah SankiWork berjalan lokal?',
    ...
    },
    {
      ...
      a: 'Hanya prompt dan konteks skill Anda yang pergi ke provider yang key-nya Anda bawa (BYOK). SankiWork tidak punya server sendiri — daemon bicara langsung dengan provider Anda. Artifact yang dihasilkan tersimpan sebagai file di direktori proyek, bukan di cloud vendor mana pun.',
    },
    {
      q: 'Bisakah memakai SankiWork tanpa menginstal CLI atau app desktop?',
      a: 'Belum bisa. SankiWork memang local-first — minimumnya adalah daemon lokal plus satu agent (Claude Code, Codex, Cursor, Gemini CLI, atau salah satu dari 17 adapter yang didukung). Sandbox hosted ada di roadmap tapi bukan prioritas: artifact di repo Anda lebih baik daripada dokumen di database orang lain.',
    },
    {
      q: 'Berapa biaya SankiWork?',
      a: 'Produknya gratis dan Apache-2.0 — tidak ada langganan SankiWork. Anda hanya membayar biaya API provider yang Anda pakai (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, dll.), ditagih langsung ke akun Anda. BYOK menjaga key dan pengeluaran tetap di sisi Anda.',
    },
    {
      q: 'Bisakah self-host SankiWork di Vercel, Cloudflare, atau server sendiri?',
    ...
    {
      q: 'Bagaimana memindahkan brand saya ke SankiWork?',
    ...
    {
      q: 'Apa saja di roadmap SankiWork?',
  ...
  nl: [
    {
      q: 'Wat is SankiWork?',
      a: 'SankiWork is de officiële open-source AI design workspace van het project nexu-io/open-design. Het verandert een lokale coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode of Qwen — in een design-engine met combineerbare skills en draagbare DESIGN.md-systemen.',
    },
    {
      q: 'Is SankiWork officieel?',
      a: 'Ja. De canonieke site is {origin} en de broncode staat op GitHub: {repo}. "SankiWork", "SankiWork", "sankiwork" en "SankiWork AI" verwijzen naar hetzelfde project.',
      official: true,
    },
    {
      q: 'Wat is het verschil met Claude Design?',
      a: 'Claude Design is een hosted product van één leverancier. SankiWork is local-first, Apache-2.0 open source en BYOK: je gebruikt je eigen agent, sleutels en DESIGN.md-systeem.',
    },
    {
      q: 'Draait SankiWork lokaal?',
    ...
    },
    {
      ...
      a: 'Alleen je prompt en de skill-context gaan naar de provider waarvoor je zelf sleutels meebrengt (BYOK). SankiWork heeft geen eigen server — de daemon praat rechtstreeks met je provider. Gegenereerde artifacts komen als bestanden in je projectdirectory terecht, niet in de cloud van een vendor.',
    },
    {
      q: 'Kan ik SankiWork gebruiken zonder de CLI of desktop-app te installeren?',
      a: 'Vandaag niet. SankiWork is bewust local-first — het minimum is een lokale daemon plus een agent (Claude Code, Codex, Cursor, Gemini CLI of een van de 17 ondersteunde adapters). Een gehoste sandbox staat op de roadmap maar is geen prioriteit: artifacts in je repo verslaan documenten in andermans database.',
    },
    {
      q: 'Wat kost SankiWork?',
      a: 'Het product is gratis en Apache-2.0 — er bestaat geen SankiWork-abonnement. Je betaalt alleen de API-kosten van de provider die je gebruikt (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot, enz.), rechtstreeks via je eigen account. BYOK houdt zowel de sleutels als de uitgaven aan jouw kant.',
    },
    {
      q: 'Kan ik SankiWork self-hosten op Vercel, Cloudflare of mijn eigen server?',
    ...
    {
      q: 'Hoe breng ik mijn merk naar SankiWork?',
    ...
    {
      q: 'Wat staat er op de roadmap van SankiWork?',
  ...
  ar: [
    {
      q: 'ما هو SankiWork؟',
      a: 'SankiWork هو مساحة عمل تصميم بالذكاء الاصطناعي رسمية ومفتوحة المصدر من مشروع nexu-io/open-design. يحوّل coding agent محلياً مثل Claude Code أو Codex أو Cursor أو Gemini CLI أو OpenCode أو Qwen إلى محرك تصميم يعمل عبر skills قابلة للتركيب وأنظمة DESIGN.md قابلة للنقل.',
    },
    {
      q: 'هل SankiWork رسمي؟',
      a: 'نعم. الموقع canonical هو {origin} والمصدر على GitHub في {repo}. تشير "SankiWork" و"SankiWork" و"sankiwork" و"SankiWork AI" إلى المشروع نفسه.',
      official: true,
    },
    {
      q: 'ما الفرق عن Claude Design؟',
      a: 'Claude Design منتج مستضاف مرتبط بمورّد واحد. SankiWork محلي أولاً، مفتوح المصدر وفق Apache-2.0، وBYOK: تستخدم agent ومفاتيحك ونظام DESIGN.md الخاص بك.',
    },
    {
      q: 'هل يعمل SankiWork محلياً؟',
    ...
    },
    {
      ...
      a: 'لا يذهب إلى المزوّد الذي تجلب مفاتيحه (BYOK) سوى الـ prompt وسياق الـ skills. لا يملك SankiWork خادماً خاصاً به — يتواصل الـ daemon مع مزوّدك مباشرة. وتُحفظ الـ artifacts الناتجة كملفات في مجلد مشروعك، لا في سحابة أي مورّد.',
    },
    {
      q: 'هل يمكن استخدام SankiWork دون تثبيت CLI أو تطبيق سطح المكتب؟',
      a: 'ليس حالياً. صُمم SankiWork ليكون محلياً أولاً — الحد الأدنى هو daemon محلي مع agent واحد (Claude Code أو Codex أو Cursor أو Gemini CLI أو أحد الـ 17 adapter المدعومة). البيئة المستضافة موجودة في خارطة الطريق لكنها ليست أولوية: الـ artifacts في مستودعك أفضل من مستندات في قاعدة بيانات شخص آخر.',
    },
    {
      q: 'كم يكلّف SankiWork؟',
      a: 'المنتج مجاني وبرخصة Apache-2.0 — لا يوجد اشتراك في SankiWork. تدفع فقط تكاليف API للمزوّد الذي تستخدمه (Anthropic أو OpenAI أو Google أو Mistral أو xAI أو Moonshot وغيرها)، وتُحاسب مباشرة على حسابك. يبقي BYOK المفاتيح والإنفاق في جانبك.',
    },
    {
      q: 'هل يمكن استضافة SankiWork ذاتياً على Vercel أو Cloudflare أو خادمي الخاص؟',
    ...
    {
      q: 'كيف أنقل علامتي التجارية إلى SankiWork؟',
    ...
    {
      q: 'ماذا في خارطة طريق SankiWork؟',
  ...
  tr: [
    {
      q: 'SankiWork açık kaynaklı bir Claude Design alternatifi mi?',
      a: 'Evet — SankiWork açık kaynaklı, yerel çalışan Claude Design alternatifidir. Claude Design kapalı, barındırılan ve Anthropic modellerine kilitliyken; SankiWork Apache-2.0’dır, kendi makinende çalışır ve BYOK’tur: Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen ile çalıştır, her çıktıyı sana ait dosyalar olarak sakla.',
      href: '/alternatives/claude-design/',
    },
    {
      q: 'Vibe design workspace nedir?',
      a: 'Vibe design workspace, her öğeyi elle yerleştirmek yerine bir yapay zeka ajanına niyetini anlatarak tasarım yaptığın yerdir — prompttan prototipe, web sayfasına, slaytlara veya HTML videoya. SankiWork açık kaynaklı, agent-native bir vibe design workspace’tir: hâlihazırda kullandığın kodlama ajanını eksiksiz bir tasarım akışına bağlar; tek bir araç seni kaba bir fikirden sana ait, teslime hazır bir sonuca götürür.',
      href: '/blog/what-is-vibe-design/',
    },
    {
      q: 'SankiWork nedir?',
      a: "SankiWork, nexu-io/open-design projesinin resmi açık kaynak AI design workspace'idir. Claude Code, Codex, Cursor, Gemini CLI, OpenCode veya Qwen gibi yerel coding agent'ları, birleştirilebilir skill'ler ve taşınabilir DESIGN.md sistemleriyle çalışan bir tasarım motoruna dönüştürür.",
    },
    {
      q: 'SankiWork resmi mi?',
      a: 'Evet. Kanonik site {origin}, kaynak kod GitHub üzerinde {repo}. "SankiWork", "SankiWork", "sankiwork" ve "SankiWork AI" aynı projeyi anlatır.',
      official: true,
    },
    {
      q: "Claude Design'dan farkı ne?",
      a: 'Claude Design tek bir vendor’a bağlı hosted bir üründür. SankiWork local-first, Apache-2.0 açık kaynak ve BYOK’tur: kendi agent’ını, anahtarlarını ve DESIGN.md sistemini kullanırsın.',
    },
    {
      q: 'SankiWork yerelde çalışır mı?',
    ...
    },
    {
      ...
      a: 'Yalnızca prompt\'unuz ve skill bağlamı, anahtarlarını kendinizin getirdiği (BYOK) sağlayıcıya gider. SankiWork\'ın kendi sunucusu yoktur — daemon doğrudan sağlayıcınızla konuşur. Üretilen artifact\'ler herhangi bir vendor bulutuna değil, proje dizininize dosya olarak düşer.',
    },
    {
      q: 'CLI veya desktop app kurmadan SankiWork kullanılabilir mi?',
      a: 'Bugün için hayır. SankiWork tasarımı gereği local-first\'tür — minimum, yerel bir daemon artı bir agent\'tır (Claude Code, Codex, Cursor, Gemini CLI veya desteklenen 17 adapter\'dan biri). Hosted bir sandbox roadmap\'te var ama öncelik değil: repo\'nuzdaki artifact\'ler, başkasının veritabanındaki belgelerden iyidir.',
    },
    {
      q: 'SankiWork\'ın maliyeti nedir?',
      a: 'Ürün ücretsiz ve Apache-2.0 lisanslıdır — SankiWork aboneliği yoktur. Yalnızca kullandığınız sağlayıcının (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot vb.) API maliyetini ödersiniz; doğrudan kendi hesabınıza faturalandırılır. BYOK hem anahtarları hem harcamayı sizin tarafınızda tutar.',
    },
    {
      q: 'SankiWork\'ı Vercel, Cloudflare veya kendi sunucumda self-host edebilir miyim?',
    ...
    {
      q: 'Markamı SankiWork\'a nasıl taşırım?',
    ...
    {
      q: 'SankiWork roadmap\'inde neler var?',
  ...
  uk: [
    {
      q: 'Що таке SankiWork?',
      a: 'SankiWork — офіційний open-source AI design workspace проєкту nexu-io/open-design. Він перетворює локальний coding agent — Claude Code, Codex, Cursor, Gemini CLI, OpenCode або Qwen — на design-двигун із composable skills і переносними DESIGN.md-системами.',
    },
    {
      q: 'SankiWork офіційний?',
      a: 'Так. Канонічний сайт — {origin}, вихідний код на GitHub: {repo}. "SankiWork", "SankiWork", "sankiwork" і "SankiWork AI" означають один проєкт.',
      official: true,
    },
    {
      q: 'Чим він відрізняється від Claude Design?',
      a: 'Claude Design — hosted-продукт одного вендора. SankiWork — local-first, Apache-2.0 open source і BYOK: ви використовуєте свого agent, свої ключі та свою DESIGN.md-систему.',
    },
    {
      q: 'SankiWork запускається локально?',
    ...
    },
    {
      ...
      a: 'Провайдеру, чиї ключі ви принесли (BYOK), іде лише ваш prompt і контекст skills. В SankiWork немає власного сервера — daemon спілкується з вашим провайдером напряму. Generated artifacts зберігаються файлами в папці проєкту, а не в хмарі вендора.',
    },
    {
      q: 'Чи можна користуватися SankiWork без встановлення CLI чи desktop-застосунку?',
      a: 'Поки ні. SankiWork за задумом local-first — мінімум це локальний daemon плюс agent (Claude Code, Codex, Cursor, Gemini CLI або один із 17 підтримуваних adapters). Hosted-пісочниця є в роадмапі, але не в пріоритеті: artifacts у вашому репозиторії кращі за документи в чужій базі даних.',
    },
    {
      q: 'Скільки коштує SankiWork?',
      a: 'Продукт безплатний і під Apache-2.0 — підписки SankiWork не існує. Ви платите лише за API того провайдера, яким користуєтеся (Anthropic, OpenAI, Google, Mistral, xAI, Moonshot тощо), напряму зі свого акаунта. BYOK залишає і ключі, і витрати на вашому боці.',
    },
    {
      q: 'Чи можна self-host SankiWork на Vercel, Cloudflare або власному сервері?',
    ...
    {
      q: 'Як перенести свій бренд в SankiWork?',
...
const HOME_PAGE_COPY_EN: HomePageCopy = {
  rail: {
    right: 'SankiWork — Vol. 01 · Issue Nº 26 · Apache-2.0',
    left: 'Skills · Systems · Agents · BYOK · Local-first',
  },
  hero: {
    discordAria: 'Join the SankiWork Discord',
    ...
    lead: (skills, systems) =>
      `SankiWork is the official, local-first alternative to Claude Design. Your existing coding agent — Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen — becomes the design engine, driven by ${skills} composable skills and ${systems} portable DESIGN.md systems.`,
  ...
  official: {
    aria: 'Official SankiWork sources',
    label: 'Official source',
    items: [
      { label: 'Official site', value: 'sanki-ai.cloud' },
  ...
  about: {
    ...
    caption: 'Studies in form · perception · machine imagination. (SankiWork, MMXXVI)',
  },
  capabilities: {
    rule: 'Capabilities · Skills · Systems',
    surfaces: '4 surfaces / 1 loop',
    ribbon: 'SANKIWORK · CAPABILITIES MATRIX · OD/26',
    label: 'Capabilities',
  ...
  testimonial: {
    ...
    label: 'Collaborators',
    quote:
      '“SankiWork helped us turn vague AI ideas into a visual system that felt sharp, believable, and genuinely new.”',
  ...
  footer: {
    ...
    downloadAria: 'Download the SankiWork desktop app',
    download: 'Download desktop',
    columns: {
      studio: 'Studio',
      library: 'Library',
    ...
    bottomLeft: 'SankiWork · Apache-2.0 · 2026 / Volume 01 / Issue Nº 26',
...
const HOME_PAGE_COPY: Partial<Record<LandingLocaleCode, HomePageCopy>> = {
  ...
  zh: {
    rail: {
      right: 'SankiWork — 第 01 卷 · 第 26 期 · Apache-2.0',
      left: 'Skills · UIUX Design · Agents · BYOK · 本地优先',
    },
    hero: {
      discordAria: '加入 SankiWork Discord',
      ...
      lead: (skills) =>
        `SankiWork 是官方、本地优先的 Claude Design 替代方案。你现有的编码 Agent —— Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen —— 会变成设计引擎，并由 ${skills} 个可组合 SKILL.md 工作流驱动。`,
      star: 'Download',
      download: '下载桌面端',
      plate: '图版 Nº 08',
      composedIn: '由',
    ...
    official: {
      ...
      label: '官方来源',
      items: [
        { label: '官方网站', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: '形式 · 感知 · 机器想象力研究。（SankiWork，MMXXVI）',
    },
    capabilities: {
      rule: '能力 · Skill · 规范',
      surfaces: '4 个表面 / 1 个循环',
      ribbon: 'SANKIWORK · 能力矩阵 · OD/26',
      label: '能力',
    ...
    testimonial: {
      ...
      shoulders: '站在前人的肩膀上',
      label: '协作者',
      quote: '来自全球，100+ 贡献者正在一起构建 SankiWork',
      authorName: 'Mina Kovac',
    ...
    footer: {
      ...
      downloadAria: '下载 SankiWork 桌面应用',
      download: '下载桌面端',
      columns: {
        studio: '工作室',
        library: 'Skill',
    ...
    libraryLinks: {
      ...
      bottomLeft: 'SankiWork · Apache-2.0 · 2026 / 第 01 卷 / 第 26 期',
...
HOME_PAGE_COPY['zh-tw'] = {
  ...
  hero: {
    ...
    titleSecondEmphasis: '你自己的 Agent 上',
    lead: (skills, systems) =>
      `SankiWork 是官方、本地優先的 Claude Design 替代方案。你現有的 coding agent —— Claude Code · Codex · Cursor · Gemini · OpenCode · Qwen —— 會變成設計引擎，並由 ${skills} 個可組合 Skill 與 ${systems} 套可攜式 DESIGN.md 系統驅動。`,
  ...
  official: {
    ...
    label: '官方來源',
    items: [
      { label: '官方網站', value: 'sanki-ai.cloud' },
  ...
  about: {
    ...
    caption: '形式 · 感知 · 機器想像力研究。（SankiWork，MMXXVI）',
  },
  capabilities: {
    ...HOME_PAGE_COPY.zh!.capabilities,
    rule: '能力 · Skill · 系統',
    ribbon: 'SANKIWORK · 能力矩陣 · OD/26',
  ...
  testimonial: {
    ...
    shoulders: '站在前人的肩膀上',
    label: '協作者',
    quote: '“SankiWork 幫我們把模糊的 AI 想法變成了一個視覺系統：鋒利、可信，而且真的有新意。”',
  ...
  footer: {
    ...
    downloadAria: '下載 SankiWork 桌面應用',
    download: '下載桌面端',
    columns: {
      studio: '工作室',
      library: '資源庫',
...
const LANDING_UI_COPY: LandingUiCopy = {
  ...
  blog: {
    title: 'Blog',
    seoTitle: 'Blog — SankiWork',
    description:
      'Notes to help you understand, explore, and build with SankiWork — across product, guides, use cases, and community.',
  ...
  tutorials: {
    title: 'SankiWork Tutorials',
    seoTitle: 'SankiWork Tutorials — Free Video Guides & How-Tos',
    description:
      'Learn how to use SankiWork with step-by-step video tutorials — getting started, plugins, design systems, and real workflows. Every guide plays right on the page.',
    ...
    contributeTitle: 'Made an SankiWork tutorial?',
    contributeBody:
    ...
    detailTitle: (title) => `${title} — SankiWork Tutorials`,
  ...
  catalog: {
    ...
    skills: {
      title: (count) => `Skills — ${count} composable design capabilities | SankiWork`,
      description:
        'Browse the full SankiWork skills catalog: 100+ file-based SKILL.md bundles spanning decks, prototypes, dashboards, mobile flows, video, and live artifacts. Each skill is a folder you drop into the daemon.',
      label: 'Catalog · Nº 01',
      ...
      featured: 'Featured',
      allAria: 'All skills',
      detailTitle: (name) => `${name} — SankiWork skill`,
      detailFallbackDescription: (name) => `SankiWork skill bundle: ${name}.`,
      detailLabel: 'Skill',
      ...
      filterTitle: (heading, count) =>
        `${heading} skills — ${count} SankiWork ${heading.toLowerCase()} agents`,
      modeDescription: (heading, count) =>
        `Every SankiWork skill that produces ${heading.toLowerCase()} artifacts. ${count} ready-to-run, system-aware agents — installable through the daemon, brand-locked through any DESIGN.md system.`,
      scenarioDescription: (heading, count) =>
        `Every SankiWork skill in the ${heading.toLowerCase()} scenario. ${count} ready-to-run agents covering decks, prototypes, templates, and live artifacts — all brand-locked through any DESIGN.md.`,
    ...
    systems: {
      title: (count) => `Design Systems — ${count} portable visual systems | SankiWork`,
      description:
        'Browse the full SankiWork design systems catalog: 100+ DESIGN.md token bundles spanning editorial, productivity, brand, futuristic, and minimalist systems. Pick one in the daemon top-bar and every skill renders in that visual language.',
      label: 'Catalog · Nº 02',
      ...
      category: 'Category',
      allAria: 'All systems',
      detailTitle: (name) => `${name} — SankiWork design system`,
      detailFallbackDescription: (name, category) =>
        `SankiWork system bundle: ${name}, ${category}.`,
      ...
      categoryDescription: (heading, count) =>
        `Every SankiWork design system tagged ${heading.toLowerCase()}. ${count} portable DESIGN.md token bundles — ready to pair with any skill in the catalog for instant brand-grade output.`,
    ...
    templates: {
      title: (count) => `Templates — ${count} ready-to-fork artifact templates | SankiWork`,
      description:
      ...
      detailTitle: (name) => `${name} — SankiWork template`,
    ...
    craft: {
      title: (count) => `Craft — ${count} brand-agnostic rendering principles | SankiWork`,
      description:
        'Universal craft rules every SankiWork skill can opt into: accessibility, animation discipline, color, form validation, laws of UX, RTL/Bidi, state coverage, and typography hierarchy.',
      label: 'Catalog · Nº 03',
      ...
      detailTitle: (name) => `${name} — SankiWork craft principle`,
      detailFallbackDescription: (name) => `SankiWork craft rule: ${name}.`,
  ...
  plugins: {
    registryTitle: 'SankiWork Plugins — Official and community registries',
    registryDescription: (count) =>
      `Browse ${count} SankiWork plugins from official and community registries. Search installable agent-native design workflows with stable vendor/plugin IDs.`,
    directoryRailRight: 'SankiWork Registry · Official · Community',
    ...
    details: 'Details',
    detailTitle: (title) => `${title} — SankiWork Plugin`,
    detailDescription: (description, command) => `${description} Install with ${command}.`,
    detailRailRight: (id) => `SankiWork Plugin · ${id}`,
...
> = {
  zh: {
    ...
    blog: {
      title: '博客',
      seoTitle: '博客 — SankiWork',
      description:
        '理解、探索和构建 SankiWork 的笔记，覆盖产品、指南、使用场景与社区。',
    ...
    tutorials: {
      title: '教程',
      seoTitle: '教程 — SankiWork',
      description:
        '观看 SankiWork 的上手 walkthrough、插件教程、演示、评测与社区视频。所有视频都在页面内播放，并保留原始 YouTube 来源。',
      ...
      contributeTitle: '做过 SankiWork 的教程？',
      contributeBody:
        '把你的视频分享给社区——在简单的表单里贴个链接就行，维护者会把它加到这个页面。',
      contributeCta: '提交一个教程 ↗',
      contributeSuggest: '想直接提 PR？↗',
      thumbnailAlt: (title) => `${title} 的视频封面`,
      detailTitle: (title) => `${title} — SankiWork 教程`,
      localizedTitle: (_title, author) => `SankiWork 教程：${author}`,
      localizedSummary: (_title, author, category) =>
        `${author} 通过一段 ${category} 视频讲解 SankiWork 的本地优先设计工作流、Skill、设计系统与可复用模板。`,
      localizedBodyHtml: (_title, author, summary) =>
        `<p>${summary}</p><h2>本地化摘要</h2><p>这段视频来自 ${author}，围绕 SankiWork 的安装、能力演示、设计系统、Skill 和本地 Agent 工作流展开。页面保留原始视频来源，非英文页面使用站内 i18n 摘要，让正文不会回退成英文。</p>`,
    },
    catalog: {
      skills: {
        title: (count) => `Skill — ${count} 个可组合设计能力 | SankiWork`,
        description:
          '浏览完整的 SankiWork Skill 目录：100+ 个基于 SKILL.md 的文件夹，覆盖演示文稿、原型、数据看板、移动流程、视频与实时 Artifact。每个 Skill 都是一个可放入 daemon 的文件夹。',
        label: '目录 · Nº 01',
        ...
        allAria: '全部 Skill',
        detailTitle: (name) => `${name} — SankiWork Skill`,
        detailFallbackDescription: (name) => `SankiWork Skill 包：${name}。`,
        detailLabel: 'Skill',
        ...
        related: '相关 Skill',
        filterTitle: (heading, count) =>
          `${heading} Skill — ${count} 个 SankiWork ${heading.toLowerCase()} Agent`,
        modeDescription: (heading, count) =>
          `所有生成 ${heading.toLowerCase()} Artifact 的 SankiWork Skill。${count} 个可直接运行、读取系统上下文的 Agent，可以通过 daemon 安装，并通过任意 DESIGN.md 系统锁定品牌。`,
        scenarioDescription: (heading, count) =>
          `${heading.toLowerCase()} 场景下的全部 SankiWork Skill。${count} 个可运行 Agent，覆盖演示文稿、原型、模板与实时 Artifact，并可通过任意 DESIGN.md 锁定品牌。`,
        modeHeading: (heading, count) =>
      ...
      systems: {
        title: (count) => `设计系统 — ${count} 套可移植视觉系统 | SankiWork`,
        description:
          '浏览完整的 SankiWork 设计系统目录：100+ 个 DESIGN.md token 包，覆盖 editorial、productivity、brand、futuristic 与 minimalist 等系统。你可以在 daemon 顶栏选择一个系统，让所有 Skill 以同一种视觉语言渲染。',
        label: '目录 · Nº 02',
        ...
        category: '分类',
        allAria: '全部设计系统',
        detailTitle: (name) => `${name} — SankiWork 设计系统`,
        detailFallbackDescription: (name, category) =>
          `SankiWork 系统包：${name}，${category}。`,
        detailLabel: '设计系统',
        ...
        categoryDescription: (heading, count) =>
          `所有标记为 ${heading.toLowerCase()} 的 SankiWork 设计系统。${count} 套可移植 DESIGN.md token 包，可与目录中任意 Skill 搭配，快速得到品牌级输出。`,
        categoryHeading: (heading, count) =>
      ...
      templates: {
        title: (count) => `模板 — ${count} 个可 fork 的 Artifact 模板 | SankiWork`,
        description:
        ...
        detailTitle: (name) => `${name} — SankiWork 模板`,
        detailLabel: '模板',
      ...
      craft: {
        title: (count) => `工艺规则 — ${count} 条品牌无关渲染原则 | SankiWork`,
        description:
          '每个 SankiWork Skill 都可以声明要加载的通用工艺规则：无障碍、动画纪律、颜色、表单验证、UX 法则、RTL/Bidi、状态覆盖和字体层级。',
        label: '目录 · Nº 03',
        heading: (count) => `工艺规则 — ${count} 条品牌无关渲染原则。`,
        lead:
          'Skill 会声明它需要哪些工艺规则。Agent 会把匹配的规则加载进系统提示，让无障碍、动效、颜色和字体等质量要求在不同视觉系统中保持不变。',
        allAria: '全部工艺规则',
        detailTitle: (name) => `${name} — SankiWork 工艺规则`,
        detailFallbackDescription: (name) => `SankiWork 工艺规则：${name}。`,
        detailLabel: '工艺规则',
    ...
    plugins: {
      registryTitle: 'SankiWork 插件 — 官方与社区注册表',
      registryDescription: (count) =>
        `浏览来自官方与社区注册表的 ${count} 个 SankiWork 插件。搜索可安装的 Agent 原生设计工作流，每个条目都有稳定的 vendor/plugin ID。`,
      directoryRailRight: 'SankiWork 注册表 · 官方 · 社区',
      directoryRailLeft: 'vendor/plugin-name · marketplace.json',
      topbarTitle: 'OD / 注册表',
      topbarSubtitle: '公开索引',
      ...
      details: '详情',
      detailTitle: (title) => `${title} — SankiWork 插件`,
      detailDescription: (description, command) => `${description} 使用 ${command} 安装。`,
      detailRailRight: (id) => `SankiWork 插件 · ${id}`,
      allPlugins: '全部插件',
      registry: '注册表',
      deprecated: '已弃用',
      yanked: '已下架',
  ...
  'zh-tw': {
    ...
    blog: {
      title: '部落格',
      seoTitle: '部落格 — SankiWork',
      description:
        '理解、探索與建構 SankiWork 的筆記，涵蓋產品、指南、使用場景與社群。',
    ...
    tutorials: {
      title: '教學',
      seoTitle: '教學 — SankiWork',
      description:
        '觀看 SankiWork 的上手 walkthrough、外掛教學、演示、評測與社群影片。所有影片都在頁面內播放，並保留原始 YouTube 來源。',
      ...
      contributeTitle: '做過 SankiWork 的教學？',
      contributeBody:
        '把你的影片分享給社群——在簡單的表單裡貼個連結就行，維護者會把它加到這個頁面。',
      contributeCta: '提交一個教學 ↗',
      contributeSuggest: '想直接提 PR？↗',
      thumbnailAlt: (title) => `${title} 的影片封面`,
      detailTitle: (title) => `${title} — SankiWork 教學`,
      localizedTitle: (_title, author) => `SankiWork 教學：${author}`,
      localizedSummary: (_title, author, category) =>
...
const HOME_PAGE_COPY_OVERRIDES: Partial<Record<LandingLocaleCode, DeepPartial<HomePageCopy>>> = {
  ja: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork は公式のローカル優先 Claude Design 代替です。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen など既存の coding agent が、${skills} 個の composable skill と ${systems} 個の portable DESIGN.md system で動くデザインエンジンになります。`,
      star: 'GitHub で Star',
    ...
    faqSection: { rule: 'FAQ', answers: '公式回答', label: 'SankiWork よくある質問', titlePrefix: '', titleMiddle: 'と', titleSuffix: 'Claude Design のオープンソース代替について' },
  ...
  ko: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork은 공식 local-first Claude Design 대안입니다. 이미 쓰는 Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen 같은 coding agent가 ${skills}개의 조합형 skill과 ${systems}개의 portable DESIGN.md system으로 구동되는 디자인 엔진이 됩니다.`,
      star: 'GitHub에서 Star',
      download: '데스크톱 다운로드',
    },
    ...
    faqSection: { rule: 'FAQ', answers: '공식 답변', label: 'SankiWork 자주 묻는 질문', titlePrefix: '', titleMiddle: '및', titleSuffix: 'Claude Design 오픈소스 대안 질문' },
  ...
  de: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork ist die offizielle local-first Alternative zu Claude Design. Dein vorhandener Coding-Agent — Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen — wird zur Design-Engine, gesteuert von ${skills} kombinierbaren Skills und ${systems} portablen DESIGN.md-Systemen.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Offizielle Antworten', label: 'SankiWork-FAQ', titlePrefix: 'Fragen zu', titleMiddle: 'und', titleSuffix: 'der Open-Source-Alternative zu Claude Design' },
  ...
  fr: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork est l'alternative officielle, local-first, à Claude Design. Votre agent de coding — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design piloté par ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Réponses officielles', label: 'FAQ SankiWork', titlePrefix: 'Questions sur', titleMiddle: 'et', titleSuffix: "l'alternative open source à Claude Design" },
  ...
  ru: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится design engine на базе ${skills} composable skills и ${systems} portable DESIGN.md systems.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Официальные ответы', label: 'Вопросы об SankiWork', titlePrefix: 'Вопросы про', titleMiddle: 'и', titleSuffix: 'open-source альтернативу Claude Design' },
  ...
  es: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork es la alternativa oficial, local-first, a Claude Design. Tu coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Respuestas oficiales', label: 'FAQ de SankiWork', titlePrefix: 'Preguntas sobre', titleMiddle: 'y', titleSuffix: 'la alternativa open source a Claude Design' },
  ...
  'pt-br': {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork é a alternativa oficial, local-first, ao Claude Design. Seu coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Respostas oficiais', label: 'FAQ SankiWork', titlePrefix: 'Perguntas sobre', titleMiddle: 'e', titleSuffix: 'a alternativa open source ao Claude Design' },
  ...
  it: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork è l'alternativa ufficiale, local-first, a Claude Design. Il tuo coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Risposte ufficiali', label: 'FAQ SankiWork', titlePrefix: 'Domande su', titleMiddle: 'e', titleSuffix: "l'alternativa open source a Claude Design" },
  ...
  vi: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork là lựa chọn chính thức, local-first, thay Claude Design. Coding agent bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Câu trả lời chính thức', label: 'FAQ SankiWork', titlePrefix: 'Câu hỏi về', titleMiddle: 'và', titleSuffix: 'lựa chọn mã nguồn mở thay Claude Design' },
  ...
  pl: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork to oficjalna, local-first alternatywa dla Claude Design. Twój coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Oficjalne odpowiedzi', label: 'FAQ SankiWork', titlePrefix: 'Pytania o', titleMiddle: 'i', titleSuffix: 'open-source alternatywę dla Claude Design' },
  ...
  id: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork adalah alternatif resmi, local-first, untuk Claude Design. Coding agent yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Jawaban resmi', label: 'FAQ SankiWork', titlePrefix: 'Pertanyaan tentang', titleMiddle: 'dan', titleSuffix: 'alternatif open source untuk Claude Design' },
  ...
  nl: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork is het officiële local-first alternatief voor Claude Design. Je bestaande coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
      star: 'Star op GitHub',
    ...
    faqSection: { rule: 'FAQ', answers: 'Officiële antwoorden', label: 'SankiWork-FAQ', titlePrefix: 'Vragen over', titleMiddle: 'en', titleSuffix: 'het open-source alternatief voor Claude Design' },
  ...
  ar: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول coding agent الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم مدفوع بـ ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'إجابات رسمية', label: 'أسئلة SankiWork', titlePrefix: 'أسئلة حول', titleMiddle: 'و', titleSuffix: 'البديل مفتوح المصدر لـ Claude Design' },
  ...
  tr: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork, Claude Design'ın resmi local-first alternatifidir. Zaten kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle çalışan bir tasarım motoruna dönüşür.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Resmi yanıtlar', label: 'SankiWork SSS', titlePrefix: '', titleMiddle: 've', titleSuffix: "Claude Design'ın açık kaynak alternatifi hakkında sorular" },
  ...
  uk: {
    hero: {
      ...
      lead: (skills, systems) =>
        `SankiWork — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine на базі ${skills} composable skills і ${systems} portable DESIGN.md systems.`,
    ...
    faqSection: { rule: 'FAQ', answers: 'Офіційні відповіді', label: 'FAQ SankiWork українською', titlePrefix: 'Питання про', titleMiddle: 'і', titleSuffix: 'open-source альтернативу Claude Design' },
...
> = {
  ja: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / 第 01 巻 / 第 26 号',
  ...
  ko: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / 01권 / 26호',
  ...
  de: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Band 01 / Ausgabe Nr. 26',
  ...
  fr: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Volume 01 / Numéro 26',
  ...
  ru: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Том 01 / Выпуск № 26',
  ...
  es: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Volumen 01 / Número 26',
  ...
  'pt-br': {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Volume 01 / Edição Nº 26',
  ...
  it: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Volume 01 / Numero 26',
  ...
  vi: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Tập 01 / Số 26',
  ...
  pl: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Tom 01 / Numer 26',
  ...
  id: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Volume 01 / Edisi Nº 26',
  ...
  nl: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Volume 01 / Editie Nº 26',
  ...
  ar: {
    ...
    discord: 'Discord',
    rss: 'RSS',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / المجلد 01 / العدد 26',
  ...
  tr: {
    ...
    htmlVideo: 'HTML Video',
    nexuIo: 'nexu.io',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Cilt 01 / Sayı Nº 26',
  ...
  uk: {
    ...
    htmlVideo: 'HTML Video',
    nexuIo: 'nexu.io',
    bottomLeft: '● SankiWork · Apache-2.0 · 2026 / Том 01 / Випуск № 26',
...
> = {
  ja: {
    ...
    downloadAria: 'SankiWork デスクトップアプリをダウンロード',
    download: 'デスクトップをダウンロード',
    columns: { studio: 'スタジオ', library: 'ライブラリ', connect: '接続', sankiWork: 'SankiWork' },
  ...
  ko: {
    ...
    downloadAria: 'SankiWork 데스크톱 앱 다운로드',
    download: '데스크톱 다운로드',
    columns: { studio: '스튜디오', library: '라이브러리', connect: '연결', sankiWork: 'SankiWork' },
  ...
  de: {
    ...
    downloadAria: 'SankiWork-Desktop-App herunterladen',
    download: 'Desktop herunterladen',
    columns: { studio: 'Studio', library: 'Bibliothek', connect: 'Verbinden', sankiWork: 'SankiWork' },
  ...
  fr: {
    ...
    downloadAria: "Télécharger l'application desktop SankiWork",
    download: 'Télécharger le desktop',
    columns: { studio: 'Studio', library: 'Bibliothèque', connect: 'Connexion', sankiWork: 'SankiWork' },
  ...
  ru: {
    ...
    downloadAria: 'Скачать настольное приложение SankiWork',
    download: 'Скачать desktop',
    columns: { studio: 'Студия', library: 'Библиотека', connect: 'Связь', sankiWork: 'SankiWork' },
  ...
  es: {
    ...
    downloadAria: 'Descargar la aplicación de escritorio de SankiWork',
    download: 'Descargar desktop',
    columns: { studio: 'Estudio', library: 'Biblioteca', connect: 'Conectar', sankiWork: 'SankiWork' },
  ...
  'pt-br': {
    ...
    downloadAria: 'Baixar o aplicativo desktop do SankiWork',
    download: 'Baixar desktop',
    columns: { studio: 'Estúdio', library: 'Biblioteca', connect: 'Conectar', sankiWork: 'SankiWork' },
  ...
  it: {
    ...
    downloadAria: "Scarica l'app desktop di SankiWork",
    download: 'Scarica desktop',
    columns: { studio: 'Studio', library: 'Libreria', connect: 'Connessione', sankiWork: 'SankiWork' },
  ...
  vi: {
    ...
    downloadAria: 'Tải ứng dụng desktop SankiWork',
    download: 'Tải desktop',
    columns: { studio: 'Studio', library: 'Thư viện', connect: 'Kết nối', sankiWork: 'SankiWork' },
  ...
  pl: {
    ...
    downloadAria: 'Pobierz aplikację desktop SankiWork',
    download: 'Pobierz desktop',
    columns: { studio: 'Studio', library: 'Biblioteka', connect: 'Kontakt', sankiWork: 'SankiWork' },
  ...
  id: {
    ...
    downloadAria: 'Unduh aplikasi desktop SankiWork',
    download: 'Unduh desktop',
    columns: { studio: 'Studio', library: 'Pustaka', connect: 'Koneksi', sankiWork: 'SankiWork' },
  ...
  nl: {
    ...
    downloadAria: 'Download de SankiWork desktop-app',
    download: 'Desktop downloaden',
    columns: { studio: 'Studio', library: 'Bibliotheek', connect: 'Verbinden', sankiWork: 'SankiWork' },
  ...
  ar: {
    ...
    downloadAria: 'تنزيل تطبيق SankiWork لسطح المكتب',
    download: 'تنزيل سطح المكتب',
    columns: { studio: 'الاستوديو', library: 'المكتبة', connect: 'التواصل', sankiWork: 'SankiWork' },
  ...
  tr: {
    ...
    downloadAria: 'SankiWork desktop uygulamasını indir',
    download: 'Desktop indir',
    columns: { studio: 'Stüdyo', library: 'Kütüphane', connect: 'Bağlantı', sankiWork: 'SankiWork' },
  ...
  uk: {
    ...
    downloadAria: 'Завантажити настільний застосунок SankiWork',
    download: 'Завантажити desktop',
    columns: { studio: 'Студія', library: 'Бібліотека', connect: "Зв'язок", sankiWork: 'SankiWork' },
...
const LOCALIZED_HOME_BODY_COPY: Partial<Record<LandingLocaleCode, DeepPartial<HomePageCopy>>> = {
  ja: homeFallbackCopy({
    railRight: 'SankiWork — 第 01 巻 · 第 26 号 · Apache-2.0',
    railLeft: 'Skill · Design System · Agent · BYOK · ローカル優先',
    discordAria: 'SankiWork Discord に参加',
    ...
    heroLead: (skills, systems) =>
      `SankiWork は Claude Design の公式ローカル優先代替です。Claude Code、Codex、Cursor、Gemini、OpenCode、Qwen など既存の coding agent が、${skills} 個の組み合わせ可能な Skill と ${systems} 個のポータブル DESIGN.md システムで動くデザインエンジンになります。`,
    star: 'GitHub で Star',
    download: 'デスクトップをダウンロード',
    plate: '図版 Nº 08',
    composedIn: '構成',
    ...
    officialAria: 'SankiWork の公式ソース',
    officialLabel: '公式ソース',
    officialItems: [
      { label: '公式サイト', value: 'sanki-ai.cloud' },
    ...
    about: {
      ...
      caption: '形 · 知覚 · 機械の想像力の研究。（SankiWork, MMXXVI）',
    },
    capabilities: {
      rule: '機能 · Skill · System',
      surfaces: '4 つの表面 / 1 つのループ',
      ribbon: 'SANKIWORK · 機能マトリクス · OD/26',
      label: '機能',
    ...
    testimonial: {
      ...
      shoulders: '先人の肩の上に立つ',
      label: '協働者',
      quote: '「SankiWork は曖昧な AI のアイデアを、鋭く、信頼でき、本当に新しい視覚システムへ変えてくれました。」',
...
LOCALIZED_HOME_BODY_COPY.ko = homeFallbackCopy({
  railRight: 'SankiWork — 01권 · 26호 · Apache-2.0',
  railLeft: 'Skill · 디자인 시스템 · Agent · BYOK · 로컬 우선',
  discordAria: 'SankiWork Discord 참여',
  ...
  heroLead: (skills, systems) =>
    `SankiWork은 Claude Design의 공식 로컬 우선 대안입니다. Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen 같은 기존 coding agent가 ${skills}개의 조합 가능한 Skill과 ${systems}개의 portable DESIGN.md 시스템으로 움직이는 디자인 엔진이 됩니다.`,
  star: 'GitHub에서 Star',
  download: '데스크톱 다운로드',
  plate: '도판 Nº 08',
  composedIn: '구성',
  ...
  officialAria: 'SankiWork 공식 출처',
  officialLabel: '공식 출처',
  officialItems: [
    { label: '공식 사이트', value: 'sanki-ai.cloud' },
  ...
  about: {
    ...
    caption: '형태 · 지각 · 기계적 상상력 연구. (SankiWork, MMXXVI)',
  },
  capabilities: {
    rule: '기능 · Skill · System',
    surfaces: '4개 표면 / 1개 루프',
    ribbon: 'SANKIWORK · 기능 매트릭스 · OD/26',
    label: '기능',
  ...
  testimonial: {
    ...
    label: '협업자',
    quote: '“SankiWork은 모호한 AI 아이디어를 날카롭고 믿을 수 있으며 실제로 새로운 시각 시스템으로 바꾸어 주었습니다.”',
...
LOCALIZED_HOME_BODY_COPY.de = homeFallbackCopy({
  railRight: 'SankiWork — Band 01 · Ausgabe Nr. 26 · Apache-2.0',
  railLeft: 'Skills · Systeme · Agents · BYOK · lokal zuerst',
  discordAria: 'SankiWork Discord beitreten',
  ...
  heroLead: (skills, systems) =>
    `SankiWork ist die offizielle lokal zuerst gedachte Alternative zu Claude Design. Dein vorhandener Coding-Agent — Claude Code, Codex, Cursor, Gemini, OpenCode oder Qwen — wird zur Design-Engine mit ${skills} kombinierbaren Skills und ${systems} portablen DESIGN.md-Systemen.`,
  star: 'Auf GitHub sternen',
  download: 'Desktop herunterladen',
  plate: 'Tafel Nr. 08',
  ...
  officialAria: 'Offizielle SankiWork-Quellen',
  officialLabel: 'Offizielle Quelle',
  officialItems: [
    { label: 'Offizielle Website', value: 'sanki-ai.cloud' },
  ...
  about: {
    ...
    caption: 'Studien zu Form · Wahrnehmung · maschinischer Vorstellungskraft. (SankiWork, MMXXVI)',
  },
  capabilities: {
    rule: 'Fähigkeiten · Skills · Systeme',
    surfaces: '4 Oberflächen / 1 Schleife',
    ribbon: 'SANKIWORK · FÄHIGKEITENMATRIX · OD/26',
    label: 'Fähigkeiten',
  ...
  testimonial: {
    ...
    label: 'Mitwirkende',
    quote: '„SankiWork half uns, vage KI-Ideen in ein visuelles System zu verwandeln, das scharf, glaubwürdig und wirklich neu wirkte.“',
