...
export const LW_META: { en: LaunchWeekMeta } & Record<string, LaunchWeekMeta | undefined> = {
  en: { title: "Launch Week Vol.01: five design launches in five days — SankiWork", description: "SankiWork Launch Week runs Aug 10–14: one new design capability a day, each aimed at a tool your team already pays for. Five days, five design jobs, five targets." },
  zh: { title: "Launch Week Vol.01：五天，五场设计发布 — SankiWork", description: "SankiWork Launch Week 于 8 月 10–14 日举行：每天上线一项新的设计能力，每一项都对准你的团队已经在付费的工具。五天，五项设计任务，五个目标。" },
  ja: { title: "Launch Week Vol.01：5日間で5つのデザイン・ローンチ — SankiWork", description: "SankiWork Launch Week は8月10〜14日開催。毎日ひとつ、新しいデザイン機能を公開します。狙うのは、あなたのチームがすでに課金しているツール。5日間、5つのデザイン業務、5つの標的。" },
  ko: { title: "Launch Week Vol.01: 5일간 다섯 번의 디자인 출시 — SankiWork", description: "SankiWork Launch Week는 8월 10–14일에 열립니다. 매일 하나씩 새로운 디자인 기능을 공개하며, 각각은 팀이 이미 비용을 지불하고 있는 도구를 겨냥합니다. 5일, 다섯 가지 디자인 작업, 다섯 개의 표적." },
  de: { title: "Launch Week Vol.01: fünf Design-Launches in fünf Tagen — SankiWork", description: "SankiWork Launch Week läuft vom 10. bis 14. August: jeden Tag eine neue Design-Fähigkeit, jede auf ein Tool gerichtet, für das dein Team bereits zahlt. Fünf Tage, fünf Design-Aufgaben, fünf Ziele." },
  ru: { title: "Launch Week Vol.01: пять дизайн-запусков за пять дней — SankiWork", description: "SankiWork Launch Week пройдёт 10–14 августа: каждый день — новая дизайн-возможность, и каждая нацелена на инструмент, за который ваша команда уже платит. Пять дней, пять задач, пять целей." },
  fr: { title: "Launch Week Vol.01 : cinq lancements design en cinq jours — SankiWork", description: "L'SankiWork Launch Week se tient du 10 au 14 août : chaque jour une nouvelle capacité de design, chacune visant un outil que votre équipe paie déjà. Cinq jours, cinq métiers du design, cinq cibles." },
  es: { title: "Launch Week Vol.01: cinco lanzamientos de diseño en cinco días — SankiWork", description: "SankiWork Launch Week se celebra del 10 al 14 de agosto: cada día una nueva capacidad de diseño, cada una apuntando a una herramienta que tu equipo ya paga. Cinco días, cinco trabajos de diseño, cinco objetivos." },
  "pt-br": { title: "Launch Week Vol.01: cinco lançamentos de design em cinco dias — SankiWork", description: "A SankiWork Launch Week acontece de 10 a 14 de agosto: a cada dia uma nova capacidade de design, cada uma mirando uma ferramenta que seu time já paga. Cinco dias, cinco trabalhos de design, cinco alvos." },
  it: { title: "Launch Week Vol.01: cinque lanci di design in cinque giorni — SankiWork", description: "L'SankiWork Launch Week si tiene dal 10 al 14 agosto: ogni giorno una nuova capacità di design, ognuna puntata su uno strumento che il tuo team già paga. Cinque giorni, cinque lavori di design, cinque bersagli." },
  tr: { title: "Launch Week Vol.01: beş günde beş tasarım lansmanı — SankiWork", description: "SankiWork Launch Week 10–14 Ağustos'ta: her gün yeni bir tasarım yeteneği, her biri ekibinizin zaten para ödediği bir araca nişan alıyor. Beş gün, beş tasarım işi, beş hedef." },
};
