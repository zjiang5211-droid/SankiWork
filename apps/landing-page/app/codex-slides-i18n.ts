...
export type CodexSlidesCopy = {
  ...
  heading: string;
  lead: string;
  /** Primary CTA label. Names SankiWork explicitly (this is a sister-product
...
const EN: CodexSlidesCopy = {
  ...
  downloadCta: 'Download SankiWork',
  heroAlt:
  ...
  tiebackTitle: 'Part of the SankiWork family',
  tiebackBody:
    'SankiWork is the open, local-first design workspace that sits outside the coding agent you already use. Codex Slides is that same idea aimed at presentations: your agent does the work in the open, the project stays on your machine, and nothing is locked behind a subscription. For the full design toolkit beyond slides, get the SankiWork app.',
  ...
  schemaRelationQuestion: 'Is Codex Slides related to SankiWork?',
  schemaRelationAnswer:
    'Yes. Codex Slides is a sister project from the team behind SankiWork, the same open, local-first, agent-native approach applied to presentations instead of design files.',
};
