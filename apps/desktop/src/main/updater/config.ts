...
export const DESKTOP_UPDATE_ENV = Object.freeze({
  ARCH: "SW_UPDATE_ARCH",
  AUTO_CHECK: "SW_UPDATE_AUTO_CHECK",
  AUTO_DOWNLOAD: "SW_UPDATE_AUTO_DOWNLOAD",
  AUTO_OPEN: "SW_UPDATE_AUTO_OPEN",
  CHECK_BACKOFF_INITIAL_MS: "SW_UPDATE_CHECK_BACKOFF_INITIAL_MS",
  CHECK_BACKOFF_MAX_MS: "SW_UPDATE_CHECK_BACKOFF_MAX_MS",
  CHECK_INITIAL_DELAY_MS: "SW_UPDATE_CHECK_INITIAL_DELAY_MS",
  CHECK_INTERVAL_MS: "SW_UPDATE_CHECK_INTERVAL_MS",
  CHANNEL: "SW_UPDATE_CHANNEL",
  CURRENT_VERSION: "SW_UPDATE_CURRENT_VERSION",
  DOWNLOAD_ROOT: "SW_UPDATE_DOWNLOAD_ROOT",
  ENABLED: "SW_UPDATE_ENABLED",
  INSTALLED_VERSION: "SW_UPDATE_INSTALLED_VERSION",
  METADATA_URL: "SW_UPDATE_METADATA_URL",
  MODE: "SW_UPDATE_MODE",
  OPEN_DRY_RUN: "SW_UPDATE_OPEN_DRY_RUN",
  PLATFORM: "SW_UPDATE_PLATFORM",
} as const);

const DEFAULT_RELEASE_ORIGIN = "https://releases.sanki-ai.cloud";
