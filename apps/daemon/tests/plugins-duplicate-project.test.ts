      ...
      const resp = await fetch(
        `${server.url}/api/plugins/${encodeURIComponent(plugin.id)}/duplicate-project`,
        {
          ...
          headers: {
            ...
            'x-sw-workspace-id': 'workspace-authority',
            'x-sw-workspace-type': 'team',
            'x-sw-workspace-member-id': 'member-authority',
    ...
    try {
      const resp = await fetch(
        `${server.url}/api/plugins/${encodeURIComponent(plugin.id)}/duplicate-project`,
        {
          ...
          headers: {
            'content-type': 'application/json',
            'x-sw-workspace-id': 'workspace-plugin-a',
            'x-sw-workspace-type': 'team',
            'x-sw-workspace-member-id': 'member-plugin-a',
            'x-sw-workspace-role': 'member',
            'x-sw-workspace-lifecycle-state': 'active',
            'x-sw-workspace-member-status': 'active',
            'x-sw-workspace-can-share-projects': 'true',
    ...
    try {
      const resp = await fetch(
        `${server.url}/api/plugins/${encodeURIComponent(plugin.id)}/duplicate-project`,
        {
          ...
          headers: {
            'content-type': 'application/json',
            'x-sw-workspace-id': 'workspace-bind-failure',
            'x-sw-workspace-type': 'team',
            'x-sw-workspace-member-id': 'member-bind-failure',
            'x-sw-workspace-role': 'member',
            'x-sw-workspace-lifecycle-state': 'active',
            'x-sw-workspace-member-status': 'active',
            'x-sw-workspace-can-share-projects': 'true',
    ...
    try {
      const resp = await fetch(
        `${server.url}/api/plugins/${encodeURIComponent(plugin.id)}/duplicate-project`,
        {
          ...
          headers: {
            'content-type': 'application/json',
            'x-sw-workspace-id': 'workspace-sqlite',
            'x-sw-workspace-type': 'team',
            'x-sw-workspace-member-id': 'member-sqlite',
            'x-sw-workspace-role': 'member',
            'x-sw-workspace-lifecycle-state': 'active',
            'x-sw-workspace-member-status': 'active',
            'x-sw-workspace-can-share-projects': 'true',
