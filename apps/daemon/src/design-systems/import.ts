...
import { extractComponentsManifest } from '@sankiwork/contracts/design-systems/components-manifest';
import { renderDesignTokensJson, renderTailwindV4Css } from '@sankiwork/contracts/design-systems/derived-token-outputs';
import {
...
function renderUsageMd(name: string, scan: ProjectScan): string {
  ...
  return [
    `# ${name} Usage`,
    '',
    '> Auto-generated by SankiWork importer. Review and edit before treating it as a canonical brand guide.',
    '',
    '## Read Order',
    '',
