...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows SankiWork's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# SankiWork integration — MUST follow

You are running inside SankiWork, a design tool. The user message contains
