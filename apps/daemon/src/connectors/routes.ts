...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · SankiWork</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="SankiWork">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">SankiWork</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in SankiWork.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        const message = { type: 'sankiwork:connector-connected', connectorId, connectorLabel };
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to SankiWork.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to SankiWork.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to SankiWork.';
        }
