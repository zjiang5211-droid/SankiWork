...
const USAGE = `Usage:
  sw artifacts create --name <path> --input <file> [--project <id-or-name>] [--manifest artifact.json] [--encoding utf8|base64] [--daemon-url <url>]

Creates one normal SankiWork project artifact entry file through the local daemon.
When --project is omitted, the active SankiWork project is used.
