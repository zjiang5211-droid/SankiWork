...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل SankiWork Cloud سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'chat.amrCard.switchCta': 'سوئیچ به SankiWork Cloud و تلاش مجدد',
  'chat.amrError.authMessage': 'حساب SankiWork Cloud شما هنوز مجاز نشده است. آن را مجاز کنید تا این اجرا به‌طور خودکار دوباره انجام شود.',
  'chat.amrError.balanceMessage': 'موجودی SankiWork Cloud شما تمام شده است. برای ادامه این اجرا شارژ کنید.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'آنچه SankiWork Cloud به شما می‌دهد',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'شما از ایجنت SankiWork Cloud استفاده می‌کنید — وارد شوید تا این وظیفه بلافاصله شروع شود.',
  ...
  'chat.runError.signInMessage.amr': 'عامل SankiWork Cloud هنوز وارد نشده است — برای استفاده وارد شوید.',
  'chat.runError.signInMessage.other': '{agent} وارد نشده است. وضعیت ورود را به‌صورت محلی بررسی کنید. عامل SankiWork Cloud را توصیه می‌کنیم — پایدارتر و مقرون‌به‌صرفه‌تر.',
  ...
  'chat.runError.cpuUnsupportedMessage': "محیط اجرای این عامل به مجموعه دستورالعمل پردازنده (AVX2) نیاز دارد که این دستگاه فاقد آن است، بنابراین نمی‌تواند اجرا شود. SankiWork را به آخرین نسخه که محیط اجرای سازگار دارد به‌روزرسانی کنید.",
  'common.cancel': 'لغو',
  ...
  'settings.welcomeTitle': 'به SankiWork خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. SankiWork یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. SankiWork در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingExecutionBody': 'از سرویس میزبانی‌شده SankiWork استفاده کنید، یک عامل محلی را متصل کنید یا کلید مدل خود را بیاورید.',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': 'مجوزدهی SankiWork Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'مراحل بعدی با هوش مصنوعی اجرا می‌شوند — برای ادامه وارد SankiWork Cloud شوید.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به SankiWork، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.amrAccountStatus': 'وضعیت حساب SankiWork Cloud',
  ...
  'settings.amrLoginErrorCompact': 'ورود به SankiWork Cloud ناموفق بود.',
  ...
  'settings.mcpServerHint': 'SankiWork را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': 'چه داده‌هایی با تیم SankiWork به اشتراک گذاشته می‌شود',
  'settings.privacyConsentKicker': 'به ما در بهبود SankiWork کمک کنید',
  'settings.privacyConsentLead': 'اشتراک‌گذاری داده‌های استفاده به ما کمک می‌کند عملکرد SankiWork را در جریان‌های کاری واقعی بهتر بفهمیم تا بخش‌هایی را که بیشترین اثر را بر تجربه شما دارند بهبود دهیم.',
  ...
  'settings.updateQuitFailed': 'نصب‌کننده باز شد، اما SankiWork نتوانست خودکار خارج شود.',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های SankiWork شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که SankiWork در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'settings.mcpBuildDaemon': 'ابتدا daemon را بسازید.',
  'settings.mcpNodeMissing': 'باینری Node یافت نشد.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js یافت نشد. دستور `pnpm --filter @sankiwork/daemon build` را اجرا کنید و صفحه را تازه‌سازی کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در SankiWork باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، SankiWork باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن SankiWork راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'entry.mailAria': 'به SankiWork ایمیل بفرستید',
  ...
  'entry.followInstagramLabel': 'دنبال کردن @sankiwork.ai در Instagram',
  'entry.followLinkedinLabel': 'دنبال کردن SankiWork در LinkedIn',
  'entry.followXiaohongshuLabel': 'دنبال کردن SankiWork در Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "برای استفاده از SankiWork Cloud و همکاری در فضای ابری وارد شوید",
  "entry.cloudCalloutDismissAria": "بستن یادداشت SankiWork Cloud",
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد SankiWork بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'handoff.amrWebsite': 'باز کردن وب‌سایت SankiWork Cloud',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه SankiWork:',
  ...
  'pluginsHome.subtitle': 'گردش‌کارهای آماده SankiWork که همراه این runtime ارائه شده‌اند. یکی را برای بارگذاری یک پرامپت شروع انتخاب کنید، یا برای موارد بیشتر در رجیستری بگردید.',
  ...
  'pluginsHome.emptyCatalog': 'کاتالوگ خالی است. پلاگین‌های همراه با SankiWork ارائه می‌شوند و باید به‌صورت خودکار اینجا نمایش داده شوند — اگر این مشکل ادامه داشت، daemon را مجدداً راه‌اندازی کنید.',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در SankiWork',
  'pluginCard.contributeTitle': 'مشارکت افزونه در SankiWork با یک PR',
  'skillPluginCandidate.createForMe': 'ساخت افزونه/قالب',
  'skillPluginCandidate.contributeToMain': 'مشارکت در sankiwork',
  ...
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از SankiWork در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید SankiWork در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از SankiWork در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از SankiWork در همه‌جا',
  'useEverywhere.modalSubtitle': 'SankiWork را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'SankiWork هر جا که Agent شما کار کند، کار می‌کند',
  'useEverywhere.section.overview.intro': 'SankiWork چیزی فراتر از یک پنجره است — یک daemon محلیِ دارای دسترسی ویژه (`sw`) به‌علاوه یک رجیستری از Skills + Design-Systems + Atoms است. به‌محض اینکه روی دستگاه شما در حال اجرا باشد، هر code agent (Claude Code، Codex، Cursor، OpenCode/openclaw، Hermes، یا اسکریپت خودتان) می‌تواند تولیدها را هدایت کند، پروژه‌ها را بررسی کند و از طریق چهار سطح قابل‌تعویض، آثار طراحی تولید کند.',
  'useEverywhere.section.overview.bullet1': 'CLI — `sw <command>` برای اسکریپت‌های headless، CI و اتوماسیون shell.',
  'useEverywhere.section.overview.bullet2': 'سرور MCP — SankiWork را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به SankiWork اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.overview.footer': 'daemon به صورت پیش‌فرض در `./.sankiwork/` (محلی پروژه) می‌نویسد. برای اشتراک‌گذاری داده‌ها میان پروژه‌ها، `SW_DATA_DIR=~/.sankiwork` را تنظیم کنید.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'کنترل SankiWork از هر shell',
  'useEverywhere.section.cli.intro': 'باینری `sw` همراه با daemon ارائه می‌شود و همان باینری‌ای است که Claude Code / Codex هنگام اجرای یک تولید از آن استفاده می‌کنند. بیشتر زیرفرمان‌ها کلاینت‌های سبکی هستند که به daemon محلی درخواست POST می‌فرستند، بنابراین چه آن را با `pnpm tools-dev` راه‌اندازی کرده باشید و چه به‌عنوان یک اپلیکیشن بسته‌بندی‌شده، یکسان کار می‌کنند.',
  'useEverywhere.section.cli.bullet1': '`sw` (بدون آرگومان) — daemon را بوت می‌کند و رابط وب را باز می‌کند.',
  'useEverywhere.section.cli.bullet2': '`sw media generate ...` — تولید بایت‌های تصویر / ویدیو / صدا از طریق پروتکل یکپارچهٔ رسانه.',
  'useEverywhere.section.cli.bullet3': '`sw run ...` — شروع یک اجرای پروژه از یک پرامپت + skill.',
  'useEverywhere.section.cli.bullet4': '`sw plugin install <source>` / `sw plugin apply <id>` — نصب و اعمال پلاگین‌های جامعه.',
  'useEverywhere.section.cli.bullet5': '`sw skills list` / `sw design-systems list` — بررسی آنچه به‌صورت محلی در دسترس است.',
  'useEverywhere.section.cli.bullet6': '`sw status` / `sw doctor` — تأیید سلامت daemon و شناسایی CLIهای Agent در PATH شما.',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن SankiWork به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'SankiWork با یک سرور Model Context Protocol (`sw mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای SankiWork را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  'useEverywhere.section.mcp.bullet1': 'انتقال stdio — بدون پورت اضافی، کلاینت مستقیماً `sw mcp` را اجرا می‌کند.',
  ...
  'useEverywhere.section.mcp.bullet4': '`SW_DATA_DIR` را پین می‌کند تا فرایند MCP ایجادشده در همان مکانی بنویسد که daemon از پیش استفاده می‌کند (از EPERM در باندل‌های اپلیکیشن بسته‌بندی‌شده macOS جلوگیری می‌کند).',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن SankiWork، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.http.footer': 'تایپ‌های خالص TypeScript برای هر درخواست/پاسخ در `@sankiwork/contracts` قرار دارند — آن‌ها را در اسکریپت خود import کنید تا بدون سیم‌کشی یک generator، تکمیل خودکار کامل داشته باشید.',
  'useEverywhere.section.skills.tab': 'مهارت‌ها و حالت بدون رابط',
  'useEverywhere.section.skills.heading': 'Skillهای آمادهٔ استفاده برای هر Agent — حتی بدون اجرای SankiWork',
  'useEverywhere.section.skills.intro': 'یک Skill دایرکتوری‌ای است با یک `SKILL.md` سازگار با Claude (فرانت‌متر YAML + بدنه). SankiWork این فرمت را با namespace به نام `od:` گسترش می‌دهد (`mode`، `preview`، `design_system`، `inputs`، …) تا همان اثر هم درون SankiWork و هم توسط یک Agent معمولی مانند Claude Code، Codex، openclaw یا hermes قابل‌استفاده باشد. کشف از یک زنجیرهٔ اولویت پیروی می‌کند تا پروژه‌ها بتوانند skillهای خود را بازنویسی کنند.',
  ...
  'useEverywhere.section.skills.bullet4': 'بدون رابط: یک Agent که `sw` در PATH آن باشد می‌تواند `sw skills list` را فراخوانی کند و سپس هر مهارتی را اجرا کند؛ daemon برای جریان‌های فقط‌خواندنی اختیاری است.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های SankiWork)',
  ...
  'entry.githubStarAria': 'به SankiWork در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های SankiWork',
  ...
  'socialShare.sankiWorkSection': 'اشتراک‌گذاری SankiWork',
  'socialShare.sankiWorkTitle': 'SankiWork در GitHub',
  'socialShare.sankiWorkText': 'SankiWork یک فضای کاری با کد منبع در دسترس برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با SankiWork: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با SankiWork: {title}\n{url}\nمخزن SankiWork: {repo}',
  ...
  'brandEnrichment.body': "SankiWork یک استخراج عمیق تر را در پس زمینه اجرا می کند، skills مناسب design system را خودکار اعمال می کند و همین سیستم را درجا به روز می کند. این کار ممکن است 10 تا 20 دقیقه طول بکشد؛ می توانید به کارتان ادامه دهید.",
  ...
  'chat.activeFilePlaceholder': 'از SankiWork بخواهید {file} را تغییر دهد...',
  ...
  'chat.mode.design.solves': 'وقتی می خواهید SankiWork فایل بسازد، workspace را به روز کند یا brief را به خروجی های چندرسانه ای قابل تحویل تبدیل کند استفاده کنید.',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید SankiWork در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.usefulInfoTip7': 'از SankiWork راضی هستید؟ در GitHub به ما ستاره بدهید.',
  ...
  'designFiles.usefulInfoTip16': 'برای دیدن پشت‌صحنه‌ها، @sankiwork.ai را در Threads دنبال کنید.',
  'designFiles.usefulInfoTip17': 'برای الهام در طراحی، @sankiwork.ai را در Instagram دنبال کنید.',
  'designFiles.usefulInfoTip18': 'برای آموزش‌ها و دموها، SankiWork را در YouTube دنبال کنید.',
  'designFiles.usefulInfoTip19': 'برای اخبار محصول، SankiWork را در LinkedIn دنبال کنید.',
  'designFiles.usefulInfoTip20': 'برای نکته‌ها و الهام، SankiWork را در Xiaohongshu دنبال کنید.',
  ...
  'fileViewer.shareMenuPublishViaOd': 'اشتراک‌گذاری سریع · SankiWork',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'ایجاد پیوند اشتراک‌گذاری نیازمند ورود به فضای کاری است. به SankiWork Cloud وارد شوید یا این فایل را از طریق استقرار به اشتراک بگذارید.',
  ...
  'assistant.shareToSankiWork': 'اشتراک‌گذاری در SankiWork',
  'assistant.shareToSankiWorkBusy': 'در حال آماده‌سازی بسته…',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه SankiWork — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه SankiWork ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ SankiWork را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که SankiWork باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.memoryStarterProjectDesc': 'SankiWork v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.activeRunsTitle': 'SankiWork هنوز در حال کار است',
  'updater.activeRunsBody': '{count} کار فعال هنوز در حال اجراست. راه‌اندازی مجدد اکنون آن‌ها را متوقف می‌کند.',
  'updater.activeRunsUnknownBody': 'SankiWork نتوانست بررسی کند که آیا کاری در حال اجراست. راه‌اندازی مجدد ممکن است کار فعال را متوقف کند.',
  'updater.availableBody': 'SankiWork {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. SankiWork در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن SankiWork',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما SankiWork بسته نشد. پیش از جایگزینی برنامه، SankiWork را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. SankiWork بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'SankiWork {version} آماده است. SankiWork بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.reinstallLearnMore': 'اطلاعات بیشتر',
  'updater.reinstallReadyGeneric': 'این به‌روزرسانی به نصب مجدد کامل نیاز دارد. SankiWork بسته می‌شود و نصب‌کننده باز خواهد شد.',
  'updater.reinstallReadyVersion': 'SankiWork {version} به نصب مجدد کامل نیاز دارد. SankiWork بسته می‌شود و نصب‌کننده باز خواهد شد.',
  ...
  'whatsNew.updatedTitle': 'SankiWork {version} آمد',
  ...
  'artifact.swCardTaskBriefChip': 'حافظه اعمال شد · مشاهدهٔ شرح',
  'artifact.swCardScorecardTitle': 'بررسی خودکار',
  'artifact.swCardScorecardStatusPass': 'قبول شد',
  'artifact.swCardScorecardStatusPartial': 'جزئی',
  'artifact.swCardScorecardStatusFail': 'نیازمند کار',
  'artifact.swCardRuleKicker': 'قانون پیشنهادی',
  'artifact.swCardRuleNameLabel': 'نام',
  'artifact.swCardRuleDescriptionLabel': 'توضیحات',
  'artifact.swCardRuleAssertionLabel': 'باید برقرار باشد',
  'artifact.swCardRuleCheckLabel': 'نحوهٔ بررسی',
  'artifact.swCardRuleRationaleLabel': 'چرا',
  'artifact.swCardRuleKeep': 'نگه‌داشتن',
  'artifact.swCardRuleEdit': 'ویرایش',
  'artifact.swCardRuleDone': 'انجام شد',
  'artifact.swCardRuleDiscard': 'دور انداختن',
  'artifact.swCardRuleSaving': 'در حال ذخیره…',
  'artifact.swCardRuleSaved': '«{name}» به‌عنوان یک قانون ذخیره شد',
  'artifact.swCardRuleError': 'ذخیرهٔ قانون ممکن نشد. دوباره تلاش کنید.',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به SankiWork بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که SankiWork در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
  ...
  'onboarding.buildBody': 'SankiWork برند شما را به یک سیستم طراحی قابل‌استفاده‌ی مجدد تبدیل می‌کند و هر چیزی را که می‌سازید هماهنگ و وفادار به برند نگه می‌دارد.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'از ۱۳ تا ۲۷ اوت، کاربران پولی می‌توانند DeepSeek V4 Pro و V4 Flash را در SankiWork رایگان استفاده کنند. سوءاستفاده گسترده ممکن است دسترسی کمپین را متوقف کند.',
  'campaign.deepseekV4Flash.windowLabel': '۱۳–۲۷ اوت',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'دو هفته رایگان',
  'campaign.deepseekV4Flash.boundary': 'سهمیه نامحدود مدل و تعداد تولید رایگان پلن فقط داخل SankiWork اعمال می‌شود — نه از طریق MCP، CLI، API یا سطوح دیگر. تفسیر نهایی با SankiWork است. برخی مدل‌ها ممکن است در ساعات شلوغی نیاز به نوبت داشته باشند.',
