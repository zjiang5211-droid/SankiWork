...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to SankiWork Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to SankiWork Cloud & retry',
  'chat.amrError.authMessage': 'Your SankiWork Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your SankiWork Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with SankiWork Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the SankiWork Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The SankiWork Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the SankiWork Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update SankiWork to the latest version, which ships a compatible runtime.",
  ...
  'settings.welcomeTitle': 'Welcome to SankiWork',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. SankiWork will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. SankiWork reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the SankiWork hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to SankiWork Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the SankiWork daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to SankiWork.',
  ...
  'settings.amrAccountStatus': 'SankiWork Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose SankiWork as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the SankiWork team',
  'settings.privacyConsentKicker': 'Help us improve SankiWork',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how SankiWork performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time SankiWork starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but SankiWork could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect SankiWork to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure SankiWork is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @sankiwork/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in SankiWork as context.',
  'settings.mcpRunningNote': 'Keep SankiWork running. Restart your coding agent after setup.',
  ...
  'entry.discordAria': 'Join the SankiWork Discord',
  'entry.discordAriaWithOnline': 'Join the SankiWork Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.mailAria': 'Email SankiWork',
  ...
  'entry.followInstagramLabel': 'Follow @sankiwork.ai on Instagram',
  'entry.followLinkedinLabel': 'Follow SankiWork on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow SankiWork on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use SankiWork Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss SankiWork Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable SankiWork plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit SankiWork Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local SankiWork project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. SankiWork Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use SankiWork workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with SankiWork and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to SankiWork',
  'pluginCard.contributeTitle': 'Contribute plugin to SankiWork with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to sankiwork',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use SankiWork from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure SankiWork is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use SankiWork everywhere',
  'useEverywhere.modalTitle': 'Use SankiWork everywhere',
  'useEverywhere.modalSubtitle': 'Drop SankiWork into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'SankiWork works wherever your agent works',
  'useEverywhere.section.overview.intro': 'SankiWork is more than a window — it is a local privileged daemon (`sw`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `sw <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires SankiWork as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without SankiWork at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `./.sankiwork/` (project-local) by default. Set `SW_DATA_DIR=~/.sankiwork` to share data across projects.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Drive SankiWork from any shell',
  'useEverywhere.section.cli.intro': 'The `sw` bin ships with the daemon and is the same binary used by Claude Code / Codex when they run a generation. Most subcommands are thin clients that POST to the local daemon, so they work the same whether you launched it via `pnpm tools-dev` or as a packaged app.',
  'useEverywhere.section.cli.bullet1': '`sw` (no args) — boots the daemon and opens the web UI.',
  'useEverywhere.section.cli.bullet2': '`sw media generate ...` — produce image / video / audio bytes through the unified media protocol.',
  'useEverywhere.section.cli.bullet3': '`sw run ...` — start a project run from a prompt + skill.',
  'useEverywhere.section.cli.bullet4': '`sw plugin install <source>` / `sw plugin apply <id>` — install and apply community plugins.',
  'useEverywhere.section.cli.bullet5': '`sw skills list` / `sw design-systems list` — inspect what is available locally.',
  'useEverywhere.section.cli.bullet6': '`sw status` / `sw doctor` — verify daemon health and detect agent CLIs on your PATH.',
  ...
  'useEverywhere.section.mcp.heading': 'Expose SankiWork as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'SankiWork ships with a Model Context Protocol server (`sw mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover SankiWork tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  'useEverywhere.section.mcp.bullet1': 'Stdio transport — no extra port, the client spawns `sw mcp` directly.',
  ...
  'useEverywhere.section.mcp.bullet4': 'Pins `SW_DATA_DIR` so the spawned MCP process writes to the same place the daemon already uses (avoids EPERM in packaged macOS app bundles).',
  ...
  'useEverywhere.section.mcp.footer': 'In the SankiWork app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@sankiwork/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@sankiwork/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without SankiWork running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). SankiWork extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside SankiWork and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.bullet4': 'Headless: an agent with `sw` on its PATH can call `sw skills list` then run any skill; the daemon is optional for read-only flows.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + SankiWork extras)',
  ...
  'entry.githubStarAria': 'Star SankiWork on GitHub',
  ...
  'newproj.locationDefault': 'SankiWork projects',
  ...
  'avatar.amrConsole': 'SankiWork Cloud',
  ...
  'socialShare.sankiWorkSection': 'Share SankiWork',
  'socialShare.sankiWorkTitle': 'SankiWork on GitHub',
  'socialShare.sankiWorkText': 'SankiWork is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with SankiWork: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with SankiWork: {title}\n{url}\nSankiWork repo: {repo}',
  ...
  'brandEnrichment.body': "SankiWork will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask SankiWork to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want SankiWork to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure SankiWork is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying SankiWork? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip16': 'Follow @sankiwork.ai on Threads for behind-the-scenes updates.',
  'designFiles.usefulInfoTip17': 'Follow @sankiwork.ai on Instagram for design inspiration.',
  'designFiles.usefulInfoTip18': 'Subscribe to SankiWork on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow SankiWork on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow SankiWork on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.shareMenuPublishViaOd': 'QUICK SHARE · SANKIWORK',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to SankiWork Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToSankiWork': 'Share to SankiWork',
  'assistant.shareToSankiWorkBusy': 'Preparing package…',
  ...
  'artifact.swCardTaskBriefChip': 'Memory applied · view brief',
  'artifact.swCardScorecardTitle': 'Self-check',
  'artifact.swCardScorecardStatusPass': 'Passed',
  'artifact.swCardScorecardStatusPartial': 'Partial',
  'artifact.swCardScorecardStatusFail': 'Needs work',
  'artifact.swCardRuleKicker': 'Proposed rule',
  'artifact.swCardRuleNameLabel': 'Name',
  'artifact.swCardRuleDescriptionLabel': 'Description',
  'artifact.swCardRuleAssertionLabel': 'Must hold',
  'artifact.swCardRuleCheckLabel': 'How to check',
  'artifact.swCardRuleRationaleLabel': 'Why',
  'artifact.swCardRuleKeep': 'Keep',
  'artifact.swCardRuleEdit': 'Edit',
  'artifact.swCardRuleDone': 'Done',
  'artifact.swCardRuleDiscard': 'Discard',
  'artifact.swCardRuleSaving': 'Saving…',
  'artifact.swCardRuleSaved': 'Saved “{name}” as a rule',
  'artifact.swCardRuleError': 'Could not save the rule. Try again.',
  'artifact.swCardBrandAssistDone': 'Browser opened',
  'artifact.swCardBrandAssistKicker': 'Browser assist needed: {reason}',
  'artifact.swCardBrandAssistBody': 'Open Browser and clear any human check. Then click More, choose Download Page, wait for the saved snapshot success, and use the left Next Step card to continue extraction. If the card is not visible, manually open the Browser tab on the right and follow More > Download Page > Continue extraction.',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with SankiWork — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with SankiWork — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple SankiWork project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions SankiWork should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'SankiWork {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'SankiWork is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'SankiWork could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. SankiWork is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit SankiWork',
  'updater.quitFailedBody': 'The installer is open, but SankiWork could not quit. Quit SankiWork before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. SankiWork will close and open the installer.',
  'updater.readyVersion': 'SankiWork {version} is ready. SankiWork will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. SankiWork will close and open the installer.',
  'updater.reinstallReadyVersion': 'SankiWork {version} requires a full reinstall. SankiWork will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'SankiWork {version} is here',
  ...
  'dsManager.createBody': 'Teach SankiWork your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions SankiWork follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach SankiWork your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'SankiWork turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in SankiWork. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside SankiWork — not via MCP, CLI, API, or other surfaces. Final interpretation rests with SankiWork. Some models may need to queue at peak hours.',
