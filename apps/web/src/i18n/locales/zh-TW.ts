...
export const zhTW: Dict = {
  ...
  'invite.landing.subtitle': "你受邀加入 SankiWork 一起協作。",
  ...
  'invite.success.body': "正在開啟 SankiWork，開始協作。",
  'invite.success.roleReceipt': "加入身分",
  'invite.success.enter': "進入工作空間",
  'invite.open.cta': "開啟 SankiWork",
  'invite.open.opening': "正在開啟 SankiWork…",
  'invite.open.retry': "已安裝？再次嘗試開啟",
  'invite.notInstalled.title': "沒有自動開啟？",
  'invite.notInstalled.body': "你的裝置可能尚未安裝 SankiWork。安裝後重新開啟此連結即可完成加入。",
  'invite.notInstalled.download': "下載 SankiWork",
  ...
  "chat.amrCard.switchBody":
    "可切換到 SankiWork Cloud 官方模型服務，無需設定 API Key。完成登入、授權與儲值後，將自動重試目前任務。",
  "chat.amrCard.chipOfficial": "官方代管",
  "chat.amrCard.chipNoKey": "無需 API Key",
  "chat.amrCard.chipAutoRetry": "授權後自動重試",
  "chat.amrCard.switchCta": "切換到 SankiWork Cloud 並重試",
  "chat.amrError.authMessage":
    "SankiWork Cloud 帳號尚未授權。完成授權後將自動重試目前任務。",
  "chat.amrError.balanceMessage":
    "SankiWork Cloud 額度不足。儲值後即可繼續執行目前任務。",
  ...
  "chat.amrBalanceGate.benefitsTitle": "SankiWork Cloud 為你提供",
  ...
  "chat.amrBalanceGate.signedOutTitle": "登入 SankiWork Cloud，開始創作",
  "chat.amrBalanceGate.signedOutMessage": "目前使用的是 SankiWork Cloud 智能體，登入後這個任務馬上就能開始。",
  ...
  "chat.runError.signInMessage.amr":
    "SankiWork Cloud 智慧體尚未登入，前往登入即可正常使用",
  "chat.runError.signInMessage.other":
    "{agent}尚未登入，請在本機檢查登入狀態。推薦使用 SankiWork Cloud 智慧體，更穩定划算",
  ...
  "chat.runError.cpuUnsupportedMessage": "此智能體的執行時需要此裝置處理器不支援的指令集（AVX2），因此無法啟動。請將 SankiWork 更新到最新版本，新版本附帶相容的執行時。",
  "common.cancel": "取消",
  ...
  "chat.contextPrompt.referenceProject":
    "請把 SankiWork 專案「{name}」作為參考上下文。它的本機路徑是：{path}。在設計或修改前，如有幫助請先搜尋並讀取這個目錄。",
  ...
  "settings.welcomeTitle": "歡迎使用 SankiWork",
  "settings.welcomeSubtitle": "",
  "settings.onboardingCreateTitle": "從一句需求開始",
  "settings.onboardingCreateBody":
    "描述你想做的網站、應用、Deck、圖片或影片，SankiWork 會建立專案，並保留可繼續編輯的產出。",
  ...
  "settings.onboardingMemoryCalloutBody":
    "這些回答會構成你的記憶檔案。SankiWork 會在每個任務中重複使用它，並在你工作時持續學習。",
  ...
  "settings.onboardingExecutionBody":
    "使用 SankiWork 託管服務、連接本機 Agent，或使用你自己的模型 Key。",
  ...
  "settings.onboardingAmrModelSourceLabel": "SankiWork 託管",
  ...
  "settings.onboardingCloudTitle": "登入 SankiWork",
  "settings.onboardingCloudBody":
    "登入後可直接用雲端 AI 開始設計，無需任何複雜設定。",
  "settings.onboardingCloudSignIn": "登入 SankiWork 雲端",
  ...
  "settings.onboardingGateTooltipAmr":
    "後續流程由 AI 執行，請先登入 SankiWork Cloud。",
  ...
  "settings.agentInstall.pathHint":
    "如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 SankiWork daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。",
  "settings.agentInstall.stepOpenLinks":
    "在目標代理卡片上開啟「安裝」或「文件」連結。",
  "settings.agentInstall.stepAuth":
    "返回 SankiWork 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。",
  ...
  "settings.amrWalletRefreshTitle": "重新整理 SankiWork Cloud 錢包餘額",
  ...
  "settings.amrAccountStatus": "SankiWork Cloud 帳戶狀態",
  "settings.amrConsole": "管理",
  "settings.amrLoginErrorCompact": "SankiWork Cloud 登入失敗。",
  ...
  "settings.dshSetupDescription": "SankiWork 將透過這台電腦上的 dsh CLI 安裝連接元件。",
  "settings.dshSetupNote": "只安裝 SankiWork 的 profile 元件。DeepSeek Harness 仍由你自行安裝和管理。",
  ...
  "settings.mcpServerHint":
    "將 SankiWork 作為 MCP 伺服器暴露給你的編碼代理。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "與 SankiWork 團隊共享哪些資料",
  "settings.privacyConsentKicker": "協助我們改進 SankiWork",
  "settings.privacyConsentLead":
    "分享使用資料後，我們能更了解 SankiWork 在真實工作流裡的表現，並優先改進真正影響體驗的地方。",
  ...
  "settings.mcpTitle": "將 SankiWork 連接至程式設計 agent",
  "settings.mcpHint": "透過 MCP，讓支援的 agent 存取您的專案與設計脈絡。",
  "settings.mcpDaemonError":
    "無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 SankiWork 正在執行，然後重新開啟此面板。",
  "settings.mcpBuildDaemon": "請先建置守護行程。",
  "settings.mcpNodeMissing": "缺少 Node 執行檔。",
  "settings.mcpBuildHint":
    "缺少 apps/daemon/dist/cli.js。請執行 `pnpm --filter @sankiwork/daemon build` 後重新整理。",
  ...
  "settings.mcpCapabilityDefault":
    "將目前在 SankiWork 中開啟的專案與檔案作為脈絡。",
  "settings.mcpRunningNote": "請保持 SankiWork 執行。設定完成後，重新啟動程式設計 agent。",
  ...
  'entry.authExpiredBody': '登入狀態已過期。登入後即可繼續使用 SankiWork Cloud。',
  'home.createFailed': '啟動任務失敗，請再試一次。',
  'home.daemonRecovering': '本機服務連線中斷，正在自動恢復…',
  "entry.cloudCalloutBody": "登入即可享受雲端協作",
  "entry.cloudCalloutDismissAria": "關閉 SankiWork Cloud 版說明",
  ...
  "messageCenter.subtitle": "SankiWork 更新、平台公告和權益提醒",
  ...
  "homeHero.chip.createPluginHint":
    "編寫可重複使用的 SankiWork 外掛並將其加入「我的外掛」。",
  ...
  "handoff.amrWebsite": "開啟 SankiWork Cloud 官網",
  ...
  "handoff.promptIntro": "請基於這個 SankiWork 專案的本機資料夾繼續實作：",
  ...
  "pluginsHome.subtitle":
    "隨附於此執行環境、可立即使用的 SankiWork 工作流程。挑選一個以載入起始提示，或瀏覽登錄檔取得更多。",
  ...
  "pluginsHome.emptyCatalog":
    "目錄是空的。內建外掛隨 SankiWork 一同提供，應會自動出現在此處 — 若問題持續發生，請嘗試重新啟動 daemon。",
  ...
  "pluginCard.contributeAria": "將 {title} 貢獻至 SankiWork",
  "pluginCard.contributeTitle": "透過 pull request 將外掛貢獻至 SankiWork",
  "skillPluginCandidate.createForMe": "建立外掛/範本",
  "skillPluginCandidate.contributeToMain": "貢獻到 sankiwork",
  "skillPluginCandidate.repoDescription": "這個倉庫看起來可以做成外掛。",
  "integrations.kicker": "整合",
  "integrations.lede":
    "連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 SankiWork。",
  ...
  "mcpClient.daemonError":
    "無法連線到本機 daemon。請確認 SankiWork 正在執行，然後重新開啟此面板。",
  "mcpClient.saveFailed": "儲存失敗。請確認 daemon 正在執行後再試一次。",
  "useEverywhere.modalAria": "隨處使用 SankiWork",
  "useEverywhere.modalTitle": "隨處使用 SankiWork",
  "useEverywhere.modalSubtitle":
    "將 SankiWork 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。",
  ...
  "useEverywhere.section.overview.heading":
    "你的 Agent 在哪裡運作，SankiWork 就在哪裡運作",
  "useEverywhere.section.overview.intro":
    "SankiWork 不只是一個視窗 — 它是一個本機特權 daemon（`sw`），外加一個 Skills + Design-Systems + Atoms 登錄。一旦它在您的機器上執行，任何程式碼 Agent（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes、您自己的指令碼）都能透過四個可互換的介面來驅動產生作業、檢視專案並產出設計成品。",
  "useEverywhere.section.overview.bullet1":
    "CLI — 以 `sw <command>` 用於無頭指令碼、CI 及 shell 自動化。",
  "useEverywhere.section.overview.bullet2":
    "MCP server — 將 SankiWork 接成 Model Context Protocol 伺服器，讓任何支援 MCP 的 Agent 都能列出技能、執行情境並讀取成品。",
  ...
  "useEverywhere.section.overview.bullet4":
    "Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 SankiWork 即可調用。",
  ...
  "useEverywhere.section.overview.footer":
    "daemon 預設會寫入 `./.sankiwork/`（專案本機）。設定 `SW_DATA_DIR=~/.sankiwork` 即可在多個專案間共用資料。",
  "useEverywhere.section.cli.tab": "CLI · od",
  "useEverywhere.section.cli.heading": "從任何 shell 操作 SankiWork",
  "useEverywhere.section.cli.intro":
    "`sw` 執行檔隨 daemon 一起發佈，與 Claude Code / Codex 執行產生作業時所用的是同一個二進位檔。多數子指令都是精簡的用戶端，會 POST 至本機 daemon，因此無論你是透過 `pnpm tools-dev` 啟動，還是以打包後的應用程式執行，運作方式都相同。",
  "useEverywhere.section.cli.bullet1":
    "`sw`（無參數）— 啟動 daemon 並開啟網頁 UI。",
  "useEverywhere.section.cli.bullet2":
    "`sw media generate ...` — 透過統一的媒體協定產生圖片／影片／音訊位元組。",
  "useEverywhere.section.cli.bullet3":
    "`sw run ...` — 從提示 + 技能啟動一次專案執行。",
  "useEverywhere.section.cli.bullet4":
    "`sw plugin install <source>` / `sw plugin apply <id>` — 安裝並套用社群外掛。",
  "useEverywhere.section.cli.bullet5":
    "`sw skills list` / `sw design-systems list` — 檢視本機可用的項目。",
  "useEverywhere.section.cli.bullet6":
    "`sw status` / `sw doctor` — 驗證 daemon 健康狀態並偵測您 PATH 上的 Agent CLI。",
  ...
  "useEverywhere.section.mcp.heading":
    "將 SankiWork 以 MCP 伺服器形式開放給任何程式設計 Agent",
  "useEverywhere.section.mcp.intro":
    "SankiWork 隨附一個 Model Context Protocol 伺服器（`sw mcp`），讓任何支援 MCP 的用戶端 — Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes — 都能探索 SankiWork 工具（列出技能、算繪預覽、產生媒體、執行外掛），而無需手動使用 shell。daemon 透過 `GET /api/mcp/install-info` 為每個主要用戶端發布可直接貼上的安裝程式碼片段。",
  "useEverywhere.section.mcp.bullet1":
    "Stdio 傳輸 — 不需額外連接埠，用戶端直接產生 `sw mcp` 程序。",
  ...
  "useEverywhere.section.mcp.bullet4":
    "固定 `SW_DATA_DIR`，讓衍生的 MCP 程序寫入 daemon 已使用的相同位置（避免在 macOS 打包應用程式套件中發生 EPERM）。",
  ...
  "useEverywhere.section.mcp.footer":
    "在 SankiWork 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。",
  ...
  "useEverywhere.section.http.intro":
    "本機 daemon 會在 `http://127.0.0.1:7456` 提供 HTTP API（連接埠可設定）。web UI 呼叫的每個端點，你的指令稿同樣可以使用。串流端點（聊天回合、專案執行）會發出 Server-Sent Events，其合約型別定義於 `@sankiwork/contracts`。",
  ...
  "useEverywhere.section.http.footer":
    "每個請求／回應的純 TypeScript 型別都位於 `@sankiwork/contracts` 中 — 在您的指令碼中匯入它們，即可享有完整的自動完成，而無需接上產生器。",
  "useEverywhere.section.skills.tab": "技能與無頭模式",
  "useEverywhere.section.skills.heading":
    "適用於任何 Agent 的隨插即用 Skills — 即使 SankiWork 未在執行也行",
  "useEverywhere.section.skills.intro":
    "Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。SankiWork 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 SankiWork 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。",
  ...
  "useEverywhere.section.skills.bullet4":
    "無頭模式：PATH 中含有 `sw` 的 Agent 可呼叫 `sw skills list`，接著執行任何技能；唯讀流程中 daemon 為選用。",
  ...
  "useEverywhere.section.skills.snippet1":
    "最精簡的 SKILL.md（Claude 相容的前置資料 + SankiWork 額外設定）",
  ...
  "entry.githubStarAria": "在 GitHub 為 SankiWork 點亮 Star",
  ...
  "newproj.locationDefault": "SankiWork 專案",
  ...
  "avatar.amrConsole": "SankiWork Cloud 帳戶",
  ...
  "socialShare.sankiWorkText":
    "SankiWork 是原始碼可用的設計智慧工作區，可以生成、編輯、部署並交付設計產物。",
  ...
  "socialShare.projectText":
    "我用 SankiWork 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}",
  ...
  "chat.brandBrowserAssistDesktopOnly":
    "瀏覽器輔助需要桌面應用，SankiWork 才能讀取即時瀏覽器頁面。",
  "chat.brandBrowserAssistReadFailed":
    "無法讀取瀏覽器頁面。請確認品牌網站已開啟並完整載入。",
  "chat.brandBrowserAssistMessage":
    "SankiWork 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。",
  "brandEnrichment.title": "AI 優化",
  "brandEnrichment.body":
    "SankiWork 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  "chat.activeFilePlaceholder": "讓 SankiWork 修改 {file}...",
  ...
  "chat.mode.design.solves":
    "當你希望 SankiWork 產生檔案、更新 workspace，或把需求變成多模態可交付結果時使用。",
  ...
  "preview.errorBody":
    "範例 HTML 載入失敗。請確認 SankiWork 正在執行後重試。",
  "preview.retry": "重試",
  ...
  "designFiles.documentTemplate.goalBody":
    "說明希望 SankiWork 基於這份文件生成、修改或判斷什麼。",
  ...
  "designFiles.documentTemplate.capabilityAgent":
    "SankiWork agent 可以讀取、編輯這份檔案，並把它作為專案上下文。",
  ...
  "designFiles.documentTemplate.nextBody":
    "檢查並編輯這份文件，然後讓 SankiWork 基於它生成、修改或執行操作。",
  ...
  "designFiles.usefulInfoTip19":
    "在 LinkedIn 上追蹤 SankiWork，了解產品動態。",
  "designFiles.usefulInfoTip20":
    "在小紅書上追蹤 SankiWork，獲取技巧和靈感。",
  ...
  "fileViewer.shareMenuPublishViaOd": "快速分享（SankiWork 託管）",
  ...
  "fileViewer.publishFileRequiresWorkspace": "產生分享連結需要登入工作區。請登入 SankiWork Cloud，或改用「部署」分享此檔案。",
  ...
  "assistant.shareToSankiWorkBusy": "正在準備投稿…",
  ...
  "pet.navHint": "領養與自訂",
  "pet.tabBuiltIn": "內建",
  "pet.tabBuiltInHint": "SankiWork 內建的精選寵物 — 一鍵領養。",
  "pet.builtInEmpty":
  ...
  "pet.codexBundled": "內建",
  "pet.codexBundledTitle": "SankiWork 內建寵物，無需下載。",
  ...
  "settings.projectLocationsDescription":
    "新增可包含多個 SankiWork 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。",
  ...
  "settings.customInstructionsHint":
    "SankiWork 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。",
  ...
  "artifact.swCardTaskBriefChip": "已套用記憶 · 查看簡報",
  "artifact.swCardScorecardTitle": "自我檢查",
  "artifact.swCardScorecardStatusPass": "通過",
  "artifact.swCardScorecardStatusPartial": "部分通過",
  "artifact.swCardScorecardStatusFail": "需改進",
  "artifact.swCardRuleKicker": "建議規則",
  "artifact.swCardRuleNameLabel": "名稱",
  "artifact.swCardRuleDescriptionLabel": "描述",
  "artifact.swCardRuleAssertionLabel": "必須成立",
  "artifact.swCardRuleCheckLabel": "如何檢查",
  "artifact.swCardRuleRationaleLabel": "原因",
  "artifact.swCardRuleKeep": "保留",
  "artifact.swCardRuleEdit": "編輯",
  "artifact.swCardRuleDone": "完成",
  "artifact.swCardRuleDiscard": "捨棄",
  "artifact.swCardRuleSaving": "儲存中…",
  "artifact.swCardRuleSaved": "已將「{name}」儲存為規則",
  "artifact.swCardRuleError": "無法儲存規則，請再試一次。",
  "artifact.swCardBrandAssistDone": "已確認瀏覽器輔助",
  "artifact.swCardBrandAssistKicker": "需要瀏覽器輔助：{reason}",
  "artifact.swCardBrandAssistBody":
    "在瀏覽器中開啟品牌網站，讓 SankiWork 繼續擷取此設計體系。",
  "artifact.swCardBrandAssistError": "無法啟動瀏覽器輔助，請重試。",
  "artifact.swCardBrandAssistWorking": "正在啟動...",
  "artifact.swCardBrandAssistConfirm": "開啟瀏覽器輔助",
  ...
  "updater.activeRunsTitle": "SankiWork 仍在執行任務",
  "updater.activeRunsBody": "仍有 {count} 個任務正在執行。現在重新啟動會中斷這些任務。",
  "updater.activeRunsUnknownBody": "SankiWork 無法確認是否仍有任務執行。現在重新啟動可能會中斷進行中的工作。",
  "updater.availableBody":
    "SankiWork {version} 可用。下載完成後即可開啟安裝器。",
  ...
  "updater.payloadReadyGeneric":
    "A new SankiWork update is ready. SankiWork will close and restart automatically.",
  "updater.payloadReadyVersion":
    "SankiWork {version} is ready. SankiWork will close and restart automatically.",
  "updater.quitButton": "結束 SankiWork",
  "updater.quitFailedBody":
    "安裝器已開啟，但 SankiWork 無法結束。替換應用程式前請先結束 SankiWork。",
  "updater.quitFailedTitle": "無法結束",
  "updater.quitting": "正在結束…",
  "updater.ready": "更新已就緒",
  "updater.readyGeneric": "新版本已就緒。SankiWork 會關閉並開啟安裝器。",
  "updater.readyVersion":
    "SankiWork {version} 已就緒。SankiWork 會關閉並開啟安裝器。",
  "updater.upToDate": "您已經是最新版本啦",
  "updater.viewVersionFeatures": "查看新版本特色",
  "updater.manualDownload": "手動下載",
  "updater.reinstallLearnMore": "了解詳情",
  "updater.reinstallReadyGeneric": "此更新需要完整重新安裝。SankiWork 將關閉並開啟安裝程式。",
  "updater.reinstallReadyVersion": "SankiWork {version} 需要完整重新安裝。SankiWork 將關閉並開啟安裝程式。",
  ...
  'settings.updateQuitFailed': '安裝程式已開啟，但 SankiWork 未能自動結束。',
  ...
  "dsManager.createBody":
    "把你的品牌、產品、程式碼、素材與設計參考教給 SankiWork。",
  ...
  "settings.customInstructionsDesc":
    "SankiWork 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。",
  ...
  "brand.librarySubtitle":
    "把你的品牌套件教給 SankiWork——從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  "onboarding.buildBody":
    "SankiWork 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。",
  ...
  "dsCreate.sourceSectionBody":
    "從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。SankiWork 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。",
  ...
  "ds.extractionRunningBody": "SankiWork 正在就地更新此體系。",
  ...
  "ds.repoConnectBannerBody":
    "連接 GitHub 後，SankiWork 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。",
  ...
  'library.getClipper': '取得 SankiWork 網頁剪藏擴充功能',
  ...
  'library.emptyHintBefore': '用 SankiWork 網頁剪藏擴充功能從任意網頁收藏，執行',
  ...
  'library.sankiWorkSystem': '開啟設計系統',
  ...
  'mcp.checking': '檢查中…',
  'mcp.clickConnectHint': '點擊「連線」，透過服務商的 OAuth 流程授予 SankiWork 存取權限。',
  ...
  'mcp.noManagedOAuthSaveDirect': '儲存此伺服器後，SankiWork 會直接使用它。',
  'mcp.noManagedOAuthUseAsConfigured': 'SankiWork 會依你的設定使用此伺服器。如果伺服器需要 token，請在下方新增標頭。',
  ...
  'mcp.starting': '啟動中…',
  'mcp.toGrantOAuthAccess': '透過服務商的 OAuth 流程授予 SankiWork 存取權限。',
  ...
  'memory.extractionSourceConnector': '已讀取已連接的應用程式，但 SankiWork 無法將這些上下文轉化為記憶。',
  'memory.extractionSourceChat': 'SankiWork 無法為這次對話執行記憶擷取。',
  ...
  'memory.noSuggestionsFound': '未找到記憶建議。SankiWork 暫時無法從所選應用程式中讀取到有用的內容。',
  ...
  'memory.chooseSourcesHint': '請先選擇已連接的應用程式。SankiWork 只會掃描你選取的應用程式。',
  ...
  'dsCreate.confirmTitle': 'SankiWork 將擷取你的設計系統。',
  ...
  'dsCreate.githubMethodOdAccount': 'SankiWork 帳號',
  'dsCreate.githubMethodOdAccountDesc': '由 SankiWork 管理的原生 GitHub 登入；此版本尚未使用 OD 託管的 GitHub 權杖。',
  ...
  'dsFlow.activityRunningTitle': 'SankiWork 正在更新此設計系統',
  ...
  'dsFlow.jobRebuildingTokens': 'SankiWork 正在重建 token',
  'dsFlow.jobRevising': 'SankiWork 正在修訂',
  'dsFlow.jobStillWorking': 'SankiWork 仍在處理中',
  ...
  'dsFlow.pickLocalAgentFirst': '請先選擇一個本機代理，然後讓 SankiWork 更新這個設計系統。',
  'dsFlow.previewPages': '預覽頁面',
  'dsFlow.proposedChanges': '建議的變更',
  'dsFlow.publishCardReady': 'SankiWork 已可供審閱。請對目前的成果給出回饋，確認它對後續專案有用後再發布。',
  'dsFlow.publishCardRevision': 'SankiWork 正在套用你的回饋。在準備更新草稿期間，你可以繼續審閱。',
  'dsFlow.publishCardTokenRebuild': 'SankiWork 正在準備一份供審閱的 token 契約重建。在你接受之前，目前生效的契約保持不變。',
  'dsFlow.publishCardWorking': 'SankiWork 仍在處理中，但你已經可以對目前的成果給出回饋。',
  ...
  'campaign.deepseekV4Flash.boundary': '方案內的無限制模型額度與免費生成次數，僅可透過 SankiWork 使用；無法在 MCP/CLI/API 及其他場景使用。解釋權歸官方所有。部分模型尖峰時段需要排隊。',
