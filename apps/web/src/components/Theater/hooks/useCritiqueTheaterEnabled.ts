...
const TOGGLE_EVENT = 'sankiwork:critique-theater-toggle';
 ...
 *
 * Source of truth is the existing `sankiwork:config` localStorage
 ...
 *   2. A same-tab `sankiwork:critique-theater-toggle` CustomEvent so
