...
所有插件共享同一个基础契约：插件是一个可移植的 agent skill 文件夹，包含 `SKILL.md`，并可选添加带版本的 `open-design.json` sidecar。`open-design.json` 负责 SankiWork marketplace 元数据、输入项、预览、pipeline、信任与能力声明。
