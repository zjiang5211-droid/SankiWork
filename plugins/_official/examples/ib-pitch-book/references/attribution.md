...
The SankiWork skill bundle (`SKILL.md`, `example.html`, `assets/template.html`,
and references in this folder) is contributed under SankiWork's repository
