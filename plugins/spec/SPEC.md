# SankiWork Plugin Spec

Language: English | [简体中文](SPEC.zh-CN.md)

This spec is the compact contract for portable SankiWork plugins. The canonical product spec remains `docs/plugins-spec.md`; this document is optimized for contributors and external coding agents.
...
- `specVersion` is the SankiWork plugin spec version that this manifest follows. Use the current spec kit value (`1.0.0`) unless the schema moves.
