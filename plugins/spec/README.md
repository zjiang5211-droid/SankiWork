...
- [`PUBLISHING-REGISTRIES.md`](PUBLISHING-REGISTRIES.md) - strategies for skills.sh, ClawHub, GitHub, and SankiWork publishing.
...
- SankiWork plugin spec: ../../docs/plugins-spec.md
