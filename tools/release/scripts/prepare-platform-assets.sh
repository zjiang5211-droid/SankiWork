...
case "$RELEASE_TARGET" in
  mac_arm64 | mac_x64)
    ...
    source_dmg="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/dmg/SankiWork-$RELEASE_NAMESPACE.dmg"
    source_zip="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/zip/SankiWork-$RELEASE_NAMESPACE.zip"
    source_payload="$TOOLS_PACK_DIR/out/mac/namespaces/$RELEASE_NAMESPACE/payload/SankiWork-$RELEASE_NAMESPACE-payload.zip"
    versioned_dmg="sankiwork-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-mac-$arch.dmg"
    versioned_zip="sankiwork-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-mac-$arch.zip"
    versioned_payload="sankiwork-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-mac-$arch-payload.zip"
    ...
    release_notes="${RELEASE_NOTES:-SankiWork $RELEASE_VERSION$RELEASE_ASSET_SUFFIX}"
...
EOF
    ;;
  linux_x64)
    source_appimage="$TOOLS_PACK_DIR/out/linux/namespaces/$RELEASE_NAMESPACE/builder/SankiWork-$RELEASE_NAMESPACE.AppImage"
    versioned_appimage="sankiwork-$RELEASE_VERSION$RELEASE_ASSET_SUFFIX-linux-x64.AppImage"
