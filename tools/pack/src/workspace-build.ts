...
const WORKSPACE_BUILD_PACKAGES = [
  ...
  { directory: "packages/dsh-runtime", name: "@sankiwork/dsh-runtime" },
...
const BUILD_COMMANDS = [
  { args: ["--filter", "@sankiwork/release", "build"] },
  { args: ["--filter", "@sankiwork/components", "build"] },
  { args: ["--filter", "@sankiwork/contracts", "build"] },
  { args: ["--filter", "@sankiwork/registry-protocol", "build"] },
  { args: ["--filter", "@sankiwork/sidecar-proto", "build"] },
  { args: ["--filter", "@sankiwork/launcher-proto", "build"] },
  { args: ["--filter", "@sankiwork/sidecar", "build"] },
  { args: ["--filter", "@sankiwork/platform", "build"] },
  { args: ["--filter", "@sankiwork/download", "build"] },
  { args: ["--filter", "@sankiwork/host", "build"] },
  { args: ["--filter", "@sankiwork/agui-adapter", "build"] },
  { args: ["--filter", "@sankiwork/plugin-runtime", "build"] },
  { args: ["--filter", "@sankiwork/diagnostics", "build"] },
  { args: ["--filter", "@sankiwork/dsh-runtime", "build"] },
  { args: ["--filter", "@sankiwork/daemon", "build"] },
  { args: ["--filter", "@sankiwork/web", "build"], env: ["SW_WEB_OUTPUT_MODE"] },
  { args: ["--filter", "@sankiwork/web", "build:sidecar"] },
  { args: ["--filter", "@sankiwork/desktop", "build"] },
  { args: ["--filter", "@sankiwork/packaged", "build"] },
] as const;
