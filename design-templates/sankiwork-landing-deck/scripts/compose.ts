...
/**
 * sankiwork-landing-deck — slide deck composer.
 *
 ...
 * stylesheet from the sister `sankiwork-landing` skill, then layers
...
const SISTER_STYLES = resolve(SKILL_ROOT, '..', 'sankiwork-landing', 'styles.css');
...
/* ------------------------------------------------------------------ *
 * deck-specific stylesheet (layered on top of sankiwork-landing CSS).
 *
