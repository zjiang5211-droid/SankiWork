/**
 * sankiwork-landing-deck — input schema.
 *
 * Sister skill to `sankiwork-landing`. Produces a single-file slide
...
import type { MixedText, BrandBlock, ImageryConfig } from '../sankiwork-landing/schema';
