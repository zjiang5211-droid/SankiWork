...
Sister design template to [`sankiwork-landing`](../sankiwork-landing/).
...
The deck assumes 16 collage assets at `../sankiwork-landing/assets/`
...
```text
design-templates/sankiwork-landing-deck/
...
uses `'../sankiwork-landing/assets/'`.

To regenerate or stub:

```bash
# Generate via gpt-image-2 (fal.ai)
FAL_KEY=fal-... npx tsx ../sankiwork-landing/scripts/imagegen.ts \
  ../sankiwork-landing/inputs.example.json \
  --out=../sankiwork-landing/assets/
...
| Old | New |
| --- | --- |
| skill folder `editorial-collage-deck/` | `sankiwork-landing-deck/` |
| shared assets `../editorial-collage/assets/` | `../sankiwork-landing/assets/` |
...
- [`sankiwork-landing`](../sankiwork-landing/) — landing-page sister template.
