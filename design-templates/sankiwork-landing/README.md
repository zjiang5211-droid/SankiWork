...
- **Path:** `skills/editorial-collage/` → `design-templates/sankiwork-landing/`.
- **Shared assets:** downstream paths such as `../editorial-collage/assets/`
  (for example from the slide-deck template) should use
  [`../sankiwork-landing/assets/`](./assets/) — see
  [`sankiwork-landing-deck`](../sankiwork-landing-deck/README.md).
...
- [`design-templates/sankiwork-landing-deck/`](../sankiwork-landing-deck/) — sibling template that produces a slide deck in the same visual language.
