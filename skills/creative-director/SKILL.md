...
## SankiWork orchestration mode

When this skill is invoked inside SankiWork, treat it as the design-flow
...
3. Search across every available SankiWork resource, not only this skill:
