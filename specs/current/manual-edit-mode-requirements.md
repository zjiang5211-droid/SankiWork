# SankiWork Manual Edit Mode Requirements

## Purpose

This document records the accepted manual edit-mode model from `apps/edit-mode-demo` so it can be migrated into the main SankiWork web app.
...
- Preserve SankiWork's existing preview model.
...
Existing SankiWork integration points:
