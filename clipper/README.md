# SankiWork Web Clipper (MV3 — Chrome · Edge · Firefox)

The **SankiWork Web Clipper**: a browser extension that captures images,
screenshots, and page content from any site straight into your SankiWork
...
1. Start SankiWork locally (`pnpm tools-dev`) so the daemon is listening on
...
**● Connected** as soon as it detects SankiWork running, and you can capture
right away.
...
- **On-page toolbar** → an optional floating page / design-system / Figma JSON /
  ...
  *Show on-page bar* in the popup (the preference is remembered, and the bar's
  ...
  snapshot.
- **Right-click an image** → *Save image to SankiWork Library*.
