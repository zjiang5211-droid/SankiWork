# SankiWork Web Clipper — Privacy Policy

_Last updated: 2026-06-16_

**Short version: the SankiWork Web Clipper does not collect, store, or transmit
your data to us or to any third party. Everything you clip goes only to the
SankiWork app running on your own computer.**
...
viewing and sends it to the SankiWork application running locally on your own
...
Nothing. The developer (SankiWork / nexu-io) operates **no servers** that
...
- **Access to websites you clip (`<all_urls>`)** — to read and screenshot the
  ...
  reach your local SankiWork app. The extension acts only on the page you
...
- **Context menus** — the right-click "Save image to SankiWork Library" entry.
...
All captured content is stored by the SankiWork app in its local Library on your
