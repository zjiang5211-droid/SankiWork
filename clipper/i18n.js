...
(function () {
  ...
  const en = {
    ...
    brandDataNote: 'This file contains a structured JSON payload at <code>#sw-design-system-data</code> for future automation.',
  ...
  const overrides = {
    ...
    'zh-CN': {
      ...
      brandDataNote: '此文件在 <code>#sw-design-system-data</code> 中包含结构化 JSON，供后续自动化使用。',
