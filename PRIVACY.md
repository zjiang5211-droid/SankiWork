...
This page describes what data the SankiWork desktop and web app collects,
...
SankiWork is **local-first**. Your projects, generated files, and BYOK API
...
SankiWork has two telemetry classes:
...
are sent through the SankiWork telemetry relay to
...
They are not telemetry fields and are never sent to the SankiWork team.

## SankiWork AMR

“SankiWork AMR” is SankiWork’s official, first-party model service. Because
