...
| REG-017 | static marketplace-json publish | `sw plugin publish --to marketplace-json` 的纯 upsert 逻辑强制 `vendor/plugin-name`，从 GitHub URL 推导 reproducible source，并稳定更新 catalog | `apps/daemon/tests/plugins-publish.test.ts` |
...
| ID | 场景 | 原因 |
| --- | --- | --- |
| REG-M01 | sanki-ai.cloud marketplace 页面视觉、SEO、插件详情叙事 | 强依赖品牌表达和真实内容质量，适合人工验收 |
