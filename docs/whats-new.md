...
```
https://whatsnew.sanki-ai.cloud/whats-new.json
```
...
- The daemon proxies it at `GET /api/whats-new` (also `sw whats-new [--json]`),
...
- `SW_WHATS_NEW_URL` overrides the source for local development and tests (for
...
```json
{
  ...
  "locales": {
    "zh-CN": {
      ...
      "linkUrl": "https://sanki-ai.cloud/zh/blog/0-13-0/"
    }
  }
}
```
