<h1 align="center">SankiWork: la alternativa de código abierto a Claude Design</h1>

> ⚡ **[SankiWork Cloud — el servicio oficial de modelos.](https://sanki-ai.cloud/zh/pricing/)** Una sola recarga permite usar modelos de agentes y de imagen dentro de SankiWork: GPT, Claude y DeepSeek para agentes; GPT Image 2.0, Seedream 5.0 Pro y Nano Banana 2.0 para imágenes.
>
> 🚀 **[DeepSeek V4 Flash y V4 Pro ya están disponibles.](https://sanki-ai.cloud/zh/pricing/)** Usa inteligencia de primer nivel para prototipos, presentaciones, sistemas de diseño y tareas cotidianas de agentes. Los miembros de SankiWork pueden usar ambos modelos sin límites durante dos semanas, directamente en la aplicación.
>
> 🧩 **[DeepSeek Harness ya es compatible.](https://sanki-ai.cloud/zh/agents/deepseek-harness-design/)** Conecta el Agent Harness oficial `dsh` de DeepSeek como runtime nativo de SankiWork, con pensamiento estructurado, llamadas a herramientas, descubrimiento de modelos, cancelación y reanudación de sesiones. Los archivos generados permanecen en el flujo de SankiWork para previsualización en vivo y entrega.
...
<p align="center">
  <a href="https://sanki-ai.cloud/">Sitio web</a> ·
  <a href="https://sanki-ai.cloud/">Descargar</a> ·
...
SankiWork es lo que obtienes cuando ese bucle deja de estar cerrado y se convierte en un **sistema de archivos de skills funcionales, plantillas de renderizado, sistemas de diseño y plugins** que tus agentes pueden leer, escribir y remezclar.
...
> SankiWork se distribuye como **skills, una CLI y un servidor MCP** que los agentes de codificación más populares consumen de forma nativa. Una vez instalado OD, un único `sw mcp install <agent>` conecta el servidor MCP a la configuración de ese agente, y llamas a las mismas herramientas desde dentro de cualquier agente.

| Agente de codificación / plataforma &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Estado &nbsp;&nbsp; | Instalación del servidor MCP en una línea &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
|---|:---:|---|
| [Claude Code](https://docs.anthropic.com/en/docs/claude-code) | ✅ Compatible | `sw mcp install claude` |
| [Codex CLI](https://github.com/openai/codex) | ✅ Compatible | `sw mcp install codex` |
| [DeepSeek Reasonix](https://github.com/esengine/DeepSeek-Reasonix) | ✅ Compatible | `sw mcp install reasonix` |
| [Raven](https://github.com/EverMind-AI/Raven) | ✅ Compatible | `sw mcp install raven` |
| [Cursor](https://www.cursor.com/cli) | ✅ Compatible | `sw mcp install cursor` |
| [VS Code + GitHub Copilot](https://github.com/features/copilot) | ✅ Compatible | `sw mcp install copilot` |
| [GitHub Copilot CLI](https://github.com/features/copilot/cli) | ✅ Compatible | `sw mcp install copilot` |
| [OpenCode](https://opencode.ai/) | ✅ Compatible | `sw mcp install opencode` |
| [OpenClaw](https://github.com/openclaw/openclaw) | ✅ Compatible | `sw mcp install openclaw` |
| [Antigravity](https://antigravity.google) | ✅ Compatible | `sw mcp install antigravity` |
| [Cline](https://github.com/cline/cline) | ✅ Compatible | `sw mcp install cline` |
| [Trae](https://www.trae.ai/) | ✅ Compatible | `sw mcp install trae` |
| [Kimi CLI](https://github.com/MoonshotAI/kimi-cli) | ✅ Compatible | `sw mcp install kimi` |
| [Kiro](https://kiro.dev) | ✅ Compatible | `sw mcp install kiro` |
| [Pi Agent](https://github.com/badlogic/pi-mono) | ✅ Compatible | `sw mcp install pi` |
| [Mistral Vibe CLI](https://github.com/mistralai/mistral-vibe) | ✅ Compatible | `sw mcp install vibe` |
| [Hermes Agent](https://github.com/nousresearch/hermes-agent) | ✅ Compatible | `sw mcp install hermes` |

`sw mcp install <agent> --print` para una vista previa en seco · `--uninstall` para eliminar · lista completa con `sw mcp install --help`.

<p align="center">
  <img src="https://repo-assets.sanki-ai.cloud/resources/images/coding-agents.png" alt="Las 25 CLIs de agentes de codificación que admite SankiWork — Claude Code · Codex · OpenCode · Hermes · Antigravity · Vela · Grok Build · Kimi · Cursor Agent · Qwen · Qoder · GitHub Copilot · Pi · Kiro · Kilo · Mistral Vibe · DeepSeek · Reasonix · Aider · Amp · CodeBuddy · Mimo · AtomCode · Devin · Trae" width="100%" />
</p>
...
**[HyperFrames][hyperframes]** es el framework de video de código abierto y agent-native de HeyGen, integrado como ciudadano de primera clase en SankiWork. El agente escribe HTML + CSS + GSAP, y HyperFrames lo renderiza a un MP4 determinista mediante Chrome headless + FFmpeg. Combínalo con **Seedance 2.0** para t2v / i2v cinematográfico, **Veo 3 / Sora 2 / Kling 2** para variantes de modelo enrutadas, y **Suno v5 / Lyria 2** para la capa de audio.
...
SankiWork (OD) es la alternativa de código abierto. El mismo bucle, el mismo modelo mental centrado en el artefacto, sin nada del lock-in:
...
La forma más rápida de usar SankiWork. Sin Node, sin pnpm, sin clonar.

- **macOS** (Apple Silicon · Intel x64) → [**sanki-ai.cloud**](https://sanki-ai.cloud/) o [GitHub Releases](https://github.com/nexu-io/open-design/releases)
- **Windows** (x64) → [**sanki-ai.cloud**](https://sanki-ai.cloud/) o [GitHub Releases](https://github.com/nexu-io/open-design/releases)
...
Puedes usar SankiWork sin abrir nunca la GUI — llámalo como skill, plugin o servidor MCP dentro de Claude Code, Codex, Cursor, Copilot, OpenClaw, Antigravity, Hermes, Kimi y más.
...
En una ejecución CLI local con sistema de archivos, el agente combina el skill funcional o la plantilla elegida con tu `DESIGN.md`, escribe los archivos canónicos y SankiWork los previsualiza. Una ejecución BYOK/API sin herramientas de archivos devuelve un único bloque `<artifact>` completo.
...
La plantilla de Sealos App Store ejecuta la imagen Docker publicada de SankiWork con almacenamiento persistente para el espacio de trabajo y Basic Auth en el proxy público. Para despliegues Docker públicos o compartidos personalizados, sigue la guía de proxy inverso y `SANKIWORK_ALLOWED_ORIGINS` en [`deploy/README.md`](../../deploy/README.md#local-compose).
...
5. **SankiWork se vuelve más inteligente conforme lo usas.** Tus capturas, fuentes, paletas y artefactos confirmados se acumulan como valores por defecto para la próxima sesión. Menos retrabajo, menos deriva.

---

## Usa SankiWork desde tu agente de codificación

SankiWork distribuye un **servidor MCP por stdio** y **scripts de instalación** por agente. Cualquier agente compatible con MCP en otro repo puede leer archivos de tus proyectos locales de SankiWork directamente — tokens CSS, componentes JSX, HTML de entrada — como una API estructurada consultable por nombre. El agente siempre ve el archivo en vivo, no una exportación obsoleta.
...
**Para un agente que empieza desde cero,** el instalador coloca `~/.config/<agent>/sankiwork.json` (o el equivalente de la plataforma) más un fragmento MCP para copiar y pegar. Cursor obtiene un deeplink de un clic; Claude Code obtiene un comando `claude mcp add-json` de una línea; cada otro agente obtiene JSON en el esquema que su configuración espera. Flujo completo por agente → **Settings → MCP server** en la app de escritorio, o [`docs/agent-adapters.md`](../../docs/agent-adapters.md).

**Modelo de seguridad.** De solo lectura por defecto, el daemon se enlaza a `127.0.0.1` y el SSRF se bloquea en el borde del proxy. La exposición a la LAN requiere un `SW_BIND_HOST` explícito más `SW_ALLOWED_ORIGINS`. Las credenciales de conectores y las rutas de vista previa de artefactos en vivo permanecen solo en loopback independientemente de ello.
...
- 🔁 **Migrar flujos de trabajo de Figma / Pencil** → código fuente React, Next.js o Vue. Consulta [`sw-figma-migration`](../../plugins/_official/scenarios/sw-figma-migration/).
- 🛠️ **Renovar una base de código existente a una especificación de marca** — apunta un plugin a un repo `git` + `DESIGN.md`, obtén un PR. Consulta [`sw-code-migration`](../../plugins/_official/scenarios/sw-code-migration/).
- 💾 **Persistir flujos de trabajo personalizados** — las plantillas reutilizables de tu equipo conviven junto a las incluidas.

### Usar plugins

Los plugins tienen plena paridad entre la **UI web** y la **CLI `sw`** — los mismos endpoints `/api/plugins`, elige el que prefieras.
...
Un plugin de SankiWork requiere `sankiwork.json` y el payload de su tipo. Los skills y escenarios también incluyen `SKILL.md`; otros tipos usan su payload específico:
...
Campos principales de `sankiwork.json`: `specVersion`, `name`, `version` y el `compat.agentSkills[].path` opcional cuando la entrada expone un Agent Skill, además de `od.kind`, `od.taskKind`, `od.mode`, `od.capabilities[]` y `od.inputs[]`.
...
1. Suelta la carpeta del plugin en [`plugins/community/`](../../plugins/community/) (plugins de terceros), o — para distribuirlo empaquetado con SankiWork — en el nivel correspondiente de [`plugins/_official/`](../../plugins/_official/).
2. Pasa la validación: `sw plugin validate`, `pnpm guard`, `pnpm --filter @sankiwork/plugin-runtime typecheck`.
...
- [x] **0.9.0** — SankiWork Cloud (Model Router oficial integrado en la app: cero configuración, inicio de sesión de un clic)
...
- [ ] `npx sw init` para generar un proyecto con `DESIGN.md`
...
SankiWork sigue avanzando porque los colaboradores — diseñadores, ingenieros, autores de prompts — siguen apareciendo. Muchos de los skills, sistemas de diseño y plugins más usados fueron escritos por personas ajenas al equipo principal.
...
| Un nuevo **plugin** | Suelta `sankiwork.json` + el payload específico de su tipo bajo una carpeta de categoría | [`plugins/community/`](../../plugins/community/) · especificación en [`plugins/spec/SPEC.md`](../../plugins/spec/SPEC.md) · guía de desarrollo con agente en [`plugins/spec/AGENT-DEVELOPMENT.md`](../../plugins/spec/AGENT-DEVELOPMENT.md) |
...
Estamos reclutando **SankiWork Fellows** en todo el mundo — los Fellows dan forma al producto junto al equipo principal, representan oficialmente a SankiWork en su región y hacen crecer la comunidad localmente, respaldados por apoyo financiado ($1,000 / MR), créditos LLM gratuitos y una vía de revisión directa. Detalles → [`MAINTAINERS.md`](../../MAINTAINERS.md) y el anuncio en [Discord](https://discord.gg/mHAjSMV6gz).
...
<picture>
  <img alt="SankiWork — métricas del repositorio" src="https://repo-assets.sanki-ai.cloud/resources/images/github-metrics.svg" />
</picture>
...
<p align="center">
  <a href="https://github.com/nexu-io/open-design"><img src="https://repo-assets.sanki-ai.cloud/resources/images/star-us.png" alt="Dale una estrella a SankiWork en GitHub — github.com/nexu-io/open-design" width="100%" /></a>
</p>
...
| [`heygen-com/hyperframes`](https://github.com/heygen-com/hyperframes) | El framework de gráficos en movimiento HTML→MP4, integrado como el `hyperframes-html` de primera clase en SankiWork. |
