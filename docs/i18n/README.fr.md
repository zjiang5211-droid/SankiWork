<h1 align="center">SankiWork : l'alternative open source à Claude Design</h1>

> ⚡ **[SankiWork Cloud — le service de modèles officiel.](https://sanki-ai.cloud/zh/pricing/)** Une seule recharge pour utiliser des modèles d'agents et d'images dans SankiWork : GPT, Claude et DeepSeek pour les agents ; GPT Image 2.0, Seedream 5.0 Pro et Nano Banana 2.0 pour les images.
>
> 🚀 **[DeepSeek V4 Flash et V4 Pro sont maintenant disponibles.](https://sanki-ai.cloud/zh/pricing/)** Mettez une intelligence de premier plan au service des prototypes, présentations, systèmes de design et tâches quotidiennes des agents. Les membres SankiWork peuvent utiliser les deux modèles sans limite pendant deux semaines, directement dans l'application.
>
> 🧩 **[DeepSeek Harness est maintenant pris en charge.](https://sanki-ai.cloud/zh/agents/deepseek-harness-design/)** Connectez l'Agent Harness officiel `dsh` de DeepSeek à SankiWork en tant que runtime natif, avec raisonnement structuré, appels d'outils, découverte des modèles, annulation et reprise de session. Les fichiers générés restent dans le workflow SankiWork pour la prévisualisation en direct et la livraison.
...
<p align="center">
  <a href="https://sanki-ai.cloud/">Site web</a> ·
  <a href="https://sanki-ai.cloud/">Télécharger</a> ·
...
SankiWork transforme cette boucle en un **système de fichiers de skills fonctionnels, de modèles de rendu, de systèmes de design et de plugins** que vos agents peuvent lire, écrire et remixer.
...
> SankiWork se présente sous forme de **skills, d'un CLI et d'un serveur MCP** que les principaux agents de code consomment nativement. Une fois OD installé, une seule commande `sw mcp install <agent>` câble le serveur MCP dans la configuration de cet agent, et vous appelez les mêmes outils depuis n'importe quel agent.

| Agent de code / plateforme &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Statut &nbsp;&nbsp; | Installation du serveur MCP en une ligne &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
|---|:---:|---|
| [Claude Code](https://docs.anthropic.com/en/docs/claude-code) | ✅ Pris en charge | `sw mcp install claude` |
| [Codex CLI](https://github.com/openai/codex) | ✅ Pris en charge | `sw mcp install codex` |
| [DeepSeek Reasonix](https://github.com/esengine/DeepSeek-Reasonix) | ✅ Pris en charge | `sw mcp install reasonix` |
| [Raven](https://github.com/EverMind-AI/Raven) | ✅ Pris en charge | `sw mcp install raven` |
| [Cursor](https://www.cursor.com/cli) | ✅ Pris en charge | `sw mcp install cursor` |
| [VS Code + GitHub Copilot](https://github.com/features/copilot) | ✅ Pris en charge | `sw mcp install copilot` |
| [GitHub Copilot CLI](https://github.com/features/copilot/cli) | ✅ Pris en charge | `sw mcp install copilot` |
| [OpenCode](https://opencode.ai/) | ✅ Pris en charge | `sw mcp install opencode` |
| [OpenClaw](https://github.com/openclaw/openclaw) | ✅ Pris en charge | `sw mcp install openclaw` |
| [Antigravity](https://antigravity.google) | ✅ Pris en charge | `sw mcp install antigravity` |
| [Cline](https://github.com/cline/cline) | ✅ Pris en charge | `sw mcp install cline` |
| [Trae](https://www.trae.ai/) | ✅ Pris en charge | `sw mcp install trae` |
| [Kimi CLI](https://github.com/MoonshotAI/kimi-cli) | ✅ Pris en charge | `sw mcp install kimi` |
| [Kiro](https://kiro.dev) | ✅ Pris en charge | `sw mcp install kiro` |
| [Pi Agent](https://github.com/badlogic/pi-mono) | ✅ Pris en charge | `sw mcp install pi` |
| [Mistral Vibe CLI](https://github.com/mistralai/mistral-vibe) | ✅ Pris en charge | `sw mcp install vibe` |
| [Hermes Agent](https://github.com/nousresearch/hermes-agent) | ✅ Pris en charge | `sw mcp install hermes` |

`sw mcp install <agent> --print` pour un aperçu à blanc · `--uninstall` pour supprimer · liste complète avec `sw mcp install --help`.

<p align="center">
  <img src="https://repo-assets.sanki-ai.cloud/resources/images/coding-agents.png" alt="Les 25 CLI d'agents de code pris en charge par SankiWork — Claude Code · Codex · OpenCode · Hermes · Antigravity · Vela · Grok Build · Kimi · Cursor Agent · Qwen · Qoder · GitHub Copilot · Pi · Kiro · Kilo · Mistral Vibe · DeepSeek · Reasonix · Aider · Amp · CodeBuddy · Mimo · AtomCode · Devin · Trae" width="100%" />
</p>
...
SankiWork (OD) est l'alternative open source. La même boucle, le même modèle mental orienté artefact, sans aucun verrouillage :
...
Le moyen le plus rapide d'utiliser SankiWork. Pas de Node, pas de pnpm, pas de clone.
...
Vous pouvez utiliser SankiWork sans jamais ouvrir l'interface graphique — appelez-le en tant que skill, plugin ou serveur MCP à l'intérieur de Claude Code, Codex, Cursor, Copilot, OpenClaw, Antigravity, Hermes, Kimi, et bien d'autres.
...
Dans une exécution CLI locale avec système de fichiers, l'agent compose le skill fonctionnel ou le modèle choisi avec votre `DESIGN.md`, écrit les fichiers canoniques et SankiWork les prévisualise. Une exécution BYOK/API sans outils de fichiers renvoie un unique bloc `<artifact>` complet.
...
Le modèle Sealos App Store exécute l'image Docker publiée d'SankiWork avec un stockage persistant pour l'espace de travail et une Basic Auth sur le proxy public. Pour les déploiements Docker publics ou partagés personnalisés, suivez les indications de proxy inverse et `SANKIWORK_ALLOWED_ORIGINS` dans [`deploy/README.md`](../../deploy/README.md#local-compose).
...
5. **SankiWork devient plus intelligent à mesure que vous l'utilisez.** Vos captures d'écran, polices, palettes et artefacts confirmés s'accumulent comme valeurs par défaut pour la session suivante. Moins de retouches, moins de dérive.

---

## Utilisez SankiWork depuis votre agent de code

SankiWork livre un **serveur MCP en stdio** et des **scripts d'installation** par agent. Tout agent compatible MCP dans un autre dépôt peut lire directement des fichiers de vos projets SankiWork locaux — tokens CSS, composants JSX, HTML d'entrée — comme une API structurée interrogeable par nom. L'agent voit toujours le fichier en direct, jamais un export périmé.
...
Les plugins sont à parité totale entre l'**interface web** et le **CLI `sw`** — les mêmes points de terminaison `/api/plugins`, choisissez celui qui convient.
...
1. Déposez le dossier du plugin dans [`plugins/community/`](../../plugins/community/) (plugins tiers), ou — pour le livrer empaqueté avec SankiWork — dans le tier correspondant de [`plugins/_official/`](../../plugins/_official/).
2. Passez la validation : `sw plugin validate`, `pnpm guard`, `pnpm --filter @sankiwork/plugin-runtime typecheck`.
...
- [x] **0.9.0** — SankiWork Cloud (Model Router officiel intégré à l'application : zéro configuration, connexion en un clic)
...
- [ ] `npx sw init` pour échafauder un projet avec un `DESIGN.md`
...
SankiWork continue d'avancer parce que des contributeurs — designers, ingénieurs, auteurs de prompts — continuent de se présenter. Beaucoup des skills, systèmes de design et plugins les plus utilisés ont été écrits par des personnes extérieures à l'équipe principale.
...
### 🏅 Programme SankiWork Fellow

Nous recrutons des **SankiWork Fellows** dans le monde entier — les Fellows façonnent le produit aux côtés de l'équipe principale, représentent officiellement SankiWork dans leur région et font grandir la communauté localement, avec le soutien d'un financement ($1,000 / MR), de crédits LLM gratuits et d'une voie de revue directe. Détails → [`MAINTAINERS.md`](../../MAINTAINERS.md) et l'annonce sur [Discord](https://discord.gg/mHAjSMV6gz).
...
<a href="https://github.com/nexu-io/open-design/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nexu-io/open-design&max=500&columns=20&anon=1&cache_bust=2026-08-04" alt="Contributeurs d'SankiWork" />
</a>
...
<picture>
  <img alt="SankiWork — métriques du dépôt" src="https://repo-assets.sanki-ai.cloud/resources/images/github-metrics.svg" />
</picture>
...
<p align="center">
  <a href="https://github.com/nexu-io/open-design"><img src="https://repo-assets.sanki-ai.cloud/resources/images/star-us.png" alt="Mettez une étoile à SankiWork sur GitHub — github.com/nexu-io/open-design" width="100%" /></a>
</p>
...
<a href="https://star-history.com/#nexu-io/open-design&Date">
  <picture>
    ...
    <img alt="Historique des étoiles d'SankiWork" src="https://api.star-history.com/svg?repos=nexu-io/open-design&type=Date&cache_bust=2026-08-04" />
  </picture>
</a>
...
| [`heygen-com/hyperframes`](https://github.com/heygen-com/hyperframes) | Le framework de motion graphics HTML→MP4, intégré comme `hyperframes-html` de première classe dans SankiWork. |
