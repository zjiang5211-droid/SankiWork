<h1 align="center">SankiWork: відкрита альтернатива Claude Design</h1>

> ⚡ **[SankiWork Cloud — офіційний сервіс моделей.](https://sanki-ai.cloud/zh/pricing/)** Одне поповнення відкриває доступ до агентних і графічних моделей в SankiWork: GPT, Claude та DeepSeek для агентів; GPT Image 2.0, Seedream 5.0 Pro та Nano Banana 2.0 для зображень.
>
> 🚀 **[DeepSeek V4 Flash і V4 Pro вже доступні.](https://sanki-ai.cloud/zh/pricing/)** Використовуйте передовий інтелект для прототипів, презентацій, дизайн-систем і щоденних агентних завдань. Учасники SankiWork можуть користуватися обома моделями без обмежень два тижні безпосередньо в застосунку.
>
> 🧩 **[DeepSeek Harness тепер підтримується.](https://sanki-ai.cloud/zh/agents/deepseek-harness-design/)** Підключіть офіційний Agent Harness `dsh` від DeepSeek до SankiWork як нативне середовище виконання зі структурованим мисленням, викликами інструментів, пошуком моделей, скасуванням і відновленням сесії. Створені файли залишаються в робочому процесі SankiWork для живого попереднього перегляду й передачі результату.
...
<p align="center">
  <a href="https://sanki-ai.cloud/">Вебсайт</a> ·
  <a href="https://sanki-ai.cloud/">Завантажити</a> ·
...
SankiWork перетворює цей цикл на **файлову систему функціональних навичок, шаблонів рендерингу, дизайн-систем і плагінів**, яку агенти можуть читати, записувати та реміксувати.
...
> SankiWork постачається як **навички, CLI та сервер MCP**, які основні кодувальні агенти споживають нативно. Щойно OD встановлено, одна команда `sw mcp install <agent>` під'єднує сервер MCP до конфігурації цього агента, і ви викликаєте ті самі інструменти зсередини будь-якого агента.

| Кодувальний агент / платформа &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Статус &nbsp;&nbsp; | Встановлення сервера MCP одним рядком &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
|---|:---:|---|
| [Claude Code](https://docs.anthropic.com/en/docs/claude-code) | ✅ Підтримується | `sw mcp install claude` |
| [Codex CLI](https://github.com/openai/codex) | ✅ Підтримується | `sw mcp install codex` |
| [DeepSeek Reasonix](https://github.com/esengine/DeepSeek-Reasonix) | ✅ Підтримується | `sw mcp install reasonix` |
| [Raven](https://github.com/EverMind-AI/Raven) | ✅ Підтримується | `sw mcp install raven` |
| [Cursor](https://www.cursor.com/cli) | ✅ Підтримується | `sw mcp install cursor` |
| [VS Code + GitHub Copilot](https://github.com/features/copilot) | ✅ Підтримується | `sw mcp install copilot` |
| [GitHub Copilot CLI](https://github.com/features/copilot/cli) | ✅ Підтримується | `sw mcp install copilot` |
| [OpenCode](https://opencode.ai/) | ✅ Підтримується | `sw mcp install opencode` |
| [OpenClaw](https://github.com/openclaw/openclaw) | ✅ Підтримується | `sw mcp install openclaw` |
| [Antigravity](https://antigravity.google) | ✅ Підтримується | `sw mcp install antigravity` |
| [Cline](https://github.com/cline/cline) | ✅ Підтримується | `sw mcp install cline` |
| [Trae](https://www.trae.ai/) | ✅ Підтримується | `sw mcp install trae` |
| [Kimi CLI](https://github.com/MoonshotAI/kimi-cli) | ✅ Підтримується | `sw mcp install kimi` |
| [Kiro](https://kiro.dev) | ✅ Підтримується | `sw mcp install kiro` |
| [Pi Agent](https://github.com/badlogic/pi-mono) | ✅ Підтримується | `sw mcp install pi` |
| [Mistral Vibe CLI](https://github.com/mistralai/mistral-vibe) | ✅ Підтримується | `sw mcp install vibe` |
| [Hermes Agent](https://github.com/nousresearch/hermes-agent) | ✅ Підтримується | `sw mcp install hermes` |

`sw mcp install <agent> --print` для попереднього перегляду без застосування · `--uninstall` для видалення · повний список через `sw mcp install --help`.
...
**[HyperFrames][hyperframes]** — це відкрита, agent-native відеоплатформа від HeyGen, інтегрована як повноправний учасник в SankiWork. Агент пише HTML + CSS + GSAP, а HyperFrames рендерить це в детермінований MP4 через headless Chrome + FFmpeg. Поєднайте її з **Seedance 2.0** для кінематографічного t2v / i2v, **Veo 3 / Sora 2 / Kling 2** для маршрутизованих варіантів моделей та **Suno v5 / Lyria 2** для аудіошару.
...
SankiWork (OD) — це альтернатива з відкритим кодом. Той самий цикл, та сама ментальна модель «спершу артефакт», без жодної прив'язки:
...
Найшвидший спосіб скористатися SankiWork. Без Node, без pnpm, без клонування.

- **macOS** (Apple Silicon · Intel x64) → [**sanki-ai.cloud**](https://sanki-ai.cloud/) або [GitHub Releases](https://github.com/nexu-io/open-design/releases)
- **Windows** (x64) → [**sanki-ai.cloud**](https://sanki-ai.cloud/) або [GitHub Releases](https://github.com/nexu-io/open-design/releases)
...
Ви можете користуватися SankiWork, жодного разу не відкриваючи GUI — викликайте його як навичку, плагін або сервер MCP усередині Claude Code, Codex, Cursor, Copilot, OpenClaw, Antigravity, Hermes, Kimi тощо.
...
У локальному CLI-запуску з файловою системою агент компонує функціональну навичку або шаблон із `DESIGN.md`, пише канонічні файли, а SankiWork їх показує. BYOK/API без файлових інструментів повертає один повний блок `<artifact>`.
...
Шаблон Sealos App Store запускає опублікований Docker-образ SankiWork із постійним сховищем робочої області та Basic Auth на публічному проксі. Для користувацьких публічних або спільних Docker-розгортань дотримуйтеся рекомендацій щодо зворотного проксі та `SANKIWORK_ALLOWED_ORIGINS` у [`deploy/README.md`](../../deploy/README.md#local-compose).
...
5. **SankiWork стає розумнішим у міру використання.** Ваші скриншоти, шрифти, палітри та підтверджені артефакти накопичуються як значення за замовчуванням для наступної сесії. Менше переробки, менше дрейфу.

---

## Використання SankiWork зі свого кодувального агента

SankiWork постачає **сервер MCP через stdio** та **скрипти встановлення** для кожного агента. Будь-який MCP-сумісний агент в іншому репозиторії може читати файли з ваших локальних проєктів SankiWork безпосередньо — CSS токенів, JSX-компоненти, вхідний HTML — як структурований API, до якого можна звертатися за іменем. Агент завжди бачить живий файл, а не застарілий експорт.
...
Плагіни мають повний паритет між **вебінтерфейсом** та **CLI `sw`** — ті самі кінцеві точки `/api/plugins`, виберіть те, що підходить.
...
1. Покладіть теку плагіна в [`plugins/community/`](../../plugins/community/) (сторонні плагіни), або — щоб постачати його в комплекті з SankiWork — у відповідний рівень [`plugins/_official/`](../../plugins/_official/).
2. Пройдіть валідацію: `sw plugin validate`, `pnpm guard`, `pnpm --filter @sankiwork/plugin-runtime typecheck`.
...
- [x] **0.9.0** — SankiWork Cloud (офіційний Model Router, вбудований у застосунок: нуль конфігурації, вхід в один клік)
...
- [ ] `npx sw init` для каркасування проєкту з `DESIGN.md`
...
SankiWork продовжує рухатися, бо контриб'ютори — дизайнери, інженери, автори промптів — продовжують приходити. Багато з найуживаніших навичок, дизайн-систем і плагінів написали люди поза основною командою.
...
### 🏅 Програма SankiWork Fellow

Ми набираємо **SankiWork Fellows** по всьому світу — Fellows формують продукт разом із основною командою, офіційно представляють SankiWork у своєму регіоні та розвивають спільноту локально, маючи фінансовану підтримку ($1,000 / MR), безкоштовні LLM-кредити та прямий трек рев'ю. Деталі → [`MAINTAINERS.md`](../../MAINTAINERS.md) та анонс у [Discord](https://discord.gg/mHAjSMV6gz).
...
| [`heygen-com/hyperframes`](https://github.com/heygen-com/hyperframes) | Платформа моушн-графіки HTML→MP4, інтегрована як повноправний `hyperframes-html` в SankiWork. |
